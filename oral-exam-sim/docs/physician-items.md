...
- Bank-wide decision: COPD exacerbation severity. The Rome proposal (Celli 2021) needs hypercapnia with acidosis for severe. GOLD 2026 Figure 4.2 also counts PaO2 60 mmHg or less. asthma-copd-33 now states both. Pick one standard for the bank.
- Bank-wide decision: burn fluid titration. burns-16 keys a 10 percent rate change (Alaska 2021). Signed-off burns-02 keys a 20 to 30 percent increase and burns-13 a 20 to 30 percent decrease. Pick one standard.
- Bank-wide decision: mock mode shows every question of a SAMP at once, so a later update can cue an earlier key. Showing questions one at a time would remove the cues that wording cannot. Product decision.
- Surviving Sepsis 2021 still cited by signed-off cqi-04, loc-11, delirium-agitation-08, infectious-diseases-01, infectious-diseases-07, multiple-patients-07, multiple-patients-09 and shock-03. The 2026 guideline (Prescott, Crit Care Med 2026) changed the steroid threshold and albumin advice. Decide whether to reopen them.
