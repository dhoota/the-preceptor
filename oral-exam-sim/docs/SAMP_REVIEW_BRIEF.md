...
10. Overlap. Search the whole bank (`grep -ril` over `src/samps/`) for your batch's scenarios and teaching points, not only the batch's own topic. Related topics overlap: chest pain and ischemic heart disease, abdominal pain and infectious diseases, shock and sepsis. A SAMP that repeats another's scenario or teaching point, even in new words, must be rewritten or flagged. The duplicate stem test only catches near-identical wording.
