...
const S = {
  ...
  ispad: { id: "ispad", citation: "Glaser N, Fritsch M, Priyambada L, et al. ISPAD Clinical Practice Consensus Guidelines 2022. Diabetic ketoacidosis and hyperglycemic hyperosmolar state. Pediatr Diabetes. 2022.", url: "https://doi.org/10.1111/pedi.13406" },
  ...
  glauser: { id: "glauser", citation: "Glauser T, Shinnar S, Gloss D, et al. Evidence-based guideline. Treatment of convulsive status epilepticus in children and adults. Report of the Guideline Committee of the American Epilepsy Society. Epilepsy Curr. 2016.", url: "https://pubmed.ncbi.nlm.nih.gov/26900382/" },
...
export const MULTIPLE_PATIENTS_S44: Samp[] = [
    ...
    questions: [
      {
        id: "q1",
        kind: "single",
        prompt: "Which of the following groups does the SALT global sort send for individual assessment first?",
        options: [
          "Bleeding from a small scalp laceration",
          "Still, or with an obvious life threat",
          "Talking but unable to stand",
          "Walked to the minor area when asked",
          "Waved or moved on command",
        ],
        correct: 1,
        explanation:
          "SALT starts with a global sort. Patients who can walk go to a set area and are assessed last. Those who wave or move on command come next. Those who lie still or have an obvious life threat, like this man, are assessed first because they most need lifesaving interventions. A talking patient who cannot stand has shown purposeful movement and a patent airway. A small bleeding scalp laceration is not an obvious life threat and does not move a patient ahead of those who lie still.",
        keyFeature: { topic: "multiple-patients", n: 1 },
        source: "salt",
      },
      {
        ...
        kind: "menu",
        select: 4,
        prompt: "Which of the following lifesaving interventions does SALT include during individual assessment before a category is assigned?",
        options: [
          "Autoinjector antidote",
          "Chest decompression",
          "Endotracheal intubation",
          "IV fluid bolus",
          "Opening the airway by positioning",
          "Pelvic binder",
          "Splinting a long bone fracture",
          "Tourniquet for major hemorrhage",
        ],
        correct: [0, 1, 4, 7],
        explanation:
          "SALT allows four rapid lifesaving interventions before categorizing: control of major hemorrhage by tourniquet or pressure, opening the airway by positioning or a basic adjunct, chest decompression and autoinjector antidotes. In a child, two rescue breaths may be added. For this man a tourniquet comes first. Advanced airways are excluded because they take time and staff. IV fluids, pelvic binders and splints are treatment after triage, not triage interventions.",
        keyFeature: { topic: "multiple-patients", n: 2 },
        source: "salt",
      },
      {
        id: "q3",
        kind: "single",
        update: "A 35-year-old woman neither walked nor waved during the global sort. She now obeys commands, has a radial pulse and breathes comfortably. She has forearm abrasions and a swollen ankle only.",
        ...
        correct: 4,
        explanation:
          "She obeys commands, has a peripheral pulse, is not in respiratory distress and has no major hemorrhage. With only minor injuries that can wait without raising her risk of death, she is minimal, green. The global sort sets the order of assessment, not the category, so being slow to respond earlier does not keep her yellow. Delayed is for patients who pass the four checks but have more than minor injuries. Immediate needs a failed check.",
        keyFeature: { topic: "multiple-patients", n: 1 },
        source: "salt",
      },
      {
        id: "q4",
        kind: "single",
        update: "A 71-year-old man has an open skull fracture with exposed brain, GCS 3 and agonal breathing. You have one surgeon, two ambulances and 8 patients in the red group.",
        prompt: "Which of the following SALT categories is most appropriate for this man?",
        options: ["Dead, black", "Delayed, yellow", "Expectant, grey", "Immediate, red", "Minimal, green"],
        correct: 2,
        explanation:
          "He fails the command check, which would make him immediate. SALT then asks whether his injuries are likely to be incompatible with life given current resources. With one surgeon and 8 red patients, an open skull fracture with exposed brain and GCS 3 meets that test, so he is expectant, grey. He is breathing, so he is not dead. Expectant patients get comfort care and are reassessed once immediate patients are treated, because resources and his condition can change.",
        keyFeature: { topic: "multiple-patients", n: 4 },
        source: "salt",
      },
    ],
  ...
  },
  {
    ...
    sources: [S.aufderheide, S.frykberg, S.christianChest],
    ...META,
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: "q4",
        kind: "single",
        update: "After decontamination the other four coworkers are in the department. Their O2 saturations are 94% to 97% on room air.",
        prompt: "Which of the following coworkers should you assess first after decontamination?",
        options: [
          "Burning eyes with a normal voice",
          "Cough with O2 sat 95% on room air",
          "Nausea and a mild headache",
          "New stridor with a hoarse voice",
          "Skin redness on both forearms",
        ],
        correct: 3,
        explanation:
          "New stridor with a hoarse voice after an irritant exposure means upper airway swelling that can close the airway within hours. Among these four, that worker needs a physician first and early airway planning. Stridor with a protected airway is at least CTAS level 2. Burning eyes with a normal voice, cough with an O2 sat of 95%, nausea with headache and skin redness all need care but pose no immediate threat to the airway.",
        keyFeature: { topic: "multiple-patients", n: 1 },
        source: "ctas-2004",
      },
    ],
    sources: [S.okumura, S.ctas2004],
    ...META,
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: "q2",
        kind: "single",
        update: "A 77-year-old woman with pneumonia and septic shock also needs ventilation. She is on norepinephrine, has a GCS of 9 and has kidney and liver failure. The outreach team scores her SOFA at 14 and the man's at 3.",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correct: [0, 3, 6],
        explanation:
          "His capillary refill of 3 seconds shows volume depletion without shock. A saline bolus of 10 to 20 mL/kg over 20 to 30 minutes is the pediatric DKA standard, and 10 mL/kg is 360 mL for 36 kg. Cardiac monitoring and a venous gas with electrolytes guide potassium and insulin. An insulin bolus is not used in children and raises the risk of cerebral edema. The infusion starts about an hour after fluids begin. Potassium before a level is known risks hyperkalemia. Bicarbonate is not routine, and dextrose is added only once glucose falls.",
        keyFeature: { topic: "multiple-patients", n: 3 },
        source: "ispad",
      },
      {
    ...
    sources: [S.ctas2004, S.ctas2016, S.ispad, S.atls],
    ...META,
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          "Order a CT by phone and see him after the repair",
        ],
        correct: 1,
        explanation:
  ...
  },
  {
    ...
    stem:
      "A 79-year-old woman is brought to the emergency department by ambulance on the third day of a heat wave. Her son found her confused in her apartment, which has no air conditioning. She takes hydrochlorothiazide and metoprolol. Her skin is hot and dry. She is disoriented and does not follow commands consistently. Nine other patients with heat related complaints are waiting, and ambulances report more on the way. The vital signs listed are hers.",
    vitals: { temperature: "41.6°C rectal", pulse: "128/minute", resp: "28/minute", bp: "96/58 mmHg", o2sat: "95% on room air" },
    questions: [
      {
        id: "q1",
        kind: "single",
      ...
      },
      {
        id: "q2",
        kind: "single",
        prompt: "Which of the following is the most important first treatment for this woman?",
        options: [
          "Acetaminophen 1 g PR",
          "CT of the head before cooling",
          "Dantrolene 2.5 mg/kg IV",
          "Repeat rectal temperature in 30 minutes",
          "Start active cooling at once",
        ],
        correct: 4,
        explanation:
          "Heat stroke injures tissue in proportion to how high and how long the core temperature stays up, so rapid cooling is the treatment. Immersion in cold water or evaporative cooling with mist and fans should start at once, with the target near 39°C. Acetaminophen does not work, because the thermoregulatory set point is normal in heat stroke. It may also worsen liver injury. Dantrolene has not been shown to speed cooling. CT and a repeat temperature delay the one treatment that changes the outcome.",
        keyFeature: { topic: "multiple-patients", n: 2 },
        source: "epstein",
      },
      {
  ...
  },
  {
    ...
    sources: [S.glauser, S.paedctas, S.ctas2016],
    ...META,
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correct: 4,
        explanation:
          "Snoring with a respiratory rate of 6/minute and an O2 sat of 84% is the next patient heading to respiratory arrest. He needs airway positioning, ventilation and naloxone now. The patient who rouses to voice with an O2 sat of 91% comes after him. The drowsy patient breathing 12/minute with 95% saturation can be watched by a nurse. Agitation and vomiting after naloxone need a nurse to protect the airway and settle the patient. The awake patient asking to leave is the least urgent.",
        keyFeature: { topic: "multiple-patients", n: 1 },
        source: "dezfulian",
      },
      {
        ...
        correct: 1,
        explanation:
          "One hour after naloxone she meets every part of the St. Paul's early discharge rule. She walks as usual, has a GCS of 15, an O2 sat above 92%, a respiratory rate of 10 to 20/minute, a pulse of 50 to 100/minute and a temperature of 35 to 37.5°C. She can be discharged with a naloxone kit and harm reduction advice. That frees a monitored space for the sicker arrivals. Admission, a long observation or an infusion are not needed when she meets the rule. A urine screen does not change care and gives no grounds to hold her.",
        keyFeature: { topic: "multiple-patients", n: 2 },
        source: "christenson",
      },
      {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          "Child of 5 years on chemotherapy, 38.4°C",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        kind: "menu",
        select: 2,
        update: "Public health asks which exposed people in the waiting room are candidates for MMR vaccine. It is now 20 hours after exposure.",
        prompt: "Which of the following exposed people should receive MMR vaccine as post-exposure prophylaxis?",
        options: [
          "Child of 3 years on high dose chemotherapy",
          "Infant of 4 months with his mother",
          "Infant of 8 months, never vaccinated",
          "Nurse with two documented MMR doses",
          "Pregnant woman with negative measles serology",
          "Unvaccinated man of 25 with no history of measles",
        ],
        correct: [2, 5],
        explanation:
          "MMR within 72 hours of exposure can prevent measles in susceptible people aged 6 months and older who can receive a live vaccine. Both the 8-month-old and the unvaccinated 25-year-old are within that window at 20 hours. The 4-month-old is too young and should get IM immune globulin 0.5 mL/kg. MMR is contraindicated in pregnancy and in severe immunosuppression, so the pregnant woman gets IV immune globulin 400 mg/kg. The child on chemotherapy gets immune globulin by weight. The nurse with two documented doses is immune and needs none.",
        keyFeature: { topic: "multiple-patients", n: 1 },
        source: "cig-measles",
      },
      {
        id: "q4",
        kind: "single",
        prompt: "Which of the following is the latest time after exposure that immune globulin can be given to the 4-month-old?",
        options: ["1 day", "3 days", "6 days", "14 days", "21 days"],
        correct: 2,
        explanation:
          "Immune globulin can prevent or modify measles when given within 6 days of exposure. That matters for the infant, the pregnant woman and the child on chemotherapy, who cannot receive MMR. The 3 day limit is for MMR, which must be given within 72 hours. Stopping at 1 day would deny protection to contacts traced later. At 14 or 21 days it is far too late, because the infection is already established. Public health often finds contacts days later, so the 6 day limit guides how fast tracing must happen.",
        keyFeature: { topic: "multiple-patients", n: 4 },
        source: "cig-measles",
      },
    ],
