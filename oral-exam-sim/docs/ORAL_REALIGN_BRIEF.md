...
2. Card: add `card` with `vitals` (formats as in SAMP_SPEC section 4, weight as "70 kg (154 lb)"), `medications` and `allergies`. Take the values from the old stem and findings. Do not change a value.
