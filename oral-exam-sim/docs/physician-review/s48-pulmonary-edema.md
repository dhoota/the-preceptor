...
- pulmonary-edema-25 q3 keys methimazole 30 mg from the ATA dosing table: a free T4 of 64 pmol/L is 2.9 times the upper limit of 22 pmol/L. Beta blockade was left out of the options. *(samps-replace-s49-s53-s47-s48.md)*
- pulmonary-edema-27 q3 keys phentolamine. It is already keyed in signed-off tox-09, but please confirm local availability. *(samps-replace-s49-s53-s47-s48.md)*
- pulmonary-edema-27 (re-rebuilt) q3 keys nifedipine ER as an add-on in hospital after oxygen alone failed, following the WMS 2024 update. Please confirm the dose and formulation (30 mg ER) against Canadian supply. *(samps-replace-s49-s53-s47-s48.md)*
- pulmonary-edema-25 q3 now treats the case as thyroid storm. Beta blockade, hydrocortisone and iodine timing are left out of the options to keep one best answer. Beta blockade in thyrotoxic heart failure needs caution. *(samps-replace-s49-s53-s47-s48.md)*
- pulmonary-edema-27 q3: the WMS 2024 summary notes that nifedipine added to oxygen and descent showed no extra benefit in one trial. The key relies on the WMS hospital statement that nifedipine can be added when oxygen alone fails. *(samps-replace-s49-s53-s47-s48.md)*
...
- pulmonary-edema-29 overlaps pulmonary-edema-09 (s15): heart failure misdiagnosed as asthma, inhalers failed, NT-proBNP as the first test. The obesity teaching point is new. q1 is not. *(samps-s48-lensA.md)*
- pulmonary-edema-32 q1 (walk test before discharge) repeats pulmonary-edema-07 q1 and q2 (s15). The score calculation in q2 is new. *(samps-s48-lensA.md)*
- pulmonary-edema-39 and pulmonary-edema-40 (review-extra) are copies of pulmonary-edema-23 and pulmonary-edema-31 (its old q1), apart from the planted defects. Reject both from the batch as duplicates. *(samps-s48-lensA.md)*
- pulmonary-edema-33 q3 keys morphine 2.5 mg SC in stage 4 kidney disease. The BC guideline supports morphine in a dyspnea crisis, and its opioid guidance favours hydromorphone in renal failure. A physician may prefer hydromorphone 0.25 to 0.5 mg SC as the key. *(samps-s48-lensA.md)*
- Heart failure guidance is mostly cited to ESC 2021. CCS 2017 (with the 2021 HFrEF and 2025 HFnrEF updates) is the Canadian source of record, but I could not fetch its acute heart failure text to check wording. pulmonary-edema-30 q3 still cites CCS 2017 for multidisciplinary home support, and that is unverified. The 2023 ESC focused update does not change any acute item here. *(samps-s48-lensA.md)*
- pulmonary-edema-39 and pulmonary-edema-40 (review-extra) copy pulmonary-edema-23 and pulmonary-edema-31 word for word apart from the planted defects. Reject both from the batch. Note that the Lens A fixes to this file were not on disk when this review started. *(samps-s48-lensB.md)*
- pulmonary-edema-16 q1 (furosemide when tadalafil rules out nitrates) still shares the teaching "no nitrate within 48 hours of tadalafil" with chest-pain s28 q2 and s42 ischemic heart disease q2, though the key differs (a diuretic in pulmonary edema). Accept or rework. *(samps-s48-lensB.md)*
- pulmonary-edema-21 q1 (benzodiazepine and nitroglycerin first in cocaine toxicity, no beta-blocker) repeats the teaching in s12 ischemic heart disease and s05 chest-pain (write-in). The pulmonary edema context and menu format are new. *(samps-s48-lensB.md)*
...
- pulmonary-edema-38 q1 (orthopnea and JVP point to cardiac wheeze) repeats pulmonary-edema-03 q1 (s15, "wheezy older woman labelled with COPD"). pulmonary-edema-29 q1 teaches a similar point with bendopnea. *(samps-s48-lensB.md)*
...
- pulmonary-edema-29 q1: at a BMI of 43, bendopnea can come from abdominal girth alone, which lowers its specificity. It is still the best of the five options, but a physician may prefer another discriminator such as paroxysmal nocturnal dyspnea. *(samps-s48-lensB.md)*
- pulmonary-edema-26 q2: the source is SITC (US-based, with an international panel). The ESC 2022 cardio-oncology guideline (methylprednisolone 500 to 1000 mg daily) agrees but was not fetched. *(samps-s48-lensB.md)*
...
Review reports: docs/reviews/writer-s48.md, samps-s48-lensA.md, samps-s48-lensB.md

## SAMPs

### pulmonary-edema-16: Breathless in front of the television

- [ ] Approved  - [ ] Needs change  - [ ] Reject

A 71-year-old man presents to the emergency department with 90 minutes of worsening shortness of breath that began while he was watching television. He has hypertension, type 2 diabetes and benign prostatic hyperplasia. He takes amlodipine, ramipril, metformin, pioglitazone, and tadalafil 5 mg daily for his prostate, last taken 9 hours ago. He takes no diuretic. He is sweaty, sitting upright and cannot finish a sentence, but he is alert and follows commands. The JVP is 5 cm above the sternal angle. There are crackles to the mid zones of both lungs and trace ankle edema.

- Temperature: 36.9°C oral
- Pulse: 118/minute
- Resp.: 34/minute
- BP: 194/108 mmHg
- O2 sat: 85% on 10 L/minute by face mask

#### Q1
*Update:* Noninvasive ventilation is started. After 10 minutes his BP is 188/104 mmHg and his saturation is 89%.

**Which of the following is the most appropriate medication to give him next?**

- A. furosemide 40 mg IV  **(key)**
- B. labetalol 20 mg IV
- C. morphine 2 mg IV
- D. nitroglycerin 20 mcg/minute IV
- E. nitroglycerin 0.4 mg sublingual

*Explanation:* Tadalafil taken 9 hours ago rules out any nitrate, whether sublingual or a low dose infusion. Kloner found the fall in BP with nitroglycerin was still greater at 24 hours after tadalafil and had gone by 48 hours. Noninvasive ventilation already lowers his preload and afterload. He is congested and takes no diuretic, and the ESC guideline suggests furosemide 20 to 40 mg IV as the starting dose for a diuretic naive patient. Labetalol lowers contractility during acute pulmonary edema and can precipitate shock. Morphine is not recommended routinely and is linked to more intubation.

*Key feature:* Pulmonary edema 1. Treat pulmonary edema early and aggressively, such as with BiPAP, before the cause is known.

*Source:* Kloner RA, Hutter AM, Emmick JT, et al. Time course of the interaction between tadalafil and nitrates. J Am Coll Cardiol. 2003.

#### Q2
*Update:* After 40 minutes on noninvasive ventilation his BP is 158/92 mmHg, his pulse is 98/minute and his saturation is 94%. His daughter says pioglitazone was started 2 months ago, and his ankles have swollen since.

**Which of the following of his regular medications most likely contributed to this episode?**
...
*Explanation:* The ESC guideline notes that thiazolidinediones cause sodium and water retention and does not recommend them in heart failure, because they increase the risk of worsening and admission. Amlodipine causes ankle swelling by dilating arterioles, not by retaining fluid, and it does not cause pulmonary edema. Ramipril lowers afterload and is protective. Metformin does not retain fluid. Tadalafil matters for nitrate safety but does not cause fluid retention.

*Key feature:* Pulmonary edema 2. While stabilizing pulmonary edema, search for the underlying cause, such as MI, volume overload, or anemia.

*Source:* McDonagh TA, Metra M, Adamo M, et al. 2021 ESC Guidelines for the diagnosis and treatment of acute and chronic heart failure. Eur Heart J. 2021. https://doi.org/10.1093/eurheartj/ehab368

#### Q3
*Update:* The ECG shows sinus rhythm with left ventricular hypertrophy and no acute ischemic change. Troponin is below the 99th percentile twice. Echo shows an ejection fraction of 55% with concentric hypertrophy and no valve disease. Pioglitazone has been stopped.

**Which of the following changes to his long-term care best reduces the chance of another episode?**

- A. Add a long-acting oral nitrate
- B. Arrange coronary angiography
- C. Intensify antihypertensive therapy  **(key)**
- D. Start digoxin 0.125 mg PO daily
- E. Start ivabradine 5 mg PO twice daily

*Explanation:* A preserved ejection fraction with concentric hypertrophy and an onset at a BP of 194/108 mmHg point to uncontrolled hypertension as the remaining driver now that pioglitazone has stopped. The ESC guideline advises treating hypertension and other causes in heart failure with preserved ejection fraction. A long-acting nitrate cannot be combined with his daily tadalafil. Two normal troponins and no ischemic change do not call for angiography. Digoxin and ivabradine slow the rate but do not treat the cause, and he is in sinus rhythm.

*Key feature:* Pulmonary edema 3. Treat the identified cause of pulmonary edema, for example with reperfusion, diuresis, or transfusion, to prevent worsening.

*Source:* McDonagh TA, Metra M, Adamo M, et al. 2021 ESC Guidelines for the diagnosis and treatment of acute and chronic heart failure. Eur Heart J. 2021. https://doi.org/10.1093/eurheartj/ehab368

### pulmonary-edema-17: Third night-time admission this year
...
**Which of the following is the most appropriate additional medication for her pulmonary congestion?**

- A. dobutamine 5 mcg/kg/minute IV
- B. enalapril 5 mg PO
- C. furosemide 40 mg IV  **(key)**
- D. nitroprusside 0.3 mcg/kg/minute IV
- E. spironolactone 25 mg PO

*Explanation:* Crackles and hypoxemia persist after rate control, and the ESC pregnancy guideline recommends a diuretic when congestion persists despite a beta-blocker in mitral stenosis, used with care for placental flow. Enalapril is contraindicated in pregnancy because of fetal kidney toxicity. Nitroprusside risks fetal cyanide toxicity. Spironolactone has antiandrogen effects on a male fetus and is avoided. Dobutamine speeds the heart and shortens diastolic filling, which worsens a fixed mitral obstruction.
...
**Which of the following vasoactive infusions is the most appropriate first agent for him?**

- A. dobutamine infusion
- B. dopamine infusion
- C. milrinone infusion
- D. norepinephrine infusion  **(key)**
- E. phenylephrine infusion

*Explanation:* He has cardiogenic shock with a BP of 78/50 mmHg and a lactate of 5.1 mmol/L. The ESC guideline suggests norepinephrine as the vasopressor of choice when perfusion pressure must be restored. Dobutamine and milrinone lower systemic resistance and can drop his pressure further across a fixed obstruction. Dopamine causes more arrhythmias than norepinephrine, and a faster rate shortens diastolic filling across the blocked valve. Phenylephrine raises afterload with no inotropic support and can lower cardiac output.

*Key feature:* Pulmonary edema 4. Watch for impending respiratory failure in pulmonary edema and escalate with ventilatory support or vasoactive drugs.

*Source:* McDonagh TA, Metra M, Adamo M, et al. 2021 ESC Guidelines for the diagnosis and treatment of acute and chronic heart failure. Eur Heart J. 2021. https://doi.org/10.1093/eurheartj/ehab368

### pulmonary-edema-20: Chest ache after moving furniture
...
#### Q3
*Update:* Thirty minutes later he is on a nonrebreather mask at 15 L/minute. His saturation is 84% and his respiratory rate is 34/minute. He is alert and follows commands. The drain is still bubbling.

**Which of the following is the most appropriate next step in his respiratory support?**

- A. Clamp the drain, then start CPAP
- B. Continue nonrebreather for 1 hour
- C. CPAP with the drain left open  **(key)**
- D. Rapid sequence intubation
- E. Venturi mask at 40%

*Explanation:* Worsening hypoxemia on a nonrebreather in an alert patient calls for positive pressure. The BTS statement lists CPAP or high flow oxygen for re-expansion pulmonary edema, and with a pneumothorax it requires a functioning open drain, because positive pressure can otherwise cause tension. Clamping before CPAP removes that protection. Another hour on the nonrebreather lets him tire. A Venturi mask gives less oxygen than the mask he is failing on. He is alert and protecting his airway, so intubation is kept for failure of positive pressure support.

*Key feature:* Pulmonary edema 4. Watch for impending respiratory failure in pulmonary edema and escalate with ventilatory support or vasoactive drugs.

*Source:* Asciak R, Bedawi EO, Bhatnagar R, et al. British Thoracic Society clinical statement on pleural procedures. Thorax. 2023. https://doi.org/10.1136/thorax-2022-219371

### pulmonary-edema-21: Breathless and agitated after a party
...
#### Q3
*Update:* Ninety minutes after the last naloxone dose he becomes drowsy on CPAP. His respiratory rate is 8/minute, his pupils are pinpoint and a venous gas shows PCO2 64 mmHg.

**Which of the following is the most appropriate next step?**

- A. Bilevel NIV with backup rate
- B. flumazenil 0.2 mg IV
- C. Increase the CPAP to 12 cm H2O
- D. naloxone 0.4 mg IV  **(key)**
- E. Rapid sequence intubation

*Explanation:* Recurrent sedation with pinpoint pupils and hypoventilation 90 minutes after naloxone means the fentanyl has outlasted the antidote. Boyer advises a titrated repeat dose of naloxone to restore breathing, followed by an infusion if sedation recurs again. A mask with a backup rate in a drowsy patient risks aspiration and does not treat the cause. More CPAP does not raise his respiratory rate. Flumazenil reverses benzodiazepines and can provoke seizures. Intubation may still be needed, but the reversible cause should be treated first.

*Key feature:* Pulmonary edema 4. Watch for impending respiratory failure in pulmonary edema and escalate with ventilatory support or vasoactive drugs.

*Source:* Boyer EW. Management of opioid analgesic overdose. N Engl J Med. 2012.

#### Q4
*Update:* The next morning he is alert and his chest has cleared. His saturation is 96% on room air. He wants to go home.

**Which of the following are the most appropriate steps before he leaves the emergency department?**

Select 3.

- A. Ambulatory oxygen saturation check  **(key)**
- B. Chest X-ray repeat in 6 weeks
- C. Echocardiogram before discharge
- D. Home oxygen prescription
- E. Offer buprenorphine-naloxone  **(key)**
- F. Outpatient chest CT
- G. Serial troponin testing
- H. Take-home naloxone kit  **(key)**

*Explanation:* Checking his saturation while he walks shows he can manage exertion before he leaves. The 2024 Canadian national guideline names buprenorphine and methadone as first-line opioid agonist treatments and supports access to take-home naloxone kits. Offering buprenorphine-naloxone now starts one of those first-line options, and a kit lets others reverse the next overdose. His edema was noncardiogenic, and bedside ultrasound showed a normal ventricle, so a formal echo and serial troponins add little. This edema clears within a day or two, so repeat imaging is not needed. He is on room air, so home oxygen has no role.

*Key feature:* Pulmonary edema 6. Before discharge after pulmonary edema, confirm safety with an exertion test, home situation review, and follow-up.

*Source:* Yakovenko I, Mukaneza Y, Germe K, et al. Management of opioid use disorder. 2024 update to the national clinical practice guideline. CMAJ. 2024. https://doi.org/10.1503/cmaj.241173

### pulmonary-edema-23: Coughing after a shoulder reduction
...
#### Q1
**Which of the following is the most likely diagnosis for her symptoms?**

- A. Community-acquired pneumonia
- B. Immersion pulmonary edema  **(key)**
- C. Pulmonary embolism
- D. Spontaneous pneumothorax
- E. Submersion injury with aspiration

*Explanation:* Dyspnea, cough and blood-tinged sputum starting during a cold open-water swim, with bilateral crackles, fit immersion pulmonary edema. Moon and colleagues showed that people prone to it have higher pulmonary artery and wedge pressures during immersed exercise, and cold water, a tight wetsuit and hypertension add risk. She never went under the water, so aspiration is unlikely. Bilateral crackles argue against a pneumothorax and against embolism. She has no fever, and a sudden onset during exertion does not fit pneumonia.

*Key feature:* Pulmonary edema 5. Consider subtle pulmonary edema in patients with apparent respiratory complaints like exertional dyspnea or wheeze.

*Source:* Moon RE, Martina SD, Peacher DF, et al. Swimming-induced pulmonary edema. Pathophysiology and risk reduction with sildenafil. Circulation. 2016.

#### Q2
**Which of the following investigations is most important to look for a predisposing condition?**

- A. Echocardiography  **(key)**
- B. Holter monitoring
- C. Methacholine challenge
- D. Pulmonary function tests
- E. Ventilation perfusion scan

*Explanation:* Immersion pulmonary edema is a hemodynamic edema caused by high pulmonary capillary pressure, and Moon and colleagues link it to hypertension and to left heart problems such as hypertrophy or valve disease. Echocardiography looks for these, and her treated hypertension makes it more relevant. Holter monitoring looks for arrhythmia, which her history does not suggest. Methacholine challenge and pulmonary function tests look for asthma, but she has no wheeze. A ventilation perfusion scan tests for embolism, which the picture does not suggest.
...
#### Q3
*Update:* Six hours later her chest is clear. Her saturation is 97% on room air and stays above 95% during a brisk walk along the corridor. She plans to race again next month.

**Which of the following are the most appropriate pieces of advice before she is discharged?**

Select 2.

- A. Arrange early cardiology follow-up  **(key)**
- B. Avoid open-water swimming alone  **(key)**
- C. Daily inhaled corticosteroid
- D. Daily sildenafil 50 mg PO
- E. Furosemide before each race
- F. Salbutamol inhaler before each swim
- G. Stop amlodipine

*Explanation:* Her edema has cleared and she passed an exertion test, but immersion pulmonary edema often recurs. Moon and colleagues showed higher pulmonary vascular pressures in susceptible swimmers, so a cardiology review for hypertension or heart disease should come before more racing. If she does swim, she should not swim alone. Their study tested a single dose of sildenafil before a swim, not daily treatment. A diuretic before exercise risks dehydration and cramps. Inhaled corticosteroids and salbutamol treat asthma, which she does not have. Stopping amlodipine would raise her BP and add risk.

*Key feature:* Pulmonary edema 6. Before discharge after pulmonary edema, confirm safety with an exertion test, home situation review, and follow-up.

*Source:* Moon RE, Martina SD, Peacher DF, et al. Swimming-induced pulmonary edema. Pathophysiology and risk reduction with sildenafil. Circulation. 2016.

### pulmonary-edema-25: Night cough that inhalers did not help

- [ ] Approved  - [ ] Needs change  - [ ] Reject

A 34-year-old woman presents to the emergency department with 3 weeks of shortness of breath on stairs and a cough that wakes her at night. A walk-in clinic diagnosed asthma 10 days ago, and salbutamol has not helped. Since last night she cannot lie flat. Over 2 months she has lost 6 kg without trying, and she feels hot and shaky and has loose stools. She has no medical history and takes no other medication. She is anxious and sweaty, with a fine tremor. Her eyes are prominent, and she has a smooth, nontender goitre with a bruit. The JVP is 6 cm above the sternal angle. There are crackles to the mid zones and no wheeze. The pulse is irregularly irregular.
...
#### Q1
**Which of the following findings most strongly suggests that her breathlessness is not from asthma?**

- A. Cough that wakes her at night
- B. Crackles with a raised JVP  **(key)**
- C. Failure to respond to salbutamol
- D. Oxygen saturation of 90%
- E. Respiratory rate of 30/minute

*Explanation:* Crackles to the mid zones with a JVP 6 cm above the sternal angle are signs of congestion, and with orthopnea they point to pulmonary edema rather than asthma. She also has no wheeze. A night cough occurs in both asthma and heart failure, so it does not separate them. Salbutamol can fail in severe asthma or with poor inhaler technique. A saturation of 90% and a respiratory rate of 30/minute show how sick she is but occur with either diagnosis.
...
#### Q2
**Which of the following investigations is most likely to identify the cause of her heart failure?**

- A. Coronary CT angiography
- B. D-dimer concentration
- C. Iron studies and ferritin
- D. Thyroid function tests  **(key)**
- E. Viral serology panel

*Explanation:* Weight loss, heat intolerance, tremor, loose stools, prominent eyes and a goitre with a bruit point to Graves thyrotoxicosis, which is driving her irregular tachycardia and heart failure. TSH and free T4 confirm it and guide treatment. She is 34 with no coronary risk factors given, so coronary imaging is unlikely to find the cause. Pulmonary embolism does not explain a goitre, weight loss or mid zone crackles, so a D-dimer does not help. Iron deficiency can cause high output failure but not these thyroid signs. Viral serology rarely changes emergency care.
...
#### Q3
*Update:* TSH is below 0.01 mU/L and free T4 is 64 pmol/L (reference 10 to 22 pmol/L). Hemoglobin is 128 g/L. She is not pregnant. Bedside ultrasound shows a normal sized left ventricle that contracts vigorously, with B lines in both lungs. She receives furosemide 40 mg IV. No antithyroid drug has been given.

**Which of the following is the most appropriate first antithyroid treatment for her?**

- A. Lugol iodine solution PO now
- B. methimazole 10 mg PO daily
- C. methimazole 20 mg PO every 6 hours  **(key)**
- D. propylthiouracil 50 mg PO daily
- E. radioactive iodine ablation

*Explanation:* Her Burch-Wartofsky score is at least 65: a pulse of 140/minute or more scores 25, pulmonary edema 15, atrial fibrillation 10, loose stools 10 and a temperature of 37.6°C scores 5. A score of 45 or more is highly suggestive of thyroid storm, so the ATA advises storm doses of a thionamide, methimazole 60 to 80 mg a day, and methimazole 20 mg every 6 hours gives 80 mg a day. Methimazole 10 mg daily is a dose for mild, uncomplicated hyperthyroidism. Propylthiouracil in storm is loaded at 500 to 1000 mg, so 50 mg daily is far too little. Iodine given before a thionamide can supply substrate for new hormone, so the ATA advises giving it at least an hour after. Radioactive iodine is not an emergency treatment and can briefly worsen thyrotoxicosis.
...
#### Q4
*Update:* Forty minutes later she is more tired. Her respiratory rate is 36/minute and her saturation is 86% on 15 L/minute by non-rebreather mask. She is alert and protecting her airway. Her BP is 128/70 mmHg.

**Which of the following is the most appropriate next step for her breathing?**

- A. Heliox by face mask
- B. High-dose nebulized salbutamol
- C. Immediate intubation
- D. Morphine 2 mg IV
- E. Noninvasive ventilation  **(key)**

*Explanation:* She is tiring, with a saturation of 86% despite high flow oxygen, from cardiogenic pulmonary edema. The ERS/ATS guideline makes a strong recommendation for bilevel ventilation or CPAP in this setting, because it lowers the need for intubation and mortality. She is alert, protects her airway and has a BP of 128/70 mmHg, so a trial of noninvasive ventilation comes before intubation. Salbutamol adds to her tachycardia and she has no bronchospasm. Heliox is for upper airway obstruction. Morphine does not treat hypoxemia and depresses her breathing.

*Key feature:* Pulmonary edema 4. Watch for impending respiratory failure in pulmonary edema and escalate with ventilatory support or vasoactive drugs.

*Source:* Rochwerg B, Brochard L, Elliott MW, et al. Official ERS/ATS clinical practice guidelines. Noninvasive ventilation for acute respiratory failure. Eur Respir J. 2017. https://doi.org/10.1183/13993003.02426-2016

### pulmonary-edema-26: Double vision during cancer treatment
...
#### Q1
*Update:* High-sensitivity troponin I is 1850 ng/L (reference below 26 ng/L) and CK is 4200 U/L. The ECG shows sinus tachycardia with a new right bundle branch block and a PR interval of 240 ms. Bedside echo shows an ejection fraction of 40% and no pericardial effusion.

**Which of the following is the most likely cause of his pulmonary edema?**

- A. Acute coronary syndrome
- B. Checkpoint inhibitor myocarditis  **(key)**
- C. Immunotherapy pneumonitis
- D. Malignant pericardial effusion
- E. Pulmonary tumour embolism

*Explanation:* A very high troponin with new conduction disease and a reduced ejection fraction, weeks after starting nivolumab with ipilimumab, point to immune checkpoint inhibitor myocarditis. The International Cardio-Oncology Society definition accepts a troponin elevation with two minor criteria once acute coronary syndrome is excluded. He has several: the clinical syndrome, new conduction system disease, a fall in systolic function, and other immune-related adverse events, particularly myositis and myasthenia gravis, which fit his CK of 4200 U/L, hip flexor weakness and ptosis. Acute coronary syndrome does not explain the muscle and eyelid findings. Pneumonitis does not raise troponin or cause conduction block. Echo shows no effusion. Tumour emboli strain the right ventricle rather than cause left-sided failure.

*Key feature:* Pulmonary edema 2. While stabilizing pulmonary edema, search for the underlying cause, such as MI, volume overload, or anemia.

*Source:* Herrmann J, Lenihan D, Armenian S, et al. Defining cardiovascular toxicities of cancer therapies. An International Cardio-Oncology Society (IC-OS) consensus statement. Eur Heart J. 2022. https://pmc.ncbi.nlm.nih.gov/articles/PMC8803367/

#### Q2
**Which of the following is the most appropriate treatment directed at the cause of his heart failure?**

- A. Dual antiplatelet therapy
- B. Full-dose heparin infusion
- C. High-dose IV corticosteroids  **(key)**
- D. Pyridostigmine by mouth alone
- E. Resume immunotherapy after diuresis

*Explanation:* Myocarditis from a checkpoint inhibitor is an immune injury, and the SITC guideline advises high-dose corticosteroids as soon as the diagnosis is likely, methylprednisolone 1000 mg IV daily for 3 to 5 days, with further immunosuppression if there is no response within 24 hours. The same guideline advises that permanent discontinuation of the checkpoint inhibitor be seriously considered, so resuming it after diuresis would risk restarting the injury. Dual antiplatelet therapy and heparin treat a coronary occlusion he does not have. Pyridostigmine may ease the eyelid weakness but does nothing for the inflammation in his heart.

*Key feature:* Pulmonary edema 3. Treat the identified cause of pulmonary edema, for example with reperfusion, diuresis, or transfusion, to prevent worsening.

*Source:* Brahmer JR, Abu-Sbeih H, Ascierto PA, et al. Society for Immunotherapy of Cancer (SITC) clinical practice guideline on immune checkpoint inhibitor-related adverse events. J Immunother Cancer. 2021. https://pmc.ncbi.nlm.nih.gov/articles/PMC8237720/

#### Q3
*Update:* Four hours later he is drowsy, his voice is weak and he struggles to clear secretions. His saturation is 85% on a nonrebreather mask. His BP is 82/54 mmHg, his hands are cool and lactate is 4.3 mmol/L.
...
- B. Endotracheal intubation  **(key)**
- C. furosemide 80 mg IV
- D. High flow nasal oxygen
- E. milrinone infusion
- F. norepinephrine infusion  **(key)**
- G. normal saline 2 L IV

*Explanation:* Drowsiness, bulbar weakness and poor secretion clearance mean he cannot protect his airway, which makes noninvasive ventilation unsafe, so he needs intubation. A BP of 82/54 mmHg with cool hands and a lactate of 4.3 mmol/L is cardiogenic shock, and the ESC heart failure guideline suggests norepinephrine to restore perfusion pressure. Bilevel ventilation and high flow oxygen do not protect his airway. Milrinone and furosemide lower his pressure further. A 2 L saline bolus will worsen his pulmonary edema.

*Key feature:* Pulmonary edema 4. Watch for impending respiratory failure in pulmonary edema and escalate with ventilatory support or vasoactive drugs.

*Source:* McDonagh TA, Metra M, Adamo M, et al. 2021 ESC Guidelines for the diagnosis and treatment of acute and chronic heart failure. Eur Heart J. 2021. https://doi.org/10.1093/eurheartj/ehab368

### pulmonary-edema-27: Breathless after a ski-touring trip

- [ ] Approved  - [ ] Needs change  - [ ] Reject

You are working in a rural emergency department in the Rocky Mountains, at an elevation of 1 400 m. A 36-year-old man is flown in by helicopter from a backcountry hut at 2 900 m. He climbed from 1 500 m to the hut in one day, 2 days ago. Since yesterday he has fallen behind his group, with a dry cough and breathlessness on minimal effort. Overnight he became breathless at rest and coughed pink frothy sputum. He has no medical history and takes no medication. He is alert and oriented, has no headache and walks heel to toe normally. There are crackles over the right mid zone and both bases, and no wheeze. The JVP is not visible and there is no leg edema. The ECG shows sinus tachycardia. A chest radiograph shows patchy opacities, worst in the right mid zone, with a normal heart size.
...
- C. High-altitude pulmonary edema  **(key)**
- D. Negative-pressure pulmonary edema
- E. Pulmonary embolism

*Explanation:* He climbed rapidly to 2 900 m and within 2 days developed a dry cough, falling exercise tolerance, breathlessness at rest and pink frothy sputum, with tachycardia, tachypnea and crackles. The WMS guideline defines high-altitude pulmonary edema by this combination of symptoms and signs after a recent gain in altitude. A low-grade temperature does not separate pneumonia from altitude illness, but the timing after ascent and the rapid progression do. A normal heart size and an invisible JVP argue against myocarditis. Negative-pressure edema follows airway obstruction, which he has not had. Pulmonary embolism does not produce frothy sputum and patchy edema.

*Key feature:* Pulmonary edema 2. While stabilizing pulmonary edema, search for the underlying cause, such as MI, volume overload, or anemia.

*Source:* Luks AM, Beidleman BA, Freer L, et al. Wilderness Medical Society clinical practice guidelines for the prevention, diagnosis, and treatment of acute altitude illness. 2024 update. Wilderness Environ Med. 2024. https://doi.org/10.1016/j.wem.2023.05.013

#### Q2
*Update:* He receives oxygen at 15 L/minute by non-rebreather mask. After 30 minutes his saturation is 84%, his respiratory rate is 34/minute and he is tiring. He remains alert, cooperative and able to clear his secretions. His BP is 124/76 mmHg.

**Which of the following is the most appropriate next step for his breathing?**

- A. CPAP by tight-fitting face mask  **(key)**
- B. Furosemide 40 mg IV
- C. Morphine 2 mg IV
- D. Rapid sequence intubation
- E. Salbutamol 5 mg nebulized

*Explanation:* His saturation of 84% on a non-rebreather mask and his rising respiratory rate show that oxygen alone is failing. The WMS guideline supports CPAP as an adjunct to oxygen in hospital, and he is alert, cooperative and clearing secretions, so a mask is safe. Intubation is kept for failure of CPAP or loss of airway protection. The guideline advises against diuretics, because many people with high-altitude pulmonary edema are volume depleted and can become hypotensive. Morphine depresses breathing. He has no wheeze, and salbutamol does not correct his hypoxemia.
...
#### Q3
*Update:* Thirty minutes later his saturation is 91% and his breathing is easier. Transfer to a regional centre is arranged.

**Which of the following medications is most appropriate to add for the cause of his pulmonary edema?**

- A. acetazolamide 250 mg PO
- B. dexamethasone 8 mg IV
- C. furosemide 40 mg IV
- D. nifedipine 30 mg ER PO  **(key)**
- E. nitroglycerin 0.4 mg SL

*Explanation:* High-altitude pulmonary edema comes from uneven hypoxic constriction of the pulmonary arteries and high pulmonary artery pressure, not from a failing left heart. In hospital the WMS guideline advises adding nifedipine when oxygen alone does not bring a response, as it did not here, and extended-release nifedipine lowers pulmonary artery pressure. Nitroglycerin treats cardiogenic edema from high left-sided pressure, and his heart size and JVP are normal. Furosemide risks hypotension in a volume-depleted patient. Acetazolamide is for acute mountain sickness. Dexamethasone treats high-altitude cerebral edema, and he is alert with a normal gait and no headache.

*Key feature:* Pulmonary edema 3. Treat the identified cause of pulmonary edema, for example with reperfusion, diuresis, or transfusion, to prevent worsening.

*Source:* Luks AM, Beidleman BA, Freer L, et al. Wilderness Medical Society clinical practice guidelines for the prevention, diagnosis, and treatment of acute altitude illness. 2024 update. Wilderness Environ Med. 2024. https://doi.org/10.1016/j.wem.2023.05.013

### pulmonary-edema-28: Flu symptoms 18 days after a new medication
...
#### Q1
*Update:* Troponin T is 310 ng/L (reference below 14 ng/L). CRP is 142 mg/L. CK is 180 U/L. The ECG shows sinus tachycardia with diffuse T wave inversion. The chest X-ray shows interstitial edema and small effusions.

**Which of the following is the most likely diagnosis for his illness?**

- A. Aspiration pneumonia
- B. Bacterial pneumonia
- C. Drug-induced myocarditis  **(key)**
- D. Neuroleptic malignant syndrome
- E. Pulmonary embolism

*Explanation:* Fever, tachycardia, a troponin more than 20 times the upper limit, a CRP of 142 mg/L and pulmonary edema 18 days after starting clozapine fit clozapine myocarditis. Ronaldson and colleagues found most cases start between days 14 and 21, often with flu-like symptoms that are easily dismissed. Pneumonia does not explain this degree of troponin rise with diffuse T wave inversion and a raised JVP. He has no rigidity and a CK of 180 U/L, which argues against neuroleptic malignant syndrome. Bilateral edema does not fit pulmonary embolism.

*Key feature:* Pulmonary edema 5. Consider subtle pulmonary edema in patients with apparent respiratory complaints like exertional dyspnea or wheeze.

*Source:* Ronaldson KJ, Fitzgerald PB, Taylor AJ, Topliss DJ, McNeil JJ. A new monitoring protocol for clozapine-induced myocarditis based on an analysis of 75 cases and 94 controls. Aust N Z J Psychiatry. 2011.

#### Q2
**Which of the following is the most appropriate change to his medications?**

- A. Add oral prednisone
- B. Continue clozapine with monitoring
- C. Halve the clozapine dose
- D. Stop clozapine today  **(key)**
- E. Switch to depot haloperidol

*Explanation:* Ronaldson and colleagues advise stopping clozapine when troponin is more than twice the upper limit or CRP is above 100 mg/L, and he exceeds both. Continuing or halving the dose leaves the cause in place while the heart is failing. Corticosteroids have no proven role in this drug-induced myocarditis. Choosing a new antipsychotic, such as a depot injection, is a decision for psychiatry after he recovers and does not treat the myocarditis today.
...
#### Q3
*Update:* Six hours later his BP is 82/50 mmHg, his hands are cool and lactate is 4.8 mmol/L. Bedside echo shows an ejection fraction of about 20%. A norepinephrine infusion is started.

**Which of the following is the most appropriate disposition for him?**

- A. Community hospital ICU
- B. Internal medicine ward with telemetry
- C. Psychiatric unit with cardiology consult
- D. Step-down unit at this hospital
- E. Transfer to a tertiary cardiac ICU  **(key)**

*Explanation:* He is in cardiogenic shock with an ejection fraction of about 20% and a lactate of 4.8 mmol/L, despite starting a vasopressor. The ESC guideline advises that short-term mechanical circulatory support should be considered in cardiogenic shock as a bridge to recovery or decision, and that venoarterial ECMO may be considered in fulminant myocarditis, so he needs a centre that can provide it. Fulminant myocarditis in a young patient can recover fully if he is bridged through the acute phase. A community ICU, step-down unit or ward cannot offer mechanical support if he worsens. A psychiatric unit cannot manage shock.

*Key feature:* Pulmonary edema 4. Watch for impending respiratory failure in pulmonary edema and escalate with ventilatory support or vasoactive drugs.

*Source:* McDonagh TA, Metra M, Adamo M, et al. 2021 ESC Guidelines for the diagnosis and treatment of acute and chronic heart failure. Eur Heart J. 2021. https://doi.org/10.1093/eurheartj/ehab368

### pulmonary-edema-29: Adult-onset asthma that inhalers do not help
...
#### Q4
*Update:* Echo shows an ejection fraction of 30%. He walks for 3 minutes without desaturation and his pulse stays below 100/minute. He lives with his wife and has a family physician. The team plans to discharge him on new heart failure medications.

**Which of the following follow-up plans is most appropriate for him?**

- A. Family physician review in 3 months
- B. Heart failure clinic review within 2 weeks  **(key)**
- C. Repeat NT-proBNP in 6 months
- D. Sleep clinic referral only
- E. No follow-up unless symptoms worsen

*Explanation:* He has a new diagnosis of heart failure with reduced ejection fraction and is starting new drugs. The ESC guideline recommends an early visit 1 to 2 weeks after discharge to check congestion, tolerance and kidney function and to titrate therapy. A review in 3 months leaves him on untitrated doses for too long. A repeat NT-proBNP in 6 months does not assess him soon enough. His sleep apnea needs attention, but it does not replace heart failure follow-up. Waiting for symptoms misses the chance to prevent readmission.

*Key feature:* Pulmonary edema 6. Before discharge after pulmonary edema, confirm safety with an exertion test, home situation review, and follow-up.

*Source:* McDonagh TA, Metra M, Adamo M, et al. 2021 ESC Guidelines for the diagnosis and treatment of acute and chronic heart failure. Eur Heart J. 2021. https://doi.org/10.1093/eurheartj/ehab368

### pulmonary-edema-30: Untouched pill packs
...
#### Q3
*Update:* After 36 hours in the observation unit she has lost 2.1 kg. Her saturation is 95% on room air. She walks for 3 minutes with her walker without desaturation and her pulse stays below 100/minute.

**Which of the following is the most important issue to address before she goes home?**

- A. Daily weights in hospital for 1 week
- B. Fluid restriction of 1 L/day
- C. Home care support for her medications  **(key)**
- D. Repeat NT-proBNP before discharge
- E. Switch furosemide to torsemide

*Explanation:* She passed a walk test, so the barrier to a safe discharge is at home. She lives alone, cannot name her medications and stopped her diuretic because of urgency and a fall. The CCS guideline supports a multidisciplinary plan with home care and help with medications for patients at high risk of readmission. A week of weights in hospital delays discharge without fixing adherence. Strict fluid restriction has little evidence. A repeat NT-proBNP does not change her plan. Changing to torsemide does not solve her urgency or her difficulty managing her pills.

*Key feature:* Pulmonary edema 6. Before discharge after pulmonary edema, confirm safety with an exertion test, home situation review, and follow-up.

*Source:* Ezekowitz JA, O'Meara E, McDonald MA, et al. 2017 Comprehensive update of the Canadian Cardiovascular Society guidelines for the management of heart failure. Can J Cardiol. 2017.

### pulmonary-edema-31: Six kilograms in ten days
...
**Which of the following is the most useful early measure of his response to this dose?**

- A. Chest X-ray at 6 hours
- B. Daily weight tomorrow morning
- C. NT-proBNP at 6 hours
- D. Serum creatinine at 6 hours
- E. Spot urine sodium at 2 hours  **(key)**

*Explanation:* The ESC guideline advises checking the diuretic response soon after the first dose, with a spot urine sodium at 2 hours or the hourly urine output over 6 hours, so a poor response can be met by doubling the dose the same day. A urine sodium above 50 to 70 mmol/L at 2 hours marks a good response. A weight tomorrow comes too late to adjust today's dosing. Serum creatinine can rise during effective decongestion and does not measure natriuresis. A chest X-ray and NT-proBNP change too slowly to guide the next dose.
...
#### Q2
*Update:* During a 3-minute walk his pulse rises to 116/minute and his saturation stays at 93%. The ECG shows no acute ischemic change. Urea is 14.6 mmol/L, bicarbonate 27 mmol/L, troponin is not elevated and NT-proBNP is 3800 pg/mL.

**Which of the following is his total score on the Ottawa Heart Failure Risk Scale?**
...
*Explanation:* He scores 2 for prior intubation for respiratory distress, 1 for a saturation below 90% on arrival, 1 for a urea of 12 mmol/L or more and 1 for a pulse of 110/minute or more during the walk test, for a total of 5. He gets nothing for stroke, for an arrival pulse of 104/minute, for the ECG or troponin, for a bicarbonate of 27 mmol/L or for an NT-proBNP below 5000 pg/mL. A score of 3 or 4 would miss one of his points, and 6 would count an item he does not have.

*Key feature:* Pulmonary edema 6. Before discharge after pulmonary edema, confirm safety with an exertion test, home situation review, and follow-up.

*Source:* Stiell IG, Perry JJ, Clement CM, et al. Prospective and explicit clinical validation of the Ottawa Heart Failure Risk Scale, with and without use of quantitative NT-proBNP. Acad Emerg Med. 2017. https://doi.org/10.1111/acem.13141

#### Q3
**Which of the following is the most appropriate disposition for him?**

- A. Admit to a medicine or cardiology bed  **(key)**
- B. Discharge with clinic review next day
- C. Discharge with home care nursing
- D. Discharge with review in 1 week
- E. Observe 4 more hours then discharge

*Explanation:* A score of 5 places him in the very high risk group of the Ottawa Heart Failure Risk Scale, with a much higher rate of serious adverse events, which include death within 30 days and relapse needing admission within 14 days. His pulse of 116/minute on a short walk shows he is not ready for home, however well he feels at rest. Early clinic review and home nursing suit patients at low risk, not this score. Four more hours of observation will not change his history, urea or walk test result.

*Key feature:* Pulmonary edema 6. Before discharge after pulmonary edema, confirm safety with an exertion test, home situation review, and follow-up.

*Source:* Stiell IG, Perry JJ, Clement CM, et al. Prospective and explicit clinical validation of the Ottawa Heart Failure Risk Scale, with and without use of quantitative NT-proBNP. Acad Emerg Med. 2017. https://doi.org/10.1111/acem.13141

### pulmonary-edema-33: A directive in the transfer envelope
...
- Resp.: 34/minute
- BP: 176/98 mmHg
- O2 sat: 84% on 6 L/minute by nasal prongs

#### Q1
**Which of the following is the most appropriate respiratory support to offer her now?**

- A. High flow nasal oxygen
- B. Nasal prongs at 6 L/minute
- C. Noninvasive ventilation  **(key)**
- D. Simple face mask at 10 L/minute
- E. Venturi mask at 50%

*Explanation:* She has hypertensive pulmonary edema and can follow commands, and her directive declines intubation but not other treatment. The ERS/ATS guideline recommends noninvasive ventilation for cardiogenic pulmonary edema. Her directive allows it, so it is the right ceiling of support, and it can reverse the edema quickly and ease her breathing. High flow oxygen gives much less positive pressure. Nasal prongs have already failed. A simple face mask or Venturi mask gives oxygen without the positive pressure that recruits flooded alveoli.
...
#### Q2
*Update:* After 1 hour of noninvasive ventilation, nitroglycerin and furosemide, she opens her eyes only to pain. Her saturation is 82%. Venous gas: pH 7.16, PCO2 74 mmHg. Her son arrives.

**Which of the following is the most appropriate next step in her care?**

- A. Add dobutamine infusion
- B. Continue NIV and recheck gas in 2 hours
- C. Intubate despite her directive
- D. Shift to comfort-focused care  **(key)**
- E. Transfer to ICU for NIV

*Explanation:* She has failed noninvasive ventilation, with falling consciousness, a pH of 7.16 and a PCO2 of 74 mmHg, and she has declined intubation. The next step is a conversation with her son to shift to comfort-focused care within her stated wishes. Intubating her would override a valid directive. Waiting 2 hours for another gas prolongs distress without a realistic chance of recovery. Dobutamine and an ICU transfer for NIV continue a treatment that has already failed at the limit she chose.
...
- Resp.: 30/minute
- BP: 84/50 mmHg
- O2 sat: 87% on 6 L/minute by nasal prongs
- Weight: 70 kg

#### Q1
**Which of the following is the most appropriate treatment for her low blood pressure now?**

- A. albumin 5% 500 mL IV
- B. norepinephrine infusion  **(key)**
- C. Ringer's lactate 500 mL IV
- D. sodium chloride 0.9% 1 L IV
- E. vasopressin 0.04 units/minute IV

*Explanation:* Her mean arterial pressure is about 61 mmHg, but new crackles, diffuse B-lines and a full, noncollapsing vena cava show she is no longer fluid responsive and is now overloaded. The Surviving Sepsis Campaign recommends norepinephrine as the first vasopressor to reach a mean pressure of 65 mmHg. Any further crystalloid or albumin will worsen her pulmonary edema with a weak ventricle. Vasopressin is suggested as an addition when norepinephrine needs rise, not as the first agent.

*Key feature:* Pulmonary edema 3. Treat the identified cause of pulmonary edema, for example with reperfusion, diuresis, or transfusion, to prevent worsening.

*Source:* Prescott HC, Antonelli M, Alhazzani W, et al. Surviving Sepsis Campaign. International guidelines for management of sepsis and septic shock 2026. Crit Care Med. 2026. https://doi.org/10.1097/CCM.0000000000007075

#### Q2
*Update:* On norepinephrine her BP is 102/58 mmHg. Her saturation is 88% and she remains congested.

**Which of the following medications is most appropriate to treat her pulmonary congestion now?**

- A. furosemide 40 mg IV  **(key)**
- B. hydrochlorothiazide 25 mg PO
- C. metoprolol 5 mg IV
- D. morphine 2 mg IV
- E. nitroglycerin 20 mcg/minute IV

*Explanation:* Her pressure is supported and she is overloaded with a weak ventricle, so a loop diuretic is the most useful drug. The ESC guideline suggests an IV dose of 1 to 2 times the usual daily oral dose, so 40 to 80 mg for her 40 mg daily. A vasodilator such as nitroglycerin is not advised with a systolic pressure below 110 mmHg, and she needs a vasopressor. Hydrochlorothiazide by mouth is slow and weak on its own. Metoprolol can worsen low output in shock. Morphine is not recommended routinely.
...
#### Q3
*Update:* One hour later she opens her eyes only to voice and is breathing shallowly. Her saturation is 84% on a nonrebreather mask. Venous gas: pH 7.22, PCO2 58 mmHg. Norepinephrine is at 0.15 mcg/kg/minute.
...
- D. Nonrebreather and recheck in 1 hour
- E. Rapid sequence intubation  **(key)**
...
### pulmonary-edema-35: Two hours from the nearest ICU
...
#### Q1
**Which of the following treatments should be started now, before the ECG and blood results are available?**
...
#### Q2
*Update:* CPAP at 10 cm H2O, three sublingual nitroglycerin doses and furosemide are given. A nitroglycerin infusion runs at 50 mcg/minute. Twenty minutes later his BP is 204/116 mmHg, his respiratory rate is 38/minute and his saturation 86%. He is alert.

**Which of the following is the most appropriate medication to give him next?**

- A. diltiazem 10 mg IV
- B. labetalol 20 mg IV
- C. metoprolol 5 mg IV
- D. morphine 4 mg IV
- E. nitroglycerin 1 mg IV  **(key)**

*Explanation:* His BP has risen to 204/116 mmHg despite CPAP and a low dose infusion, so vasodilation needs to escalate quickly with an IV bolus. The ESC guideline notes that nitroglycerin can be given as 1 to 2 mg boluses in severely hypertensive acute pulmonary edema, while watching for hypotension. Diltiazem, metoprolol and labetalol all reduce contractility in a failing ventricle and can tip him into shock. Morphine is not recommended routinely in acute heart failure.
...
#### Q3
*Update:* His BP falls to 162/94 mmHg. His saturation is still 87%. He has a full beard, air hisses from around the mask and the CPAP pressure gauge will not hold 10 cm H2O. He is alert and calm.

**Which of the following is the most appropriate next step in his respiratory support?**

- A. Increase CPAP to 15 cm H2O
- B. morphine 4 mg IV
- C. Rapid sequence intubation
- D. Refit or change the CPAP mask  **(key)**
- E. Switch to a nonrebreather mask

*Explanation:* The pressure gauge cannot hold 10 cm H2O because of a large leak around his beard, so he is not receiving the CPAP that was set. Masip and colleagues stress choosing the right interface and avoiding excessive leak for NIV to work. Refitting the mask or changing it to one that seals should come before any escalation in an alert, calm patient. A higher pressure only increases the leak. Intubation is not needed while he is alert and the fault is correctable. A nonrebreather removes positive pressure. Morphine is not recommended routinely.

*Key feature:* Pulmonary edema 4. Watch for impending respiratory failure in pulmonary edema and escalate with ventilatory support or vasoactive drugs.

*Source:* Masip J, Peacock WF, Price S, et al. Indications and practical approach to non-invasive ventilation in acute heart failure. Eur Heart J. 2018. https://doi.org/10.1093/eurheartj/ehx580

### pulmonary-edema-36: Collapsed at the gym
...
**Which of the following ventilation strategies is most appropriate for her lungs and brain?**

- A. Hyperventilate to PCO2 25 mmHg
- B. Large tidal volumes of 10 mL/kg
- C. Permissive hypercapnia
- D. Titrated PEEP with normocapnia  **(key)**
- E. Zero PEEP with normocapnia

*Explanation:* Neurogenic pulmonary edema needs PEEP to recruit flooded alveoli, and Busl and Bleck describe supportive, lung protective ventilation. Keeping the PCO2 near normal avoids both cerebral vasodilation and ischemia. PEEP can be titrated with attention to BP and ICP. Permissive hypercapnia raises intracranial pressure. Deliberate hyperventilation to 25 mmHg risks cerebral ischemia. Zero PEEP leaves her hypoxemic, and hypoxemia also harms the brain. Large tidal volumes injure the lungs.

*Key feature:* Pulmonary edema 4. Watch for impending respiratory failure in pulmonary edema and escalate with ventilatory support or vasoactive drugs.

*Source:* Busl KM, Bleck TP. Neurogenic pulmonary edema. Crit Care Med. 2015.

### pulmonary-edema-37: Pulled from the backyard pool
...
- A. Discharge home with return advice  **(key)**
- B. Keep overnight for observation
- C. Observe for another 12 hours
- D. Repeat chest X-ray then decide
- E. Transfer to a pediatric ICU

*Explanation:* Szpilman and colleagues note that most grade 2 patients return to normal within 6 to 8 hours on oxygen and can then be sent home. She has a saturation of 98% on room air, a respiratory rate of 24/minute and a clear chest after 6 hours. Her parents need clear advice to return for cough, fast breathing or fever. An overnight stay or 12 more hours adds little to a normal 6 hour period. A chest X-ray will not change the decision when her examination and saturation are normal.
...
#### Q3
**Which of the following home safety measures are most effective at preventing another event?**

Select 2.

- A. Close supervision within arm's reach  **(key)**
- B. Four-sided isolation fencing  **(key)**
- C. Inflatable arm floats in the pool
- D. Pool cover when the pool is not in use
- E. Supervision by an older sibling
- F. Swimming only in the shallow end

*Explanation:* Her fence has only three sides, with the house door opening straight onto the pool. Szpilman and colleagues identify four-sided fencing that separates the pool from the house and constant, close adult supervision as key prevention measures. Arm floats can slip off or deflate and give false reassurance. A cover may not be replaced every time and a child can be trapped under it. An older sibling is not a reliable supervisor. Young children can drown in the shallow end.

*Key feature:* Pulmonary edema 6. Before discharge after pulmonary edema, confirm safety with an exertion test, home situation review, and follow-up.

*Source:* Szpilman D, Bierens JJ, Handley AJ, Orlowski JP. Drowning. N Engl J Med. 2012.

### pulmonary-edema-38: Wheezy since yesterday
