...
- dvt-pe-18 q3: serial ultrasound is keyed for a calf DVT three weeks after a major ulcer bleed. Thrombosis Canada suggests anticoagulation when symptoms are severe, and his calf is 3.5 cm larger with pitting edema. The recent bleed makes surveillance defensible, but a physician should confirm the key is unambiguous. *(samps-s33-lensA.md)*
- dvt-pe-33 q2: admission is keyed for intermediate low risk PE with sPESI 0 and RV dilation. Practice varies and some centres discharge such patients. The key follows Thrombosis Canada caution about RV dilation. *(samps-s33-lensA.md)*
- dvt-pe-16 and 45: whether a 16-year-old should be managed under pediatric (ASH/ISTH) or adult rules. The rebuilt 16 q4 gives 3 months under either. *(samps-s33-lensA.md)*
- Local anesthesia protocols for neuraxial timing (40 q2) vary. The 24 hour rule is the Thrombosis Canada statement. *(samps-s33-lensA.md)*
- Wells PE "PE most likely" item (39 q2, 42 q1, 39 q1 context). Both stems say PE is "as likely as" the alternative and award 3 points. That follows the common "PE is the most likely diagnosis or equally likely" wording. The original 2001 wording is "an alternative diagnosis is less likely than PE", under which an equal likelihood scores 0, giving 0 (39) and 2.5 (42). 2.5 is an option in 42 q1. A physician should decide whether to reword both stems to "You think PE is more likely than any other diagnosis" to remove the ambiguity. The PERC teaching in 39 would still hold. *(samps-s33-lensB.md)*
- The Lens A physician items (18 q3 surveillance after a major bleed, 33 q2 admission at intermediate low risk, pediatric versus adult rules for a 16-year-old, local neuraxial protocols) are unchanged. *(samps-s33-lensB.md)*

Review reports: docs/reviews/writer-s33.md, samps-s33-lensA.md, samps-s33-lensB.md

## SAMPs

### dvt-pe-16: Swollen calf in a teenager
...
#### Q1
**Which of the following additional history items would most increase her baseline risk of venous thromboembolism?**

Select 2.

- A. Age at first menstrual period
- B. Creatine supplement use
- C. Family history of hemophilia
- D. Known inherited thrombophilia  **(key)**
- E. Previous venous thromboembolism  **(key)**
- F. Recent influenza vaccination
- G. Seasonal allergic rhinitis
- H. Topical acne treatment

*Explanation:* A previous VTE is one of the strongest risk factors for a new event, and a known thrombophilia is a recognized moderate risk factor. Either would add to her current risks from arthroscopic knee surgery, reduced weight bearing and a combined oral contraceptive. Hemophilia in a relative is a bleeding disorder and does not raise her clot risk. Age at menarche, allergic rhinitis, influenza vaccination, topical acne treatment and creatine use are not recognized VTE risk factors.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 1. When DVT or PE is suspected, take a history that captures the patient's baseline risk factors.

*Source:* Konstantinides SV, et al. 2019 ESC guidelines for the diagnosis and management of acute pulmonary embolism. Eur Heart J. 2020. https://pubmed.ncbi.nlm.nih.gov/31504429/

#### Q2
**Which of the following is the most appropriate first diagnostic test for her?**

- A. Compression ultrasound of the left leg  **(key)**
- B. Contrast venography of the left leg
- C. CT venography of the pelvis and leg
- D. Magnetic resonance venography of the leg
- E. Quantitative D-dimer level

*Explanation:* Clinical decision rules and D-dimer testing have not been validated in children, so the diagnosis of DVT in a child starts with compression ultrasound. Her calf swelling, pitting edema and deep vein tenderness make ultrasound the right first test. A D-dimer would also be raised by her surgery 12 days ago. CT or MR venography is considered only if ultrasound is negative and suspicion stays high, and contrast venography is invasive.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 5. Tailor VTE testing to context, such as leg ultrasound first in pregnancy or CT over VQ with lung disease.

*Source:* Thrombosis Canada. Clinical guide: deep vein thrombosis (DVT) diagnosis. 2025. https://thrombosiscanada.ca/clinical_guides/pdfs/DEEPVEINTHROMBOSISDIAGNOSIS_60.pdf
...
**Which of the following is the most appropriate initial anticoagulant regimen for her?**

- A. ASA 81 mg PO daily
- B. enoxaparin 60 mg SC every 12 hours  **(key)**
- C. enoxaparin 40 mg SC once daily
- D. heparin 5000 units SC every 12 hours
- E. warfarin 5 mg PO daily

*Explanation:* Therapeutic enoxaparin is dosed on actual weight at 1 mg/kg SC every 12 hours, which is 58 mg for 58 kg, rounded to the nearest 60 mg prefilled syringe. Enoxaparin 40 mg daily and heparin 5000 units SC every 12 hours are prophylactic doses and will not treat an established proximal DVT. Warfarin alone has no immediate effect and must overlap with a heparin for at least 5 days. ASA is not a treatment for acute DVT.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 6. Choose anticoagulation that fits the patient, for example avoiding warfarin in pregnancy or LMWH in renal failure.

*Source:* Thrombosis Canada. Clinical guide: deep vein thrombosis (DVT) treatment. 2025. https://thrombosiscanada.ca/clinical_guides/pdfs/DEEPVEINTHROMBOSISTREATMENT_80.pdf
...
#### Q1
**Which of the following additional examination findings would most support venous thrombosis as the cause?**

- A. Absent radial pulse when the arm is abducted
- B. Dilated collateral veins over the shoulder  **(key)**
- C. Ptosis and miosis on the right side
- D. Tender fluctuant swelling in the axilla
- E. Wasting of the thenar muscles

*Explanation:* Dilated collateral veins over the arm, neck or upper chest are a recognized sign of upper extremity DVT and reflect obstruction of the axillary or subclavian vein. His swelling after repeated overhead exertion fits effort thrombosis. Loss of the radial pulse with abduction points to arterial compression at the thoracic outlet. Ptosis with miosis suggests a Horner syndrome from an apical lung tumour. A fluctuant axillary swelling suggests an abscess, and thenar wasting suggests nerve compression.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 2. Examine for signs supporting DVT or PE and for findings that suggest an alternative diagnosis.

*Source:* Thrombosis Canada. Clinical guide: deep vein thrombosis (DVT) diagnosis. 2025. https://thrombosiscanada.ca/clinical_guides/pdfs/DEEPVEINTHROMBOSISDIAGNOSIS_60.pdf

#### Q2
**Which of the following is the most appropriate first diagnostic test for him?**

- A. Contrast venography of the right arm
- B. CT venography of the chest
- C. Duplex ultrasound of the right arm  **(key)**
- D. Magnetic resonance venography
- E. X-ray of the cervical spine and ribs

*Explanation:* His history and findings give a high pretest probability of upper extremity DVT, and duplex ultrasound, combining compression and colour Doppler flow, should be done first. If it is negative and suspicion remains high, contrast venography, CT venography or MRI can follow. Those tests are second line because of contrast, radiation or access. Cervical spine and rib films may show a cervical rib later in a thoracic outlet workup but cannot diagnose venous thrombosis.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 4. Choose tests suited to pretest probability, for example skipping D-dimer in high probability patients.
...
- A. Admit for IV unfractionated heparin
- B. Admit for urgent first rib resection
- C. Arrange catheter directed thrombolysis this evening
- D. Discharge on apixaban with thrombosis follow-up  **(key)**
- E. Observe on telemetry for 24 hours

*Explanation:* He is stable with mild symptoms and normal labs, and outpatient treatment is preferred unless the DVT is limb threatening, bleeding risk is high or another reason for admission exists. Follow-up should look for a thoracic outlet cause of his effort thrombosis. Catheter directed thrombolysis is considered only case by case for extensive, very symptomatic upper extremity DVT. First rib resection is not an emergency. IV heparin and telemetry add nothing for a stable patient who can take an oral agent.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 7. Use objective data like vitals, oxygen saturation, and biomarkers to decide whether outpatient VTE treatment is safe.

*Source:* Thrombosis Canada. Clinical guide: deep vein thrombosis (DVT) treatment. 2025. https://thrombosiscanada.ca/clinical_guides/pdfs/DEEPVEINTHROMBOSISTREATMENT_80.pdf

### dvt-pe-18: Calf aching in an older man
...
#### Q1
**Which of the following is his two level Wells score for deep vein thrombosis?**
...
#### Q4
**Which of the following findings on the repeat ultrasound would most support starting anticoagulation?**

- A. Extension into the popliteal vein  **(key)**
- B. Hematoma in the medial gastrocnemius
- C. Small Baker cyst behind the knee
- D. Superficial varicose veins in the calf
- E. Unchanged 3 cm peroneal thrombus

*Explanation:* Progression on repeat imaging is an indication to anticoagulate, and extension into the popliteal vein makes this a proximal DVT that needs at least 3 months of treatment. An unchanged distal thrombus supports continuing surveillance. A gastrocnemius hematoma would argue against anticoagulation. A Baker cyst and varicose veins are incidental findings that do not call for anticoagulation.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 6. Choose anticoagulation that fits the patient, for example avoiding warfarin in pregnancy or LMWH in renal failure.

*Source:* Thrombosis Canada. Clinical guide: deep vein thrombosis (DVT) treatment. 2025. https://thrombosiscanada.ca/clinical_guides/pdfs/DEEPVEINTHROMBOSISTREATMENT_80.pdf

### dvt-pe-19: Pleuritic pain after abdominal surgery
...
*Explanation:* She scores 1.5 for a heart rate above 100/minute and 1.5 for surgery within the past 4 weeks, for a total of 3.0. She has no signs of DVT, hemoptysis, cancer or previous VTE. PE is not the most likely diagnosis, so that item scores zero. A total of 4.0 or less falls in the low clinical probability group used by PEGeD.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 3. Apply validated decision rules to estimate the pretest probability of DVT or PE.

*Source:* Wells PS, et al. Excluding pulmonary embolism at the bedside without diagnostic imaging. Ann Intern Med. 2001. https://pubmed.ncbi.nlm.nih.gov/11453709/

#### Q2
**Which of the following is the most appropriate next step to assess her for PE?**

- A. Age adjusted D-dimer cutoff
- B. Bilateral leg compression ultrasound
- C. CT pulmonary angiogram
- D. D-dimer with a 1000 mcg/L cutoff  **(key)**
- E. Ventilation perfusion lung scan

*Explanation:* With a low clinical pretest probability, PEGeD showed that a D-dimer below 1000 mcg/L FEU safely excludes PE without imaging. Going straight to CT or VQ imaging exposes her to radiation that a negative D-dimer could avoid. Leg ultrasound has a low yield with no leg symptoms. An age adjusted cutoff applies only above age 50 and would give her the lower standard cutoff of 500 mcg/L, sending more patients to imaging.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 4. Choose tests suited to pretest probability, for example skipping D-dimer in high probability patients.

*Source:* Kearon C, et al. Diagnosis of pulmonary embolism with d-dimer adjusted to clinical probability (PEGeD). N Engl J Med. 2019. https://pubmed.ncbi.nlm.nih.gov/31774957/

#### Q3
*Update:* Her D-dimer is 820 mcg/L FEU.

**Which of the following is the most appropriate next step for suspected PE?**
...
#### Q4
**Which of the following additional history findings would move her into the moderate clinical probability group?**

- A. Active cancer on treatment
- B. Estrogen containing contraceptive
- C. Hemoptysis this morning
- D. Previous proximal DVT  **(key)**
- E. Smoking 10 cigarettes daily

*Explanation:* A previous DVT or PE adds 1.5 points, raising her Wells score from 3.0 to 4.5, which is moderate probability, 4.5 to 6.0, in PEGeD. Moderate probability lowers the D-dimer threshold for excluding PE to 500 mcg/L FEU, so her 820 mcg/L result would then need imaging. Hemoptysis and active cancer add 1 point each, giving 4.0, which stays in the low group. Estrogen use and smoking do not score in the Wells rule.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 1. When DVT or PE is suspected, take a history that captures the patient's baseline risk factors.

*Source:* Kearon C, et al. Diagnosis of pulmonary embolism with d-dimer adjusted to clinical probability (PEGeD). N Engl J Med. 2019. https://pubmed.ncbi.nlm.nih.gov/31774957/

### dvt-pe-20: Chest pain in the second trimester
...
#### Q1
**Which of the following features of her history increase her risk of venous thromboembolism?**

Select 3.

- A. Age of 34 years
- B. Body mass index of 34 kg/m2  **(key)**
- C. Breastfeeding her infant
- D. Delivery 12 days ago  **(key)**
- E. Emergency caesarean delivery  **(key)**
- F. Oral iron supplements
- G. Prenatal vitamin use

*Explanation:* The early postpartum period raises the daily risk of VTE 15 to 35 fold compared with women who are not pregnant. Emergency caesarean section and obesity are additional recognized risk factors in pregnancy and the puerperium. Maternal age raises risk mainly at 40 years or more, so age 34 does not. Breastfeeding, prenatal vitamins and oral iron are not VTE risk factors.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 1. When DVT or PE is suspected, take a history that captures the patient's baseline risk factors.

*Source:* Thrombosis Canada. Clinical guide: pregnancy, thromboprophylaxis. 2025. https://thrombosiscanada.ca/clinical_guides/pdfs/THROMBOPROPHYLAXISINPREGNANCY_43.pdf

#### Q2
**Which of the following is the most appropriate anticoagulant regimen while she is breastfeeding?**

- A. apixaban 10 mg PO twice daily
- B. dabigatran 150 mg PO twice daily
- C. dalteparin 18 000 units SC daily  **(key)**
- D. edoxaban 60 mg PO once daily
- E. rivaroxaban 15 mg PO twice daily

*Explanation:* LMWH is safe for the breastfed infant and is dosed on actual weight, so dalteparin 200 units/kg for 90 kg is 18 000 units once daily. Rivaroxaban and dabigatran pass into breast milk, and the makers of apixaban, dabigatran, edoxaban and rivaroxaban all advise against use while breastfeeding. Warfarin started with LMWH overlap would be another safe option for a nursing mother.
...
#### Q1
**Which of the following is his simplified pulmonary embolism severity index (sPESI) score?**
...
*Explanation:* He scores 1 point for cancer and 1 point for a heart rate of 110/minute or more, for a total of 2. He is under 80 years, has no chronic heart or lung disease, his systolic BP is 100 mmHg or more and his oxygen saturation is 90% or more. Any score of 1 or more places him outside the low risk group.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 7. Use objective data like vitals, oxygen saturation, and biomarkers to decide whether outpatient VTE treatment is safe.

*Source:* Jimenez D, et al. Simplification of the pulmonary embolism severity index for prognostication in patients with acute symptomatic pulmonary embolism. Arch Intern Med. 2010. https://pubmed.ncbi.nlm.nih.gov/20696966/

#### Q2
**Which of the following features of his case favour LMWH over a DOAC for his PE?**

Select 2.

- A. Age of 66 years
- B. Creatinine clearance of 72 mL/minute
- C. Heart rate of 114/minute
- D. Normal RV to LV ratio
- E. Unresected gastric cancer  **(key)**
- F. Vomiting after most meals  **(key)**

*Explanation:* LMWH is preferred over a DOAC for cancer of the GI tract, because edoxaban and rivaroxaban caused more GI bleeding in patients with upper GI cancers. Significant nausea and vomiting make oral absorption unreliable, which also favours a parenteral drug. His creatinine clearance of 72 mL/minute allows either class. His heart rate and normal RV to LV ratio describe the severity of the PE, and his age does not change the choice.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 6. Choose anticoagulation that fits the patient, for example avoiding warfarin in pregnancy or LMWH in renal failure.

*Source:* Thrombosis Canada. Clinical guide: cancer and thrombosis. 2024. https://thrombosiscanada.ca/clinical_guides/pdfs/CANCERANDTHROMBOSIS_51.pdf

#### Q3
**Which of the following is the most appropriate anticoagulant regimen for him?**

- A. apixaban 10 mg PO twice daily
- B. dalteparin 15 000 units SC daily  **(key)**
- C. dalteparin 7500 units SC daily
- D. edoxaban 60 mg PO once daily
- E. warfarin 5 mg PO once daily

*Explanation:* Dalteparin 200 units/kg daily for the first month is the recommended LMWH regimen for cancer associated thrombosis. For 70 kg that is 14 000 units, rounded up to the 15 000 unit prefilled syringe as the cancer guide advises. Half dose LMWH is for platelet counts of 25 to 50 x 10^9/L, and his count is 186 x 10^9/L. Apixaban is oral and less reliable while he is vomiting. Edoxaban also needs 5 days of LMWH first. Warfarin is less effective than LMWH or anti-Xa DOACs in cancer associated thrombosis.
...
**Which of the following is the most appropriate duration of anticoagulation for him?**

- A. Continue while the cancer is active  **(key)**
- B. Stop after six months
- C. Stop after three months
- D. Stop when chemotherapy ends
- E. Switch to ASA 81 mg after three months
...
#### Q5
**Which of the following is the most appropriate disposition at the time of diagnosis?**

- A. Admit to a medical ward  **(key)**
- B. Admit to ICU for thrombolysis
- C. Discharge after 4 hours of observation
- D. Discharge home with dalteparin
- E. Observe in the ED until vomiting stops

*Explanation:* His sPESI of 2, from his cancer and a heart rate of 114/minute, places him outside the low risk group that can be considered for outpatient care. Persistent vomiting is a further medical reason for admission. Thrombolysis is reserved for high risk PE with hypotension or cardiac arrest, and he is normotensive with a normal RV to LV ratio. Discharge after a short observation, or once vomiting settles in the ED, ignores his objective risk markers.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 7. Use objective data like vitals, oxygen saturation, and biomarkers to decide whether outpatient VTE treatment is safe.

*Source:* Thrombosis Canada. Clinical guide: pulmonary embolism (PE) treatment. 2025. https://thrombosiscanada.ca/clinical_guides/pdfs/44_60.pdf

### dvt-pe-23: Thigh swelling after a long drive
...
#### Q1
**Which of the following is the most appropriate initial anticoagulant regimen for him?**

- A. apixaban 5 mg PO twice daily
- B. apixaban 10 mg PO twice daily  **(key)**
- C. dabigatran 150 mg PO twice daily
- D. edoxaban 60 mg PO once daily
- E. enoxaparin 150 mg SC once daily

*Explanation:* For patients with a body mass index above 40 kg/m2 or weight above 120 kg, the ISTH guidance lists standard doses of apixaban or rivaroxaban among the appropriate options. Apixaban starts at 10 mg twice daily for 7 days, so 5 mg twice daily omits the first week of higher dosing. The guidance suggests against dabigatran and edoxaban at this weight because supporting data are limited. Enoxaparin 150 mg once daily is an underdose, since 1.5 mg/kg daily for 152 kg is 228 mg.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 6. Choose anticoagulation that fits the patient, for example avoiding warfarin in pregnancy or LMWH in renal failure.

*Source:* Martin KA, et al. Use of direct oral anticoagulants in patients with obesity for treatment and prevention of venous thromboembolism: updated communication from the ISTH SSC Subcommittee on Control of Anticoagulation. J Thromb Haemost. 2021. https://pubmed.ncbi.nlm.nih.gov/34259389/

#### Q2
*Update:* His drug plan will not cover a DOAC for several weeks, and he agrees to injections meanwhile.

**Which of the following enoxaparin regimens is most appropriate for him in the meantime?**

- A. enoxaparin 230 mg SC every 12 hours
- B. enoxaparin 150 mg SC every 12 hours  **(key)**
- C. enoxaparin 100 mg SC every 12 hours
- D. enoxaparin 40 mg SC every 12 hours
- E. enoxaparin 150 mg SC once daily

*Explanation:* There is no maximum LMWH dose, and therapeutic enoxaparin is dosed on actual weight at 1 mg/kg every 12 hours, which is 152 mg, rounded to the 150 mg syringe. Capping the dose at 100 mg underdoses him. Forty mg every 12 hours is an intermediate prophylactic regimen. The once daily dose is 1.5 mg/kg, so 150 mg once daily is about one third too low, and 230 mg every 12 hours gives the once daily dose twice.
...
- A. Admit for catheter directed thrombolysis tonight
- B. Admit for IV heparin infusion
- C. Admit for vena cava filter insertion
- D. Discharge on anticoagulation with follow-up  **(key)**
- E. Observe for 24 hours for PE symptoms

*Explanation:* He has an uncomplicated proximal DVT with stable vital signs, normal kidney function and no bleeding risk, so the ASH guideline suggests home treatment over hospital treatment. For most proximal DVT, anticoagulation alone is suggested over thrombolysis. A vena cava filter is not indicated when he can be anticoagulated. He has no chest symptoms, so observation for PE adds nothing, and IV heparin offers no advantage over his outpatient regimen.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 7. Use objective data like vitals, oxygen saturation, and biomarkers to decide whether outpatient VTE treatment is safe.

*Source:* Ortel TL, et al. American Society of Hematology 2020 guidelines for management of venous thromboembolism: treatment of deep vein thrombosis and pulmonary embolism. Blood Adv. 2020. https://pubmed.ncbi.nlm.nih.gov/33007077/

#### Q4
**Which of the following new examination findings would indicate limb threatening DVT?**

- A. Calf swelling of 4 cm
- B. Cyanosis with weak pedal pulses  **(key)**
- C. Dilated superficial veins
- D. Pitting edema to the thigh
- E. Tenderness along the femoral vein
...
### dvt-pe-24: Pleuritic pain in a man with epilepsy
...
#### Q3
**Which of the following medications, like carbamazepine, would make a DOAC a poor choice for him?**
...
- A. apixaban 10 mg PO twice daily
- B. dabigatran after 5 days of LMWH
- C. edoxaban after 5 days of LMWH
- D. LMWH overlapped with warfarin  **(key)**
- E. rivaroxaban 15 mg PO twice daily

*Explanation:* DOACs are preferred over warfarin except when there are drug interactions through CYP3A4 or P-glycoprotein, and carbamazepine is a strong inducer of both. LMWH overlapped with warfarin avoids unreliable DOAC levels. Carbamazepine also affects warfarin, but INR monitoring allows the dose to be adjusted. LMWH continues for at least 5 days and until the INR is 2.0 or more on two consecutive days.
...
- A. Admit for vena cava filter insertion
- B. Admit to ICU for thrombolysis
- C. Admit to medicine until the INR is therapeutic
- D. Discharge on LMWH and warfarin with follow-up  **(key)**
- E. Observe 24 hours on telemetry

*Explanation:* He meets none of the Hestia criteria. He is hemodynamically stable, needs no oxygen, has pain controlled with oral analgesia, has no bleeding risk or renal impairment, and has support at home. Hestia negative patients can be treated as outpatients. Staying in hospital until the INR is therapeutic is unnecessary because LMWH provides full anticoagulation meanwhile. Thrombolysis, a vena cava filter and telemetry are not indicated for a stable segmental PE.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 7. Use objective data like vitals, oxygen saturation, and biomarkers to decide whether outpatient VTE treatment is safe.

*Source:* Zondag W, et al. Outpatient treatment in patients with acute pulmonary embolism: the Hestia Study. J Thromb Haemost. 2011. https://pubmed.ncbi.nlm.nih.gov/21645235/

### dvt-pe-25: Leg swelling during rehabilitation
...
#### Q1
**Which of the following is her 4Ts score for heparin induced thrombocytopenia?**
...
#### Q3
**Which of the following is the most appropriate anticoagulant for her now?**

- A. argatroban IV infusion  **(key)**
- B. dalteparin 12 500 units SC daily
- C. enoxaparin 60 mg SC every 12 hours
- D. heparin IV infusion
- E. warfarin 5 mg PO daily

*Explanation:* Acute HIT with thrombosis needs a non-heparin anticoagulant, and argatroban is one of the recommended options, along with bivalirudin, danaparoid, fondaparinux or a DOAC. Dalteparin, enoxaparin and IV unfractionated heparin all expose her to heparin and can worsen HIT. Warfarin started during acute HIT can cause venous limb gangrene and should wait until the platelet count recovers.
...
#### Q4
**Which of the following examination findings would most strengthen the diagnosis of HIT?**

- A. Bruising around the hip incision
- B. Petechiae on both shins
- C. Pitting edema of the right ankle
- D. Skin necrosis at injection sites  **(key)**
- E. Splinter hemorrhages in the nails

*Explanation:* Skin necrosis at heparin injection sites is a thrombotic complication of HIT and scores in the thrombosis item of the 4Ts. HIT is prothrombotic, and bleeding signs such as petechiae are unusual despite the low platelet count. Bruising near a recent hip incision is expected after surgery. Ankle edema reflects her known DVT, and splinter hemorrhages suggest endocarditis or trauma.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 2. Examine for signs supporting DVT or PE and for findings that suggest an alternative diagnosis.

*Source:* Cuker A, et al. American Society of Hematology 2018 guidelines for management of venous thromboembolism: heparin-induced thrombocytopenia. Blood Adv. 2018. https://pubmed.ncbi.nlm.nih.gov/30482768/

### dvt-pe-26: A blue, swollen leg
...
#### Q1
**Which of the following diagnoses best describes this presentation of leg swelling?**

- A. Acute arterial embolism
- B. Necrotizing fasciitis
- C. Phlegmasia alba dolens
- D. Phlegmasia cerulea dolens  **(key)**
- E. Ruptured popliteal cyst

*Explanation:* Massive swelling of the whole leg with cyanosis, pain and reduced distal perfusion, in a patient with cancer who stopped anticoagulation, is phlegmasia cerulea dolens, a limb threatening extensive DVT. Phlegmasia alba dolens presents with a white, blanched leg. An arterial embolism causes a pale, cold limb without massive swelling. Necrotizing fasciitis causes severe pain with skin changes and toxicity rather than a blue leg swollen to the groin, and a ruptured popliteal cyst causes calf swelling only.
...
#### Q2
**Which of the following bedside tests would best support PE before treatment?**

- A. Arterial blood gas analysis
- B. Compression ultrasound of the left leg  **(key)**
- C. Portable anteroposterior chest X-ray
- D. Quantitative D-dimer level
- E. Serum lactate and troponin

*Explanation:* In a patient with suspected high risk PE who cannot have CT, echocardiographic RV dysfunction is enough to justify emergency reperfusion, and bedside compression ultrasound showing a proximal DVT adds strong support for VTE. Her left calf pain makes a DVT likely to be found. A D-dimer cannot confirm PE. Blood gas, lactate, troponin and chest X-ray reflect severity or other causes but do not confirm PE.
...
- B. apixaban 10 mg PO now
- C. dalteparin 14 000 units SC now
- D. heparin IV infusion alone
- E. Transfer for CT before treatment

*Explanation:* She has high risk PE, with persistent hypotension despite fluid and a vasopressor, RV dilation and a proximal DVT, and she has no contraindication to thrombolysis. Systemic thrombolysis is indicated, and alteplase 100 mg IV over 2 hours is a standard regimen, followed by IV unfractionated heparin. Anticoagulation alone with heparin, dalteparin or apixaban does not relieve the obstruction quickly enough in shock. Transfer for CT would delay reperfusion when the diagnosis is already well supported.
...
**Which of the following alteplase regimens is most appropriate now?**

- A. alteplase 10 mg IV bolus
- B. alteplase 50 mg IV bolus  **(key)**
- C. alteplase 100 mg IV over 2 hours
- D. alteplase 0.9 mg/kg IV over 1 hour
- E. alteplase 0.6 mg/kg IV over 15 minutes

*Explanation:* For a patient in cardiac arrest from PE, alteplase 50 mg can be given as an IV bolus over 1 minute, with CPR continuing afterward. The 2 hour infusion is too slow during arrest. The 0.6 mg/kg regimen over 15 minutes is an accelerated option for patients who still have a pulse. A 10 mg bolus is only the first part of a split dose, and 0.9 mg/kg over 1 hour is the ischemic stroke regimen.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 6. Choose anticoagulation that fits the patient, for example avoiding warfarin in pregnancy or LMWH in renal failure.

*Source:* Thrombosis Canada. Clinical guide: pulmonary embolism (PE) treatment. 2025. https://thrombosiscanada.ca/clinical_guides/pdfs/44_60.pdf

### dvt-pe-28: Calf swelling late in the evening
...
#### Q1
**Which of the following is her two level Wells score for deep vein thrombosis?**
...
- A. Admit for IV heparin until ultrasound
- B. D-dimer, and discharge if it is negative
- C. Discharge and book ultrasound without treatment
- D. Start LMWH and book ultrasound for tomorrow  **(key)**
- E. Transfer tonight for ultrasound elsewhere

*Explanation:* With a likely pretest probability and a delay to ultrasound of more than 4 hours, a rapidly acting anticoagulant such as LMWH should start until testing is done, unless bleeding risk is high. A likely score calls for ultrasound, and a negative D-dimer alone is not the recommended way to exclude DVT in this group. Discharge without treatment leaves a probable DVT untreated overnight. Admission for IV heparin or a night transfer adds cost and risk without benefit.
...
- A. Continue tinzaparin for 3 months
- B. Contrast venography of the left leg
- C. CT venography of the left leg
- D. Repeat proximal ultrasound in 5 to 7 days  **(key)**
- E. No further testing for DVT

*Explanation:* A negative proximal ultrasound does not exclude a calf DVT that may extend, and with a likely pretest probability and a positive D-dimer, proximal ultrasound should be repeated in 5 to 7 days. Treating for 3 months without a diagnosis exposes her to unnecessary bleeding risk. Venography is not needed at this stage. Stopping all testing would be reasonable only with a negative D-dimer.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 4. Choose tests suited to pretest probability, for example skipping D-dimer in high probability patients.

*Source:* Thrombosis Canada. Clinical guide: deep vein thrombosis (DVT) diagnosis. 2025. https://thrombosiscanada.ca/clinical_guides/pdfs/DEEPVEINTHROMBOSISDIAGNOSIS_60.pdf

### dvt-pe-29: Calf pain after a previous clot
...
#### Q2
**Which of the following is the most appropriate next step for suspected recurrent DVT?**

- A. Contrast venography of the left leg
- B. CT venography of the left leg
- C. D-dimer, with ultrasound if positive  **(key)**
- D. Empirical rivaroxaban for 3 months
- E. Proximal ultrasound now and in 1 week

*Explanation:* For suspected recurrent DVT with an unlikely pretest probability, the ASH guideline suggests starting with a D-dimer, with ultrasound only if it is positive. A negative D-dimer spares him imaging that can be hard to interpret after a previous DVT. Starting rivaroxaban without a diagnosis exposes him to bleeding. CT and contrast venography are not first line tests.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 4. Choose tests suited to pretest probability, for example skipping D-dimer in high probability patients.

*Source:* Lim W, et al. American Society of Hematology 2018 guidelines for management of venous thromboembolism: diagnosis of venous thromboembolism. Blood Adv. 2018. https://pubmed.ncbi.nlm.nih.gov/30482764/
...
**Which of the following is the most appropriate plan for anticoagulation?**

- A. Anticoagulation for 3 months, then stop
- B. Anticoagulation with no planned stop date  **(key)**
- C. ASA 81 mg PO daily indefinitely
- D. IVC filter without anticoagulation
- E. Rivaroxaban for 6 weeks, then stop

*Explanation:* This second DVT has no transient provoking factor, so it is unprovoked. For unprovoked VTE, the ASH guideline suggests indefinite anticoagulation after primary treatment, with periodic review of bleeding risk. Stopping after 3 months or 6 weeks leaves him at high risk of recurrence. Anticoagulation is suggested over ASA for secondary prevention, and a filter without anticoagulation is only for patients who cannot be anticoagulated.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 6. Choose anticoagulation that fits the patient, for example avoiding warfarin in pregnancy or LMWH in renal failure.

*Source:* Ortel TL, et al. American Society of Hematology 2020 guidelines for management of venous thromboembolism: treatment of deep vein thrombosis and pulmonary embolism. Blood Adv. 2020. https://pubmed.ncbi.nlm.nih.gov/33007077/

### dvt-pe-30: Whole leg swelling in late pregnancy
...
**Which of the following is the most appropriate diagnostic plan for her?**

- A. Contrast venography of the left leg
- B. CT venography of the pelvis
- C. D-dimer to decide on treatment
- D. Serial ultrasound with iliac Doppler  **(key)**
- E. No further testing and stop LMWH

*Explanation:* When the first ultrasound is negative but suspicion persists in pregnancy, the ASH guideline suggests further testing with serial compression ultrasound or MR venography. With MR unavailable, serial ultrasound that includes Doppler assessment of the iliac veins is the right choice. CT and contrast venography add fetal radiation. D-dimer is raised in normal pregnancy, and stopping all testing leaves an iliac DVT undiagnosed.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 5. Tailor VTE testing to context, such as leg ultrasound first in pregnancy or CT over VQ with lung disease.

*Source:* Bates SM, et al. American Society of Hematology 2018 guidelines for management of venous thromboembolism: venous thromboembolism in the context of pregnancy. Blood Adv. 2018. https://pmc.ncbi.nlm.nih.gov/articles/PMC6258928/

### dvt-pe-31: Sudden breathlessness with a swollen calf
...
*Explanation:* He scores 3 for clinical signs of DVT, 3 for PE as the most likely diagnosis, 1.5 for a heart rate above 100/minute, 1.5 for surgery within 4 weeks and 1 for hemoptysis, for 10.0. He has no cancer or previous VTE. A score above 6.0 is high clinical probability.
...
#### Q1
**Which of the following is her simplified pulmonary embolism severity index (sPESI) score?**
...
*Explanation:* She scores 1 point for age over 80 years, 1 point for a heart rate of 110/minute or more and 1 point for an oxygen saturation below 90%, for a total of 3. She has no cancer and no chronic heart or lung disease, and her systolic BP is 100 mmHg or more. Any score of 1 or more places her outside the low risk group.
...
- A. Admit to a medical ward  **(key)**
- B. Admit to ICU for thrombolysis
- C. Discharge after 6 hours of observation
- D. Discharge home on apixaban
- E. Discharge with home care nursing

*Explanation:* Her oxygen saturation of 88% means she needs supplemental oxygen, which is a Hestia criterion for admission, and her sPESI of 3 also excludes her from the low risk group. Living alone is a further social reason to admit her. Thrombolysis is not indicated because she is normotensive, with a normal RV to LV ratio and troponin. Any form of discharge, even with nursing support, ignores her hypoxemia and tachycardia.
...
#### Q1
**Which of the following is his risk category under the ESC pulmonary embolism guideline?**

- A. High risk with instability
- B. Intermediate high risk
- C. Intermediate low risk  **(key)**
- D. Low risk by Hestia criteria
- E. Low risk by sPESI score

*Explanation:* His RV to LV ratio of 1.2 on CT shows RV dysfunction while his troponin is normal. The ESC guideline places patients with RV dysfunction or a raised troponin in the intermediate risk group even when the sPESI is 0, and one abnormal marker without the other makes him intermediate low risk. Intermediate high risk needs both RV dysfunction and a raised troponin. High risk requires hemodynamic instability. A low risk label from sPESI or Hestia alone ignores his RV finding.
...
- A. Admit to hospital on anticoagulation  **(key)**
- B. Admit to ICU for systemic thrombolysis
- C. Arrange catheter directed therapy tonight
- D. Discharge after a repeat troponin
- E. Discharge home on apixaban

*Explanation:* RV dilation on imaging is a higher mortality marker, so he should not be treated as a low risk outpatient despite his sPESI of 0, and he should be admitted, anticoagulated and monitored. Thrombolysis is not routinely indicated in intermediate risk PE because it increases major bleeding and hemorrhagic stroke. Catheter directed therapy is not routine for intermediate or high risk PE. A second normal troponin would not remove his RV dilation.
...
#### Q4
**Which of the following findings during his admission would indicate high risk PE?**

Select 2.

- A. Heart rate rising to 118/minute
- B. Need for norepinephrine to keep BP up  **(key)**
- C. New right bundle branch block
- D. O2 sat falling to 92% on room air
- E. Systolic BP below 90 mmHg for over 15 minutes  **(key)**
- F. Troponin rising above normal
- G. Worsening pleuritic chest pain

*Explanation:* High risk PE is defined by hemodynamic instability: cardiac arrest, obstructive shock with a need for vasopressors, or persistent hypotension with a systolic BP below 90 mmHg or a drop of 40 mmHg or more for over 15 minutes. A rising troponin with his RV dilation would make him intermediate high risk, not high risk. Tachycardia, a new bundle branch block, mild desaturation and worse pain signal deterioration and need reassessment, but none of them defines high risk.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 7. Use objective data like vitals, oxygen saturation, and biomarkers to decide whether outpatient VTE treatment is safe.

*Source:* Konstantinides SV, et al. 2019 ESC guidelines for the diagnosis and management of acute pulmonary embolism. Eur Heart J. 2020. https://pubmed.ncbi.nlm.nih.gov/31504429/

### dvt-pe-34: A red, painful shin
...
#### Q1
**Which of the following examination findings most favours an alternative diagnosis to DVT?**

- A. Calf swelling of 3 cm
- B. Dilated superficial collateral veins
- C. Lymphangitic streaking up the thigh  **(key)**
- D. Pitting edema confined to the leg
- E. Tenderness along the deep veins

*Explanation:* Red streaks tracking up the leg from a skin wound are lymphangitis, which with fever, spreading erythema from an abrasion and a tender inguinal node points to cellulitis. Calf swelling, pitting edema, deep vein tenderness and non-varicose collateral veins are Wells criteria that support DVT. Cellulitis and DVT can coexist, so the alternative diagnosis lowers but does not remove the need to test for DVT.
...
**Which of the following is the most appropriate next step for suspected DVT now?**

- A. Contrast venography of the right leg
- B. CT venography of the right leg
- C. Repeat ultrasound in 5 to 7 days
- D. Start apixaban while awaiting results
- E. No further testing for DVT  **(key)**

*Explanation:* In a patient with an unlikely pretest probability, a positive D-dimer followed by a negative compression ultrasound excludes DVT. A repeat ultrasound in 5 to 7 days is for patients with a likely score whose first proximal study is negative. Venography by CT or contrast is not needed. Anticoagulation is not indicated once DVT is excluded, and her cellulitis should now be treated.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 4. Choose tests suited to pretest probability, for example skipping D-dimer in high probability patients.

*Source:* Thrombosis Canada. Clinical guide: deep vein thrombosis (DVT) diagnosis. 2025. https://thrombosiscanada.ca/clinical_guides/pdfs/DEEPVEINTHROMBOSISDIAGNOSIS_60.pdf

### dvt-pe-35: New breathlessness on an anticoagulant
...
- B. Contrast venography of the right leg
- C. CT venography of the right leg
- D. D-dimer, with ultrasound if positive
- E. Thrombophilia testing panel

*Explanation:* A Wells score of 2 or more makes DVT likely, and compression ultrasound is the recommended first test. Starting with D-dimer is the strategy for an unlikely score and would not avoid imaging for him. Thrombophilia testing does not diagnose an acute DVT. CT venography and contrast venography are not first line for suspected leg DVT.
...
- A. dabigatran 150 mg PO twice daily
- B. edoxaban 60 mg PO once daily
- C. rivaroxaban 20 mg PO once daily
- D. rivaroxaban 15 mg PO twice daily  **(key)**
- E. warfarin 5 mg PO once daily

*Explanation:* Rivaroxaban can be started alone at 15 mg twice daily for 21 days, then 20 mg once daily, and DOACs are preferred to warfarin for initial treatment. Starting at 20 mg once daily omits the 3 week higher dose phase. Dabigatran and edoxaban both need 5 to 10 days of LMWH before they start. Warfarin alone has no immediate effect and needs overlap with a heparin.
...
#### Q1
**Which of the following features of his history most increases his risk of VTE?**

- A. Lifelong nonsmoking
- B. Normal kidney function
- C. Paralysis of the right leg  **(key)**
- D. Pneumatic compression use
- E. Treated hypertension

*Explanation:* Paralytic stroke is a recognized moderate risk factor for VTE, and his right leg paralysis after the hemorrhage leaves him unable to walk. Intermittent pneumatic compression lowers VTE risk rather than raising it. Treated hypertension, normal kidney function and not smoking do not increase his risk of VTE.
...
#### Q3
**Which of the following is the most appropriate long term plan for the filter?**

- A. Keep it in place permanently
- B. Remove it after 72 hours
- C. Remove it once anticoagulation is safe  **(key)**
- D. Remove it when his leg swelling resolves
- E. Replace it with ASA 81 mg daily

*Explanation:* A retrievable filter is a bridge: once therapeutic anticoagulation is safe and established, the filter should be removed, and anticoagulation continues for at least 3 months for the proximal DVT. Removing it at 72 hours or when the swelling settles ignores whether he can yet be anticoagulated. Leaving it permanently offers no benefit once he is anticoagulated. ASA does not replace anticoagulation for proximal DVT.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 6. Choose anticoagulation that fits the patient, for example avoiding warfarin in pregnancy or LMWH in renal failure.

*Source:* Thrombosis Canada. Clinical guide: deep vein thrombosis (DVT) treatment. 2025. https://thrombosiscanada.ca/clinical_guides/pdfs/DEEPVEINTHROMBOSISTREATMENT_80.pdf

### dvt-pe-38: Breathless after a bus trip
...
#### Q2
**Which of the following is the most appropriate next test in this hospital?**

- A. Bedside compression ultrasound of the left leg  **(key)**
- B. D-dimer with a 500 mcg/L cutoff
- C. Transfer for CT pulmonary angiogram tonight
- D. Transthoracic echocardiography
...
#### Q1
**Which of the following best describes the use of the PERC rule for him?**

- A. All criteria met, and PE is excluded
- B. All criteria met, but PERC does not apply  **(key)**
- C. Fails the age criterion
- D. Fails the heart rate criterion
- E. Fails the oxygen saturation criterion

*Explanation:* He meets all eight PERC criteria: age under 50, heart rate below 100/minute, oxygen saturation of 95% or more, no hemoptysis, no estrogen use, no previous VTE, no unilateral leg swelling and no recent surgery or trauma. PERC was designed to rule out PE only when clinical gestalt is low, below about 15%, and his estimate is 30%. So PE is not excluded and he needs further testing. His age of 29, pulse of 96/minute and saturation of 96% all meet the criteria.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 3. Apply validated decision rules to estimate the pretest probability of DVT or PE.

*Source:* Kline JA, et al. Clinical criteria to prevent unnecessary diagnostic testing in emergency department patients with suspected pulmonary embolism. J Thromb Haemost. 2004. https://pubmed.ncbi.nlm.nih.gov/15304025/
...
#### Q3
**Which of the following is the highest D-dimer threshold validated to exclude PE in him?**

- A. Below 250 mcg/L FEU
- B. Below 500 mcg/L FEU
- C. Below 750 mcg/L FEU
- D. Below 1000 mcg/L FEU  **(key)**
- E. Below 1500 mcg/L FEU

*Explanation:* In PEGeD, patients with a low clinical pretest probability, a Wells score of 4.0 or less, had PE excluded by a D-dimer below 1000 mcg/L FEU, and he scores 3.0. The 500 mcg/L threshold applies to moderate probability, a score of 4.5 to 6.0. Lower thresholds would still be safe but send more patients to imaging, and a 1500 mcg/L threshold has not been validated.
...
- D. Repeat D-dimer in 6 hours
- E. Transthoracic echocardiography

*Explanation:* His D-dimer is above the 1000 mcg/L FEU threshold for low clinical probability, so PE is not excluded and CT pulmonary angiography is needed. Leg ultrasound has a low yield without leg symptoms, and a negative study would not exclude PE. Repeating the D-dimer only delays the diagnosis. Echocardiography cannot exclude PE, and an exercise test is unsafe before PE is excluded in a patient who fainted on exertion.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 4. Choose tests suited to pretest probability, for example skipping D-dimer in high probability patients.

*Source:* Kearon C, et al. Diagnosis of pulmonary embolism with d-dimer adjusted to clinical probability (PEGeD). N Engl J Med. 2019. https://pubmed.ncbi.nlm.nih.gov/31774957/

### dvt-pe-40: Contractions on an anticoagulant
...
#### Q1
**Which of the following is the most appropriate anticoagulant plan for him?**

- A. Continue warfarin alone
- B. enoxaparin with ongoing warfarin  **(key)**
- C. Switch to apixaban 10 mg twice daily
- D. Switch to dabigatran after LMWH
- E. Switch to rivaroxaban 15 mg twice daily
...
#### Q2
**Which of the following INR ranges should his warfarin now target?**

- A. INR 1.5 to 2.0
- B. INR 2.0 to 3.0
- C. INR 2.5 to 3.5  **(key)**
- D. INR 3.0 to 4.0
- E. INR 3.5 to 4.5

*Explanation:* The ASH guideline recommends an INR range of 2.0 to 3.0 for VTE, but his mechanical mitral valve already needs his higher target of 2.5 to 3.5. That range also treats the DVT, so it should not be lowered. A range of 1.5 to 2.0 would undertreat both conditions, and targets above 3.5 add bleeding risk without added benefit for his valve or his DVT.
...
- A. Admit for IV heparin until INR is in range
- B. Admit for vena cava filter insertion
- C. Discharge on warfarin with INR in 1 week
- D. Discharge with enoxaparin and INR checks  **(key)**
- E. Observe 24 hours on telemetry

*Explanation:* He has an uncomplicated popliteal DVT with normal vital signs, kidney function and blood counts, so the ASH guideline suggests home treatment over hospital treatment. He can inject enoxaparin at home while warfarin is adjusted with frequent INR checks. Warfarin alone with an INR in a week leaves him inadequately treated for days. IV heparin, telemetry and a filter add nothing for a stable patient.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 7. Use objective data like vitals, oxygen saturation, and biomarkers to decide whether outpatient VTE treatment is safe.

*Source:* Ortel TL, et al. American Society of Hematology 2020 guidelines for management of venous thromboembolism: treatment of deep vein thrombosis and pulmonary embolism. Blood Adv. 2020. https://pubmed.ncbi.nlm.nih.gov/33007077/

### dvt-pe-42: Blood streaked sputum and breathlessness
...
*Explanation:* She scores 3 because PE is more likely than the alternative diagnosis, 1.5 for a previous DVT and 1 for hemoptysis, for 5.5. Her heart rate of 94/minute does not score, and she has no DVT signs, cancer, recent surgery or immobilization. In PEGeD, a score of 4.5 to 6.0 is moderate clinical probability.
...
*Explanation:* With moderate clinical probability, PEGeD excludes PE only with a D-dimer below 500 mcg/L FEU. Her 720 mcg/L result is above that threshold, so she needs CT pulmonary angiography. The 1000 mcg/L threshold applies only to low probability patients. Leg ultrasound has a low yield without leg symptoms, echocardiography cannot exclude PE, and a repeat D-dimer delays the diagnosis.
...
#### Q3
**Which of the following findings raises her VTE risk without adding Wells points?**

- A. Blood streaked sputum
- B. Heart rate of 94/minute
- C. Normal chest X-ray
- D. Oral menopausal hormone therapy  **(key)**
- E. Previous DVT after a fracture

*Explanation:* Oral estrogen hormone replacement therapy is a recognized moderate risk factor for VTE, but it is not one of the Wells items. Hemoptysis and a previous DVT each add Wells points, 1 and 1.5. A heart rate of 94/minute scores nothing and does not raise VTE risk. A normal chest X-ray is common in PE and does not change her risk.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 1. When DVT or PE is suspected, take a history that captures the patient's baseline risk factors.

*Source:* Konstantinides SV, et al. 2019 ESC guidelines for the diagnosis and management of acute pulmonary embolism. Eur Heart J. 2020. https://pubmed.ncbi.nlm.nih.gov/31504429/

### dvt-pe-43: Breathless woman after a cold
...
*Explanation:* Her heart rate of 94/minute does not exceed 100/minute, and she has no signs of DVT, hemoptysis, cancer, previous VTE, recent surgery or immobilization. Pneumonia is more likely than PE, so the 3 points for PE as the most likely diagnosis do not apply. Her Wells score is 0, and PE is unlikely.
...
#### Q2
**Which of the following is her age adjusted D-dimer cutoff?**
...
*Explanation:* For patients older than 50 years in whom PE is unlikely, the age adjusted cutoff is the age multiplied by 10 mcg/L FEU, which is 760 mcg/L at 76 years. The standard 500 mcg/L cutoff loses specificity in older patients. A cutoff of 1000 mcg/L comes from the clinical probability approach of PEGeD rather than from age. Values of 380 and 660 mcg/L do not follow the age times 10 rule.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 4. Choose tests suited to pretest probability, for example skipping D-dimer in high probability patients.

*Source:* Righini M, et al. Age-adjusted D-dimer cutoff levels to rule out pulmonary embolism: the ADJUST-PE study. JAMA. 2014. https://pubmed.ncbi.nlm.nih.gov/24643601/
...
- A. Contrast venography through the line
- B. CT venography of the chest
- C. D-dimer with a 500 mcg/L cutoff
- D. Duplex ultrasound of the left arm  **(key)**
- E. MR venography of the chest

*Explanation:* Clinical decision rules and D-dimer have not been validated in children, so testing for DVT starts with ultrasound, and duplex ultrasound suits the arm veins around a catheter. A D-dimer would also be raised by his lung disease. CT or MR venography may be considered if ultrasound is negative and suspicion stays high, and CT adds radiation for a child. Contrast venography is invasive.
...
**Which of the following is the most appropriate management of the catheter?**

- A. Instil alteplase into the catheter
- B. Keep the functioning catheter in place  **(key)**
- C. Remove it and finish oral antibiotics
- D. Remove it before starting anticoagulation
- E. Replace it over a guidewire

*Explanation:* For children with symptomatic catheter related thrombosis who still need venous access, the ASH guideline suggests not removing a functioning catheter, which spares a child with limited access sites a new line. His catheter flushes and draws well, and he needs four more days of IV antibiotics. Removal, with or without a guidewire exchange, leaves him needing new access. Switching to oral antibiotics changes his planned treatment, and alteplase in the lumen treats catheter occlusion rather than a DVT around it.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 6. Choose anticoagulation that fits the patient, for example avoiding warfarin in pregnancy or LMWH in renal failure.

*Source:* Monagle P, et al. American Society of Hematology 2018 guidelines for management of venous thromboembolism: treatment of pediatric venous thromboembolism. Blood Adv. 2018. https://pubmed.ncbi.nlm.nih.gov/30482766/

#### Q3
**Which of the following is the most appropriate initial anticoagulant regimen for him?**

- A. ASA 81 mg PO daily
- B. enoxaparin 42 mg SC every 12 hours
- C. enoxaparin 28 mg SC every 12 hours  **(key)**
- D. enoxaparin 14 mg SC every 12 hours
- E. warfarin 5 mg PO once daily

*Explanation:* Children start with a parenteral anticoagulant, and the pediatric DOAC trials gave at least 5 days of it before rivaroxaban or dabigatran, which the 2024 ASH/ISTH update now suggests for ongoing treatment. For children older than 5 years, the starting enoxaparin dose is 1 mg/kg every 12 hours, which is 28 mg for 28 kg. A dose of 14 mg is half the therapeutic dose, and 42 mg is about 1.5 mg/kg, a starting dose for infants under 3 months. Warfarin started alone has no immediate effect, and ASA does not treat VTE.

*Key feature:* Deep venous thrombosis (DVT) and pulmonary embolus (PE) 6. Choose anticoagulation that fits the patient, for example avoiding warfarin in pregnancy or LMWH in renal failure.

*Source:* Monagle P, et al. American Society of Hematology/International Society on Thrombosis and Haemostasis 2024 updated guidelines for treatment of venous thromboembolism in pediatric patients. Blood Adv. 2025. https://pubmed.ncbi.nlm.nih.gov/40423983/

### dvt-pe-46: Calf pain during chemotherapy
...
#### Q2
**Which of the following findings defines her PE as high risk?**

- A. Hypotension needing norepinephrine  **(key)**
- B. Mobile right atrial thrombus
- C. Oxygen saturation below 90%
- D. Respiratory rate of 30/minute
- E. Severe dilation of the right ventricle

*Explanation:* High risk PE is defined by hemodynamic instability, here hypotension that persists after fluid and needs a vasopressor. RV dilation and a right heart thrombus are markers of severity, but without instability they would place a patient in the intermediate risk group. Hypoxemia and tachypnea are common in PE and do not define the risk class.
...
#### Q3
**Which of the following history items, if present, would be absolute contraindications to systemic thrombolysis?**

Select 2.

- A. Allergy to penicillin
- B. Controlled hypertension
- C. Craniotomy six days ago  **(key)**
- D. Hip replacement eight weeks ago
- E. Ischemic stroke four months ago  **(key)**
- F. Previous DVT two years ago
- G. Type 2 diabetes on metformin

*Explanation:* Absolute contraindications to thrombolysis include ischemic stroke within 6 months, a central nervous system neoplasm, and major surgery, trauma or head injury within 3 weeks, so both a craniotomy six days ago and a stroke four months ago qualify. A hip replacement eight weeks ago is outside the 3 week window. Controlled hypertension, diabetes, a penicillin allergy and a previous DVT are not contraindications.
