...
21 SAMPs. All are reviewed: false until signed off. The key is marked on each question.
...
- critical-appraisal-33 q4. Cast thromboprophylaxis has no Canadian guideline, and guidance is split. NICE supports risk-based LMWH. ACCP 2012 suggests no routine prophylaxis for isolated lower leg injury. The key holds for a patient with prior VTE, but please confirm. *(samps-s31-lensA.md)*
- critical-appraisal-37 and critical-appraisal-38 (review-extra). Exact copies of critical-appraisal-23 and critical-appraisal-30 with planted errors. The errors are fixed, but both should be dropped, not added. *(samps-s31-lensA.md)*
- Overlap flags above for critical-appraisal-27, 22, 19 and 34. Decide whether to rewrite them or accept them. *(samps-s31-lensA.md)*
- critical-appraisal-28 q4 cites a US guideline (IDSA 2014) for surgical exploration. No Canadian equivalent was found. *(samps-s31-lensA.md)*
- critical-appraisal-37 and critical-appraisal-38 (review-extra) are copies of critical-appraisal-23 and critical-appraisal-30. Their planted errors are now fixed and they match the originals, but they should be dropped, not added. They would fail the near duplicate stem test if merged. *(samps-s31-lensB.md)*
- critical-appraisal-19. Please confirm a 5 percentage point noninferiority margin for oral step-down in cellulitis. It replaces the original 8 points so that the per-protocol interval can cross the margin with 1 000 patients. *(samps-s31-lensB.md)*
- critical-appraisal-24 and critical-appraisal-28. BP was lowered so that the explanations' "hypotension" is true. Confirm the keys still read as intended (they do on Lens B review). *(samps-s31-lensB.md)*

Review reports: docs/reviews/writer-s31.md, samps-s31-lensA.md, samps-s31-lensB.md

## SAMPs

### critical-appraisal-16: A pathway with no events
...
#### Q1
**Which of the following is closest to the upper limit of the 95% confidence interval for the 30-day MACE rate in this study?**
...
*Explanation:* Zero events in 600 patients still leaves an upper 95% limit of about 3 divided by 600, or 0.5%. This is the rule of three, which approximates the exact one-sided limit (0.498%) whenever no events occur. The point estimate of 0% is not the interval. A figure of 0.2% is 1 divided by 600, the rate had a single event occurred. A limit of 1.0% would need only 300 event-free patients, and 3.0% is the limit for 100 patients.

*Key feature:* Critical appraisal 2. Calculate sensitivity, specificity, likelihood ratios, and NNT or NNH from study data and explain what they mean.

*Source:* Hanley JA, Lippman-Hand A. If nothing goes wrong, is everything all right? Interpreting zero numerators. JAMA 1983. https://pubmed.ncbi.nlm.nih.gov/6827763/

#### Q2
**Which of the following questions would need a concurrent usual care comparison group to answer?**

- A. Whether follow-up was complete
- B. Whether MACE was rare after discharge
- C. Whether the pathway reduced admissions  **(key)**
- D. Whether the sites enrolled consecutively
- E. Whether the upper limit of risk was low

*Explanation:* A single-group cohort shows what happened to pathway patients, but not what would have happened to them under usual care. Only a comparison group, ideally randomized, can show that the pathway changed admissions or testing. The study itself shows that follow-up was complete, that consecutive patients were enrolled, and that MACE was rare, with an upper 95% limit of 0.5%. Those questions are answered within one group and need no comparator.

*Key feature:* Critical appraisal 1. Identify a study's design and explain the strengths and weaknesses that design brings to the research question.

*Source:* Guyatt G, Rennie D, Meade MO, Cook DJ, editors. Users' Guides to the Medical Literature. A Manual for Evidence-Based Clinical Practice. 3rd edition. JAMA Evidence and McGraw-Hill Education. 2015. https://jamaevidence.mhmedical.com/content.aspx?bookid=847&sectionid=69030714
...
**Which of the following study features most directly shows that this conclusion goes beyond the data?**

- A. Ages 30 to 64 only  **(key)**
- B. Enrolment at 4 sites
- C. Follow-up of 30 days
- D. Only 600 patients enrolled
- E. Use of a single troponin
...
*Key feature:* Critical appraisal 4. Judge whether results matter clinically, apply to your own patients, and actually support the authors' conclusions.

*Source:* McGinn TG, Guyatt GH, Wyer PC, Naylor CD, Stiell IG, Richardson WS. Users' guides to the medical literature XXII. How to use articles about clinical decision rules. JAMA 2000. https://pubmed.ncbi.nlm.nih.gov/10872017/

#### Q4
**Which of the following is the most appropriate plan for this patient?**

- A. Admit for coronary angiography today
- B. Discharge home using the new pathway
- C. Discharge with a stress test in 6 weeks
- D. Repeat troponin and apply a validated score  **(key)**
- E. Start heparin and admit to telemetry

*Explanation:* She is 71, older than anyone the study enrolled, so the pathway's reassuring event rate does not transfer to her. Her pain began 3 hours ago, and a single early troponin cannot rule out infarction, so a repeat troponin and a risk score validated in older adults should guide her disposition. Discharge on the new pathway applies it outside its population. A delayed stress test skips the serial troponin she still needs. Heparin and angiography are not warranted with a normal ECG and a normal first troponin.
...
### critical-appraisal-17: A score in banded form
...
**Using the study prevalence as his pretest probability, which of the following is closest to his post-test probability of appendicitis?**
...
- A. Discharge with review in 24 hours
- B. Observe overnight with serial examinations
- C. Oral antibiotics and outpatient ultrasound
- D. Repeat the score and WBC in 12 hours
- E. Transfer for surgical assessment  **(key)**
...
*Key feature:* Critical appraisal 3. Use these statistics to justify specific clinical decisions and changes to practice.

*Source:* Guyatt G, Rennie D, Meade MO, Cook DJ, editors. Users' Guides to the Medical Literature. A Manual for Evidence-Based Clinical Practice. 3rd edition. JAMA Evidence and McGraw-Hill Education. 2015. https://jamaevidence.mhmedical.com/content.aspx?bookid=847&sectionid=69030714

### critical-appraisal-18: Not every child had an X-ray
...
#### Q1
**Which of the following is closest to the sensitivity of POCUS as reported in the analysis of the 110 children?**
...
*Explanation:* In the 110 children with an X-ray there were 75 fractures, 72 detected by POCUS and 3 missed. Sensitivity is 72 divided by 75, or 96.0%. The reported specificity is 27 divided by 35, or 77.1%, since 8 of the 35 children without a fracture had a positive scan. A value of 86% is the sensitivity after correcting for the unverified children. A value of 90% is 72 divided by 80, the positive predictive value. A sensitivity of 99% would need almost no missed fractures.

*Key feature:* Critical appraisal 2. Calculate sensitivity, specificity, likelihood ratios, and NNT or NNH from study data and explain what they mean.

*Source:* Bossuyt PM, Reitsma JB, Bruns DE, et al. STARD 2015. An updated list of essential items for reporting diagnostic accuracy studies. BMJ 2015. https://doi.org/10.1136/bmj.h5527

#### Q2
**Which of the following biases best describes restricting the analysis to children whose X-ray was ordered based on the POCUS result?**

- A. Imperfect reference bias
- B. Incorporation bias
- C. Partial verification bias  **(key)**
- D. Spectrum bias
- E. Test review bias

*Explanation:* Every POCUS positive child had the reference standard, but only a quarter of the POCUS negative children did, and the rest were dropped. That is partial verification, or work-up, bias. It hides false negatives, so sensitivity is overestimated and specificity underestimated. Imperfect reference bias arises when the reference standard itself misclassifies, but X-ray is a sound reference for these fractures. Incorporation bias occurs when the test forms part of the reference standard. Spectrum bias comes from an unrepresentative sample. Test review bias occurs when the reference is read with knowledge of the index test.
...
**Which of the following is closest to the corrected sensitivity of POCUS for distal forearm fracture?**
...
**Which of the following is closest to his probability of fracture after this negative scan?**
...
**Which of the following best interprets the intention-to-treat result against the prespecified margin?**

- A. Inconclusive, as the interval crosses zero
- B. Noninferior, with superiority not shown  **(key)**
- C. Oral inferior, as its failures were higher
- D. Oral superior, as the interval includes negatives
- E. Uninterpretable without a p value

*Explanation:* The whole 95% interval, from 2.3 points fewer failures to 4.3 points more, lies below the 5 point margin, so noninferiority is shown by intention to treat. The interval also includes zero, so oral therapy is not shown to be better. Crossing zero is expected in a noninferiority trial and does not make it inconclusive. The question is whether the upper limit clears the margin. A higher point estimate of failure does not show inferiority when the interval excludes the margin. The confidence interval carries more information than a p value here.

*Key feature:* Critical appraisal 4. Judge whether results matter clinically, apply to your own patients, and actually support the authors' conclusions.

*Source:* Piaggio G, Elbourne DR, Pocock SJ, et al. Reporting of noninferiority and equivalence randomized trials. Extension of the CONSORT 2010 statement. JAMA 2012. https://doi.org/10.1001/jama.2012.87802

#### Q2
**Which of the following describes how the 90 IV patients who switched to oral therapy are handled by intention to treat?**

- A. Analysed in the IV group  **(key)**
- B. Analysed in the oral group
- C. Counted as treatment failures
- D. Excluded from the analysis
- E. Replaced by new enrolments

*Explanation:* Intention to treat analyses every patient in the group to which they were randomized, whatever treatment they then received. So the 90 IV patients who switched to oral therapy stay in the IV group, which keeps the balance that randomization created. Moving them to the oral group analyses them as treated and breaks randomization. Excluding them is what a per-protocol analysis does. A change of route is not the prespecified outcome, which was treatment failure at 14 days. Randomized patients are never replaced by new enrolments.
...
#### Q4
**Which of the following is the most appropriate plan for this patient today?**

- A. Admit for daily IV cefazolin
- B. Home IV cefazolin through a PICC line
- C. Oral cephalexin with review in 48 hours  **(key)**
- D. Stop antibiotics and review in 48 hours
- E. Switch to IV vancomycin in the department

*Explanation:* He is improving after 24 hours of IV therapy, has no abscess and has poor IV access, so oral step-down with early review suits him. Even the least favourable per-protocol limit allows up to 6 more failures per 100, and early review catches those who fail. Admission or a PICC line for daily IV therapy adds line risks for a benefit the trial could not confirm. Stopping antibiotics after one day undertreats cellulitis. He is responding to cefazolin and has no risk factor for MRSA given in the case, so vancomycin is not needed.

*Key feature:* Critical appraisal 5. Integrate the best available evidence into decisions about the care of an individual patient.

*Source:* Guyatt G, Rennie D, Meade MO, Cook DJ, editors. Users' Guides to the Medical Literature. A Manual for Evidence-Based Clinical Practice. 3rd edition. JAMA Evidence and McGraw-Hill Education. 2015. https://jamaevidence.mhmedical.com/content.aspx?bookid=847&sectionid=69030714

### critical-appraisal-20: Randomizing departments, not patients
...
#### Q1
**Which of the following is the main reason to randomize whole departments rather than individual patients for this intervention?**

- A. Clusters allow blinding of the nurses
- B. Clusters need fewer patients overall
- C. Consent can be waived for every patient
- D. Randomizing sites balances patient ages
- E. Staff would carry the bundle across arms  **(key)**

*Explanation:* The bundle is delivered by nurses who care for many patients at once. If patients in one department were randomized individually, staff trained in the bundle would apply parts of it to control patients, which would dilute the difference. Randomizing departments avoids that contamination. Cluster trials need more patients, not fewer, because patients within a site resemble each other. Nurses delivering a bundle cannot be blinded. Consent rules differ by trial and are not the reason for the design. With only 12 clusters, randomizing sites balances patient traits less well than individual randomization would.

*Key feature:* Critical appraisal 1. Identify a study's design and explain the strengths and weaknesses that design brings to the research question.

*Source:* Campbell MK, Piaggio G, Elbourne DR, Altman DG. CONSORT 2010 statement. Extension to cluster randomised trials. BMJ 2012. https://doi.org/10.1136/bmj.e5661

#### Q2
**Which of the following is the number needed to treat with the bundle to prevent one case of delirium?**
...
**Which of the following is closest to the effective sample size once clustering is taken into account?**
...
#### Q4
**Which of the following is the most likely consequence of analyzing this trial as if patients were individually randomized?**

- A. Confidence interval that is too narrow  **(key)**
- B. Confidence interval that is too wide
- C. Larger absolute risk reduction
- D. Loss of balance created by randomization
- E. Smaller relative risk reduction

*Explanation:* Ignoring clustering treats 2 400 patients as independent when they carry the information of about 480. The standard error is too small, so the confidence interval is too narrow and the p value too small, which can make a chance result look significant. The point estimates of absolute and relative risk reduction are not biased by this error. Only their precision is overstated. The analysis method cannot undo balance that randomization of the clusters created at the start.
...
### critical-appraisal-21: A bedtime pill and another fall
...
#### Q1
**Which of the following is the relative risk of a repeat fall within 90 days with benzodiazepine use?**
...
#### Q2
**Which of the following is the number needed to harm for one additional repeat fall within 90 days?**
...
#### Q3
**Which of the following most threatens the conclusion that benzodiazepines caused the excess falls in this cohort?**

- A. Confounding by frailty and comorbidity  **(key)**
- B. Lack of blinding of the participants
- C. Recall bias about the index fall
- D. Too few repeat falls to analyze
- E. Use of a prospective design

*Explanation:* Patients were not randomized to benzodiazepines. Those who take them may be frailer, more cognitively impaired or more unwell, and those traits cause falls on their own. Unless the analysis adjusts for them, some of the doubled risk may reflect who gets the drug rather than the drug. Blinding matters less for an objective outcome such as a fall. Recall bias affects case-control studies that ask about past exposure. With 150 repeat falls the study had enough events. A prospective design is a strength of this cohort.

*Key feature:* Critical appraisal 1. Identify a study's design and explain the strengths and weaknesses that design brings to the research question.

*Source:* von Elm E, Altman DG, Egger M, et al. The Strengthening the Reporting of Observational Studies in Epidemiology (STROBE) statement. Guidelines for reporting observational studies. Lancet 2007. https://doi.org/10.1016/S0140-6736(07)61602-X

#### Q4
**Which of the following is the most appropriate plan for her lorazepam?**

- A. Add melatonin and continue lorazepam
- B. Continue lorazepam at the same dose
- C. Stop lorazepam abruptly tonight
- D. Switch lorazepam to zopiclone 7.5 mg
- E. Taper lorazepam with sleep support  **(key)**

*Explanation:* The cohort adds to consistent evidence that benzodiazepines raise fall risk in older adults, and she has just fallen at night while taking one. The Beers Criteria advise avoiding benzodiazepines in older adults, so a gradual taper with nonpharmacologic sleep support, arranged with her family physician, is the right plan. Continuing the drug, with or without melatonin, leaves the risk in place. Stopping abruptly after 2 years of nightly use risks withdrawal. Zopiclone is also on the Beers list and carries a similar risk of falls.

*Key feature:* Critical appraisal 5. Integrate the best available evidence into decisions about the care of an individual patient.

*Source:* American Geriatrics Society Beers Criteria Update Expert Panel. American Geriatrics Society 2023 updated AGS Beers Criteria for potentially inappropriate medication use in older adults. Journal of the American Geriatrics Society 2023. https://doi.org/10.1111/jgs.18372

### critical-appraisal-22: A small difference in a large trial
...
#### Q1
**Which of the following questions can this trial's design answer?**

- A. Benefit of adding the drug to ketorolac  **(key)**
- B. Benefit of the drug in children
- C. Benefit of the drug in place of ketorolac
- D. Benefit of the drug over IV morphine
- E. Effect of the drug on stone passage

*Explanation:* Every patient received ketorolac and then the drug or placebo, so the comparison isolates the effect of adding the drug to ketorolac. It cannot show how the drug performs in place of ketorolac, because no one received the drug alone. The trial enrolled adults, so it says nothing about children. No arm received morphine, so it offers no head-to-head comparison with an opioid. The primary outcome was pain at 30 minutes, which cannot tell you whether stones pass over the following days or weeks.
...
**Which of the following is the number needed to treat for one additional patient to achieve at least 50% pain reduction?**
...
#### Q1
**Which of the following is the number needed to treat with the gel for one additional patient to stop bleeding within 15 minutes?**
...
**Which of the following is the best interpretation of the fragility index alongside the losses to follow-up?**

- A. Four missing outcomes could overturn the result  **(key)**
- B. Fragility matters only when p exceeds 0.01
- C. Losses under 5% cannot change the result
- D. The index shows a large treatment effect
- E. The result is robust with a p value of 0.02

*Explanation:* Only 2 changed outcomes would remove statistical significance, and 4 randomized patients have no outcome at all. If those 4 had done poorly, the result could lose significance, so it is fragile. A fragility index says how many events hold up a p value. It is not a measure of effect size. Fragility is a concern at any p value, and it is greatest near 0.05. Losses below 5% can still overturn a result when the fragility index is smaller than the number lost. A p of 0.02 alone says nothing about robustness.

*Key feature:* Critical appraisal 4. Judge whether results matter clinically, apply to your own patients, and actually support the authors' conclusions.

*Source:* Walsh M, Srinathan SK, McAuley DF, et al. The statistical significance of randomized controlled trial results is frequently fragile. A case for a Fragility Index. Journal of Clinical Epidemiology 2014. https://doi.org/10.1016/j.jclinepi.2013.10.019

#### Q3
**Which of the following design changes would most reduce bias in measuring the primary outcome of this trial?**

- A. Enrolment at more sites
- B. Longer follow-up to 7 days
- C. Per-protocol primary analysis
- D. Stratified randomization by age
- E. Use of a blinded outcome assessor  **(key)**

*Explanation:* In this open label trial the treating physician, who knew the allocation, judged when bleeding stopped. That is a subjective call open to detection bias in favour of the new gel. A blinded assessor, or a timed objective definition checked by someone unaware of the group, protects the outcome. More sites improve generalizability, not measurement. Longer follow-up addresses rebleeding, a different question. A per-protocol analysis adds bias rather than removing it. Stratifying by age improves balance but does not fix how the outcome is judged.
...
#### Q4
**Which of the following is the most appropriate response to your colleague's proposal to stock the gel as first-line treatment?**

- A. Adopt it for anticoagulated patients only
- B. Adopt it since the number needed is under 10
- C. Adopt the gel as first-line for all patients
- D. Await a larger trial with blinded assessment  **(key)**
- E. Reject it as shown to be ineffective

*Explanation:* The effect looks large, but the trial is small, fragile and open to detection bias, so the result may not hold. A larger trial with blinded outcome assessment should come before a practice change. An attractive number needed to treat does not make an unreliable estimate trustworthy. The trial did not report results for anticoagulated patients, so limiting use to them has no support. The evidence is weak but it does not show the gel is ineffective, and the point estimate favours it.

*Key feature:* Critical appraisal 3. Use these statistics to justify specific clinical decisions and changes to practice.

*Source:* Guyatt G, Rennie D, Meade MO, Cook DJ, editors. Users' Guides to the Medical Literature. A Manual for Evidence-Based Clinical Practice. 3rd edition. JAMA Evidence and McGraw-Hill Education. 2015. https://jamaevidence.mhmedical.com/content.aspx?bookid=847&sectionid=69030714

### critical-appraisal-24: Mortality before and after an alert
...
#### Q3
**Which of the following is the relative risk reduction in 30-day mortality reported by this study?**
...
#### Q4
**Which of the following designs would best test whether the alert itself reduces sepsis mortality across a health region?**

- A. Case-control study of sepsis deaths
- B. Cross-sectional survey of staff
- C. Larger before-after study
- D. Retrospective cohort at one site
- E. Stepped-wedge cluster randomized trial  **(key)**

*Explanation:* An alert changes how a whole department works, so it is randomized by hospital. A stepped-wedge design switches each hospital on at a random time. Every site eventually gets the alert, and calendar time can be modelled, which separates the alert's effect from secular trends and cointerventions. A larger before-after study repeats the same confounding with more patients. A case-control study of deaths, a single-site cohort and a staff survey cannot control for unmeasured differences or for time trends.

*Key feature:* Critical appraisal 1. Identify a study's design and explain the strengths and weaknesses that design brings to the research question.

*Source:* Hemming K, Taljaard M, McKenzie JE, et al. Reporting of stepped wedge cluster randomised trials. Extension of the CONSORT 2010 statement with explanation and elaboration. BMJ 2018. https://pubmed.ncbi.nlm.nih.gov/30413417/

#### Q5
**Which of the following is the most appropriate management for this patient now?**

- A. Antibiotics once the urine culture results
- B. Crystalloid bolus, cultures and antibiotics now  **(key)**
- C. CT abdomen before starting antibiotics
- D. Oral ciprofloxacin and discharge home
- E. Wait for the ICU outreach team to assess

*Explanation:* She has probable pyelonephritis with hypotension and a lactate of 3.4 mmol/L, so she needs fluid resuscitation, blood and urine cultures, and IV antibiotics within the first hour. Doubt about the alert's value does not weaken the evidence for early treatment of sepsis with hypoperfusion. Waiting for culture results or for CT delays antibiotics in a patient at high risk of death. Discharge on oral therapy is unsafe with hypotension and a raised lactate. The outreach team can help, but treatment should not wait for them.
...
#### Q1
**Which of the following is closest to her probability of group A streptococcus if the rapid test were positive?**
...
#### Q2
**Which of the following is closest to her probability of group A streptococcus if the rapid test were negative?**
...
#### Q3
**Which of the following is the most appropriate approach to testing and treatment for her?**

- A. Antibiotics without testing
- B. Rapid test and treat if positive
- C. Rapid test, then culture if negative
- D. Throat culture and delayed antibiotics
- E. No testing and no antibiotics  **(key)**

*Explanation:* Her probability of 5% sits below the testing threshold. If 1 000 patients like her were tested, about 43 true positives and 48 false positives would be treated, so half of those given antibiotics would gain nothing and bear the side effects. Her cough and runny nose point to a viral cause, and a missed streptococcal pharyngitis in a healthy adult carries a low risk. Treating without testing gives antibiotics to 95 of every 100 patients like her who do not need them. A culture, or a culture after a negative rapid test, adds cost and delay for the same low yield.

*Key feature:* Critical appraisal 3. Use these statistics to justify specific clinical decisions and changes to practice.

*Source:* Pauker SG, Kassirer JP. The threshold approach to clinical decision making. New England Journal of Medicine 1980. https://pubmed.ncbi.nlm.nih.gov/7366635/
...
**Which of the following best explains why the test's sensitivity differs between these two groups?**

- A. Culture misses streptococcus in mild cases
- B. Higher prevalence raises sensitivity directly
- C. Milder disease has less antigen to detect  **(key)**
- D. Operators test severe cases more carefully
- E. Specificity rises as sensitivity falls

*Explanation:* Sensitivity varies with the spectrum of disease. Patients with florid pharyngitis carry more bacteria and more antigen, so the rapid test detects them more often than it detects mild or early infection. This spectrum effect is why a single pooled sensitivity can mislead for a patient at one end of the range. Prevalence does not change sensitivity directly, although sicker groups often have both higher prevalence and higher sensitivity. If culture missed mild cases, the rapid test's positives would be counted as false, not missed. No operator difference is given, and sensitivity and specificity are not shown to trade off between these groups.

*Key feature:* Critical appraisal 4. Judge whether results matter clinically, apply to your own patients, and actually support the authors' conclusions.

*Source:* Bossuyt PM, Reitsma JB, Bruns DE, et al. STARD 2015. An updated list of essential items for reporting diagnostic accuracy studies. BMJ 2015. https://doi.org/10.1136/bmj.h5527

### critical-appraisal-26: An adult rule for a toddler
...
#### Q1
**Which of the following features of this case most limit applying the fictional rule to this boy?**

Select 2.

- A. Age outside the derivation population  **(key)**
- B. Canadian derivation sites
- C. Community hospital setting
- D. Derivation sample of 3 000 patients
- E. Normal behaviour per his mother
- F. Predictors he cannot yet report  **(key)**
- G. Single episode of vomiting
- H. Use of a GCS of 13 to 15

*Explanation:* The rule was derived only in patients aged 16 or older, so its accuracy in a 20-month-old is unknown. Two of its predictors, amnesia and headache, depend on a verbal report that a toddler cannot give, so a score of zero may simply reflect missing information. Canadian sites, a community setting and a large sample do not limit its use here. His normal behaviour and single vomit are findings, not reasons the rule fails. He is alert and playful, which fits the rule's GCS range of 13 to 15.
...
**Which of the following is closest to the lower limit of the 95% confidence interval for the rule's sensitivity in this validation?**
...
*Explanation:* Sensitivity is 120 divided by 124, or 96.8%. With only 124 patients who had the outcome, the Wilson 95% confidence interval runs from about 92.0% to 98.7%. So the rule could miss up to 8 in 100 injuries and still fit these data. The value 97% is the point estimate, not a limit. Values of 80% to 89% are wider than this sample allows. The width of the interval depends on the number of patients with the outcome, not on the total enrolled.

*Key feature:* Critical appraisal 2. Calculate sensitivity, specificity, likelihood ratios, and NNT or NNH from study data and explain what they mean.

*Source:* Stiell IG, Wells GA. Methodologic standards for the development of clinical decision rules in emergency medicine. Annals of Emergency Medicine 1999. https://doi.org/10.1016/s0196-0644(99)70309-4

#### Q3
**Which of the following steps would be needed before a rule like this could be used in children under 2 years?**

- A. Derivation with age-appropriate predictors  **(key)**
- B. External validation in adults at more sites
- C. Impact analysis in adult departments
- D. Meta-analysis of adult validation studies
- E. Reliability study of the adult predictors

*Explanation:* Validation tests a rule in the population it was built for. Here the problem is the predictors themselves, because a toddler cannot report amnesia or headache. A rule for young children needs derivation with predictors that can be assessed at that age, such as behaviour and scalp findings, followed by its own validation. More adult validation, an impact analysis in adults, a meta-analysis of adult studies or a reliability study of adult predictors all add evidence about adults. None of them tells you how the rule performs in toddlers.
...
### critical-appraisal-27: An algorithm flags an ECG
...
#### Q1
**Which of the following study designs would best estimate the algorithm's accuracy in your department?**

- A. Case series of flagged ECGs
- B. Consecutive cohort of chest pain ECGs  **(key)**
- C. Larger case-control study
- D. Randomized trial of algorithm use
- E. Survey of emergency physicians

*Explanation:* Accuracy that applies to your patients comes from a consecutive cohort of people like them, each tested with the algorithm and each checked against the same reference standard. That captures the full range of ECGs, including the look-alikes that cause false flags. The vendor study sampled by known disease status, a case-control design, and enlarging it only makes a biased estimate more precise. A series of flagged ECGs has no unflagged patients, so it cannot give sensitivity or specificity. A randomized trial of algorithm use measures its effect on care and outcomes, not its accuracy. A survey measures opinion.
...
#### Q2
**Which of the following is closest to the positive predictive value of the algorithm in your department?**
...
*Explanation:* Among 1 000 patients, 20 have an occlusion and the algorithm flags 18 of them. Of the 980 without one, 10% or 98 are flagged falsely. The positive predictive value is 18 divided by 116, or 15.5%, which rounds to 16%. A value of 90% would apply only at the vendor study's artificial 50% prevalence. A value of 50% would apply at a prevalence of 10%. The value 10% is the false positive rate, and 2% is the prevalence.
...
**Which of the following is the negative likelihood ratio of marker N at the 1.0 ng/mL cutoff?**
...
**Which of the following is closest to his probability of necrotizing infection after the marker N result of 0.6 ng/mL?**
...
#### Q3
**Which of the following is the best interpretation of the area under the ROC curve of 0.80 for marker N?**

- A. 80% of patients are correctly classified
- B. Probability a case outranks a non-case is 0.80  **(key)**
- C. Sensitivity is 80% at the best cutoff
- D. The test is useful at every cutoff
- E. The test rules out 80% of non-cases

*Explanation:* The area under the ROC curve is the probability that a randomly chosen patient with the disease has a higher marker value than a randomly chosen patient without it. At 0.80 that happens 4 times in 5. It summarizes discrimination across all cutoffs and does not give accuracy, sensitivity or specificity at any single one. The 2.5 ng/mL cutoff happens to have 80% sensitivity, but that is a separate figure. A useful overall area can still hide cutoffs, such as 1.0 ng/mL, with poor specificity.
...
- A. Discharge on oral antibiotics
- B. IV antibiotics and admit to medicine
- C. MRI of the thigh before any surgery
- D. Repeat marker N in 6 hours
- E. Urgent surgical consultation for exploration  **(key)**

*Explanation:* An 11% chance of a necrotizing infection, with hypotension, tachycardia and pain out of proportion, is far too high to accept, so the low marker must not delay surgery. Surgical exploration is both the diagnostic standard and the treatment, alongside broad IV antibiotics. Admission to medicine or a repeat marker in 6 hours lets a rapidly lethal infection progress. MRI delays surgery and should not hold up exploration when suspicion is high. Discharge on oral antibiotics is unsafe in a hypotensive patient.

*Key feature:* Critical appraisal 5. Integrate the best available evidence into decisions about the care of an individual patient.

*Source:* Stevens DL, Bisno AL, Chambers HF, et al. Practice guidelines for the diagnosis and management of skin and soft tissue infections. 2014 update by the Infectious Diseases Society of America. Clinical Infectious Diseases 2014. https://academic.oup.com/cid/article/59/2/e10/2895845

### critical-appraisal-29: Rating a body of evidence for vertigo
...
#### Q1
**Which of the following GRADE domains should lower the certainty of this evidence for her decision?**
...
#### Q3
**Which of the following is the most appropriate way to respond to her question about drug V?**

- A. Give drug V only if she is admitted
- B. Prescribe drug V as standard care
- C. Refuse drug V as shown to be harmful
- D. Share the uncertainty and decide together  **(key)**
- E. Withhold drug V as shown to be ineffective

*Explanation:* With very low certainty evidence, the benefit of drug V is uncertain and the decision depends on her values, such as how she weighs a possible faster recovery against cost and side effects. So the evidence should be shared with her and the choice made together. Prescribing it as standard care overstates evidence that has not shown a benefit. The review showed neither harm nor lack of effect, only uncertainty, so refusing it on either ground is also wrong. Admission status has no bearing on whether the drug works.
...
#### Q4
**Which of the following new studies would most increase the certainty of evidence about drug V for emergency patients like her?**

- A. Case series of emergency patients treated
- B. Large blinded trial in emergency patients  **(key)**
- C. Larger unblinded trial in clinic patients
- D. Pharmacy claims study of drug V users
- E. Updated review of the same six trials

*Explanation:* A large trial with concealed allocation and blinded outcome assessment addresses risk of bias and imprecision at once. If it enrols patients within a day or two of onset in the emergency department, it also fixes indirectness. A larger unblinded clinic trial repeats the existing biases and indirectness. Case series and claims data lack a randomized control group and start at low certainty. Reanalyzing the same six trials cannot add information they do not contain.

*Key feature:* Critical appraisal 1. Identify a study's design and explain the strengths and weaknesses that design brings to the research question.

*Source:* Guyatt GH, Oxman AD, Vist GE, et al. GRADE. An emerging consensus on rating quality of evidence and strength of recommendations. BMJ 2008. https://doi.org/10.1136/bmj.39489.470347.AD

### critical-appraisal-30: A block for broken ribs
...
**Which of the following best interprets the intention-to-treat result for pneumonia?**

- A. Harmful, since the interval reaches 1.10
- B. Inconclusive, allowing benefit or slight harm  **(key)**
- C. Proven benefit of 22% fewer pneumonias
- D. Proven benefit, since the estimate is below 1
- E. No effect, since the interval includes 1

*Explanation:* The interval runs from a 45% lower hazard to a 10% higher hazard. That is compatible with an important benefit, no effect or slight harm, so the result is inconclusive. An interval that includes 1 does not show that there is no effect. It shows the trial could not tell. A point estimate below 1 is not proof of benefit when the interval crosses 1. The upper limit of 1.10 marks the largest harm compatible with the data, not a harm shown.
...
#### Q2
**Which of the following is the number needed to treat implied by the crude pneumonia rates in this trial?**
...
**Which of the following is the most appropriate change to your department's rib fracture pathway based on this trial?**

- A. Abandon blocks as shown to be ineffective
- B. Mandate blocks to prevent pneumonia
- C. Offer the block for pain control  **(key)**
- D. Reserve blocks for patients under 65
- E. Wait for trial data before any change

*Explanation:* The block lowered pain by 2.1 points, with an interval of 1.6 to 2.6 that sits above the roughly 1.3 point change patients notice. That is a precise, clinically important benefit. So offering the block for pain is justified, while the pneumonia benefit remains unproven. Mandating it to prevent pneumonia claims more than the trial showed. The trial did not show that blocks are ineffective. Patients under 65 were not studied, so reserving blocks for them runs opposite to the evidence. Waiting ignores a pain benefit already shown.

*Key feature:* Critical appraisal 3. Use these statistics to justify specific clinical decisions and changes to practice.

*Source:* Guyatt G, Rennie D, Meade MO, Cook DJ, editors. Users' Guides to the Medical Literature. A Manual for Evidence-Based Clinical Practice. 3rd edition. JAMA Evidence and McGraw-Hill Education. 2015. https://jamaevidence.mhmedical.com/content.aspx?bookid=847&sectionid=69030714

### critical-appraisal-31: A syncope score in a new setting
...
#### Q1
**Which of the following best describes the score's performance in the rural validation?**

- A. Good calibration but poor discrimination
- B. Good discrimination and calibration
- C. Good discrimination but poor calibration  **(key)**
- D. Poor discrimination and calibration
- E. Unusable, since the C statistic is below 0.9

*Explanation:* A C statistic of 0.82 means the score ranks patients well, so discrimination is good. But patients predicted to have a 2% risk had an observed risk of 6%, so the score underestimates absolute risk in this setting, which is poor calibration. The two properties are separate, and a score can rank correctly while every estimate is too low. A C statistic above 0.8 is generally considered good, and no fixed 0.9 threshold makes a score unusable.

*Key feature:* Critical appraisal 4. Judge whether results matter clinically, apply to your own patients, and actually support the authors' conclusions.

*Source:* Collins GS, Reitsma JB, Altman DG, Moons KGM. Transparent reporting of a multivariable prediction model for individual prognosis or diagnosis (TRIPOD). The TRIPOD statement. BMJ 2015. https://pubmed.ncbi.nlm.nih.gov/25569120/

#### Q2
**Which of the following is the ratio of observed to expected risk for patients with her score in the rural validation?**
...
*Explanation:* The observed risk is 6% and the expected risk from the score is 2%, so the ratio is 6 divided by 2, or 3.0. Serious outcomes occurred three times as often as predicted. A value of 0.33 inverts the ratio, which would imply overprediction. The value 4.0 is the difference in percentage points, not a ratio. The values 2.0 and 6.0 are the expected and observed risks themselves.
...
#### Q1
**Which of the following is the number needed to treat with the nebulized drug to prevent one hospital admission in this trial?**
...
#### Q2
**Which of the following best describes this trial on the spectrum from explanatory to pragmatic design?**

- A. Cluster, testing effects across sites
- B. Explanatory, testing efficacy in ideal conditions  **(key)**
- C. Noninferiority, testing against a margin
- D. Observational, testing use in real practice
- E. Pragmatic, testing effectiveness in usual care

*Explanation:* The trial used tertiary centres, strict eligibility, therapist-delivered doses and adherence checks. Those are features of an explanatory trial, which asks whether a drug can work under ideal conditions. A pragmatic trial would enrol the broad range of infants seen in ordinary departments and let usual staff give the drug as they normally would. Individual infants, not sites, were randomized, so it is not a cluster trial. It compared the drug with placebo for superiority, not against a margin, and it was randomized, not observational.
...
- A. Dexamethasone PO and discharge home
- B. Discharge after one dose of the drug
- C. Give the drug and observe for 4 hours
- D. Nebulized salbutamol trial, then discharge
- E. Supportive care and admission with monitoring  **(key)**

*Explanation:* He is 7 weeks old, was born at 32 weeks, has marked work of breathing and is taking only half his feeds. He needs admission for monitoring, feeding support and oxygen if his saturation falls further. The Canadian Paediatric Society recommends supportive care for bronchiolitis and advises against routine salbutamol and corticosteroids. The trial drug was never tested in infants like him, so giving it, with or without discharge, relies on evidence that does not apply to him.

*Key feature:* Critical appraisal 5. Integrate the best available evidence into decisions about the care of an individual patient.

*Source:* Friedman JN, Rieder MJ, Walton JM. Canadian Paediatric Society, Acute Care Committee and Drug Therapy and Hazardous Substances Committee. Bronchiolitis. Recommendations for diagnosis, monitoring and management of children one to 24 months of age. Paediatrics and Child Health 2014, updated 2021. https://cps.ca/en/documents/position/bronchiolitis

### critical-appraisal-33: Weighing clots against bleeds in a cast
...
#### Q1
**Which of the following is the number needed to treat with LMWH to prevent one symptomatic VTE in this trial?**
...
#### Q2
**Which of the following is the number needed to harm with LMWH for one additional major bleed in this trial?**
...
**Which of the following is closest to his individual number needed to treat with LMWH to prevent one symptomatic VTE?**
...
#### Q4
**Which of the following is the most appropriate thromboprophylaxis plan for him while he is in the cast?**

- A. Enoxaparin 40 mg SC daily while in the cast  **(key)**
- B. Graduated compression stocking on the right
- C. Rivaroxaban 20 mg PO daily for 3 months
- D. Warfarin, target INR 2 to 3, for 6 weeks
- E. No prophylaxis while in the cast

*Explanation:* His prior VTE raises his risk enough that about 1 in 21 like him avoids a VTE with prophylaxis, against about 1 in 250 who has a major bleed. That balance favours prophylactic-dose LMWH for as long as he is casted, the regimen the trial tested. It also matches NICE guidance to consider LMWH during lower limb immobilization when the risk of VTE outweighs the risk of bleeding. No prophylaxis ignores his much higher baseline risk. A stocking cannot be worn under a below-knee cast on the injured leg. Rivaroxaban 20 mg daily is a treatment dose, and warfarin to an INR of 2 to 3 is full anticoagulation, so both add bleeding risk and neither was tested in the trial.

*Key feature:* Critical appraisal 3. Use these statistics to justify specific clinical decisions and changes to practice.

*Source:* National Institute for Health and Care Excellence. Venous thromboembolism in over 16s. Reducing the risk of hospital-acquired deep vein thrombosis or pulmonary embolism. NICE guideline NG89. 2018, updated 2019. https://www.nice.org.uk/guidance/ng89

### critical-appraisal-34: Confusion and a cloudy dipstick
...
#### Q1
**Which of the following is closest to her probability of urinary tract infection after the positive urinalysis?**
...
#### Q2
**Which of the following is closest to her probability of urinary tract infection had the urinalysis shown no pyuria?**
...
*Explanation:* The negative likelihood ratio is (1 minus 0.90) divided by 0.50, or 0.2. Pretest odds of 0.11 multiplied by 0.2 give odds of 0.022, a probability of about 2% (0.022 divided by 1.022). So a negative result would make infection unlikely, while a positive result barely raises it, because pyuria is sensitive but not specific. 10% is the pretest probability, her probability before any test. 17% is her probability after the positive result. 5% would need a likelihood ratio near 0.47, and 1% one near 0.09.
...
#### Q3
**Which of the following findings, if present, would support starting antibiotics for urinary tract infection in a resident like her?**

Select 3.

- A. Change in urine colour
- B. Fever of 38.2°C with flank tenderness  **(key)**
- C. Fever of 38.2°C with new cough
- D. Fever of 38.2°C with new urgency  **(key)**
- E. Foul-smelling urine
- F. Increased confusion alone
- G. New onset of dysuria  **(key)**
- H. Positive nitrite on dipstick

*Explanation:* The consensus minimum criteria for a resident without a catheter accept acute dysuria alone, or fever above 37.9°C with at least one urinary sign, such as costovertebral angle (flank) tenderness or new urgency. Fever alone does not meet them. Fever with a new cough points to a respiratory source, not the urinary tract. A change in urine colour or smell and confusion alone are common and nonspecific in residents with asymptomatic bacteriuria. A positive nitrite, like pyuria, reflects bacteriuria rather than symptomatic infection.

*Key feature:* Critical appraisal 5. Integrate the best available evidence into decisions about the care of an individual patient.

*Source:* Loeb M, Bentley DW, Bradley S, et al. Development of minimum criteria for the initiation of antibiotics in residents of long-term-care facilities. Results of a consensus conference. Infection Control and Hospital Epidemiology 2001. https://pubmed.ncbi.nlm.nih.gov/11232875/

#### Q4
**Which of the following is the most appropriate next step in her care?**

- A. Ceftriaxone IV and admit for urinary infection
- B. Nitrofurantoin PO for 5 days
- C. Repeat urinalysis in 24 hours
- D. Stop oxybutynin and reassess  **(key)**
- E. Urine culture and treat if positive

*Explanation:* Her probability of infection after the urinalysis is only about 17%, and she has a more likely cause. Oxybutynin is strongly anticholinergic, and her confusion began after starting it. The Beers Criteria advise avoiding strongly anticholinergic drugs in older adults. Stopping it, with hydration and a search for other causes, addresses the probable cause. Antibiotics for pyuria alone treat asymptomatic bacteriuria and bring side effects and resistance. A culture will often grow bacteria in a resident without infection, so treating a positive culture repeats the error. A repeat urinalysis adds nothing.

*Key feature:* Critical appraisal 3. Use these statistics to justify specific clinical decisions and changes to practice.

*Source:* American Geriatrics Society Beers Criteria Update Expert Panel. American Geriatrics Society 2023 updated AGS Beers Criteria for potentially inappropriate medication use in older adults. Journal of the American Geriatrics Society 2023. https://doi.org/10.1111/jgs.18372

### critical-appraisal-35: Distraction for a frightened child
...
#### Q1
**Which of the following features of this study most threaten the validity of its result?**

Select 2.

- A. Age range of 4 to 12 years
- B. Allocation by day of the month  **(key)**
- C. Distress rated by the inserting nurse  **(key)**
- D. Sample of 300 children
- E. Single pediatric department
- F. Standard care as comparator
- G. Use of a binary outcome

*Explanation:* Allocation by date is predictable, so staff could choose which children to enrol on each day, which is selection bias. The nurse who knew the allocation also rated distress, a subjective outcome, which invites detection bias in favour of VR. The age range, sample size and single site affect precision and generalizability, not internal validity. Standard care is the right comparator for a practical question. A binary outcome loses some information but does not bias the result.
...
#### Q2
**Which of the following is the number needed to treat with VR to prevent one child from having high distress?**
...
*Explanation:* High distress fell from 40% to 25%, an absolute reduction of 15 percentage points. The number needed to treat is 1 divided by 0.15, or 6.7, rounded up to 7. The value 15 is the absolute reduction in percentage points. The value 38 is the relative risk reduction, 15 divided by 40, as a percentage (37.5%). The values 25 and 40 are the rates of high distress in each group.
...
#### Q3
**Which of the following changes to the design would best prevent selection bias in a repeat study?**

- A. Allocation by the treating nurse
- B. Alternating weeks instead of days
- C. Larger sample at the same site
- D. Matching children by age
- E. Web-based concealed randomization  **(key)**

*Explanation:* Central, web-based randomization with allocation hidden until the child is enrolled stops staff from predicting or influencing which group a child joins. Alternating weeks is still predictable, and allocation by the treating nurse invites exactly the bias to be removed. A larger sample improves precision but leaves the bias in place. Matching by age balances one known factor but cannot balance unknown ones the way randomization does.
...
#### Q4
**Which of the following is the most appropriate approach to her IV insertion?**

- A. Hold still with two staff, no analgesia
- B. Intramuscular ketamine before the IV
- C. Oral midazolam before every IV
- D. Topical anesthetic plus distraction  **(key)**
- E. No preparation, to avoid delay
...
*Source:* Trottier ED, Dore-Bergeron MJ, Chauvin-Kimoff L, Baerg K, Ali S. Canadian Paediatric Society, Acute Care Committee. Managing pain and distress in children undergoing brief diagnostic and therapeutic procedures. Paediatrics and Child Health 2019. https://pubmed.ncbi.nlm.nih.gov/31844394/

### critical-appraisal-36: Two tests for a collapsed lung
...
#### Q1
**Which of the following is the sensitivity of POCUS for pneumothorax in this study?**
...
*Explanation:* POCUS detected 72 of the 80 pneumothoraces, so its sensitivity is 72 divided by 80, or 90%. The sensitivity of supine chest X-ray is 40 divided by 80, or 50%. The value 20% is the prevalence, 80 of 400. The values 72 and 80 are counts of patients, not proportions. POCUS specificity is 314 divided by 320, or 98.1%.
...
#### Q2
**Which of the following is the main strength of performing both tests on every patient in this study?**

- A. Each patient serves as their own control  **(key)**
- B. It blinds readers to the CT result
- C. It doubles the effective sample size
- D. It makes CT unnecessary as a reference
- E. It removes the need for consecutive enrolment

*Explanation:* In a paired comparison, both tests are applied to the same patients against the same reference, so differences in accuracy cannot come from differences in who was tested. That makes the comparison between the two tests fair. Blinding readers to the CT result is a separate design step. Pairing does not double the sample, and it still needs CT as the reference for every patient. Consecutive enrolment is still needed to avoid spectrum bias.
...
**Which of the following is closest to his probability of left pneumothorax after this POCUS result?**
...
#### Q5
**Which of the following is the most appropriate use of this POCUS result in planning his care?**

- A. Confirm with a repeat supine X-ray first
- B. Disregard it, as CT was not done
- C. Manage him as having a left pneumothorax  **(key)**
- D. Repeat POCUS by a second physician
- E. Treat as normal given the negative X-ray
