...
- pre-eclampsia-23 q1: the ergonovine dose in the option is 0.2 mg IM (the Canadian label and FIGO). SOGC 431 uses 0.25 mg. Either way the key holds. Confirm which dose you want shown. *(samps-pass2-mixed-review.md)*
- pre-eclampsia-37 q3: "Bed rest and a fluid bolus" is also a way of giving no tocolytic drug, so it sits close to the key "No tocolytic medication". The explanation rejects it on its own merits. Consider a cleaner distractor if you see ambiguity. Low confidence. *(samps-pass2-mixed-review.md)*
- pre-eclampsia-34: the bradycardic runner setup now matters only in the last sentence of the q2 explanation. This came from the overlap fix against pre-eclampsia-14 q1. It is acceptable, but the stem detail is now largely decorative. *(samps-pass2-mixed-review.md)*
- pre-eclampsia-23 q1: the SOGC 431 full text could not be retrieved (403), so FIGO 2022 is cited. The ergonovine dose of 0.2 mg follows FIGO. The Canadian product is labelled 0.25 mg/mL, so please confirm the dose in the option. The carboprost note (no asthma) is standard teaching and is not quoted from FIGO. *(samps-pass2-mixed.md)*
- pre-eclampsia-23 q2: the 12 hour lab interval is carried over from the earlier ACOG PB 222 wording, now applied after birth. Please confirm. *(samps-pass2-mixed.md)*
- pre-eclampsia-34 q2: the key is 60 minutes, the upper end of ACOG's 30 to 60 minute window. *(samps-pass2-mixed.md)*
- pre-eclampsia-18 q1: Ramoska 1989 is old but is primary ED literature and is still cited. *(samps-pass2-mixed.md)*
- Drop both extras (pre-eclampsia-39 and pre-eclampsia-40). Each is an exact copy of a batch SAMP, and each carried a planted defect, now fixed. They would fail the near-duplicate stem rule if exported. *(samps-s47-lensA.md)*
- Overlap rewrites. Decide whether to rebuild pre-eclampsia-23, 34 (q1 and q2), 37 and 38 q3, or accept the repetition of s15's write-in cases in MCQ form. *(samps-s47-lensA.md)*
- pre-eclampsia-25 q3 tests the ACOG platelet threshold for a severe feature (below 100 x 10^9/L) in a Canadian bank. The stem names ACOG, so the key is correct. I could not confirm SOGC 2022's own platelet threshold, and the brief prefers a Canadian standard. Consider recasting it to SOGC once the full text is checked. Low. *(samps-s47-lensA.md)*
- pre-eclampsia-28 q1 keys the sFlt-1 to PlGF ratio. ISSHP and SOGC support it where available, but few Canadian emergency departments can get it quickly. The key is the best of the options. Low. *(samps-s47-lensA.md)*
- pre-eclampsia-26 q2 calls severe hypertension on an average of 160/103 mmHg (158/102 and 162/104 mmHg). That is correct under SOGC, which uses the average of two readings, but it sits right on the threshold. Low. *(samps-s47-lensA.md)*
- Overlap rewrites: pre-eclampsia-23 q1 (s15 pre-eclampsia-12 q1), pre-eclampsia-34 q2 (s15 pre-eclampsia-14 q1) and pre-eclampsia-37 q3 (s15 pre-eclampsia-02 q3). Decide whether to rebuild them or accept each as an MCQ restatement of an s15 write-in point. The batch now has four questions that teach "atypical symptoms, so do HELLP labs" (16 q1, 23 q1, 31 q1, 37 q1). One or two of these could be retargeted. *(samps-s47-lensB.md)*
- pre-eclampsia-34 q2 rests on ACOG's caution about labetalol in bradycardia. ISSHP does not list it, and a pulse of 46/minute from athletic training with a normal ECG is not a strict contraindication. The key holds because nifedipine is equally first-line. A physician should confirm that labetalol is not also defensible as "most appropriate". *(samps-s47-lensB.md)*
- Both extras (pre-eclampsia-39 and pre-eclampsia-40) are still exact copies of batch SAMPs. Each carried a planted defect again after the rework. They should not be exported. *(samps-s47-lensB.md)*

Review reports: docs/reviews/writer-s47.md, samps-s47-lensA.md, samps-s47-lensB.md

## SAMPs

### pre-eclampsia-16: Heartburn that antacids did not settle
...
- A. Discharge with pantoprazole and follow-up
- B. Gastrointestinal cocktail and reassessment
- C. Lipase to exclude pancreatitis
- D. Platelets, AST, ALT, creatinine and LDH  **(key)**
- E. Urine dipstick for protein

*Explanation:* Epigastric and right upper quadrant pain after 20 weeks must be treated as possible HELLP syndrome until blood work shows otherwise, even with a BP of 134/86 mmHg. HELLP can appear before hypertension or proteinuria. Platelets, AST, ALT, creatinine and LDH answer the question within an hour. A gastrointestinal cocktail or pantoprazole with discharge risks missing HELLP, because pain relief does not exclude it. A lipase or a dipstick alone cannot detect hemolysis, low platelets or raised liver enzymes.

*Key feature:* Pre-eclampsia 1. Consider pre-eclampsia in pregnant patients with unexplained headache, abdominal pain, or confusion, even with normal blood pressure.

*Source:* Sibai BM. Diagnosis, controversies, and management of the syndrome of hemolysis, elevated liver enzymes, and low platelet count. Obstet Gynecol. 2004.

#### Q2
*Update:* Hemoglobin 104 g/L, platelets 88 x 10^9/L, AST 236 U/L, ALT 198 U/L, LDH 812 U/L, creatinine 64 umol/L, glucose 5.2 mmol/L and INR 1.0. The film shows schistocytes. At 1540 her BP is 138/88 mmHg.

**Which of the following is the most likely diagnosis in this patient?**

- A. Acute cholangitis
- B. Fatty liver of pregnancy
- C. HELLP syndrome  **(key)**
- D. Immune thrombocytopenia
- E. Viral hepatitis

*Explanation:* Schistocytes with an LDH of 812 U/L, an AST of 236 U/L and platelets of 88 x 10^9/L complete the triad of hemolysis, raised liver enzymes and low platelets. HELLP can occur with a BP below 140/90 mmHg, as here. Fatty liver of pregnancy usually brings hypoglycemia, coagulopathy or renal failure, and her glucose, INR and creatinine are normal. Immune thrombocytopenia does not raise liver enzymes or fragment red cells. Viral hepatitis and cholangitis do not explain microangiopathic hemolysis, and she has no fever.
...
#### Q3
**Which of the following results is the most specific evidence of hemolysis in her?**

- A. ALT 198 U/L
- B. AST 236 U/L
- C. Hemoglobin 104 g/L
- D. Platelets 88 x 10^9/L
- E. Schistocytes on film  **(key)**

*Explanation:* Schistocytes are red cell fragments sheared in damaged small vessels, so they show microangiopathic hemolysis directly. LDH also rises with hemolysis, but liver injury raises it too. A hemoglobin of 104 g/L is common in the third trimester from dilution and iron deficiency, so it does not prove hemolysis. The AST and ALT show liver injury, and platelets of 88 x 10^9/L show consumption rather than red cell destruction.
...
#### Q4
**Which of the following corticosteroid regimens is most appropriate for her now?**

- A. betamethasone 12 mg IM, repeat in 24 hours  **(key)**
- B. dexamethasone 10 mg IV every 12 hours
- C. hydrocortisone 100 mg IV every 8 hours
- D. methylprednisolone 1 g IV daily
- E. prednisone 50 mg PO daily

*Explanation:* HELLP at 31 weeks and 2 days makes birth within 7 days likely, and SOGC recommends antenatal corticosteroids between 24 and 34 weeks and 6 days in that situation. Betamethasone 12 mg IM, repeated after 24 hours, reduces neonatal death, respiratory distress and intraventricular hemorrhage. Dexamethasone 10 mg IV every 12 hours is not the antenatal regimen, and high doses given to raise the platelet count in HELLP have not improved outcomes. Hydrocortisone and prednisone are largely inactivated by the placenta. Methylprednisolone 1 g is an immunosuppressive pulse.
...
*Source:* Skoll A, Boutin A, Bujold E, et al. No. 364: Antenatal corticosteroid therapy for improving neonatal outcomes. J Obstet Gynaecol Can. 2018.

### pre-eclampsia-17: Sparkles in her vision far from a perinatal centre

- [ ] Approved  - [ ] Needs change  - [ ] Reject

You are working in a rural hospital emergency department 3 hours by road from the regional perinatal centre. The hospital stocks no IV antihypertensive drugs. A 24-year-old woman, G1P0 at 34 weeks and 3 days, presents at 1402 with a severe frontal headache for 6 hours and repeated episodes of seeing sparkles. Her family physician follows the pregnancy. At 30 weeks her BP was 116 mmHg systolic and 74 mmHg diastolic. She has no medical history and takes no medications. She is alert and oriented. Reflexes are 3+ with 2 beats of ankle clonus. There is mild pitting edema of both ankles. The fetal heart rate by Doppler is 140/minute.
...
#### Q1
**Which of the following is the most appropriate way to confirm severe hypertension in her before treatment?**

- A. Ambulatory BP monitoring for 24 hours
- B. Home BP readings for 2 days
- C. Repeat BP after 4 hours of rest
- D. Repeat BP within 15 minutes  **(key)**
- E. Supine BP after 10 minutes

*Explanation:* SOGC defines severe hypertension as a systolic of 160 mmHg or more or a diastolic of 110 mmHg or more, confirmed by a repeat reading within 15 minutes in the same arm. Her triage reading of 168/112 mmHg with neurological symptoms needs quick confirmation so that treatment is not delayed. Waiting 4 hours is the ACOG interval for diagnosing non-severe hypertension. Home or ambulatory readings delay urgent care. Lying supine late in pregnancy lowers BP through aortocaval compression and breaks standard technique.

*Key feature:* Pre-eclampsia 2. Evaluate suspected pre-eclampsia systematically, including risk factors, symptoms, BP change from baseline, and labs, to decide quickly.

*Source:* Magee LA, Smith GN, Bloch C, et al. Guideline No. 426: Hypertensive disorders of pregnancy: diagnosis, prediction, prevention, and management. J Obstet Gynaecol Can. 2022.

#### Q2
*Update:* A repeat BP at 1412 is 166/110 mmHg. An IV is in place.

**Which of the following is the most appropriate first antihypertensive for her?**

- A. captopril 25 mg PO
- B. furosemide 40 mg IV
- C. hydrochlorothiazide 25 mg PO
- D. methyldopa 250 mg PO
- E. nifedipine 10 mg PO  **(key)**

*Explanation:* Immediate-release oral nifedipine 10 mg, swallowed whole, is a first-line drug for severe hypertension in pregnancy and needs no IV drug, which suits a site without IV antihypertensives. It can be repeated at 30 minutes if her BP stays at 160/110 mmHg or higher. Captopril, like other ACE inhibitors, is fetotoxic. Methyldopa 250 mg acts slowly and is well below the 1 000 mg ISSHP urgent dose. Furosemide and hydrochlorothiazide do not lower severe hypertension quickly, and diuresis worsens the contracted plasma volume of pre-eclampsia.

*Key feature:* Pre-eclampsia 4. Begin BP control and seizure prophylaxis, monitor mother and fetus, and arrange urgent obstetric planning for delivery.

*Source:* Magee LA, Brown MA, Hall DR, et al. The 2021 International Society for the Study of Hypertension in Pregnancy classification, diagnosis and management recommendations for international practice. Pregnancy Hypertens. 2022.

#### Q3
*Update:* At 1445 her BP is 152/102 mmHg. The headache persists.

**Which of the following magnesium sulfate regimens is most appropriate for her?**

- A. 1 g IV over 20 minutes, then 1 g/hour
- B. 2 g IV over 20 minutes, then 1 g/hour
- C. 4 g IV over 20 minutes, then 1 g/hour  **(key)**
- D. 4 g IV over 20 minutes, then 4 g/hour
- E. 10 g IV over 20 minutes, then 1 g/hour

*Explanation:* Hypertension with headache, visual sparkles, 3+ reflexes and clonus is pre-eclampsia with neurological features, and ISSHP recommends magnesium sulfate for eclampsia prevention. ISSHP recommends the Magpie and Eclampsia Trial regimen, given as 4 g IV over 20 minutes, then 1 g/hour. Loads of 1 or 2 g are too small to reach a protective level quickly. A 10 g IV load or a 4 g/hour infusion risks toxicity, with loss of reflexes, respiratory depression and cardiac arrest.
...
#### Q4
**Which of the following is the most appropriate plan for her delivery?**

- A. Admit locally and deliver at 37 weeks
- B. Discharge with home BP monitoring
- C. Expectant care at the perinatal centre
- D. Steroid course, then delivery in 48 hours
- E. Transfer for delivery once stabilized  **(key)**

*Explanation:* A severe headache with repeated visual symptoms and clonus is an abnormal neurological feature, which ISSHP lists as an indication for delivery at any gestational age. So she needs transfer to the perinatal centre for delivery once her BP is controlled and magnesium is running. Expectant care or delivery at 37 weeks ignores that indication. SOGC allows betamethasone up to 34 weeks and 6 days, but waiting 48 hours for its full effect should not delay a maternal indication for birth. Discharge would be unsafe.

*Key feature:* Pre-eclampsia 4. Begin BP control and seizure prophylaxis, monitor mother and fetus, and arrange urgent obstetric planning for delivery.

*Source:* Magee LA, Brown MA, Hall DR, et al. The 2021 International Society for the Study of Hypertension in Pregnancy classification, diagnosis and management recommendations for international practice. Pregnancy Hypertens. 2022.

### pre-eclampsia-18: Teenager with headache and vomiting
...
#### Q4
**Which of the following is the most appropriate fetal monitoring while magnesium sulfate is infusing?**

- A. Biophysical profile in 24 hours
- B. Continuous cardiotocography  **(key)**
- C. Doppler auscultation every 4 hours
- D. Fetal kick counts by the patient
- E. No fetal monitoring until transfer
...
### pre-eclampsia-19: Referral from the midwifery clinic
...
#### Q1
**Which of the following is the most appropriate next step in measuring her BP?**

- A. Automated reading lying on her back
- B. Large cuff, seated, after rest  **(key)**
- C. Repeat standard cuff in the left arm
- D. Standard cuff with the arm raised
- E. Thigh cuff with patient supine
...
#### Q3
**Which of the following new findings at a later visit would reclassify her condition as pre-eclampsia?**

Select 2.

- A. ALT rising to 96 U/L  **(key)**
- B. BP 150/98 mmHg
- C. Hemoglobin 108 g/L
- D. Mid-shin ankle edema
- E. New persistent headache  **(key)**
- F. Platelets 162 x 10^9/L
- G. Urine PCR 24 mg/mmol
- H. Weight gain of 2 kg in a week

*Explanation:* SOGC defines pre-eclampsia as gestational hypertension with new proteinuria or at least one adverse condition of end-organ or uteroplacental dysfunction. A new persistent headache is a neurological adverse condition, and an ALT rising to 96 U/L shows liver involvement. A PCR of 24 mg/mmol stays below the 30 mg/mmol threshold. Edema and weight gain are common in normal pregnancy and are no longer diagnostic. Platelets of 162 x 10^9/L are normal, a hemoglobin of 108 g/L is not an adverse condition, and 150/98 mmHg is still non-severe.
...
#### Q4
**Which of the following is the most appropriate diastolic BP target if she starts oral labetalol?**
...
*Explanation:* In the CHIPS trial, a diastolic target of 85 mmHg, compared with 100 mmHg, reduced progression to severe hypertension without harming the baby, and SOGC and ISSHP adopt 85 mmHg. ISSHP advises reducing therapy when the diastolic falls to 80 mmHg or below, so 75 mmHg overshoots and risks reduced placental perfusion. A target of 100 mmHg was the less-tight arm of CHIPS, and 95 or 105 mmHg similarly allow more severe hypertension.

*Key feature:* Pre-eclampsia 4. Begin BP control and seizure prophylaxis, monitor mother and fetus, and arrange urgent obstetric planning for delivery.

*Source:* Magee LA, von Dadelszen P, Rey E, et al. Less-tight versus tight control of hypertension in pregnancy. N Engl J Med. 2015.

### pre-eclampsia-20: Early pregnancy on an ACE inhibitor
...
#### Q1
**Which of the following best classifies her hypertension in this pregnancy?**

- A. Chronic hypertension  **(key)**
- B. Gestational hypertension
- C. Pre-eclampsia
- D. Superimposed pre-eclampsia
- E. White coat hypertension

*Explanation:* Hypertension diagnosed before pregnancy, and still present at 13 weeks, is chronic or pre-existing hypertension. Gestational hypertension and pre-eclampsia arise at or after 20 weeks, so neither fits at 13 weeks. Superimposed pre-eclampsia would need new proteinuria or adverse conditions after 20 weeks. White coat hypertension needs normal out-of-office readings, and she has a 4-year treated history.
...
#### Q2
**Which of the following features in her history raise her risk of pre-eclampsia in this pregnancy?**

Select 4.

- A. Age of 31 years
- B. BMI of 36 kg/m2  **(key)**
- C. Chronic hypertension  **(key)**
- D. Headache today
- E. Metformin use
- F. Pre-eclampsia at 33 weeks  **(key)**
- G. Previous caesarean birth
- H. Type 2 diabetes  **(key)**

*Explanation:* Previous pre-eclampsia, chronic hypertension, pregestational diabetes and a BMI above 30 kg/m2 are each listed by ISSHP as a high-risk factor for pre-eclampsia. An age of 31 years is below the age thresholds that guidelines list. The caesarean itself does not raise her risk, and metformin is a treatment, not a risk factor. Her headache settled with acetaminophen and, at 13 weeks, is not a feature of pre-eclampsia.
...
#### Q4
**Which of the following is the most appropriate change to her antihypertensive therapy?**

- A. Continue ramipril 10 mg PO
- B. Hold all antihypertensives
- C. Switch to atenolol 50 mg PO
- D. Switch to losartan 50 mg PO
- E. Switch to nifedipine XL 30 mg PO  **(key)**

*Explanation:* ACE inhibitors and angiotensin receptor blockers should not be used once pregnancy is known because of fetal renal toxicity and its consequences, including stillbirth, so ramipril must stop and losartan is no safer. Her BP of 146/92 mmHg still needs treatment toward a diastolic of 85 mmHg, so holding all drugs is wrong. Long-acting nifedipine is a first-line oral agent in pregnancy, as are labetalol and methyldopa. Atenolol is not a first-line agent and has been linked to lower birth weight.

*Key feature:* Pre-eclampsia 4. Begin BP control and seizure prophylaxis, monitor mother and fetus, and arrange urgent obstetric planning for delivery.

*Source:* Magee LA, Brown MA, Hall DR, et al. The 2021 International Society for the Study of Hypertension in Pregnancy classification, diagnosis and management recommendations for international practice. Pregnancy Hypertens. 2022.

### pre-eclampsia-21: Evening headache at term
...
**Which of the following is the most appropriate management of her BP now?**

- A. Oral labetalol if diastolic reaches 110 mmHg
- B. Recheck BP in 4 hours before treating
- C. Treat now with labetalol 20 mg IV  **(key)**
- D. Treat once proteinuria is confirmed
- E. Treat only if headache persists

*Explanation:* A systolic of 160 mmHg or more is severe hypertension even when the diastolic is below 110 mmHg, and it needs treatment within 30 to 60 minutes. Stroke in pre-eclampsia tracks systolic pressure. In a series of 28 women with stroke, 23 of the 24 with readings just before the stroke had a systolic of 160 mmHg or more, but only 3 had a diastolic of 110 mmHg or more. Waiting for a diastolic of 110 mmHg, for 4 hours, for proteinuria results or for the headache to persist delays treatment of that risk.

*Key feature:* Pre-eclampsia 4. Begin BP control and seizure prophylaxis, monitor mother and fetus, and arrange urgent obstetric planning for delivery.

*Source:* Martin JN Jr, Thigpen BD, Moore RC, et al. Stroke and severe preeclampsia and eclampsia: a paradigm shift focusing on systolic blood pressure. Obstet Gynecol. 2005.

#### Q2
*Update:* At 2310, 30 minutes after labetalol 20 mg IV, her BP is 162/98 mmHg and her pulse is 78/minute.

**Which of the following is the most appropriate next antihypertensive dose for her?**

- A. labetalol 10 mg IV
- B. labetalol 40 mg IV  **(key)**
- C. labetalol 120 mg IV
- D. labetalol 200 mg IV
- E. labetalol 300 mg IV

*Explanation:* ISSHP suggests doubling IV labetalol when BP is still severe 30 minutes after the first dose, so 40 mg follows her 20 mg, and doses of 40 to 80 mg can follow every 30 minutes. A 10 mg dose is smaller than the dose that has already failed. Boluses of 120 to 300 mg exceed any recommended single bolus, and 300 mg is the maximum total for a whole treatment course. Her pulse of 78/minute leaves room for further beta blockade.
...
#### Q3
*Update:* By 2350 her BP is 148/92 mmHg and the headache has resolved. PCR 58 mg/mmol, platelets 168 x 10^9/L, ALT 30 U/L, creatinine 66 umol/L. The fetal tracing is normal.

**Which of the following is the most appropriate plan for her pregnancy?**

- A. Arrange delivery after stabilization  **(key)**
- B. Deliver at 40 weeks if stable
- C. Discharge with weekly lab tests
- D. Outpatient care until spontaneous labour
- E. Repeat PCR and decide in 24 hours

*Explanation:* Hypertension with a PCR of 58 mg/mmol at 38 weeks and 2 days is pre-eclampsia, and SOGC recommends initiating delivery at 37 weeks or later. At term the baby gains nothing from waiting, while she stays exposed to eclampsia, abruption and HELLP. Waiting to 40 weeks, outpatient care until labour or weekly tests all accept that risk. A repeat PCR adds nothing, because ISSHP advises that proteinuria testing need not be repeated once significant proteinuria is confirmed.
...
#### Q4
**Which of the following is the most appropriate use of magnesium sulfate for her?**

- A. Give only if a seizure occurs
- B. Give only if clonus develops
- C. Start after delivery only
- D. Start now, stop at delivery
- E. Start now, until 24 hours postpartum  **(key)**

*Explanation:* She has proteinuria with severe systolic hypertension and had a headache, and ISSHP recommends magnesium sulfate for eclampsia prevention in that setting. It is given as 4 g IV, then 1 g/hour, and continued until 24 hours after birth because eclampsia can occur during labour and after delivery. Waiting for clonus or a seizure gives up prevention, and magnesium roughly halves the risk of eclampsia. Stopping at delivery or starting only afterward leaves her unprotected in labour or the postpartum period.

*Key feature:* Pre-eclampsia 4. Begin BP control and seizure prophylaxis, monitor mother and fetus, and arrange urgent obstetric planning for delivery.

*Source:* Magee LA, Brown MA, Hall DR, et al. The 2021 International Society for the Study of Hypertension in Pregnancy classification, diagnosis and management recommendations for international practice. Pregnancy Hypertens. 2022.

### pre-eclampsia-22: Sudden pain five days after a hypertension diagnosis
...
- A. Hepatic capsule hematoma
- B. Placenta previa
- C. Placental abruption  **(key)**
- D. Preterm labour
- E. Uterine rupture

*Explanation:* Sudden constant pain with a firm, tender uterus and dark bleeding in a woman with pre-eclampsia is placental abruption, a uteroplacental complication of pre-eclampsia, and smoking adds to the risk. A pulse of 118/minute and a BP of 104/68 mmHg, far below her recent readings, suggest concealed blood loss. Placenta previa bleeds painlessly from a soft uterus. Preterm labour gives intermittent pain with relaxation between contractions. Uterine rupture is rare without a uterine scar, and a hepatic hematoma causes upper abdominal pain.

*Key feature:* Pre-eclampsia 1. Consider pre-eclampsia in pregnant patients with unexplained headache, abdominal pain, or confusion, even with normal blood pressure.

*Source:* Oyelese Y, Ananth CV. Placental abruption. Obstet Gynecol. 2006. https://doi.org/10.1097/01.AOG.0000239439.04364.9a

#### Q2
**Which of the following investigations are the most important to send now?**

Select 3.

- A. CBC with platelets  **(key)**
- B. Fibrinogen level  **(key)**
- C. Group and crossmatch  **(key)**
- D. Lipase level
- E. Repeat urine PCR
- F. Serum D-dimer
- G. Ultrasound for abruption
- H. Uric acid level

*Explanation:* Abruption can cause heavy concealed bleeding and disseminated intravascular coagulation, so she needs a CBC with platelets, a fibrinogen level and a group and crossmatch now. A low fibrinogen marks consumptive coagulopathy and guides replacement. Abruption is a clinical diagnosis, and ultrasound is of limited value, so a normal scan cannot exclude one and must not delay care. D-dimer is raised in normal pregnancy and adds nothing. A repeat PCR, uric acid and lipase do not change management.
...
**Which of the following treatments best addresses her most severe coagulation deficit?**

- A. Albumin 5% infusion
- B. Cryoprecipitate  **(key)**
- C. Platelets only
- D. Protamine sulfate
- E. Vitamin K IV

*Explanation:* A fibrinogen of 1.1 g/L with an INR of 1.6 is consumptive coagulopathy from abruption, and fibrinogen falls first and furthest. Cryoprecipitate replaces fibrinogen, given with red cells and plasma as bleeding requires. Platelets alone leave the fibrinogen deficit, and a count of 74 x 10^9/L is not the main problem. Vitamin K corrects deficiency, not consumption. Protamine reverses heparin, which she has not received. Albumin adds volume without clotting factors. Coagulopathy from abruption is managed aggressively while delivery removes its cause.

*Key feature:* Pre-eclampsia 4. Begin BP control and seizure prophylaxis, monitor mother and fetus, and arrange urgent obstetric planning for delivery.

*Source:* Oyelese Y, Ananth CV. Placental abruption. Obstet Gynecol. 2006. https://doi.org/10.1097/01.AOG.0000239439.04364.9a

### pre-eclampsia-23: Birth in the department
...
**Which of the following medications for her postpartum hemorrhage carries the greatest risk in her case?**

- A. carbetocin 100 mcg IV
- B. carboprost 250 mcg IM
- C. ergonovine 0.2 mg IM  **(key)**
- D. misoprostol 800 mcg SL
- E. tranexamic acid 1 g IV

*Explanation:* Ergonovine is an ergot alkaloid that constricts blood vessels and can raise BP sharply, so FIGO advises using it only when hypertensive disorders have been excluded. She has pre-eclampsia with HELLP and a BP of 154/100 mmHg, so ergonovine risks severe hypertension and stroke. Sublingual misoprostol 800 mcg is a recommended treatment when bleeding continues. Tranexamic acid 1 g IV is recommended as soon as hemorrhage is diagnosed and within 3 hours of birth. Carboprost is an accepted second-line uterotonic, and she has no asthma. Carbetocin is a long-acting oxytocin analogue without a vasoconstrictor effect of this kind.

*Key feature:* Pre-eclampsia 4. Begin BP control and seizure prophylaxis, monitor mother and fetus, and arrange urgent obstetric planning for delivery.

*Source:* Escobar MF, Nassar AH, Theron G, et al. FIGO recommendations on the management of postpartum hemorrhage 2022. Int J Gynaecol Obstet. 2022. https://doi.org/10.1002/ijgo.14116
...
**Which of the following is the longest acceptable interval between her repeat laboratory tests?**
...
#### Q1
*Update:* Hemoglobin 72 g/L, platelets 14 x 10^9/L, LDH 1 680 U/L, bilirubin 52 umol/L, AST 48 U/L, ALT 36 U/L, creatinine 102 umol/L, INR 1.1, fibrinogen 3.8 g/L. The film shows many schistocytes. PCR is 20 mg/mmol.

**Which of the following is the most likely diagnosis in this patient?**

- A. Acute fatty liver of pregnancy
- B. HELLP syndrome with pre-eclampsia
- C. Hemolytic uremic syndrome
- D. Immune thrombocytopenic purpura
- E. Thrombotic thrombocytopenic purpura  **(key)**

*Explanation:* Platelets of 14 x 10^9/L with many schistocytes, an LDH of 1 680 U/L, transient neurological symptoms and low-grade fever at 23 weeks point to thrombotic thrombocytopenic purpura, which pregnancy can unmask. HELLP rarely drives platelets this low with near-normal liver enzymes, and she has neither hypertension nor proteinuria, with a BP of 132/82 mmHg and a PCR of 20 mg/mmol. Fatty liver of pregnancy causes liver failure with coagulopathy, and her INR and fibrinogen are normal. Hemolytic uremic syndrome causes more severe kidney injury. Immune thrombocytopenia does not cause hemolysis.

*Key feature:* Pre-eclampsia 3. Exclude HELLP syndrome in pregnant patients with vague symptoms like nausea, vomiting, or abdominal pain before other diagnoses.

*Source:* Scully M, Thomas M, Underwood M, et al. Thrombotic thrombocytopenic purpura and pregnancy: presentation, management, and subsequent pregnancy outcomes. Blood. 2014.

#### Q2
**Which of the following tests best distinguishes her condition from HELLP syndrome?**

- A. ADAMTS13 activity  **(key)**
...
**Which of the following changes to her analgesic or antihypertensive medications is most appropriate?**

- A. Add hydrochlorothiazide 25 mg PO
- B. Double the ibuprofen dose
- C. Replace acetaminophen with codeine
- D. Stop ibuprofen, continue acetaminophen  **(key)**
- E. Switch ibuprofen to naproxen

*Explanation:* Her creatinine has nearly doubled, from 68 to 132 umol/L, after a 1 200 mL hemorrhage while she takes regular ibuprofen. ISSHP supports NSAIDs after pre-eclampsia only when BP is controlled and there is no acute kidney injury or risk factor such as postpartum hemorrhage. Stopping ibuprofen and relying on acetaminophen removes the renal insult. Naproxen or a higher ibuprofen dose carries the same risk. Codeine is avoided in breastfeeding because ultrarapid maternal metabolism can cause infant opioid toxicity. A thiazide adds volume depletion to an injured kidney.
...
**Which of the following is the most appropriate treatment for her BP now?**

- A. enalapril 10 mg PO
- B. furosemide 40 mg IV
- C. hydrochlorothiazide 25 mg PO
- D. labetalol 20 mg IV  **(key)**
- E. methyldopa 500 mg PO
...
*Source:* American College of Obstetricians and Gynecologists. Committee Opinion No. 767: Emergent therapy for acute-onset, severe hypertension during pregnancy and the postpartum period. Obstet Gynecol. 2019.

#### Q3
**Which of the following postpartum intervals is when BP after pre-eclampsia most often peaks?**
...
*Explanation:* BP after a hypertensive pregnancy usually peaks 3 to 7 days after birth, as fluid moves from the tissues back into the circulation. That is often after discharge, so ISSHP advises checking BP at least once between days 3 and 7 and having a treatment plan in place. She is on day 4, squarely in that window. The first day after birth, days 10 to 14 and the later weeks are not the usual peak, although pre-eclampsia and eclampsia can still appear up to 6 weeks postpartum.

*Key feature:* Pre-eclampsia 2. Evaluate suspected pre-eclampsia systematically, including risk factors, symptoms, BP change from baseline, and labs, to decide quickly.

*Source:* Magee LA, Brown MA, Hall DR, et al. The 2021 International Society for the Study of Hypertension in Pregnancy classification, diagnosis and management recommendations for international practice. Pregnancy Hypertens. 2022.

### pre-eclampsia-27: Little urine while awaiting obstetrics
...
#### Q3
**Which of the following home BP readings should prompt her to return to hospital immediately?**

- A. 130/80 mmHg or higher
- B. 140/90 mmHg or higher
- C. 150/100 mmHg or higher
- D. 160/110 mmHg or higher  **(key)**
- E. 180/120 mmHg or higher

*Explanation:* A systolic of 160 mmHg or more or a diastolic of 110 mmHg or more is severe hypertension, which ISSHP says needs urgent treatment in a monitored setting, so either reading should bring her straight back. On treatment her diastolic target is 85 mmHg, so readings of 140/90 or 150/100 mmHg call for a prompt review of her medication, not an emergency visit. A reading of 130/80 mmHg is at or near target. Waiting for 180/120 mmHg accepts a stroke risk that begins at a systolic of 160 mmHg. New headache, visual change or abdominal pain should also bring her back at any BP.

*Key feature:* Pre-eclampsia 4. Begin BP control and seizure prophylaxis, monitor mother and fetus, and arrange urgent obstetric planning for delivery.

*Source:* Magee LA, Brown MA, Hall DR, et al. The 2021 International Society for the Study of Hypertension in Pregnancy classification, diagnosis and management recommendations for international practice. Pregnancy Hypertens. 2022.

### pre-eclampsia-29: Sudden headache and arm weakness at 36 weeks
...
#### Q3
*Update:* CT shows a 3 cm left basal ganglia hemorrhage without hydrocephalus. Platelets 176 x 10^9/L and INR 1.0. Her BP is 196/120 mmHg and she has vomited twice more.

**Which of the following is the most appropriate antihypertensive for her now?**

- A. enalaprilat 1.25 mg IV
- B. hydralazine 20 mg IV
- C. labetalol 20 mg IV  **(key)**
- D. nifedipine 10 mg PO
- E. nitroprusside 0.5 mcg/kg/minute IV

*Explanation:* Labetalol 20 mg IV lowers BP within minutes and can be repeated at double the dose every 30 minutes, and her pulse of 64/minute allows it. Oral nifedipine is first-line for severe hypertension, but she is vomiting with a GCS of 13, so an oral drug is unreliable and risks aspiration. Hydralazine starts at 5 mg IV, and 20 mg is the maximum total dose, so a 20 mg bolus risks abrupt hypotension. Enalaprilat is fetotoxic. Nitroprusside is reserved for refractory hypertension because of fetal cyanide toxicity.
...
**Which of the following findings most argues against pyelonephritis as the cause of her pain?**

- A. Costovertebral angle tenderness
- B. Previous UTI at 24 weeks
- C. Proteinuria of 2+ on dipstick
- D. Right-sided flank pain
- E. Urine free of leukocytes and nitrites  **(key)**

*Explanation:* Pyuria is present in nearly all cases of acute pyelonephritis, so a urine free of leukocytes and nitrites should prompt a search for another diagnosis, and she also has no fever. Right upper quadrant pain, nausea and 3+ reflexes at 30 weeks, with a BP of 138/88 mmHg against a baseline of 108/66 mmHg, point toward pre-eclampsia or HELLP, which calls for a repeat BP, PCR, platelets and liver enzymes rather than an antibiotic. Costovertebral angle tenderness, right flank pain and a previous UTI all fit pyelonephritis. Proteinuria can occur in either condition, so it does not argue against infection.

*Key feature:* Pre-eclampsia 1. Consider pre-eclampsia in pregnant patients with unexplained headache, abdominal pain, or confusion, even with normal blood pressure.

*Source:* Johnson JR, Russo TA. Acute pyelonephritis in adults. N Engl J Med. 2018. https://doi.org/10.1056/NEJMcp1702758

#### Q2
*Update:* At 1330 her BP is 146/94 mmHg and at 1350 it is 144/96 mmHg. PCR 64 mg/mmol, platelets 128 x 10^9/L, AST 88 U/L, ALT 102 U/L, LDH 410 U/L, creatinine 70 umol/L.

**Which of the following best describes her condition based on these results?**
...
#### Q1
*Update:* At 1015 and 1030 her BP is 150/98 and 148/96 mmHg. PCR 45 mg/mmol, platelets 204 x 10^9/L, ALT 22 U/L, creatinine 61 umol/L. The fetal heart tracing is normal.

**Which of the following is the most appropriate plan for the timing of her delivery?**

- A. Caesarean within 2 hours
- B. Discharge until labour begins
- C. Discuss induction now versus waiting  **(key)**
- D. Expectant care to 40 weeks
- E. Induce only at 39 weeks

*Explanation:* Hypertension with a PCR of 45 mg/mmol is pre-eclampsia, and SOGC recommends discussing initiation of delivery with women who have pre-eclampsia between 34 weeks and 35 weeks and 6 days, because earlier birth lowers maternal risk but raises neonatal respiratory problems. She has no severe features, so an emergency caesarean is not indicated. SOGC recommends delivery for pre-eclampsia from 37 weeks, so waiting to 39 or 40 weeks is not advised. Discharge until labour leaves her exposed to progression.
...
#### Q3
*Update:* At 1420 and 1430 her BP is 166/108 and 164/106 mmHg. A nurse asks whether nifedipine can be given while magnesium is running.

**Which of the following is the most appropriate antihypertensive plan for her?**

- A. Give nifedipine 10 mg PO now  **(key)**
- B. Stop magnesium before nifedipine
- C. Treat only if diastolic reaches 110
- D. Use nifedipine 10 mg sublingually
- E. Wait 1 hour and recheck BP
...
### pre-eclampsia-33: Blood pressure that will not come down
...
#### Q1
*Update:* She has received labetalol IV 20 mg at 0815, 40 mg at 0845, 80 mg at 0915, 80 mg at 0945 and 80 mg at 1015. At 1045 her BP is 170/112 mmHg and her pulse is 66/minute.

**Which of the following is the most appropriate antihypertensive for her now?**

- A. hydralazine 20 mg IV
- B. labetalol 80 mg IV
- C. labetalol 2 mg/minute IV
- D. nifedipine 10 mg PO  **(key)**
- E. nitroprusside 0.5 mcg/kg/minute IV

*Explanation:* She has received 20 + 40 + 80 + 80 + 80 = 300 mg of IV labetalol, the maximum for a treatment course, so further labetalol by bolus or infusion is not an option. ISSHP advises switching to a drug from a different class, such as immediate-release nifedipine 10 mg PO. Hydralazine is an alternative only from 5 mg IV, and a 20 mg bolus, which is its maximum total dose, risks abrupt hypotension. Nitroprusside is kept for refractory hypertension after first-line drugs fail because of fetal cyanide toxicity.
...
#### Q3
**Which of the following would be an ISSHP indication for delivery regardless of gestational age?**

- A. BP severe on three drug classes  **(key)**
- B. Edema of the face and hands
- C. PCR above 500 mg/mmol
- D. Platelets 120 x 10^9/L
- E. Uric acid above 400 umol/L
...
### pre-eclampsia-34: Headache in a distance runner

- [ ] Approved  - [ ] Needs change  - [ ] Reject

A 30-year-old woman, G1P0 at 31 weeks and 4 days, presents to the emergency department with a frontal headache for 5 hours. She is a competitive marathon runner. Her resting pulse is usually in the high 40s, and an ECG at 20 weeks showed only sinus bradycardia. At 28 weeks her BP was 108 mmHg systolic and 68 mmHg diastolic. She has no visual symptoms, chest pain or shortness of breath. She takes a prenatal vitamin. Her neurological examination is normal apart from 3+ reflexes with 2 beats of clonus. The fetal heart rate is 145/minute.
...
#### Q1
**Which of the following investigations are the most important to evaluate her for pre-eclampsia and its complications?**

Select 4.

- A. AST and ALT  **(key)**
- B. Blood alcohol level
- C. CBC with platelets  **(key)**
- D. Serum ammonia
- E. Serum cortisol
- F. Serum creatinine  **(key)**
- G. Serum lipase
- H. Urine PCR  **(key)**

*Explanation:* She has had no testing for pre-eclampsia, so a urine PCR is needed to look for proteinuria, and a CBC with platelets, AST, ALT and creatinine detect HELLP and kidney injury, which change her management. SOGC defines pre-eclampsia as hypertension after 20 weeks with proteinuria or adverse conditions such as these. Blood alcohol, ammonia, cortisol and lipase look for causes her presentation does not suggest.
...
**Which of the following is the longest acceptable delay from confirmation of her severe hypertension to the first antihypertensive dose?**
...
#### Q3
*Update:* Her BP settles to 150/100 mmHg, but the headache and clonus persist. Obstetrics plans a caesarean today. Magnesium sulfate 4 g IV, then 1 g/hour, is running.

**Which of the following neonatal outcomes is her magnesium sulfate infusion also expected to reduce?**

- A. Bronchopulmonary dysplasia
- B. Cerebral palsy  **(key)**
- C. Intraventricular hemorrhage
- D. Necrotizing enterocolitis
- E. Respiratory distress syndrome

*Explanation:* Given at 33 weeks and 6 days or earlier when birth is imminent or planned, magnesium sulfate reduces cerebral palsy in surviving preterm infants, with a relative risk of 0.71 for any cerebral palsy in the SOGC meta-analysis. She is 31 weeks and 4 days with a birth planned today, so the infusion given to prevent eclampsia also protects the baby's brain. Respiratory distress syndrome and intraventricular hemorrhage are reduced by antenatal corticosteroids, not magnesium. Magnesium has not been shown to prevent necrotizing enterocolitis or bronchopulmonary dysplasia.

*Key feature:* Pre-eclampsia 4. Begin BP control and seizure prophylaxis, monitor mother and fetus, and arrange urgent obstetric planning for delivery.

*Source:* Magee LA, De Silva DA, Sawchuck D, Synnes A, von Dadelszen P. No. 376: Magnesium sulphate for fetal neuroprotection. J Obstet Gynaecol Can. 2019.

### pre-eclampsia-35: Headache and swelling at 21 weeks
...
#### Q1
**Which of the following in her history most likely explains pre-eclampsia this early in pregnancy?**

- A. Antiphospholipid syndrome  **(key)**
- B. Hydroxychloroquine use
- C. Low-dose ASA use
- D. Maternal age of 29 years
- E. Previous miscarriage
...
#### Q3
*Update:* Six hours later her platelets are 72 x 10^9/L, AST 164 U/L and LDH 690 U/L. Haptoglobin is undetectable and the film shows schistocytes. Hemoglobin has fallen from 118 to 101 g/L.

**Which of the following is the most likely explanation for these new results?**

- A. Drug-induced hepatitis
- B. HELLP syndrome  **(key)**
- C. Lupus flare with hemolysis
- D. Lupus hepatitis
- E. Viral hepatitis

*Explanation:* In severe early pre-eclampsia, schistocytes, undetectable haptoglobin and an LDH of 690 U/L show microangiopathic hemolysis, and with an AST of 164 U/L and platelets falling from 96 to 72 x 10^9/L this is HELLP syndrome. Autoimmune hemolysis in a lupus flare produces spherocytes and a positive direct antiglobulin test rather than schistocytes. Lupus, drug-induced and viral hepatitis can raise liver enzymes but do not explain microangiopathic hemolysis with a falling platelet count.

*Key feature:* Pre-eclampsia 3. Exclude HELLP syndrome in pregnant patients with vague symptoms like nausea, vomiting, or abdominal pain before other diagnoses.

*Source:* Sibai BM. Diagnosis, controversies, and management of the syndrome of hemolysis, elevated liver enzymes, and low platelet count. Obstet Gynecol. 2004.

### pre-eclampsia-36: A migraine that feels different
...
#### Q3
*Update:* At 1310 her BP is 144/96 mmHg in the same arm. PCR 18 mg/mmol. Platelets 190 x 10^9/L, ALT 21 U/L, creatinine 55 umol/L. The fetal heart tracing is normal. The headache persists.

**Which of the following best classifies her condition using SOGC 2022 definitions?**
...
### pre-eclampsia-37: Back pain and tightening at 29 weeks
...
#### Q2
*Update:* At 1420 and 1440 her BP is 146/94 and 148/96 mmHg. Platelets 88 x 10^9/L, AST 212 U/L, ALT 190 U/L, LDH 690 U/L, creatinine 68 umol/L, glucose 5.0 mmol/L, INR 1.0. PCR is 52 mg/mmol. The cervix is 2 cm dilated.
...
#### Q3
**Which of the following is the most appropriate approach to her contractions?**

- A. Bed rest and a fluid bolus
- B. indomethacin 50 mg PO
- C. nifedipine 20 mg PO
- D. terbutaline 0.25 mg SC
- E. No tocolytic medication  **(key)**

*Explanation:* HELLP syndrome is pre-eclampsia with severe features, which ACOG lists as a contraindication to tocolysis, because the risks of prolonging the pregnancy outweigh those of preterm birth and delivery is the treatment. Indomethacin is also an NSAID that impairs platelet and kidney function, which matters with platelets of 88 x 10^9/L. Nifedipine and terbutaline act on BP and heart rate. Bed rest and hydration have not been shown to prevent preterm birth, and a fluid bolus risks pulmonary edema in pre-eclampsia. Her care now centres on magnesium sulfate, betamethasone and planned birth.

*Key feature:* Pre-eclampsia 4. Begin BP control and seizure prophylaxis, monitor mother and fetus, and arrange urgent obstetric planning for delivery.

*Source:* American College of Obstetricians and Gynecologists. Practice Bulletin No. 171: Management of preterm labor. Obstet Gynecol. 2016. https://pubmed.ncbi.nlm.nih.gov/27661654/

### pre-eclampsia-38: Low-speed crash with no memory of it
...
#### Q1
**Which of the following is the most likely explanation for her confusion?**

- A. Alcohol intoxication
- B. Concussion from the crash
- C. Hypoglycemic event
- D. Posttraumatic subdural hematoma
- E. Seizure from eclampsia  **(key)**

*Explanation:* A lateral tongue bite, amnesia for the event and confusion, after a morning headache, with a BP of 166/108 mmHg and 3+ reflexes at 33 weeks, suggest that an eclamptic seizure caused the crash rather than the crash causing her confusion. A low-speed, belted crash with no scalp injury makes concussion or a subdural hematoma less likely, although imaging is still needed. Her glucose of 5.4 mmol/L excludes hypoglycemia, and a breath alcohol of zero excludes intoxication.
...
#### Q3
*Update:* Magnesium sulfate and labetalol are running. An hour later she is alert, her BP is 148/96 mmHg and the fetal tracing is normal. The fetus is cephalic, she is contracting every 4 minutes and the cervix is 5 cm dilated.

**Which of the following is the most appropriate plan for her delivery?**

- A. Allow labour to continue vaginally  **(key)**
- B. Delay delivery 48 hours for steroids
- C. Expectant care to 37 weeks
- D. Immediate caesarean delivery
- E. Tocolysis to stop labour

*Explanation:* ACOG states that eclampsia by itself is not an indication for caesarean delivery. Once the mother is stable, the route depends on gestational age, presentation and the cervix, and a woman progressing in labour can continue labour after an eclamptic seizure. She is alert with controlled BP, a cephalic fetus, a normal tracing and a cervix at 5 cm, so vaginal birth with magnesium continuing is appropriate. Eclampsia calls for timely delivery, so tocolysis, a 48-hour delay for steroids or expectant care to 37 weeks are all wrong.
