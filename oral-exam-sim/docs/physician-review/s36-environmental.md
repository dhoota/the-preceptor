...
- environmental-19 q3: the serial liver and clotting test question is mapped to environmental KF1. No environmental key feature names complications. *(samps-overlap-pass2b-review.md)*
- environmental-17 q1 cites the Rosen textbook. *(samps-overlap-pass2b-review.md)*
...
- environmental-24 q1: dextrose 10% 5 mL/kg (0.5 g/kg, 60 mL at 12 kg) sits inside PALS and common Canadian paediatric ranges. Confirm it against the local TREKK or hospital protocol. *(samps-s36-lensA.md)*
- Rosen-only claims (writer's list) are standard teaching and I found no error: rocuronium over succinylcholine with K 6.3 mmol/L and peaked T waves (environmental-19 q1), oxygen and observation for immersion pulmonary edema (environmental-31 q3), posterior dislocation after electrical tetany (environmental-34 q1), lightning myocardial injury (environmental-37 q2). environmental-26 q2 and environmental-37 q1 no longer rely on Rosen's. *(samps-s36-lensA.md)*
- Whether to rewrite or drop the high-severity overlaps above, above all environmental-38 and environmental-31 against s48, and whether to discard environmental-39 and environmental-40. *(samps-s36-lensA.md)*
- environmental-38 (rebuilt): confirm the scenario and keys. In particular, confirm that combined evaporative, ice pack and cold IV fluid cooling is the best of the options offered for a rigid, agitated tetraplegic patient, since immersion is deliberately not an option. Also confirm that restoring intrathecal baclofen is realistic as the ED "specific treatment" key, done through the pump team or neurosurgery. *(samps-s36-lensB.md)*
- Key feature mapping, low confidence, not changed: environmental-16 q2 and q3 (treatment of hyponatremia in a normothermic runner) are tagged key feature 2, which is about severe hyperthermia. environmental-30 q3 (ciguatera relapse advice) is tagged key feature 4 but does not test dysbarism or hyperbaric referral. Consider re-tagging or replacing. *(samps-s36-lensB.md)*
- environmental-39 and environmental-40 are verbatim duplicates of environmental-23 and environmental-31, apart from the planted defects now fixed. I recommend that neither is added to the bank. *(samps-s36-lensB.md)*
...
- environmental-37 q3: the sentence that lightning victims are often thrown and have blunt injuries that are easily missed comes from general teaching and the WMS guideline's advice to examine for trauma. It is not from the ACR document. *(samps-textbooks-s36.md)*

Review reports: docs/reviews/writer-s36.md, samps-s36-lensA.md, samps-s36-lensB.md

## SAMPs

### environmental-16: Collapse at a mountain aid station
...
#### Q3
**Which of the following is the most appropriate approach to his temperature of 40.4°C?**

- A. Acetaminophen and observe for 1 hour
- B. Cooling once heat stroke is confirmed
- C. Dantrolene 2.5 mg/kg IV
- D. Simultaneous cooling and antibiotics  **(key)**
- E. No cooling until the CT is reviewed

*Explanation:* He worked all day at 31°C and is confused with a temperature above 40°C, so heat stroke may be adding to the infection, and the cause cannot be confirmed quickly. Severe hyperthermia with altered mental status is cooled at once with physical methods while the antibiotics run. Waiting for confirmation or for imaging prolongs the time spent above 40°C. Acetaminophen alone is too slow. Dantrolene has no proven role in heat stroke or sepsis.

*Key feature:* Environmental 2. Cool severe hyperthermia rapidly with several methods before confirming the cause, while considering NMS, overdose, endocrine, or infection.

*Source:* Eifling KP, Gaudio FG, Dumke C, and colleagues. Wilderness Medical Society clinical practice guidelines for the prevention and treatment of heat illness. 2024 update. Wilderness Environ Med. 2024. https://pubmed.ncbi.nlm.nih.gov/38425235/

### environmental-19: A firefighter flown in from the fire line
...
**Which of the following neuromuscular blockers is most appropriate for his rapid sequence intubation?**

- A. Cisatracurium 0.15 mg/kg IV
- B. Pancuronium 0.1 mg/kg IV
- C. Rocuronium 1.2 mg/kg IV  **(key)**
- D. Succinylcholine 1.5 mg/kg IV
- E. Vecuronium 0.1 mg/kg IV

*Explanation:* Succinylcholine raises serum potassium, which is dangerous at 6.3 mmol/L with ECG changes and likely rhabdomyolysis from exertional heat stroke. The Society of Critical Care Medicine suggests either rocuronium or succinylcholine for rapid sequence intubation when succinylcholine has no known contraindication. Rocuronium 1.2 mg/kg, about 100 mg at 85 kg, gives rapid intubating conditions without raising potassium. Cisatracurium, pancuronium and vecuronium at these doses take several minutes to work, which is too slow for rapid sequence intubation.

*Key feature:* Environmental 1. Suspect heat stroke in a confused, febrile patient exposed to heat and start cooling right away.

*Source:* Acquisto NM, Mosier JM, Bittner EA, and colleagues. Society of Critical Care Medicine clinical practice guidelines for rapid sequence intubation in the critically ill adult patient. Crit Care Med. 2023. doi:10.1097/CCM.0000000000006000 https://pubmed.ncbi.nlm.nih.gov/37707379/

#### Q2
*Update:* He is intubated and sedated. His rectal temperature is 41.6°C. There is no immersion tub in the department.

**Which of the following is the most effective way to cool him now?**

- A. Cold IV saline 30 mL/kg alone
- B. Cooling blanket and ice to the groin
- C. Evaporative mist with fans
- D. Ice packs to neck, axillae and groin
- E. Tarp-assisted ice water immersion  **(key)**

*Explanation:* A tarp held around him by staff, filled with ice water, gives cooling rates close to tub immersion and can be done on a stretcher in an intubated patient. Cooling is urgent because the time spent above 40°C drives organ injury. Cold IV saline alone lowers temperature slowly and adds a large volume in a patient with acute kidney injury. Evaporative cooling, ice packs and cooling blankets all cool much more slowly than immersion.
...
**Which of the following is the most appropriate plan for his liver and clotting tests?**

- A. No repeat after normal arrival values
- B. Repeat once at 6 hours
- C. Repeat only if bleeding or jaundice
- D. Serial testing over the next few days  **(key)**
- E. Single check at a 1 week clinic visit
...
### environmental-20: A football player cooled on the sideline
...
- A. Admit for IV fluids and serial labs  **(key)**
- B. Discharge after 2 L of oral fluids
- C. Discharge with CK recheck in 1 week
- D. ICU admission for dantrolene
- E. Observe 4 hours, then discharge

*Explanation:* A creatinine of 128 umol/L and a CK of 4200 U/L show early kidney and muscle injury, and liver and coagulation injury often peak 24 to 48 hours after heat stroke. He needs admission for IV fluids and repeat creatinine, CK, liver enzymes and coagulation tests. Discharge after oral fluids or a short observation would miss this evolution. Dantrolene has no proven role, and his normal mental status does not require ICU care.
...
**Which of the following is the most appropriate advice about his return to football?**

- A. Full practice once he feels well
- B. Light practice in full gear in 2 days
- C. Permanent exclusion from contact sport
- D. Rest 7 days, then a graded return  **(key)**
- E. Return after one normal CK result

*Explanation:* The ACSM advises no exercise for at least 7 days after release from care, then a review of end organ function. After that he starts exercise in a cool setting and increases duration, intensity and heat exposure over 2 to 4 weeks. Returning when he feels well, or after one normal CK, skips the rest period and acclimatization. Early practice in full gear adds heat stress too soon. One episode of heat stroke does not require permanent exclusion.

*Key feature:* Environmental 1. Suspect heat stroke in a confused, febrile patient exposed to heat and start cooling right away.

*Source:* Roberts WO, Armstrong LE, Sawka MN, Yeargin SW, Heled Y, O'Connor FG. ACSM expert consensus statement on exertional heat illness: recognition, management, and return to activity. Curr Sports Med Rep. 2023. https://pubmed.ncbi.nlm.nih.gov/37036463/

### environmental-21: Two skiers from the same slide
...
- Temperature: 26.4°C core
- Pulse: 38/minute
- Resp.: 6/minute
- BP: 78/40 mmHg

#### Q1
**Which of the following is the most appropriate management of the man who was buried for 20 minutes?**

- A. Continue CPR until core temperature is 35°C
- B. Intermittent CPR during transport
- C. Measure potassium to guide the decision
- D. Stop resuscitation efforts  **(key)**
- E. Transfer for ECLS with mechanical CPR

*Explanation:* A burial of 20 minutes with an obstructed airway and a core temperature of 34.6°C means an asphyxial arrest, not a hypothermic one. ICAR 2023 treats such victims as normothermic arrests and defers the decision to stop to standard termination guidance, and 35 minutes of CPR in asystole with no hypothermia or other reversible cause meets it. Continuing until 35°C and ECLS apply to hypothermic arrest, which needs a core temperature below 30°C. Potassium helps triage victims buried more than 60 minutes. Intermittent CPR is for patients below 28°C.

*Key feature:* Environmental 3. Rewarm hypothermic patients effectively, track core temperature with a reliable probe, and keep resuscitating until warm.

*Source:* Pasquier M, Strapazzon G, Kottmann A, and colleagues. On-site treatment of avalanche victims: scoping review and 2023 recommendations of the International Commission for Mountain Emergency Medicine (ICAR MedCom). Resuscitation. 2023. https://pubmed.ncbi.nlm.nih.gov/36709825/

#### Q2
**Which of the following is the most appropriate plan for the woman?**

- A. Active external rewarming, then reassess
- B. Bladder lavage with warmed saline
- C. Forced air warming and admission here
- D. Transfer to an ECLS centre now  **(key)**
- E. Warm peritoneal lavage in this ED

*Explanation:* A core temperature of 26.4°C, which is below 30°C, and a systolic BP of 78 mmHg, which is below 90 mmHg, each place her at high risk of cardiac arrest. Either one is a criterion for direct transfer to an ECLS centre, with ECLS ready if she arrests. External rewarming here and reassessing wastes the time she needs for transfer. Bladder lavage adds less than 0.5°C per hour. Peritoneal lavage is reserved for when ECLS cannot be reached within about 6 hours.

*Key feature:* Environmental 3. Rewarm hypothermic patients effectively, track core temperature with a reliable probe, and keep resuscitating until warm.

*Source:* Paal P, Pasquier M, Darocha T, and colleagues. Accidental hypothermia: 2021 update. Int J Environ Res Public Health. 2022. https://pubmed.ncbi.nlm.nih.gov/35010760/

#### Q3
**Which of the following is the most appropriate airway plan for the woman before the flight?**

- A. Defer intubation until rewarmed
- B. Intubate before departure  **(key)**
- C. Nasal high flow oxygen
- D. Oxygen by face mask only
- E. Supraglottic airway in flight
...
**Which of the following is the most appropriate imaging plan for his decreased level of consciousness?**

- A. CT head now as rewarming continues  **(key)**
- B. CT head once rewarmed to 35°C
- C. CT head only if a focal deficit appears
- D. MRI of the brain once he is warm
- E. No imaging if GCS rises with warming
...
#### Q2
**Which of the following is the most appropriate time to thaw his frozen feet?**

- A. After his core temperature stabilizes  **(key)**
- B. After 24 hours of observation
- C. Before core rewarming begins
- D. Once the feet thaw on their own
- E. Only after surgical consultation

*Explanation:* Frozen tissue is thawed as soon as circulation and core temperature have been stabilized, because core rewarming comes first and the feet have no risk of refreezing in hospital. Thawing before core rewarming diverts care from the priority and returns cold blood from the limbs. Slow spontaneous thawing gives worse tissue outcomes than rapid rewarming in 37 to 39°C water. Waiting 24 hours or for surgery wastes the window for iloprost or thrombolysis.

*Key feature:* Environmental 3. Rewarm hypothermic patients effectively, track core temperature with a reliable probe, and keep resuscitating until warm.

*Source:* McIntosh SE, Freer L, Grissom CK, and colleagues. Wilderness Medical Society clinical practice guidelines for the prevention and treatment of frostbite. 2024 update. Wilderness Environ Med. 2024. https://pubmed.ncbi.nlm.nih.gov/38577729/
...
**Which of the following is the most appropriate treatment to improve tissue survival in his feet?**

- A. Alteplase IV with heparin
- B. Early amputation of the toes
- C. Heparin infusion alone
- D. Iloprost IV infusion  **(key)**
- E. Topical nitroglycerin paste

*Explanation:* Deep frostbite with no capillary refill after thawing needs a systemic treatment to restore perfusion. His acute subdural hematoma contraindicates alteplase and heparin. Iloprost is a vasodilator with a much lower bleeding risk and is recommended for deep frostbite within 72 hours. A Yukon protocol using it salvaged about 80% of affected digits. Amputation is delayed for weeks until the tissue demarcates. Heparin alone and topical nitroglycerin lack evidence.

*Key feature:* Environmental 3. Rewarm hypothermic patients effectively, track core temperature with a reliable probe, and keep resuscitating until warm.

*Source:* Poole A, Gauthier J, MacLennan M. Management of severe frostbite with iloprost, alteplase and heparin: a Yukon case series. CMAJ Open. 2021. https://pubmed.ncbi.nlm.nih.gov/34021017/

### environmental-24: A toddler found in a neighbour's yard
...
#### Q1
**Which of the following is the most appropriate treatment for his capillary glucose of 2.4 mmol/L?**

- A. dextrose 10% 60 mL IV  **(key)**
- B. glucagon 0.5 mg IM
- C. oral glucose gel 15 g
- D. warm apple juice 120 mL PO
- E. No treatment until rewarmed

*Explanation:* Hypoglycemia in a drowsy hypothermic child needs IV dextrose now, and 5 mL/kg of dextrose 10% is 60 mL at 12 kg, which gives 6 g. IM glucagon is absorbed poorly from cold, vasoconstricted muscle and needs glycogen stores that cold exposure depletes. Oral gel or juice risks aspiration while he is drowsy. Waiting until he is rewarmed leaves the brain without fuel.
...
#### Q3
**Which of the following new findings would most clearly require transfer to a centre able to provide ECLS?**

- A. Blood glucose of 3.1 mmol/L
- B. Core temperature of 32.4°C
- C. Pulse of 72/minute
- D. Red, swollen fingers
- E. Ventricular tachycardia  **(key)**

*Explanation:* Ventricular arrhythmia in a hypothermic patient signals a high risk of cardiac arrest and is one of the criteria for transfer to an ECLS centre, along with arrest, a core temperature below 30°C and, in adults, a systolic BP below 90 mmHg. A core temperature of 32.4°C shows he is rewarming. A pulse of 72/minute is expected sinus bradycardia at this temperature. Mild hypoglycemia is treated with dextrose. Red, swollen fingers are superficial cold injury.

*Key feature:* Environmental 3. Rewarm hypothermic patients effectively, track core temperature with a reliable probe, and keep resuscitating until warm.

*Source:* Paal P, Pasquier M, Darocha T, and colleagues. Accidental hypothermia: 2021 update. Int J Environ Res Public Health. 2022. https://pubmed.ncbi.nlm.nih.gov/35010760/

### environmental-25: Through the ice on a March afternoon
...
#### Q2
**Which of the following is the most appropriate plan for his cough and hypoxemia?**

- A. Discharge once he is rewarmed
- B. Empiric antibiotics for aspiration
- C. Furosemide for pulmonary edema
- D. Oxygen and admission for observation  **(key)**
- E. Steroids to limit lung injury

*Explanation:* Coughing, bilateral crackles and an SpO2 of 91% after aspirating water mean a symptomatic drowning, and lung injury can worsen over the next hours. He needs oxygen and admission for observation. Discharge is only for drowning patients who stay symptom free for several hours. Prophylactic antibiotics and corticosteroids are not recommended. The pulmonary edema of drowning is from lung injury, not fluid overload, so furosemide does not help.

*Key feature:* Environmental 3. Rewarm hypothermic patients effectively, track core temperature with a reliable probe, and keep resuscitating until warm.

*Source:* Davis CA, Schmidt AC, Sempsrott JR, and colleagues. Wilderness Medical Society clinical practice guidelines for the treatment and prevention of drowning. 2024 update. Wilderness Environ Med. 2024. https://pubmed.ncbi.nlm.nih.gov/38379489/
...
**Which of the following most likely caused the companion to lose his pulse during the rescue?**

- A. Cold shock hyperventilation
- B. Hypotension on vertical extraction  **(key)**
- C. Myocardial infarction on exertion
- D. Pulmonary embolism from immobility
- E. Sudden release of potassium

*Explanation:* Collapse during extrication, called rescue collapse, is most often caused by hypovolemia and by movement that triggers arrhythmia in a cold heart. Lifting him upright removed the water pressure that had supported his venous return, so rescuers lift hypothermic patients horizontally. Cold shock hyperventilation occurs in the first minutes of immersion, not at 45 minutes. Infarction and embolism are possible but far less likely in this sequence. Hyperkalemia follows cell death, not extraction.

*Key feature:* Environmental 3. Rewarm hypothermic patients effectively, track core temperature with a reliable probe, and keep resuscitating until warm.

*Source:* Paal P, Pasquier M, Darocha T, and colleagues. Accidental hypothermia: 2021 update. Int J Environ Res Public Health. 2022. https://pubmed.ncbi.nlm.nih.gov/35010760/

### environmental-26: Three days without power
...
- Temperature: 32.8°C rectal
- Pulse: 58/minute irregular
- Resp.: 14/minute
- BP: 102/58 mmHg
- O2 sat: 95% on room air
- Weight: 58 kg
...
#### Q2
**Which of the following is the most effective rewarming method to add during CPR in this hospital?**

- A. Bladder irrigation with warmed saline
- B. Heat packs to the hands and feet
- C. Humidified oxygen at 40°C alone
- D. IV fluids at 40°C as the sole method
- E. Warmed peritoneal lavage via catheter  **(key)**

*Explanation:* Peritoneal lavage with warmed fluid is an internal rewarming method that a general hospital can provide during CPR, and guidelines list it with forced air and heating blankets for non-ECLS rewarming. Bladder irrigation adds less than 0.5°C per hour because of its small surface area. Warmed IV fluids and humidified oxygen prevent further heat loss but do not rewarm on their own. Heat to the hands and feet does little for the core and may cause burns on cold skin.
...
**Which of the following intermittent CPR patterns is acceptable until continuous compressions can resume?**

- A. 2 minutes on, up to 2 minutes off
- B. 5 minutes on, up to 5 minutes off
- C. 5 minutes on, up to 10 minutes off  **(key)**
- D. 5 minutes on, up to 20 minutes off
- E. 10 minutes on, up to 30 minutes off

*Explanation:* When continuous CPR is impossible in severe hypothermic arrest, the ERC based algorithm allows alternating at least 5 minutes of CPR with pauses. Below 20°C, as here at 19.8°C, pauses of up to 10 minutes are acceptable. Between 20 and 28°C pauses are limited to 5 minutes. Longer pauses and cycles of 2 minutes are not part of the algorithm. Continuous compressions should resume as soon as staff or a device allow.

*Key feature:* Environmental 3. Rewarm hypothermic patients effectively, track core temperature with a reliable probe, and keep resuscitating until warm.

*Source:* Paal P, Pasquier M, Darocha T, and colleagues. Accidental hypothermia: 2021 update. Int J Environ Res Public Health. 2022. https://pubmed.ncbi.nlm.nih.gov/35010760/

### environmental-28: A drive over the pass after two lake dives
...
#### Q1
**Which of the following of her findings classifies her decompression sickness as serious rather than mild?**

- A. Aching left elbow
- B. Errors on serial sevens  **(key)**
- C. Fatigue and malaise
- D. Itchy red skin over the trunk
- E. Onset during the drive home
...
*Key feature:* Environmental 4. Consider decompression illness in divers with pain or unexplained symptoms, and refer for hyperbaric oxygen when indicated.

*Source:* Mitchell SJ, Bennett MH, Moon RE. Decompression sickness and arterial gas embolism. N Engl J Med. 2022. https://pubmed.ncbi.nlm.nih.gov/35353963/

#### Q2
**Which of the following most likely brought on her symptoms after two otherwise uneventful dives?**

- A. Driving over a high mountain pass  **(key)**
- B. Eating lunch between the dives
- C. Freshwater rather than sea diving
- D. Two cups of coffee at lunch
- E. Wearing a drysuit on both dives

*Explanation:* Going to altitude soon after diving lowers the ambient pressure, so nitrogen still dissolved in her tissues comes out of solution and bubbles grow. The drive to 1774 m began only 90 minutes after two dives, one of them to 27 m, and her symptoms began on the way. Late onset of decompression sickness is well described after post-dive altitude exposure. Food, coffee, fresh water and a drysuit do not explain the timing.
...
**Which of the following is the most appropriate next step now that her symptoms have resolved?**

- A. Cancel the hyperbaric transfer
- B. Continue oxygen here overnight only
- C. Discharge with advice to return
- D. Observe 6 hours, then discharge
- E. Proceed with transfer for recompression  **(key)**

*Explanation:* The UHMS advises recompression even when signs and symptoms resolve before treatment, because cerebral decompression sickness can recur and surface oxygen is first aid, not definitive care. Her cerebral findings make this serious disease, so the transfer should go ahead with oxygen continued. Surface oxygen alone is considered only for mild, stable symptoms with a normal neurological examination when evacuation is not feasible. Discharge or local observation leaves a serious case without recompression.

*Key feature:* Environmental 4. Consider decompression illness in divers with pain or unexplained symptoms, and refer for hyperbaric oxygen when indicated.

*Source:* Undersea and Hyperbaric Medical Society. UHMS best practice guidelines: prevention and treatment of decompression sickness and arterial gas embolism. 2011. https://www.uhms.org/images/DCS-AGE-Committee/dcsandage_prevandmgt_uhms-fi.pdf

### environmental-29: A shoulder ache after a holiday flight
...
#### Q3
**Which of the following is the most important advice to reduce the chance his symptoms return?**

- A. Avoid alcohol and all fish for months  **(key)**
- B. Hyperbaric oxygen if tingling returns
- C. Only avoid reef fish such as barracuda
- D. Return to his usual diet once he is well
- E. Take loperamide if diarrhea recurs

*Explanation:* Symptoms of ciguatera often recur in the weeks or months after poisoning when patients drink alcohol or eat any fish, including freshwater species. The review advises avoiding alcohol, caffeine, nuts, pork, chicken and all fish for 3 to 6 months or until symptom free. Avoiding only reef fish is not enough. Hyperbaric oxygen does not treat a toxin. Loperamide does not prevent the neurological relapse.

*Key feature:* Environmental 4. Consider decompression illness in divers with pain or unexplained symptoms, and refer for hyperbaric oxygen when indicated.

*Source:* Friedman MA, Fernandez M, Backer LC, and colleagues. An updated review of ciguatera fish poisoning: clinical, epidemiological, environmental, and public health management. Mar Drugs. 2017. https://pubmed.ncbi.nlm.nih.gov/28335428/

### environmental-31: A spearfisher with a weak hand
...
**Which of the following is the most appropriate assessment before he returns to diving?**

- A. Bubble contrast echo for PFO  **(key)**
- B. Chest CT for lung bullae
- C. Lung function testing only
- D. Resume diving in 1 week
- E. No restriction once he is well

*Explanation:* A patent foramen ovale lets venous bubbles reach the arterial circulation and is an individual risk factor for decompression sickness in breath-hold divers, especially the cerebral form he had. A bubble contrast echocardiogram looks for it and guides advice with a diving physician. Chest CT and lung function address barotrauma, which he did not have. Resuming within a week, or without restriction, ignores a serious neurological event.

*Key feature:* Environmental 4. Consider decompression illness in divers with pain or unexplained symptoms, and refer for hyperbaric oxygen when indicated.

*Source:* Schipke JD, Limper U, Tetzlaff K. Breath-hold diving and decompression sickness. Am J Med. 2026. https://pubmed.ncbi.nlm.nih.gov/41397651/

### environmental-32: A facial droop after a shore dive
...
#### Q3
**Which of the following findings would most strongly suggest a diagnosis other than facial baroparesis?**

- A. Blood behind the eardrum
- B. Ear fullness on ascent
- C. Forehead weakness
- D. Taste change on the tongue
- E. Weakness of the right arm  **(key)**

*Explanation:* Weakness of an arm points to a lesion in the brain, which after a dive suggests arterial gas embolism, and it needs urgent discussion about recompression. The facial nerve carries taste fibres from the front of the tongue through the chorda tympani, so a taste change fits baroparesis. Blood behind the eardrum and fullness on ascent show middle ear barotrauma. Forehead weakness supports a peripheral nerve lesion.

*Key feature:* Environmental 4. Consider decompression illness in divers with pain or unexplained symptoms, and refer for hyperbaric oxygen when indicated.

*Source:* Mitchell SJ, Bennett MH, Moon RE. Decompression sickness and arterial gas embolism. N Engl J Med. 2022. https://pubmed.ncbi.nlm.nih.gov/35353963/

### environmental-33: Brought in by police after an arrest
...
#### Q1
**Which of the following is the most important immediate treatment for him?**

- A. Acetaminophen 1 g PO
- B. Haloperidol 5 mg IM alone
- C. Midazolam IV and active cooling  **(key)**
- D. Physical restraint, prone position
- E. Troponin and 24 hour monitoring

*Explanation:* A temperature of 40.4°C with agitation and tachycardia after methamphetamine is sympathomimetic hyperthermia, which can progress to rhabdomyolysis, coagulopathy and arrest. A benzodiazepine calms him and reduces heat production, and active cooling brings his temperature down. Prone restraint raises the risk of sudden death and struggling adds heat. Haloperidol alone does not control sympathetic drive. Acetaminophen does not treat drug induced hyperthermia.

*Key feature:* Environmental 2. Cool severe hyperthermia rapidly with several methods before confirming the cause, while considering NMS, overdose, endocrine, or infection.

*Source:* Walls RM, Hockberger RS, Gausche-Hill M, Erickson TB, Wilcox SR, editors. Rosen's Emergency Medicine: Concepts and Clinical Practice. 10th ed. Elsevier. 2023. Chapter 144, Cocaine and Other Sympathomimetics. https://www.us.elsevierhealth.com/rosens-emergency-medicine-concepts-and-clinical-practice-9780323757898.html

#### Q2
**Which of the following is the most appropriate management of the probe below his eyebrow?**

- A. Leave in place for ophthalmology  **(key)**
- B. Pull out with a sharp tug
- C. Push through and cut the barb
- D. Remove after a skin incision
- E. Twist out under local anesthetic

*Explanation:* Probes in the skin of most areas can be removed with a quick pull, but a probe near the eye may have penetrated the globe or orbit. It is left in place, and the eye is assessed by ophthalmology before removal. Pulling, twisting or pushing it through risks further injury to the eye if it has entered the orbit. Cutting down on it blindly near the eye carries the same risk. The probe in his back can be removed in the usual way.
...
*Source:* Vilke G, Chan T, Bozeman WP, Childers R. Emergency department evaluation after conducted energy weapon use: review of the literature for the clinician. J Emerg Med. 2019. https://pubmed.ncbi.nlm.nih.gov/31500994/

#### Q3
**Which of the following investigations is most indicated for injuries related to his arrest?**

- A. CT head without contrast  **(key)**
- B. Echocardiogram for cardiac injury
- C. Serial troponins over 6 hours
- D. Telemetry for 24 hours
- E. Urine drug screen

*Explanation:* He fell face first onto pavement, has a scalp hematoma and does not remember the fall, so he needs CT of the head. Intoxication and agitation make his examination unreliable. Studies of discharges up to 15 seconds have found no dangerous cardiac or laboratory effects, so the weapon itself does not call for troponins, echocardiography or prolonged telemetry. A urine drug screen does not change management when he has already disclosed methamphetamine use.

*Key feature:* Environmental 5. After electrical injury, look for hidden internal and cardiac damage and associated trauma, and monitor until risk has passed.

*Source:* Vilke G, Chan T, Bozeman WP, Childers R. Emergency department evaluation after conducted energy weapon use: review of the literature for the clinician. J Emerg Med. 2019. https://pubmed.ncbi.nlm.nih.gov/31500994/

### environmental-34: A fall onto the subway tracks
...
#### Q1
**Which of the following best explains why he did not stay stuck to the rail after contact?**

- A. Current passing through the brainstem
- B. Direct current without tetany  **(key)**
- C. Low skin resistance from wet hands
...
- B. Continuous cardiac monitoring  **(key)**
- C. Creatine kinase level  **(key)**
- D. CT head without contrast  **(key)**
- E. CT of the cervical spine  **(key)**
- F. Nerve conduction studies
- G. Serum lipase level
...
- A. Discharge after a normal troponin
- B. Discharge home with a Holter monitor
- C. Observe 4 hours, then discharge
...
#### Q3
**Which of the following is the most useful test for myocardial injury in this patient?**

- A. B-type natriuretic peptide
- B. CK-MB fraction
- C. Myoglobin level
- D. Total CK level
- E. Troponin I or T  **(key)**

*Explanation:* Electrical injury damages skeletal muscle, which releases CK, myoglobin and the CK-MB fraction, so these can rise without any myocardial injury. Cardiac troponin is specific to the myocardium and is the preferred marker after electrical injury. BNP reflects cardiac wall stress and does not identify myocardial injury from current.

*Key feature:* Environmental 5. After electrical injury, look for hidden internal and cardiac damage and associated trauma, and monitor until risk has passed.

*Source:* Waldmann V, Narayanan K, Combes N, Jost D, Jouven X, Marijon E. Electrical cardiac injuries: current concepts and management. Eur Heart J. 2018. https://pubmed.ncbi.nlm.nih.gov/28444167/

### environmental-36: A boy who climbed a tree in the park
...
- A. Burn shock from fluid loss
- B. Hemorrhage from the fall  **(key)**
- C. Myocardial injury from current
- D. Neurogenic shock from spinal injury
- E. Third spacing from rhabdomyolysis

*Explanation:* A systolic BP of 88 mmHg with a pulse of 136/minute soon after a 4 m fall, with left upper quadrant tenderness and guarding, points to hemorrhage, most likely from the spleen. Burn shock develops over hours, so early hypotension in a burned patient means another cause must be found. Third spacing from rhabdomyolysis is also a later process. Neurogenic shock causes bradycardia, not tachycardia. Myocardial injury is possible but less likely than bleeding in this picture.

*Key feature:* Environmental 5. After electrical injury, look for hidden internal and cardiac damage and associated trauma, and monitor until risk has passed.

*Source:* Walls RM, Hockberger RS, Gausche-Hill M, Erickson TB, Wilcox SR, editors. Rosen's Emergency Medicine: Concepts and Clinical Practice. 10th ed. Elsevier. 2023. Chapter 54, Thermal Injuries. https://www.us.elsevierhealth.com/rosens-emergency-medicine-concepts-and-clinical-practice-9780323757898.html

#### Q2
**Which of the following is the most appropriate next step in his assessment?**

- A. Burn dressings before any imaging
- B. Echocardiogram for myocardial injury
- C. Escharotomy of the chest wall
- D. FAST examination at the bedside  **(key)**
- E. Parkland fluids, reassess in 1 hour

*Explanation:* A bedside FAST examination quickly looks for intraperitoneal blood in a hypotensive trauma patient and guides the decision for surgery. Dressing the burns can wait until life threats are addressed. His burns are on the front of the chest only, not circumferential, and his saturation is 97% on room air, so escharotomy is not needed. Burn formula fluids treat burn shock, not hemorrhage. Echocardiography does not address the more likely source of his shock.

*Key feature:* Environmental 5. After electrical injury, look for hidden internal and cardiac damage and associated trauma, and monitor until risk has passed.

*Source:* Walls RM, Hockberger RS, Gausche-Hill M, Erickson TB, Wilcox SR, editors. Rosen's Emergency Medicine: Concepts and Clinical Practice. 10th ed. Elsevier. 2023. Chapter 38, Abdominal Trauma. https://www.us.elsevierhealth.com/rosens-emergency-medicine-concepts-and-clinical-practice-9780323757898.html

#### Q3
**Which of the following features of his case are criteria for burn centre consultation or referral?**

Select 4.

- A. Age 14 years or younger  **(key)**
- B. Associated traumatic injury  **(key)**
- C. Burns to the chest wall
- D. High voltage mechanism  **(key)**
- E. Normal level of alertness
- F. Partial thickness burns of 12%  **(key)**
- G. Sinus tachycardia on ECG

*Explanation:* The American Burn Association lists all high voltage injuries of 1000 volts or more, partial thickness burns of 10% or more and burns with associated trauma as triggers for immediate consultation. All burns in children aged 14 years or younger, or under 30 kg, are also on the list. The chest wall is not one of the listed critical areas, which are the face, hands, feet, genitalia, perineum and major joints. Sinus tachycardia and his level of alertness are not referral criteria.

*Key feature:* Environmental 5. After electrical injury, look for hidden internal and cardiac damage and associated trauma, and monitor until risk has passed.

*Source:* American Burn Association. Guidelines for burn patient referral. 2025. https://ameriburn.org/resources/burnreferral/

#### Q4
**Which of the following is the most appropriate cardiac evaluation for him?**

- A. CK-MB every 8 hours
- B. ECG and continuous monitoring  **(key)**
- C. Holter monitor after discharge
- D. Troponin alone at 6 hours
- E. No cardiac tests if he is alert
...
### environmental-37: A storm on a Kananaskis trail
...
#### Q1
**Which of the following is the most appropriate management of the pattern on her shoulder and chest?**

- A. Cool running water for 20 minutes
- B. Reassurance without treatment  **(key)**
- C. Silver sulfadiazine dressings
- D. Tetanus booster for the wound
- E. Topical corticosteroid cream

*Explanation:* A branching, fern-like pattern on intact skin after a lightning strike is a Lichtenberg figure, which is not a burn and fades within hours to a day. The pattern itself needs no treatment. Cool running water and silver sulfadiazine are for true burns, and she has no burned or broken skin. A tetanus booster is not needed for intact skin. Corticosteroid cream does not change its course.

*Key feature:* Environmental 5. After electrical injury, look for hidden internal and cardiac damage and associated trauma, and monitor until risk has passed.

*Source:* Davis C, Engeln A, Johnson EL, and colleagues. Wilderness Medical Society practice guidelines for the prevention and treatment of lightning injuries. 2014 update. Wilderness Environ Med. 2014. https://pubmed.ncbi.nlm.nih.gov/25498265/
...
#### Q3
**Which of the following is the most appropriate investigation for her back pain?**

- A. Analgesia and discharge home
- B. CT of the thoracic spine  **(key)**
- C. MRI of the brain
- D. Plain chest radiograph only
- E. Spine radiographs in 1 week

*Explanation:* She was thrown 3 m and has midline tenderness at T7 and T8, so a thoracic spine fracture must be excluded, and CT is the most sensitive rapid test. Lightning victims are often thrown or fall, and their blunt injuries are easy to miss among the more striking electrical findings. A chest radiograph does not show the spine well. Delayed radiographs or discharge risk missing an unstable fracture. Brain MRI does not address the back.

*Key feature:* Environmental 5. After electrical injury, look for hidden internal and cardiac damage and associated trauma, and monitor until risk has passed.

*Source:* Beckmann NM, West OC, Nunez D Jr, and colleagues. ACR Appropriateness Criteria suspected spine trauma. American College of Radiology. J Am Coll Radiol. 2019. doi:10.1016/j.jacr.2019.02.002 https://pubmed.ncbi.nlm.nih.gov/31054754/

### environmental-38: Confusion in a hot apartment
...
#### Q1
**Which of the following is the most appropriate way to lower his temperature now?**

- A. Acetaminophen 1 g PR, then reassess
- B. Cooling after the cause is confirmed
- C. Fans, mist, ice packs, cold IV fluid  **(key)**
- D. Single cooling blanket under his back
- E. Tepid sponging every 30 minutes

*Explanation:* A rectal temperature of 40.8°C with confusion is cooled at once, before the cause is confirmed, and of these options only the combination of evaporative and conductive methods cools quickly. Mist with fans adds evaporation, ice packs to the neck, axillae and groin add conduction, and cold IV fluid also treats his BP of 92/54 mmHg. He sweats only on his face and neck, so he depends on external cooling. Acetaminophen does not lower heat from muscle activity and a hot room, where the set point is normal. Waiting for a diagnosis, a single blanket or intermittent sponging keeps him above 40°C for longer.
...
#### Q2
**Which of the following findings most strongly suggests a cause other than environmental heat?**

- A. Confusion and agitation
- B. Dry skin below the neck
- C. Indoor temperature of 31°C
- D. Itching and stronger spasms  **(key)**
- E. Pulse of 132/minute

*Explanation:* Itching and a return of spasticity beyond his baseline are early signs of intrathecal baclofen withdrawal, which can progress to high fever, altered mental status, rigidity, rhabdomyolysis, multiple organ failure and death. Heat exposure does not explain them. Confusion and a pulse of 132/minute occur in heat stroke, in baclofen withdrawal and in sepsis, so they do not separate the causes. Absent sweating below his cervical cord injury is expected and adds to his heat risk. An indoor temperature of 31°C explains heat stress but not his itching or spasms.

*Key feature:* Environmental 2. Cool severe hyperthermia rapidly with several methods before confirming the cause, while considering NMS, overdose, endocrine, or infection.

*Source:* Novartis Pharmaceuticals Canada Inc. Lioresal Intrathecal (baclofen injection) product monograph. Revised 2020. https://pdf.hres.ca/dpd_pm/00056262.PDF

#### Q3
*Update:* Cooling is under way and his rectal temperature is 39.8°C. His BP is 96/58 mmHg after 1 L of cold normal saline.

**Which of the following investigations are most appropriate now to look for another cause of his fever?**
...
**Which of the following is the most appropriate specific treatment for his condition?**

- A. Bromocriptine 2.5 mg by NG tube
- B. Intrathecal baclofen restored now  **(key)**
- C. Oral baclofen as the only treatment
- D. Propranolol 1 mg IV for tachycardia
- E. Pump removal in the operating room
