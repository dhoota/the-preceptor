...
export const ethicsCommunication: OralCase = {
  ...
  findings: [
    ...
    },
    {
      ...
      result:
        "Apixaban 2.5 mg twice daily for atrial fibrillation. Last dose given at 20:00 last night. Also ramipril 5 mg daily, atorvastatin 20 mg daily, and vitamin D. No allergies.",
    },
    {
      id: "history",
  ...
  nodes: [
    ...
    },
    {
      ...
      modelAnswer: [
        ...
        "Notify Ontario Health (Trillium Gift of Life Network) as required by the Gift of Life Act.",
      ],
      rubric: ["ec-p1", "ec-p4"],
      next: "end",
    },
  ...
  rubric: [
    ...
    },
    {
      ...
      points: 3,
      critical: true,
      teaching: "Ontario order: guardian, attorney for personal care, board appointed representative, spouse or partner, then a child or parent at the same rank, a parent with access rights only, a brother or sister, and any other relative. The Public Guardian and Trustee is the last resort.",
      source: "hcca",
    },
    {
      id: "ec-s3",
  ...
  sources: [
    { id: "hcca", citation: "Health Care Consent Act, 1996, S.O. 1996, c. 2, Sched. A. Ontario.", url: "https://www.ontario.ca/laws/statute/96h02" },
    { id: "apology-act", citation: "Apology Act, 2009, S.O. 2009, c. 3. Ontario.", url: "https://www.ontario.ca/laws/statute/09a03" },
    {
      id: "cpso",
      citation: "College of Physicians and Surgeons of Ontario. Disclosure of Harm policy, updated 2019, and Decision Making for End of Life Care policy, updated 2023.",
      url: "https://www.cpso.on.ca/en/physicians/policies-guidance/policies/disclosure-of-harm",
    },
    {
      id: "cmpa",
    ...
    {
      id: "hsf-stroke",
      citation: "Heart and Stroke Foundation. Canadian Stroke Best Practice Recommendations. Management of spontaneous intracerebral hemorrhage. 7th edition, 2020 update.",
      url: "https://www.strokebestpractices.ca/recommendations/management-of-intracerebral-hemorrhage/emergency-management-of-intracerebral-hemorrhage",
    },
    {
      id: "tgln",
      citation: "Gift of Life Act, R.S.O. 1990, c. H.20. Ontario. Formerly the Trillium Gift of Life Network Act. Notice to Ontario Health (Trillium Gift of Life Network).",
