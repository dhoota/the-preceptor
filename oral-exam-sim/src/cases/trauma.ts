...
export const trauma: OralCase = {
  ...
  nodes: [
    ...
    },
    {
      ...
      rubric: ["tr-p2"],
      choices: [
        { id: "c-tube", label: "I did a finger thoracostomy and placed a left chest tube.", next: "q-blood", quality: "strong" },
        { id: "c-xray-first", label: "I waited for a chest X ray to confirm it first.", next: "s-xray-wait", quality: "partial" },
      ],
    },
    {
      kind: "say",
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "c-saline", label: "I gave two more litres of warmed normal saline first.", next: "s-crystalloid", quality: "unsafe" },
      ],
    },
    {
      kind: "say",
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "c-crests", label: "I placed the binder at the level of the iliac crests.", next: "s-binder", quality: "partial" },
        { id: "c-hold-txa", label: "I held tranexamic acid until CT confirmed where he was bleeding.", next: "s-txa-delay", quality: "unsafe" },
      ],
    },
    {
      kind: "say",
    ...
    },
    {
      ...
      choices: [
        { id: "c-no-ct", label: "I declined the CT and kept him in resus while I called the trauma centre.", next: "q-labs", quality: "strong" },
        { id: "c-send-ct", label: "I sent him to CT with a nurse.", next: "s-ct-crash", quality: "unsafe" },
      ],
    },
    {
      kind: "say",
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "c-propofol", label: "I kept my systolic target at 80 and intubated with propofol.", next: "s-propofol", quality: "unsafe" },
      ],
    },
    {
      kind: "say",
  ...
  domains: [
    { id: "primary", name: "Primary survey and resuscitation" },
    { id: "hemorrhage", name: "Hemorrhage control and transfusion" },
    { id: "decisions", name: "Diagnosis and decision making" },
    { id: "comm", name: "Communication and collaboration" },
    { id: "tbi", name: "Airway and head injury" },
  ],
  rubric: [
    {
      id: "tr-p1",
