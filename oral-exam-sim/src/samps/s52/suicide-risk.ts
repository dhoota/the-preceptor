...
const S = {
  ...
  dart: { id: "apap-consensus", citation: "Dart RC, Mullins ME, Matoushek T, and colleagues. Management of acetaminophen poisoning in the US and Canada: a consensus statement. JAMA Netw Open. 2023.", url: "https://pubmed.ncbi.nlm.nih.gov/37552484/" },
...
export const SUICIDE_RISK_S52: Samp[] = [
  ...
  /* 28 Unknown tablets, medical workup ------------------------------------- */
  {
    ...
    questions: [
      {
        id: "q1",
        kind: "single",
        prompt: "Which of the following investigations should be obtained for her now, whatever she reports taking?",
        options: ["Acetaminophen concentration", "Comprehensive urine drug screen", "CT head without contrast", "Serum lithium concentration", "Serum osmolality"],
        correct: 0,
        explanation:
          "Acetaminophen is in most homes, early poisoning causes few symptoms and acetylcysteine works best when started early, so a concentration is measured after every intentional ingestion. A comprehensive urine screen rarely changes emergency management and cannot confirm timing or dose. CT of the head is not needed in an alert patient with no trauma or focal findings. A lithium level and serum osmolality are ordered when the history or findings point to lithium or a toxic alcohol.",
    ...
    sources: [S.dart, S.appelbaum, S.acep],
    ...META,
  },
  ...
  /* 31 Wrist wound in an older man ----------------------------------------- */
  {
    ...
    topic: "suicide-risk",
    alsoTopics: ["lacerations"],
    title: "A broken pane in the shed",
    stem:
      "You are working in a rural hospital emergency department. An 81-year-old man presents with a laceration to his left wrist. He says he fell against a broken window pane in his shed yesterday evening. He lives alone on an acreage 40 km from town. He has type 2 diabetes, macular degeneration and hypertension, and takes metformin and amlodipine. The wound is on the front of the wrist and has been wrapped in a tea towel. Tendons, nerves and circulation are intact. He is polite, quiet and keen to get home to his dog.",
    vitals: { temperature: "36.5°C oral", pulse: "78/minute", resp: "16/minute", bp: "152/84 mmHg", o2sat: "97% on room air" },
    questions: [
      {
        id: "q1",
        kind: "single",
        prompt: "Which of the following findings on examining the wound would most suggest that it was self-inflicted?",
        options: ["Abrasions on both palms", "Bruise on the left hip", "Parallel cuts across the wrist", "Presented 1 day after the injury", "Wound contains glass fragments"],
        correct: 2,
        explanation:
          "Several parallel cuts across the front of the wrist fit deliberate, repeated cutting rather than a single impact with glass. Abrasions on both palms and a bruised hip fit a fall. Glass in the wound fits his account. A delay of a day is common in older adults who live alone and does not by itself point to self-harm. In older men, an injury explained as an accident can conceal a suicide attempt, so the wound pattern must be checked against the story.",
        keyFeature: { topic: "suicide-risk", n: 2 },
        source: "ccsmh",
      },
      {
        id: "q2",
        kind: "single",
        update: "He admits he cut himself. His wife died last year, and 2 months ago he lost his driver's licence because of his eyesight. He drinks 4 glasses of rye each night.",
        prompt: "Which of the following statements about suicidal behaviour in older adults is most accurate?",
        options: ["Depression is a normal part of aging", "Few see a physician in the prior month", "Lethality of attempts is higher", "Rates are lowest in older men", "Self-neglect rarely reflects suicidal wishes"],
        correct: 2,
        explanation:
          "Older adults make fewer attempts for each death than younger people, because their attempts are more often planned and lethal, so any attempt must be taken seriously. Depression is common in later life but is not a normal part of aging. Many older adults who die by suicide saw a physician in the weeks before death. Older men have among the highest suicide rates in Canada. Self-neglect and stopping treatment can be indirect expressions of suicidal wishes.",
        keyFeature: { topic: "suicide-risk", n: 1 },
        source: "ccsmh",
      },
      {
        id: "q3",
        kind: "single",
        update: "He says he has not slept well since his wife died. His daughter phones and asks you to give him something to help him sleep.",
        prompt: "Which of the following is the most appropriate response to the request for a sleep medication?",
        options: ["Diphenhydramine 50 mg at bedtime", "Lorazepam 1 mg at bedtime", "Quetiapine 25 mg at bedtime", "Zopiclone 7.5 mg at bedtime", "No sedative prescription tonight"],
        correct: 4,
        explanation:
          "A sedative gives an older man who has just harmed himself, and who drinks nightly, a new means of overdose, and it adds falls and confusion. His insomnia is best treated through his depression and alcohol use. Lorazepam and zopiclone combine dangerously with alcohol. Diphenhydramine is strongly anticholinergic and causes delirium in older adults. Low dose quetiapine has metabolic and fall risks and no role as a sleep aid here.",
        keyFeature: { topic: "suicide-risk", n: 5 },
        source: "ccsmh",
      },
      {
        ...
        kind: "single",
        prompt: "Which of the following is the most appropriate disposition for him from the emergency department?",
        options: ["Discharge home with a phone check tomorrow", "Home care nursing for wound checks", "Outpatient geriatric psychiatry referral", "Psychiatric admission for assessment", "Wound check with his family doctor"],
        correct: 3,
        explanation:
          "A self-inflicted wound that he first concealed, in a recently widowed older man who lives alone, drinks nightly and has lost his independence, places him at high risk. He needs admission for psychiatric assessment rather than discharge. A phone check tomorrow, home nursing, an outpatient referral and a wound review all send him back to the same isolation and means before his depression has been assessed or treated.",
        keyFeature: { topic: "suicide-risk", n: 4 },
        source: "ccsmh",
      },
    ],
  ...
  /* 33 Laid off and ready to go home --------------------------------------- */
  {
    id: "suicide-risk-33",
    topic: "suicide-risk",
    title: "What he said at the bar",
    stem:
      "A 36-year-old man is brought to an Ontario emergency department by a friend at 20:00. He was laid off from his warehouse job today. At a bar he told his friend he might as well be dead. On assessment 3 hours later he is sober, calm and embarrassed. He says he has no wish to die, no plan and no past attempts. He has no psychiatric history, sleeps well and coaches his daughter's soccer team. He shares custody of his daughter and has savings. There are no firearms in his home. He wants to go home and says he will look for work tomorrow.",
  ...
  /* 34 Second overdose this year ------------------------------------------- */
  {
    ...
    questions: [
      ...
      },
      {
        id: "q3",
        kind: "single",
        prompt: "Which of the following is most likely to help her attend outpatient care this time?",
        options: ["Advice to see her family doctor", "Clinic phone number to call", "Follow-up calls until she attends", "Leaflet with clinic addresses", "Referral faxed to the clinic"],
        correct: 2,
        explanation:
    ...
    sources: [S.owens, S.motto, S.stanley18],
    ...META,
  },
