...
const WMS: Source = {
  id: "wms-altitude",
  citation: "Luks AM, Beidleman BA, Freer L, et al. Wilderness Medical Society clinical practice guidelines for the prevention, diagnosis, and treatment of acute altitude illness. 2024 update. Wilderness Environ Med. 2024.",
...
export const PULMONARY_EDEMA_S48_SAMPS: Samp[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        kind: "single",
        update:
          "After 40 minutes on noninvasive ventilation his BP is 158/92 mmHg, his pulse is 98/minute and his saturation is 94%. His daughter says pioglitazone was started 2 months ago, and his ankles have swollen since.",
  ...
  },
  {
    ...
    topic: "pulmonary-edema",
    alsoTopics: ["sob"],
    title: "Night cough that inhalers did not help",
    stem:
    ...
    vitals: { temperature: "37.6°C oral", pulse: "146/minute", resp: "30/minute", bp: "138/64 mmHg", o2sat: "90% on room air", weight: "58 kg" },
    questions: [
      {
        id: "q1",
        kind: "single",
        prompt: "Which of the following findings most strongly suggests that her breathlessness is not from asthma?",
        options: [
          "Cough that wakes her at night",
          "Crackles with a raised JVP",
          "Failure to respond to salbutamol",
          "Oxygen saturation of 90%",
          "Respiratory rate of 30/minute",
        ],
        correct: 1,
        explanation:
          "Crackles to the mid zones with a JVP 6 cm above the sternal angle are signs of congestion, and with orthopnea they point to pulmonary edema rather than asthma. She also has no wheeze. A night cough occurs in both asthma and heart failure, so it does not separate them. Salbutamol can fail in severe asthma or with poor inhaler technique. A saturation of 90% and a respiratory rate of 30/minute show how sick she is but occur with either diagnosis.",
        keyFeature: { topic: "pulmonary-edema", n: 5 },
        source: "eschf",
      },
      {
        id: "q2",
        kind: "single",
        prompt: "Which of the following investigations is most likely to identify the cause of her heart failure?",
        options: [
      ...
      },
      {
        ...
        kind: "single",
        update:
          "TSH is below 0.01 mU/L and free T4 is 64 pmol/L (reference 10 to 22 pmol/L). Hemoglobin is 128 g/L. She is not pregnant. Bedside ultrasound shows a normal sized left ventricle that contracts vigorously, with B lines in both lungs. She receives furosemide 40 mg IV. No antithyroid drug has been given.",
        prompt: "Which of the following is the most appropriate first antithyroid treatment for her?",
        options: [
          "Lugol iodine solution PO now",
          "methimazole 10 mg PO daily",
          "methimazole 20 mg PO every 6 hours",
          "propylthiouracil 50 mg PO daily",
          "radioactive iodine ablation",
        ],
        correct: 2,
        explanation:
          "Her Burch-Wartofsky score is at least 65: a pulse of 140/minute or more scores 25, pulmonary edema 15, atrial fibrillation 10, loose stools 10 and a temperature of 37.6°C scores 5. A score of 45 or more is highly suggestive of thyroid storm, so the ATA advises storm doses of a thionamide, methimazole 60 to 80 mg a day, and methimazole 20 mg every 6 hours gives 80 mg a day. Methimazole 10 mg daily is a dose for mild, uncomplicated hyperthyroidism. Propylthiouracil in storm is loaded at 500 to 1000 mg, so 50 mg daily is far too little. Iodine given before a thionamide can supply substrate for new hormone, so the ATA advises giving it at least an hour after. Radioactive iodine is not an emergency treatment and can briefly worsen thyrotoxicosis.",
        keyFeature: { topic: "pulmonary-edema", n: 3 },
        source: "ata",
      },
      {
        ...
        kind: "single",
        update:
          "Forty minutes later she is more tired. Her respiratory rate is 36/minute and her saturation is 86% on 15 L/minute by non-rebreather mask. She is alert and protecting her airway. Her BP is 128/70 mmHg.",
        prompt: "Which of the following is the most appropriate next step for her breathing?",
        options: [
          "Heliox by face mask",
          "High-dose nebulized salbutamol",
  ...
  },
  {
    ...
    topic: "pulmonary-edema",
    alsoTopics: ["environmental"],
    title: "Breathless after a ski-touring trip",
    stem:
    ...
    vitals: { temperature: "37.9°C oral", pulse: "118/minute", resp: "30/minute", bp: "128/78 mmHg", o2sat: "72% on room air", weight: "82 kg" },
    questions: [
      {
        id: "q1",
        kind: "single",
      ...
      },
      {
        ...
        kind: "single",
        update:
          "He receives oxygen at 15 L/minute by non-rebreather mask. After 30 minutes his saturation is 84%, his respiratory rate is 34/minute and he is tiring. He remains alert, cooperative and able to clear his secretions. His BP is 124/76 mmHg.",
        prompt: "Which of the following is the most appropriate next step for his breathing?",
        options: [
          "CPAP by tight-fitting face mask",
          "Furosemide 40 mg IV",
          "Morphine 2 mg IV",
          "Rapid sequence intubation",
          "Salbutamol 5 mg nebulized",
        ...
        correct: 0,
        explanation:
          "His saturation of 84% on a non-rebreather mask and his rising respiratory rate show that oxygen alone is failing. The WMS guideline supports CPAP as an adjunct to oxygen in hospital, and he is alert, cooperative and clearing secretions, so a mask is safe. Intubation is kept for failure of CPAP or loss of airway protection. The guideline advises against diuretics, because many people with high-altitude pulmonary edema are volume depleted and can become hypotensive. Morphine depresses breathing. He has no wheeze, and salbutamol does not correct his hypoxemia.",
        keyFeature: { topic: "pulmonary-edema", n: 4 },
        source: "wms-altitude",
      },
      {
        ...
        prompt: "Which of the following medications is most appropriate to add for the cause of his pulmonary edema?",
        options: [
          "acetazolamide 250 mg PO",
          "dexamethasone 8 mg IV",
          "furosemide 40 mg IV",
          "nifedipine 30 mg ER PO",
  ...
  },
  {
    ...
    topic: "pulmonary-edema",
    title: "Wheelchair user after a night on CPAP",
    stem:
      "A 68-year-old man is brought to the emergency department by ambulance at 02:00 with shortness of breath that woke him. He had a right below-knee amputation 2 years ago for a diabetic foot infection and uses a manual wheelchair. He has heart failure with preserved ejection fraction, type 2 diabetes and hypertension. He takes furosemide 40 mg daily, empagliflozin, amlodipine and insulin glargine. Yesterday he ate a large salty meal at a family wedding. On arrival his saturation was 86% on room air, with crackles to the mid zones. He improved with 40 minutes of CPAP, nitroglycerin and furosemide 80 mg IV. It is now 08:00. He feels well and wants to go home. His crackles have cleared. His ECG shows sinus rhythm with no ischemic change.",
    vitals: { temperature: "36.7°C oral", pulse: "96/minute", resp: "18/minute", bp: "118/70 mmHg", o2sat: "94% on room air" },
    questions: [
      {
        id: "q1",
        kind: "single",
        prompt: "Which of the following findings at 08:00 argues most against discharging him at this time?",
        options: [
          "Heart rate of 96/minute",
          "Oxygen saturation of 94%",
          "Respiratory rate of 18/minute",
          "Systolic pressure of 118 mmHg",
          "Temperature of 36.7°C",
        ],
        correct: 0,
        explanation:
          "The CAEP checklist lists resting vital signs after treatment that support discharge: saturation above 92%, systolic pressure above 100 mmHg, heart rate below 90/minute and respiratory rate of 20/minute or less. His heart rate of 96/minute is the only value outside these limits, so he is not ready yet. A saturation of 94%, a systolic pressure of 118 mmHg and a respiratory rate of 18/minute all meet the criteria. A temperature of 36.7°C is normal and is not one of the listed criteria.",
        keyFeature: { topic: "pulmonary-edema", n: 6 },
        source: "caep-ahf",
      },
      {
        id: "q2",
        kind: "single",
        prompt: "Which of the following is the most appropriate exertion assessment for him before discharge?",
        options: [
          "Bed rest without an exertion test",
          "Exercise treadmill test today",
          "Observe transfers and wheeling",
          "Six-minute walk test with a walker",
          "Three-minute walk test on crutches",
        ],
        correct: 2,
        explanation:
          "The CAEP checklist asks that a patient walk, or reach his baseline level of mobility, without tachycardia, tachypnea or hypoxia before discharge. He does not walk, so his baseline is his usual transfers and wheeling, watched with oximetry. A fall in saturation below 90%, a heart rate above 110/minute or a respiratory rate above 28/minute would count as a failed test. Walking on crutches or with a walker is not his baseline and could fail for reasons unrelated to his heart. A treadmill test is not possible for him. Skipping exertion testing leaves exertional hypoxia unrecognized.",
        keyFeature: { topic: "pulmonary-edema", n: 6 },
        source: "caep-ahf",
      },
      {
        ...
        kind: "single",
        update:
          "His assessment is now satisfactory. Potassium and creatinine are normal. A personal support worker visits him each morning, and a heart failure clinic appointment is booked in 5 days.",
        prompt: "Which of the following is the most appropriate furosemide plan for him at discharge?",
        options: [
          "furosemide 160 mg PO daily for 5 days",
          "furosemide 80 mg PO daily for 5 to 10 days",
          "furosemide 80 mg PO daily, long term",
          "furosemide 40 mg PO daily, unchanged",
          "No furosemide until the clinic visit",
        ],
        correct: 1,
        explanation:
          "He came in with volume overload, and the CAEP checklist suggests a temporary doubling of the usual diuretic dose for 5 to 10 days. His usual dose is 40 mg daily, so 80 mg daily for 5 to 10 days fits, with electrolytes and creatinine checked within 7 days. Continuing 40 mg daily ignores the overload that brought him in. A permanent doubling goes beyond the temporary increase the checklist advises. A dose of 160 mg is four times his usual dose. Stopping furosemide until the clinic visit leaves the overload untreated.",
        keyFeature: { topic: "pulmonary-edema", n: 6 },
        source: "caep-ahf",
      },
    ],
    sources: [
      {
        id: "caep-ahf",
        citation: "Stiell IG, Almufleh A, Archambault PM, et al. CAEP Acute Heart Failure Best Practices Checklist. CJEM. 2025.",
        url: "https://doi.org/10.1007/s43678-025-00961-y",
      },
    ],
    reviewed: true,
    author: AUTHOR,
  ...
  },
  {
    ...
    topic: "pulmonary-edema",
    title: "Chest cold that will not settle",
    stem:
      "An 82-year-old man is brought to the emergency department by his daughter with 4 days of cough and breathlessness. A walk-in clinic diagnosed a chest cold 3 days ago. Since last night he cannot lie flat. He has hypertension treated with amlodipine and no known heart disease. For several months he has dribbled urine through the day, and this week he has wet the bed at night. He has never been assessed for this. He is anxious and speaks in short sentences. There are crackles at both bases and scattered wheeze. His lower abdomen is full and dull to percussion up to the umbilicus.",
    vitals: { temperature: "37.2°C oral", pulse: "108/minute", resp: "30/minute", bp: "186/98 mmHg", o2sat: "89% on room air" },
    questions: [
      {
        id: "q1",
        kind: "single",
        update: "NT-proBNP is 7 800 pg/mL and the white cell count is 9.8 x 10^9/L.",
        prompt: "Which of the following findings most supports pulmonary edema rather than a chest infection as the cause?",
        options: [
          "Cough for 4 days",
          "NT-proBNP of 7 800 pg/mL",
          "Scattered expiratory wheeze",
          "Temperature of 37.2°C",
          "White cell count of 9.8 x 10^9/L",
        ],
        correct: 1,
        explanation:
          "The CAEP checklist treats an NT-proBNP above 1 800 pg/mL in a patient older than 75 years as making acute heart failure likely, and a value below 300 pg/mL as making it unlikely. His value of 7 800 pg/mL is far above that threshold. Cough and wheeze occur with both edema and infection, so they do not separate the two. A normal white cell count and a temperature of 37.2°C make infection less likely but do not point to a cardiac cause.",
        keyFeature: { topic: "pulmonary-edema", n: 5 },
        source: "caep-ahf",
      },
      {
        id: "q2",
        kind: "single",
        prompt: "Which of the following is the most appropriate immediate drug treatment for his breathlessness?",
        options: [
          "metoprolol 5 mg IV",
          "morphine 2.5 mg IV",
          "nitroglycerin 0.4 mg SL",
          "salbutamol 5 mg by nebulizer",
          "sodium chloride 0.9% 500 mL IV",
        ],
        correct: 2,
        explanation:
          "He has pulmonary edema with a systolic pressure of 186 mmHg, and the CAEP checklist advises nitroglycerin when systolic pressure is 100 mmHg or more, starting with sublingual doses to reduce afterload. It should start now, before the cause is found. The checklist advises against IV morphine because it increases morbidity and mortality. It advises avoiding beta blockers for tachycardia when the ejection fraction is unknown, as it is here. Salbutamol treats bronchospasm, not wheeze from fluid in the airways. A saline bolus adds fluid to lungs that are already flooded.",
        keyFeature: { topic: "pulmonary-edema", n: 1 },
        source: "caep-ahf",
      },
      {
        ...
        kind: "single",
        update:
          "A bedside bladder scan shows 1 350 mL. Creatinine is 386 umol/L, up from 92 umol/L six months ago, and potassium is 5.4 mmol/L.",
        prompt: "Which of the following is the most appropriate treatment for the underlying cause of his pulmonary edema?",
        options: [
          "Hemodialysis through a central catheter",
          "Indwelling urethral catheter now",
          "IV fluids for acute kidney injury",
          "tamsulosin 0.4 mg PO, then reassess",
          "Urology clinic referral this week",
        ],
        correct: 1,
        explanation:
          "A bladder of 1 350 mL with months of dribbling and new bed-wetting is chronic retention, and it has caused kidney failure with fluid overload. NICE advises catheterizing men whose kidney function is impaired by chronic retention, so a urethral catheter now relieves the obstruction. Hemodialysis is not the first step while a reversible obstruction is still in place, and a potassium of 5.4 mmol/L does not force it. IV fluids would add to the pulmonary edema. NICE advises an alpha blocker such as tamsulosin before a catheter placed for acute retention is removed, not as a substitute for draining the bladder. A clinic referral leaves the obstruction untreated.",
        keyFeature: { topic: "pulmonary-edema", n: 3 },
        source: "nice-luts",
      },
    ],
    sources: [
      ...
      {
        id: "nice-luts",
        citation: "National Institute for Health and Care Excellence. Lower urinary tract symptoms in men: management. Clinical guideline CG97. 2010, updated 2015.",
