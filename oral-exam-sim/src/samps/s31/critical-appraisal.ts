  ...
  /* 19 ----------------------------------------------------------------- */
  {
    ...
    questions: [
      ...
      },
      {
        id: "q2",
        kind: "single",
        prompt: "Which of the following describes how the 90 IV patients who switched to oral therapy are handled by intention to treat?",
        options: [
          "Analysed in the IV group",
          "Analysed in the oral group",
          "Counted as treatment failures",
          "Excluded from the analysis",
          "Replaced by new enrolments",
        ],
        correct: 0,
        explanation:
          "Intention to treat analyses every patient in the group to which they were randomized, whatever treatment they then received. So the 90 IV patients who switched to oral therapy stay in the IV group, which keeps the balance that randomization created. Moving them to the oral group analyses them as treated and breaks randomization. Excluding them is what a per-protocol analysis does. A change of route is not the prespecified outcome, which was treatment failure at 14 days. Randomized patients are never replaced by new enrolments.",
        keyFeature: { topic: "critical-appraisal", n: 1 },
        source: "consort-noninferiority",
      },
      {
    ...
    questions: [
      {
        id: "q1",
        kind: "single",
        prompt: "Which of the following questions can this trial's design answer?",
        options: [
          "Benefit of adding the drug to ketorolac",
          "Benefit of the drug in children",
          "Benefit of the drug in place of ketorolac",
          "Benefit of the drug over IV morphine",
          "Effect of the drug on stone passage",
        ],
        correct: 0,
        explanation:
          "Every patient received ketorolac and then the drug or placebo, so the comparison isolates the effect of adding the drug to ketorolac. It cannot show how the drug performs in place of ketorolac, because no one received the drug alone. The trial enrolled adults, so it says nothing about children. No arm received morphine, so it offers no head-to-head comparison with an opioid. The primary outcome was pain at 30 minutes, which cannot tell you whether stones pass over the following days or weeks.",
        keyFeature: { topic: "critical-appraisal", n: 1 },
        source: "users-guides",
      },
      {
