...
export const AIRWAY_S21_SAMPS: Samp[] = [
  ...
  },
  {
    ...
    stem:
      "A 12-year-old girl is transferred to your emergency department from a community hospital. She had 4 days of cough and a runny nose, then last night developed a fever of 40°C, a brassy cough and noisy breathing. At the community hospital a lateral neck X-ray showed a normal epiglottis and irregular soft tissue within the tracheal air column. She received ceftriaxone and vancomycin before transfer. She is previously well and fully immunized.\n\nShe sits upright and looks toxic. She has inspiratory and expiratory stridor with suprasternal retractions, coughs up thick yellow secretions and speaks in short phrases. She is not drooling.",
    ...
    questions: [
      {
        ...
        options: ["Admit to the ward on humidified oxygen", "Awake nasal intubation now", "Controlled intubation in the operating room", "Heliox and repeat nebulized epinephrine", "Second dose of dexamethasone and observe"],
        correct: 2,
        explanation:
          "A toxic, febrile child with stridor in both phases of breathing, thick secretions and irregular soft tissue inside the trachea on X-ray has bacterial tracheitis, and in a multicentre series 91% of children with it needed intubation. Her airway should be secured early and in a controlled setting with anesthesia and ENT, rather than after she tires. The ward, heliox, nebulized epinephrine and dexamethasone treat croup or buy time without securing an airway that is likely to fail. An awake nasal intubation is poorly tolerated by a frightened child and is not a controlled plan for a trachea lined with membranes.",
        keyFeature: { topic: "airway", n: 2 },
      ...
      },
      {
        id: "q2",
        kind: "single",
        update: "The anesthesia team plans an IV induction with rocuronium, with sugammadex drawn up in case the airway is lost.",
        ...
        options: ["Reversal also ends the sedative effect", "Reversal is fast enough to prevent hypoxemia", "Reversal leaves her obstruction in place", "Reversal replaces the need for a double setup", "Reversal works for succinylcholine too"],
        correct: 2,
        explanation:
          "Sugammadex reverses rocuronium, but when the problem is obstructing airway pathology, such as the membranes in her trachea, reversing paralysis does not open the airway. Even when reversal is appropriate, some patients desaturate critically in the time it takes to draw up, give and act, and the sedative given at induction keeps working. A plan to reverse rocuronium is therefore not a reliable sole strategy, and a double setup for a surgical airway is still needed. Sugammadex binds rocuronium and vecuronium, not succinylcholine.",
        keyFeature: { topic: "airway", n: 5 },
        source: "cafg2",
      },
      {
        ...
        options: ["ENT surgeon ready to intervene", "Nasal tube chosen as first route", "Paralytic given before sedation", "Parents asked to leave the room", "Supine position before induction"],
        correct: 0,
        explanation:
          "In a child with a predicted difficult airway from obstruction, an ENT surgeon should be present and ready for rigid bronchoscopy or a surgical airway before induction begins, as part of a double setup that is briefed before induction. Laying her supine before induction can worsen the obstruction, so she stays upright until she is asleep. Keeping a parent with her reduces distress, which worsens stridor. A nasal first route adds risk in an airway lined with membranes, and a paralytic must never be given to a child who is still awake.",
        keyFeature: { topic: "airway", n: 4 },
        source: "cafg2",
      },
      {
        id: "q4",
        kind: "single",
        update: "She is intubated with a cuffed tube and ventilated. Thick membranes and pus are being suctioned from the tube every few minutes.",
        prompt: "Which of the following monitors is most likely to show the earliest sign that her tube is blocking?",
        options: ["Arterial blood pressure", "Continuous pulse oximetry", "Heart rate on the monitor", "Serial chest X-rays", "Waveform capnography"],
        correct: 4,
        explanation:
          "Waveform capnography changes with each breath, and it shows airway obstruction and hypoventilation minutes before pulse oximetry falls, so a shrinking or changing trace is the earliest warning that secretions are blocking her tube. Oxygen saturation drops later, once oxygen stores are used up. Heart rate and BP change later still, often only when hypoxemia is severe. Chest X-rays are intermittent and do not show a tube blocking in real time.",
        keyFeature: { topic: "airway", n: 6 },
        source: "rath-capnography",
      },
    ],
    sources: [
      ...
      CAFG2,
      { id: "rath-capnography", citation: "Rath S, Alsabri M, Tawfik AM, and colleagues. Seeing beyond the numbers: capnography as a vital tool in pediatric emergency care. Int J Emerg Med. 2026.", url: "https://doi.org/10.1186/s12245-025-01110-z" },
    ],
    reviewed: false,
    author: AUTHOR,
    version: 3,
  ...
  },
  {
    ...
    topic: "airway",
    alsoTopics: ["sob"],
    title: "Pneumonia in a man with a stiff, treated neck",
    stem:
      "A 66-year-old man presents to the emergency department with 3 days of fever, productive cough and worsening shortness of breath. Eighteen months ago he had chemoradiation for cancer of the base of the tongue. Since then his neck has been firm and stiff, and he has had trouble opening his mouth. He has a full beard.\n\nHe is alert and cooperative and speaks in short sentences. He can open his mouth 2.5 cm and cannot extend his neck. The skin of the neck is thickened and woody, and the cricothyroid membrane cannot be felt. There are crackles at the right base, and the chest X-ray shows right lower lobe consolidation. He is on high-flow nasal oxygen at 60 L/minute with FiO2 1.0, and he needs intubation. He is thin.",
    vitals: { temperature: "38.7°C oral", pulse: "112/minute", resp: "34/minute", bp: "118/70 mmHg", o2sat: "88% on high-flow oxygen, FiO2 1.0", weight: "60 kg" },
    questions: [
      {
        id: "q1",
        kind: "single",
        ...
        correct: 0,
        explanation:
          "Limited mouth opening and neck extension predict difficult laryngoscopy, and his irradiated, woody neck with an impalpable cricothyroid membrane predicts a difficult surgical airway. When difficulty is predicted with two or more methods of airway management, awake tracheal intubation should be strongly considered, and it can be done with high-flow nasal oxygen running while he keeps breathing, which helps a patient whose pneumonia limits how long he can tolerate apnea. Rapid sequence intubation removes his own breathing, and if laryngoscopy fails the rescue options are also predicted to be difficult. Inhalational induction as the sole strategy is not endorsed for adults with a predicted difficult airway. Blind nasal intubation is not a controlled technique. His SpO2 of 88% on FiO2 1.0 means he needs a secure airway now, not a trial of noninvasive ventilation.",
        keyFeature: { topic: "airway", n: 3 },
        source: "cafg2",
      },
      {
        id: "q2",
        kind: "single",
        prompt: "Which of the following is the maximum total dose of topical lidocaine for his awake intubation?",
        options: ["180 mg", "270 mg", "420 mg", "540 mg", "720 mg"],
        correct: 3,
        explanation:
          "The recommended maximum dose of topical lidocaine for awake intubation is 9 mg/kg of lean body weight, and he is thin, so 9 x 60 is 540 mg. The lowest dose that gives good conditions should be used, because toxicity has been reported at and below this limit. Doses of 180, 270 and 420 mg are 3, 4.5 and 7 mg/kg, figures closer to limits quoted for injected lidocaine, and all are below the topical maximum. A dose of 720 mg is 12 mg/kg and exceeds the limit.",
        keyFeature: { topic: "airway", n: 5 },
        source: "cafg2",
      },
      {
        id: "q3",
        kind: "single",
        update: "He is intubated over a flexible scope, which is then withdrawn. The tube is taped at 17 cm at the teeth. He groans with each breath, there is a loud leak around the tube, and the capnography waveform is small and irregular. The cuff pressure is 28 cmH2O.",
        prompt: "Which of the following is the most likely explanation for these findings?",
        ...
        correct: 0,
        explanation:
          "A tube at 17 cm at the teeth in an adult man sits too shallow, and a cuff lying at or above the cords lets him make sounds and gives a large leak with a small, irregular capnography trace despite a normal cuff pressure. It should be advanced under scope vision. Esophageal intubation would not let him groan past the tube and would give no sustained waveform. A right mainstem tube lies too deep, not too shallow. A ruptured cuff would not hold a pressure of 28 cmH2O. A tube blocked by secretions makes bagging stiff without a leak.",
        keyFeature: { topic: "airway", n: 6 },
        source: "cafg1",
      },
    ],
  ...
  },
  {
    ...
    title: "Stung while drinking from a can",
    stem:
      "A 27-year-old man is brought to the emergency department by ambulance 20 minutes after a wasp that had crawled into his can of pop stung him on the tongue. Within minutes his tongue began to swell and he developed hives on his chest and arms. He has no known allergies and takes no medications.\n\nHis tongue is swollen and fills most of his mouth, and he can open his mouth only about 2 cm. His voice is muffled and he is drooling. There is no stridor. He has hives on the trunk and arms and scattered wheeze. His neck moves freely. His BMI is 24 kg/m2.",
    vitals: { temperature: "36.9°C oral", pulse: "118/minute", resp: "26/minute", bp: "96/60 mmHg", o2sat: "95% on room air", weight: "82 kg" },
    questions: [
      {
        id: "q1",
        kind: "single",
        prompt: "Which of the following is the most appropriate first medication for him?",
        options: ["diphenhydramine 50 mg IV", "epinephrine 0.5 mg IM", "epinephrine 1 mg IV push", "methylprednisolone 125 mg IV", "racemic epinephrine nebulized"],
        correct: 1,
        explanation:
          "Hives, tongue swelling, wheeze and a low BP after a sting are anaphylaxis, and IM epinephrine into the thigh comes first. At 82 kg the dose of 0.01 mg/kg is capped at 0.5 mg, repeated every 5 minutes as needed. A 1 mg IV push is the cardiac arrest dose and can cause dangerous arrhythmias in a patient with a pulse. Diphenhydramine and methylprednisolone do not treat airway swelling or hypotension quickly enough. Nebulized epinephrine may help upper airway swelling but does not replace IM epinephrine.",
      ...
      },
      {
        id: "q2",
        kind: "single",
        update: "Ten minutes after treatment starts his BP is 108/66 mmHg, but his tongue is larger, his voice is harder to understand and soft inspiratory stridor has appeared. His SpO2 is 94%.",
        prompt: "Which of the following is the most appropriate airway action now?",
        options: ["Epinephrine infusion and observe", "Intubate now with a double setup", "Nebulized epinephrine and reassess", "Supraglottic airway placement", "Wait for a third IM dose"],
        correct: 1,
        explanation:
          "Swelling that keeps progressing despite epinephrine, with new stridor, means the airway may close, so he should be intubated now by the most skilled operator, with preparation for a surgical airway at the same time. Waiting for more medication or observing on an infusion risks losing the chance to intubate while it is still possible. A supraglottic airway sits above the swollen tissue and cannot bypass it. Epinephrine by nebulizer or infusion can continue, but not in place of securing the airway.",
        keyFeature: { topic: "airway", n: 2 },
        source: "cafg2",
      },
      {
        id: "q3",
        kind: "menu",
        prompt: "Which of the following findings predict a difficult airway in him?",
        select: 2,
        options: ["Age of 27 years", "BMI of 24 kg/m2", "Full neck range of motion", "Hives on the trunk and arms", "Mouth opening of 2 cm", "Tongue filling the oral cavity"],
        correct: [4, 5],
        explanation:
          "A tongue that fills the mouth leaves little room to pass a blade or tube and hides the larynx, and a mouth opening of only 2 cm limits laryngoscopy and device insertion. Both point to an obstructed, distorted airway. His young age, normal BMI and full neck movement are reassuring features. Hives show the reaction is systemic but do not affect the airway anatomy.",
        keyFeature: { topic: "airway", n: 3 },
        source: "cafg2",
      },
    ],
