...
export const PRE_ECLAMPSIA_S47_SAMPS: Samp[] = [
  /* 16 ------------------------------------------------------------------ */
  {
    ...
    title: "Shoulder pain late in pregnancy",
    stem:
      "A 35-year-old woman, G2P1 at 34 weeks and 1 day, presents to the emergency department with right shoulder pain since she woke 5 hours ago. She thought she had slept on it awkwardly, but acetaminophen has not helped. She has mild nausea and no shortness of breath. Her pregnancy has been uncomplicated. At 32 weeks her BP was 112 mmHg systolic and 70 mmHg diastolic. She takes a prenatal vitamin. Her neck is nontender, and the right arm has normal strength, sensation and reflexes. The shoulder has a full, painless range of motion and no tenderness. The right upper quadrant is tender. The uterus is soft and nontender, and the fetal heart rate is 140/minute.",
    vitals: { temperature: "36.8°C oral", pulse: "96/minute", resp: "18/minute", bp: "136/88 mmHg", o2sat: "98% on room air", weight: "70 kg" },
    questions: [
      {
        id: "q1",
        kind: "single",
        prompt: "Which of the following is the most likely source of her right shoulder pain?",
        options: [
          "Cervical nerve root compression",
          "Liver capsule stretch",
          "Pleurisy from pulmonary embolism",
          "Rotator cuff tendon strain",
          "Subacromial bursitis",
        ],
        correct: 1,
        explanation:
          "A normal shoulder and neck examination with a tender right upper quadrant means the shoulder pain is referred from the liver. Right shoulder pain is a recognized symptom of HELLP syndrome, when the swollen liver stretches its capsule or bleeds beneath it. Her BP of 136/88 mmHg is below 140/90 mmHg but well above her baseline of 112/70 mmHg, which keeps pre-eclampsia in view. A full, painless range of motion without tenderness argues against rotator cuff strain and bursitis. A nontender neck with normal strength, sensation and reflexes argues against nerve root compression. Pulmonary embolism does not explain upper quadrant tenderness, and she has no dyspnea and a saturation of 98%.",
      ...
      },
      {
        ...
        kind: "single",
        update:
          "Hemoglobin 106 g/L, platelets 72 x 10^9/L, AST 388 U/L, ALT 342 U/L, LDH 764 U/L, creatinine 71 umol/L, glucose 4.8 mmol/L and INR 1.1. The film shows schistocytes. Her BP is now 144/92 mmHg.",
        prompt: "Which of the following investigations is most appropriate now for her shoulder and abdominal pain?",
        options: [
        ...
        correct: 2,
        explanation:
          "Schistocytes, an LDH of 764 U/L, an AST of 388 U/L and platelets of 72 x 10^9/L confirm HELLP syndrome. Right shoulder and upper quadrant pain in HELLP raises concern for a subcapsular liver hematoma, which ultrasound, CT or MRI can show. Ultrasound is quick, avoids radiation to the fetus and can be repeated. Hepatobiliary scintigraphy and MR cholangiopancreatography look for gallbladder and bile duct disease, which do not explain hemolysis and low platelets. A shoulder radiograph adds nothing after a normal shoulder examination. CT pulmonary angiography answers a question the case does not raise.",
      ...
      },
      {
        id: "q3",
        kind: "single",
        update: "Ultrasound shows a 4 cm subcapsular hematoma of the right lobe with an intact capsule and no free fluid. Her pulse is 94/minute and her BP is 142/90 mmHg.",
        prompt: "Which of the following is the most appropriate management of the liver finding?",
        options: [
          "Conservative care with serial imaging",
          "Hepatic artery embolization now",
          "Laparotomy with perihepatic packing",
          "Liver transplant assessment",
          "Percutaneous drainage of the hematoma",
        ],
        correct: 0,
        explanation:
          "The hematoma is contained, the capsule is intact, there is no free fluid, and her pulse and BP are stable. An unruptured hematoma does not usually need an operation, so care is supportive, with blood products as needed and repeat imaging to detect expansion while delivery is planned. Laparotomy with packing, hepatic artery embolization and liver transplant are the options for a ruptured hematoma, which she does not have. Needle drainage of a contained collection is not a treatment for this lesion and risks fresh bleeding with platelets of 72 x 10^9/L.",
        keyFeature: { topic: "pre-eclampsia", n: 3 },
        source: "haram-hellp",
      },
      {
        id: "q4",
        kind: "single",
        update: "Obstetrics plans a caesarean birth today after magnesium sulfate is started. A repeat platelet count is 41 x 10^9/L. INR is 1.1 and fibrinogen is 3.4 g/L.",
        prompt: "Which of the following is the most appropriate step before her caesarean birth?",
        options: [
        ...
        correct: 3,
        explanation:
          "Her platelet count of 41 x 10^9/L is below 50 x 10^9/L, the SOGC threshold for platelet transfusion before caesarean birth, and she has a liver hematoma that could bleed. Her INR of 1.1 and fibrinogen of 3.4 g/L show no coagulopathy, so plasma and vitamin K correct nothing. Dexamethasone can raise the platelet count in HELLP but has not reduced maternal complications, so it is not given for this purpose. Immune globulin treats immune thrombocytopenia, not the platelet consumption of HELLP.",
