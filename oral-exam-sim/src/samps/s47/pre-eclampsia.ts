...
export const PRE_ECLAMPSIA_S47_SAMPS: Samp[] = [
  ...
  /* 34 ------------------------------------------------------------------ */
  {
    ...
    topic: "pre-eclampsia",
    alsoTopics: ["headache"],
    title: "Headache in a distance runner",
    stem:
    ...
    vitals: { temperature: "36.7°C oral", pulse: "48/minute", resp: "16/minute", bp: "172/112 mmHg", o2sat: "99% on room air", weight: "60 kg" },
    questions: [
      {
        id: "q1",
        kind: "menu",
        select: 4,
        prompt: "Which of the following investigations are the most important to evaluate her for pre-eclampsia and its complications?",
        options: [
          "AST and ALT",
          "Blood alcohol level",
          "CBC with platelets",
      ...
      },
      {
        ...
        kind: "single",
        update:
          "Her BP settles to 150/100 mmHg, but the headache and clonus persist. Obstetrics plans a caesarean today. Magnesium sulfate 4 g IV, then 1 g/hour, is running.",
        prompt: "Which of the following neonatal outcomes is her magnesium sulfate infusion also expected to reduce?",
        options: [
