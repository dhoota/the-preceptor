...
export const ASTHMA_COPD_SAMPS: Samp[] = [
  {
    id: "asthma-copd-01",
    topic: "asthma-copd",
    title: "A storm over the festival",
    stem:
      "A 34-year-old man is brought to the emergency department by ambulance at 21:40 on a June evening. At 20:15 a thunderstorm with strong gusts swept across the outdoor music festival he was attending in Ottawa. Within 30 minutes he had chest tightness, cough and wheeze, which have worsened since. He has had sneezing and itchy eyes every June since his teens and takes cetirizine. He has never been diagnosed with asthma but wheezed with exercise as a child. Paramedics report many calls from the festival grounds. He sits upright, speaks in short phrases and uses his neck muscles to breathe. There is diffuse expiratory wheeze.",
    vitals: { temperature: "36.9°C", pulse: "124/minute", resp: "32/minute", bp: "142/86 mmHg", o2sat: "89% on room air", weight: "80 kg" },
    questions: [
      {
        id: "q1",
        kind: "short",
        prompt: "What further history would you seek to judge his risk of a fatal or near fatal attack?",
        required: 3,
        accept: [
          { id: "icu", text: "Previous intubation or ICU admission for breathing", match: ["intubation", "intubated", "icu", "intensive care", "ventilator", "ventilated", "mechanical ventilation"] },
          { id: "visits", text: "Hospital admission or several emergency visits for breathing in the past year", match: ["hospitalization", "hospitalisation", "admission", "admitted", "emergency visit", "ed visit", "er visit", "emergency department visit", "hospital visit"] },
          { id: "ocs", text: "Current or recent oral corticosteroid use", match: ["oral steroid", "oral corticosteroid", "prednisone", "prednisolone", "systemic steroid", "systemic corticosteroid", "recent steroid"] },
          { id: "ics", text: "No inhaled corticosteroid or poor adherence to one", match: ["no inhaled steroid", "no inhaled corticosteroid", "no ics", "no preventer", "no controller", "not on ics", "inhaled corticosteroid", "inhaled steroid", "ics", "preventer", "controller", "adherence"] },
          { id: "saba", text: "Heavy salbutamol use, such as more than one canister a month", match: ["salbutamol", "saba", "ventolin", "canister", "reliever", "puffer", "rescue inhaler"] },
          { id: "psych", text: "Psychiatric illness or psychosocial problems", match: ["psychiatric", "psychosocial", "mental health", "depression", "social problem", "substance use"] },
          { id: "food", text: "Food allergy or previous anaphylaxis", match: ["food allergy", "food allergie", "anaphylaxis"] },
          { id: "perception", text: "Poor perception of breathlessness", match: ["perception", "poor perceiver"] },
          { id: "comorbid", text: "Pneumonia, diabetes or arrhythmia", match: ["diabetes", "arrhythmia", "pneumonia"] },
        ],
        explanation:
          "GINA lists red flags for fatal or near fatal asthma. The strongest is a past attack that needed intubation and ventilation. Others are a hospital stay or several emergency visits in the past year, current or recent oral corticosteroids, no inhaled corticosteroid, heavy salbutamol use, psychosocial problems, food allergy and poor perception of breathlessness. He has never had an asthma diagnosis, but GINA notes that asthma deaths also occur in people with no past urgent care. Any red flag lowers the threshold for escalation and admission.",
      ...
      },
      {
        id: "q2",
        kind: "short",
        update: "Every nebulizer in the department is already in use.",
        prompt: "What medications would you give him in the first 20 minutes, with the dose and route of each?",
        required: 3,
        accept: [
          { id: "salb", text: "Salbutamol 6 to 10 puffs of 100 mcg by MDI with spacer, repeated every 20 minutes", match: ["salbutamol 5 puff", "salbutamol 6 puff", "salbutamol 8 puff", "salbutamol 10 puff", "salbutamol 600 mcg", "salbutamol 800 mcg", "salbutamol 1000 mcg", "ventolin 6 puff", "ventolin 8 puff", "ventolin 10 puff"] },
          { id: "ipra", text: "Ipratropium 4 puffs of 20 mcg by MDI with spacer, repeated every 20 minutes for 3 doses", match: ["ipratropium 4 puff", "ipratropium 6 puff", "ipratropium 8 puff", "ipratropium 80 mcg", "ipratropium 160 mcg", "atrovent 4 puff", "atrovent 8 puff"] },
          { id: "steroid", text: "Prednisone 50 mg PO", match: ["prednisone 40", "prednisone 50", "prednisone 60", "prednisolone 40", "prednisolone 50", "methylprednisolone 60", "methylprednisolone 80", "methylprednisolone 125", "dexamethasone 10", "dexamethasone 12", "dexamethasone 16", "hydrocortisone 100", "hydrocortisone 200"] },
          { id: "o2", text: "Oxygen titrated to SpO2 92 to 95%", match: ["oxygen", "o2"] },
          { id: "mg", text: "Magnesium sulfate 2 g IV over 20 minutes", match: ["magnesium 2 g", "magnesium sulfate 2", "mgso4 2", "magnesium 2"] },
        ],
        unacceptable: [
          ...
          { text: "Antibiotic without evidence of infection", match: ["antibiotic", "azithromycin", "amoxicillin"] },
        ],
        explanation:
          "He cannot speak in sentences, his respiratory rate is 32/minute and his SpO2 is 89% on room air, so his attack is severe by GINA criteria. GINA notes that salbutamol by MDI and spacer gives a similar improvement in lung function to a nebulizer, so a shortage of nebulizers should not delay treatment. For a severe attack GINA advises salbutamol 6 to 10 puffs with ipratropium 4 puffs, repeated up to 3 times 20 to 30 minutes apart, oxygen to a target of 92 to 95%, and a systemic corticosteroid such as prednisone 50 mg within the first hour. IV magnesium may be added. Sedatives can precipitate respiratory arrest.",
      ...
      },
      {
        id: "q3",
        kind: "single",
        update: "After three rounds of bronchodilators he feels better and speaks in phrases. His SpO2 is 94% on 2 L/minute by nasal prongs. His predicted peak flow is 610 L/minute, and his best of three blows is 250 L/minute.",
        prompt: "Which of the following best describes the severity of his attack at this point?",
        options: [
        ...
        correct: 4,
        explanation:
          "A peak flow of 250 L/minute is 41% of his predicted 610 L/minute. GINA grades a peak flow below 50% of predicted or personal best as a severe presentation, whatever the other signs. Speaking in phrases fits a moderate attack, but symptoms track airflow poorly, and a saturation measured on oxygen cannot be used for grading. A mild attack needs a peak flow above 70%. Life-threatening features are drowsiness, confusion, cyanosis or a silent chest, and he has none. Near-fatal asthma describes an attack that needed intubation and ventilation.",
      ...
      },
      {
        id: "q4",
        kind: "short",
        update: "The charge nurse tells you that 23 more people with wheeze are coming from the festival within the hour. Most have never been diagnosed with asthma.",
        prompt: "What standing orders would you give the triage nurses for these patients before a physician sees them?",
        required: 3,
        accept: [
          { id: "salb", text: "Salbutamol by MDI and spacer at triage", match: ["salbutamol", "ventolin", "saba", "bronchodilator", "reliever"] },
          { id: "ipra", text: "Ipratropium by MDI and spacer for moderate or severe wheeze", match: ["ipratropium", "atrovent", "anticholinergic"] },
          { id: "steroid", text: "Oral prednisone for moderate or severe attacks", match: ["prednisone", "prednisolone", "steroid", "corticosteroid", "dexamethasone"] },
          { id: "o2", text: "Oxygen titrated to SpO2 92 to 95%", match: ["oxygen", "o2"] },
          { id: "grade", text: "Peak flow and SpO2 at triage to grade severity", match: ["peak flow", "pef", "peak expiratory", "fev1", "saturation", "spo2", "oximetry"] },
          { id: "resus", text: "Anyone drowsy, confused, cyanosed or with a silent chest goes straight to resuscitation", match: ["resuscitation", "resus", "drowsy", "confused", "silent chest", "cyanosis", "cyanosed", "life threatening"] },
          { id: "surge", text: "Activate the hospital surge or Code Orange plan", match: ["code orange", "surge", "disaster plan", "mass casualty", "extra staff", "call in staff"] },
        ],
        unacceptable: [
          { text: "Wait for a physician diagnosis of asthma before any bronchodilator", match: ["wait for physician", "await physician", "wait for diagnosis", "confirm asthma before"] },
        ],
        explanation:
          "In the 2016 Melbourne thunderstorm event, emergency departments saw 3365 excess respiratory presentations within 30 hours, and only 28% of the patients questioned had current doctor-diagnosed asthma. Wheeze after a storm in a person with grass pollen allergy is treated as acute asthma at once, without waiting for a diagnosis. Salbutamol and ipratropium by MDI and spacer, a systemic corticosteroid and titrated oxygen can start at triage, with severity graded by saturation and peak flow. The event set a new benchmark for escalation of emergency and hospital services. All 35 patients admitted to ICU had asthma, and 5 of them died.",
        keyFeature: { topic: "asthma-copd", n: 5 },
        source: "thien-thunderstorm",
      },
    ],
    sources: [GINA_2026, THIEN],
    reviewed: false,
    author: AUTHOR,
    version: 2,
  },
  ...
  },
  {
    ...
    title: "Worse after the ambulance nebulizer",
    stem:
      "A 58-year-old man is brought to the emergency department by ambulance at 02:30. He woke from sleep breathless and wheezing. Paramedics treated him for asthma with two doses of salbutamol 5 mg by nebulizer, and he now feels his heart racing. He has had no lung disease. For two months he has been short of breath on stairs and has coughed at night. He moved to Canada from Nepal 2 years ago. At age 11 he had a long illness with painful, swollen knees and ankles. He takes no medications. He sits upright and coughs. There is diffuse expiratory wheeze and the pulse is irregularly irregular.",
    vitals: { temperature: "37.2°C", pulse: "142/minute", resp: "30/minute", bp: "118/76 mmHg", o2sat: "87% on room air", weight: "64 kg" },
    questions: [
      {
        id: "q1",
        kind: "short",
        prompt: "What diagnoses other than asthma would you consider for his wheeze?",
        required: 3,
        accept: [
          { id: "hf", text: "Acute heart failure with pulmonary edema, including from valve disease", match: ["heart failure", "chf", "pulmonary edema", "pulmonary oedema", "cardiac asthma", "valve", "valvular", "mitral", "rheumatic", "cardiomyopathy"] },
          { id: "pe", text: "Pulmonary embolism", match: ["pulmonary embolism", "pulmonary emboli", "pe"] },
          { id: "pneumonia", text: "Pneumonia", match: ["pneumonia", "chest infection"] },
          { id: "arrhythmia", text: "Tachyarrhythmia such as atrial fibrillation", match: ["arrhythmia", "atrial fibrillation", "afib", "af", "tachyarrhythmia"] },
          ...
          { id: "fb", text: "Inhaled foreign body", match: ["foreign body"] },
        ],
        explanation:
          "GINA advises asking whether acute symptoms are really asthma before treating them as asthma, and names pneumothorax, anaphylaxis, inducible laryngeal obstruction, pneumonia, acute cardiac failure and pulmonary embolism. A first episode of wheeze at 58, after two months of breathlessness on exertion and cough at night, with an irregularly irregular pulse, points toward heart failure with an arrhythmia. A childhood illness with painful, swollen joints raises the possibility of rheumatic fever and later valve disease. Salbutamol has sped his heart without easing his breathing.",
        keyFeature: { topic: "asthma-copd", n: 1 },
        source: "gina-2026",
      },
      {
        id: "q2",
        kind: "short",
        prompt: "What features of his history and examination point to pulmonary edema rather than asthma?",
        required: 3,
        accept: [
          { id: "late", text: "First wheeze at 58 with no past lung disease", match: ["first wheeze", "first episode", "new wheeze", "no lung disease", "no history of asthma", "no asthma history", "late onset", "age 58", "older age"] },
          { id: "noct", text: "Months of breathlessness on exertion with a cough at night, orthopnea or waking breathless", match: ["orthopnea", "orthopnoea", "pnd", "paroxysmal nocturnal", "nocturnal cough", "cough at night", "night cough", "sits upright", "sitting upright", "exertional", "on exertion", "on stairs"] },
          { id: "af", text: "Irregularly irregular pulse suggesting atrial fibrillation", match: ["irregular", "atrial fibrillation", "af", "afib", "arrhythmia"] },
          { id: "salb", text: "Breathing and heart rate worsened after salbutamol", match: ["worse after salbutamol", "worsened after salbutamol", "worsened with salbutamol", "no response to salbutamol", "not improved with salbutamol", "poor response to salbutamol", "failed salbutamol", "poor bronchodilator response"] },
          { id: "rf", text: "Childhood illness suggesting rheumatic fever, from a region where it is common", match: ["rheumatic", "childhood illness", "joint illness", "swollen joint", "nepal"] },
          { id: "crackles", text: "Crackles on auscultation", match: ["crackle", "rales", "crepitation"] },
          { id: "jvp", text: "Raised JVP", match: ["jvp", "jugular", "jvd"] },
          { id: "murmur", text: "Heart murmur, such as an apical diastolic rumble", match: ["murmur", "rumble", "opening snap", "loud s1", "loud first heart sound"] },
          { id: "s3", text: "Third heart sound", match: ["s3", "third heart sound", "gallop"] },
          { id: "edema", text: "Leg edema", match: ["leg edema", "ankle edema", "pedal edema", "peripheral edema", "leg swelling", "ankle swelling"] },
        ],
        explanation:
          "Wheeze does not point to asthma here, because in the review by Long and colleagues it was no more common in heart failure than in other causes of breathlessness. Orthopnea and waking breathless at night are among the commonest symptoms of acute heart failure, although each alone only modestly raises its likelihood. Atrial fibrillation is the commonest arrhythmia that precipitates heart failure. A third heart sound is highly specific but heard in only about 13% of patients, and crackles, a raised JVP, a murmur and leg edema each help without being decisive. A first wheeze at 58 that worsened with salbutamol, after a childhood illness that may have been rheumatic fever, should prompt a search for a cardiac cause.",
      ...
      },
      {
        id: "q3",
        kind: "short",
        update: "ECG shows atrial fibrillation at 146/minute with no ST elevation. Lung ultrasound shows diffuse bilateral B lines. Bedside echocardiography shows thickened mitral leaflets that open poorly, a large left atrium and a normal sized, vigorous left ventricle. BP is 116/74 mmHg.",
        prompt: "What treatments would you start now?",
        required: 3,
        accept: [
          { id: "rate", text: "IV rate control, such as esmolol or metoprolol, or diltiazem if a beta blocker cannot be used", match: ["esmolol", "metoprolol", "beta blocker", "rate control", "diltiazem", "verapamil", "calcium channel blocker", "digoxin"] },
          { id: "niv", text: "CPAP or BiPAP", match: ["cpap", "bipap", "noninvasive", "non invasive", "niv", "positive pressure"] },
          { id: "diuretic", text: "IV furosemide", match: ["furosemide", "lasix", "diuretic"] },
          { id: "o2", text: "Oxygen", match: ["oxygen", "o2"] },
          { id: "heparin", text: "Therapeutic heparin", match: ["heparin", "anticoagulation", "anticoagulant", "enoxaparin", "dalteparin", "tinzaparin", "lmwh"] },
          { id: "salb", text: "Stop salbutamol", match: ["stop salbutamol", "no salbutamol", "hold salbutamol", "avoid salbutamol", "stop ventolin", "stop beta agonist"] },
        ],
        unacceptable: [
          { text: "More salbutamol", match: ["more salbutamol", "repeat salbutamol", "continuous salbutamol", "salbutamol neb", "salbutamol puff"] },
          { text: "Electrical cardioversion of atrial fibrillation of unknown duration", match: ["cardioversion", "cardiovert"] },
        ],
        explanation:
          "His BP is maintained and the echo shows a narrowed mitral valve with a healthy left ventricle, so the fast ventricular rate is the main driver of his edema. In mitral stenosis, atrial fibrillation raises the gradient across the valve. Shenthar advises acute IV rate control to below 80/minute in stable patients, with esmolol as the first choice and diltiazem or verapamil when a beta blocker cannot be used. CPAP or BiPAP and IV furosemide treat the edema while the rate falls. More salbutamol speeds the heart further. Shenthar warns that restoring sinus rhythm when a left atrial thrombus is present can cause a stroke, so he should not be cardioverted now.",
        keyFeature: { topic: "pulmonary-edema", n: 1 },
        source: "shenthar-rhd-af",
      },
      {
        id: "q4",
        kind: "short",
        update: "An hour later his pulse is 88/minute and his SpO2 is 95% on CPAP.",
        prompt: "What further tests would you order to look for conditions that triggered or worsened his decompensation?",
        required: 2,
        accept: [
          { id: "tsh", text: "TSH for hyperthyroidism", match: ["tsh", "thyroid", "t4"] },
          { id: "cbc", text: "CBC for anemia", match: ["cbc", "hemoglobin", "haemoglobin", "anemia", "anaemia", "blood count"] },
          { id: "infection", text: "Blood cultures and a search for infection, including endocarditis", match: ["blood culture", "culture", "endocarditis", "infection", "septic"] },
          { id: "echo", text: "Formal echocardiography for valve area and gradient", match: ["echocardiogram", "echocardiography", "echo", "tte", "transthoracic", "transesophageal", "tee"] },
        ],
        explanation:
          "A narrowed mitral valve leaves little reserve. Pala and colleagues note that tachycardia shortens diastolic filling, and that anemia, fever and hyperthyroidism raise cardiac output and can raise the gradient even when the stenosis is only moderate. Each of these is quick to test for and changes his treatment. Formal echocardiography measures the valve area and gradient that guide valve intervention, and in atrial fibrillation the gradient must be averaged over several beats.",
        keyFeature: { topic: "pulmonary-edema", n: 2 },
        source: "pala-ms",
      },
    ],
    sources: [GINA_2026, LONG_AHF, SHENTHAR, PALA_MS],
    reviewed: false,
    author: AUTHOR,
    version: 2,
  },
