...
export const ANAPHYLAXIS: Samp[] = [
  ...
  },
  {
    ...
    id: "anaphylaxis-02",
    alsoTopics: ["shock"],
    title: "Flushing the day after a cancer treatment",
    stem:
      "A 66-year-old man is brought to the emergency department by ambulance with flushing, wheeze and light-headedness that began 40 minutes ago. He has a metastatic small bowel neuroendocrine tumour with liver metastases. His monthly lanreotide injection was stopped 4 weeks ago, and yesterday afternoon he received his first lutetium-177 dotatate treatment. Since then he has had several episodes of watery diarrhea. He ate a tuna sandwich 2 hours ago. He has no known allergies. Paramedics gave epinephrine 0.5 mg IM 20 minutes ago without improvement. His face, neck and upper chest are deep red. His lips and eyelids are puffy. He has diffuse expiratory wheeze. There are no hives.",
    vitals: { temperature: "37.1°C", pulse: "128/minute", resp: "26/minute", bp: "76/40 mmHg", o2sat: "93% on room air", weight: "72 kg" },
    questions: [
      {
        id: "q1",
        kind: "short",
        prompt: "What conditions must you consider as the cause of his flushing, wheeze and hypotension?",
        required: 3,
        accept: [
          {
            id: "crisis",
            text: "Carcinoid crisis from his neuroendocrine tumour",
            match: ["carcinoid", "neuroendocrine crisis", "serotonin release", "tumour hormone", "tumor hormone", "hormone release"],
          },
          { id: "ana", text: "Anaphylaxis", match: ["anaphylaxis", "anaphylactic", "allergic reaction"] },
          {
            id: "scombroid",
            text: "Scombroid, or histamine fish poisoning, from the tuna",
            match: ["scombroid", "scombroidosis", "histamine fish", "histamine poisoning", "fish poisoning"],
          },
          { id: "mast", text: "Systemic mastocytosis or another mast cell disorder", match: ["mastocytosis", "mast cell"] },
        ],
        explanation:
          "Flushing with wheeze and hypotension meets the WAO clinical criteria for anaphylaxis, so anaphylaxis stays on the list even with no hives and no known allergen. The WAO lists carcinoid syndrome, scombroid poisoning from fish such as tuna, and mastocytosis among the conditions that mimic anaphylaxis. His small bowel neuroendocrine tumour with liver metastases and his treatment yesterday make a carcinoid crisis the leading alternative. Keeping all of these in mind stops the team from treating a hormonal crisis as allergy alone, or from missing anaphylaxis in a patient with cancer.",
      ...
      },
      {
        ...
        kind: "single",
        update:
          "His wife ate half of the same tuna sandwich and is well. He has eaten tuna often without a reaction. His ECG shows sinus tachycardia at 128 without ST changes.",
        prompt: "Which of the following is the most likely cause of his shock?",
        options: [
          "Acute coronary syndrome with pump failure",
          "Anaphylaxis to an unrecognized food",
          "Carcinoid crisis after lutetium therapy",
          "Histamine fish poisoning from tuna",
          "Hypovolemic shock from his diarrhea",
        ],
        correct: 2,
        explanation:
          "ENETS defines carcinoid crisis by abrupt flushing, unstable BP, profuse diarrhea and bronchospasm, and lists labial and periocular edema among its signs. It names PRRT among the triggers and warns that sympathomimetics can provoke further hormone release, which fits his lack of response to epinephrine. His somatostatin analogue was stopped for the treatment, and his tumour has spread to the liver. The WAO notes that histamine fish poisoning usually affects more than one person who ate the fish, and his wife is well. Anaphylaxis to a food is less likely with a familiar food and no hives, and diarrhea alone does not explain flushing and wheeze. His ECG shows no ischemia to suggest a coronary cause.",
      ...
      },
      {
        id: "q3",
        kind: "short",
        prompt: "What drug specific to this diagnosis would you give now, and by what route?",
        required: 1,
        accept: [
          {
            id: "octreotide",
            text: "Octreotide IV, as a 500 to 1 000 mcg bolus repeated as needed, then an infusion",
            match: c(["octreotide", "sandostatin"], ["iv", "intravenous", "intravenously", "bolus", "infusion"]),
          },
        ],
        unacceptable: [{ text: "A long-acting depot such as octreotide LAR or lanreotide", match: ["lar", "depot", "long acting"] }],
        explanation:
          "Sozio and colleagues call prompt IV octreotide the single most important step in treating carcinoid crisis, because it inhibits the release of vasoactive amines from tumour cells. They describe an IV bolus of 500 to 1 000 mcg at the onset of symptoms, repeated every 5 minutes until symptoms are controlled, then a continuous infusion if symptoms persist. Crisis is most often seen within 12 to 48 hours of a first lutetium-177 dotatate dose, and a midgut tumour with liver metastases raises the risk. Octreotide LAR is a monthly IM depot used for prevention, so it cannot treat a crisis that is happening now.",
      ...
      },
      {
        ...
        kind: "short",
        update:
          "After two IV boluses of octreotide his flushing fades and BP is 88/50 mmHg. Bedside echocardiography shows a small, vigorous left ventricle and a dilated right ventricle. The tricuspid leaflets are thickened and fixed open, with severe regurgitation. The IVC is 2.4 cm and does not collapse. There is no pericardial effusion.",
        prompt: "What do these ultrasound findings mean for his ongoing resuscitation?",
        required: 2,
        accept: [
          {
            id: "chd",
            text: "Carcinoid heart disease of the tricuspid valve",
            match: ["carcinoid heart", "valve disease", "valvular disease", "tricuspid valve", "tricuspid regurgitation", "right sided valve", "tr"],
          },
          {
            id: "rhf",
            text: "Right ventricular volume overload, with a risk of right heart failure",
            match: ["right heart failure", "right ventricular failure", "rv failure", "right ventricular dysfunction", "rv dysfunction", "rv overload", "right ventricular overload", "volume overload", "dilated rv", "rv dilated", "rv dilation", "rv dilatation", "dilated right ventricle", "right ventricular dilation", "right ventricular dilatation"],
          },
          {
            id: "ivc",
            text: "The full IVC reflects the regurgitant right heart, so it cannot guide fluid",
            match: ["ivc unreliable", "ivc not reliable", "ivc misleading", "ivc cannot", "ivc cant", "ivc not useful", "ivc not accurate", "ignore ivc", "ivc falsely", "ivc reflect"],
          },
          {
            id: "fluid",
            text: "Give further fluid cautiously, in small reassessed amounts",
            match: ["cautious fluid", "fluid cautious", "fluid cautiously", "small bolus", "small boluses", "cautious bolus", "cautious boluses", "careful bolus", "careful boluses", "small fluid", "careful fluid", "titrate fluid", "limit fluid", "restrict fluid", "avoid large", "no large", "not large", "stop fluid", "no more fluid", "no further fluid", "judicious fluid"],
          },
          {
            id: "lv",
            text: "The small, vigorous left ventricle fits ongoing distributive shock",
            match: ["distributive", "hyperdynamic", "vigorous", "underfilled", "vasodilat", "vasodilation", "vasodilatory"],
          },
          {
            id: "tamponade",
            text: "No pericardial effusion, so tamponade is not the cause",
            match: ["no tamponade", "tamponade excluded", "not tamponade", "no effusion", "no pericardial effusion", "rule out tamponade", "excludes tamponade"],
          },
          { id: "pressor", text: "Support BP with phenylephrine or vasopressin if a vasopressor is needed", match: ["phenylephrine", "vasopressin"] },
        ],
        unacceptable: [{ text: "A rapid crystalloid bolus of 1 to 2 L", match: ["1 to 2 l", "2 l bolus", "2 litre", "2 liter", "large bolus", "large volume", "wide open"] }],
        explanation:
          "Thickened, fixed tricuspid leaflets with severe regurgitation and a dilated right ventricle match the ENETS description of carcinoid heart disease, which leads to right ventricular volume overload and right heart failure. His IVC is full because of the regurgitant right heart, so a full IVC does not show that he has enough fluid. The small, vigorous left ventricle fits the distributive shock of the crisis, and there is no effusion to suggest tamponade. For fluid given with PRRT, ENETS advises titrating volume and rate to cardiac function in carcinoid heart disease. The same caution applies now, so further fluid is given in small, reassessed amounts rather than as a rapid 1 to 2 L bolus. If a vasopressor is needed, ENETS prefers phenylephrine or vasopressin.",
    ...
    sources: [
      WAO_2020,
      {
        id: "enets-2022",
        citation:
          "Grozinsky-Glasberg S, Davar J, Hofland J, et al. European Neuroendocrine Tumor Society (ENETS) 2022 guidance paper for carcinoid syndrome and carcinoid heart disease. J Neuroendocrinol. 2022.",
        url: "https://doi.org/10.1111/jne.13146",
      },
      {
        id: "sozio-2024",
        citation:
          "Sozio SJ, Raynor W, Becker MC, Yudd A, Kempf JS. Carcinoid crisis in lutetium-177-dotatate therapy of neuroendocrine tumors. An overview of pathophysiology, risk factors, recognition, and treatment. EJNMMI Rep. 2024.",
        url: "https://doi.org/10.1186/s41824-024-00216-6",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    id: "anaphylaxis-06",
    alsoTopics: ["airway"],
    title: "Scratchy throat at a restaurant",
    stem:
      "A 46-year-old man presents to the emergency department 35 minutes after a halibut dinner at a restaurant. Midway through the meal he felt a scratch in his throat and thought he had swallowed a bone. Ten minutes later his throat felt tight, his palms itched and he felt light-headed. Two years ago his lips itched and tingled after he ate cod. He has no other medical history and takes no medications. He points to the whole front of his neck. His voice is hoarse and swallowing hurts. He has no hives, flushing, lip swelling, stridor or wheeze. No bone is seen in his mouth or on his tonsils. The triage nurse has booked a CT of the neck to look for a bone.",
    vitals: { temperature: "36.9°C", pulse: "118/minute", resp: "22/minute", bp: "104/66 mmHg", o2sat: "97% on room air" },
    questions: [
      {
        id: "q1",
        kind: "short",
        prompt: "What is the most likely diagnosis?",
        required: 1,
        accept: [{ id: "ana", text: "Anaphylaxis to fish", match: ["anaphylaxis", "anaphylactic"] }],
        unacceptable: [{ text: "An impacted bone as the only cause", match: ["impacted bone", "bone impaction", "bone stuck", "foreign body"] }],
        explanation:
          "Under the WAO 2020 criteria, laryngeal involvement after exposure to a known or highly probable allergen is anaphylaxis, even with no skin signs. The WAO lists vocal change and pain on swallowing as laryngeal symptoms, and he has both. His lip itching after cod makes fish a probable allergen for him. A bone could explain a scratch and pain on swallowing, but not itchy palms, light-headedness and a heart rate of 118.",
        keyFeature: { topic: "anaphylaxis", n: 2 },
        source: "wao-2020",
      },
      {
        id: "q2",
        kind: "short",
        prompt: "What features favour anaphylaxis over a fish bone as the cause of his throat symptoms?",
        required: 2,
        accept: [
          { id: "voice", text: "Hoarse voice, a sign of laryngeal involvement", match: ["hoarse", "hoarseness", "dysphonia", "voice change", "laryngeal", "larynx"] },
          { id: "itch", text: "Itchy palms, a symptom away from the throat", match: ["itch", "itchy", "pruritus", "palm"] },
          {
            id: "circulation",
            text: "Light-headedness with a fast heart rate",
            match: ["light headed", "lightheaded", "light headedness", "presyncope", "dizzy", "dizziness", "tachycardia", "heart rate", "pulse"],
          },
          {
            id: "prior",
            text: "A previous reaction to cod, so fish is a probable allergen for him",
            match: ["cod", "previous reaction", "prior reaction", "past reaction", "fish allergy", "allergic to fish", "reaction to fish"],
          },
          {
            id: "diffuse",
            text: "Discomfort over the whole front of the neck rather than one sharp point",
            match: ["diffuse", "whole neck", "whole front", "not localized", "not localised", "poorly localized", "poorly localised", "not one point", "not a single point"],
          },
          { id: "onset", text: "Symptoms beyond the throat within minutes of eating", match: ["within minutes", "minutes after", "rapid onset", "sudden onset"] },
        ],
        explanation:
          "A bone causes local symptoms. His hoarse voice points to the larynx, and his itchy palms, light-headedness and heart rate of 118 involve other systems within minutes of eating. His earlier lip itching after cod makes fish a probable allergen, which is what the WAO criterion for anaphylaxis without skin signs requires. He points to the whole front of his neck, not one spot. The lack of hives, flushing and wheeze does not exclude anaphylaxis, and waiting for them delays epinephrine.",
        keyFeature: { topic: "anaphylaxis", n: 2 },
        source: "wao-2020",
      },
      {
        ...
        kind: "short",
        update:
          "He receives epinephrine 0.5 mg IM. Ten minutes later his voice is more hoarse and he is spitting out his saliva. His SpO2 is 96% on room air. The CT technologist calls to say the scanner is ready for him.",
        prompt: "What is your plan for the CT scan, given the state of his airway?",
        required: 2,
        accept: [
          {
            id: "noct",
            text: "Do not send him to CT now, as the scan will not change his immediate care",
            match: ["no ct", "not ct", "cancel ct", "delay ct", "defer ct", "postpone ct", "hold ct", "ct later", "ct can wait", "ct wait", "avoid ct", "not send", "do not send", "dont send", "not go to ct", "stop ct", "ct not needed", "ct unnecessary", "ct not indicated"],
          },
          {
            id: "resus",
            text: "Keep him in the resuscitation room, where airway equipment and help are at hand",
            match: ["resuscitation room", "resus room", "resus bay", "resuscitation bay", "stay in resus", "keep in resus", "remain in resus", "in resus"],
          },
          {
            id: "flat",
            text: "Avoid lying him flat in the scanner, which can worsen his breathing",
            match: ["avoid lying flat", "avoid lie flat", "not lie flat", "not lying flat", "cannot lie flat", "cant lie flat", "no lying flat", "avoid supine", "not supine", "worse lying flat", "worse supine", "lying flat worse", "supine worse", "flat worsen", "supine worsen"],
          },
          { id: "sit", text: "Keep him sitting up", match: ["sit up", "sitting up", "upright", "sitting position", "seated"] },
          {
            id: "secure",
            text: "If imaging is still needed, secure his airway first",
            match: ["intubate before ct", "intubate first", "secure airway first", "secure airway before", "airway before ct", "intubation before ct", "after intubation", "once airway secure", "after airway secured"],
          },
          {
            id: "escort",
            text: "If he must go, a physician with airway skills and equipment goes with him",
            match: ["escort", "accompany", "accompanied", "go with him", "physician with him"],
          },
        ],
        unacceptable: [{ text: "Send him to CT now", match: ["send to ct", "send for ct", "proceed with ct", "proceed to ct"] }],
        explanation:
          "Worse hoarseness and trouble swallowing his saliva after epinephrine mean his larynx is still swelling, and his airway may need to be secured soon. The diagnosis is clinical, so a scan for a bone would not change what he needs now. The CAFG lists an adverse location, with difficult access to the patient and help far away, among the factors that make airway management harder, and the CT scanner is such a place. The WAO advises a sitting position when breathing is difficult, and the scanner would lay him flat. If a scan is still wanted later, it waits until his airway is secure or the swelling has clearly settled.",
        keyFeature: { topic: "airway", n: 2 },
        source: "cafg-2",
      },
    ],
    sources: [WAO_2020, CAFG_2],
  },
  {
    ...base,
    id: "anaphylaxis-07",
