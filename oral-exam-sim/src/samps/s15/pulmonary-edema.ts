...
const S = {
  ...
  ash: {
    id: "ash-hit-2018",
    citation:
      "Cuker A, Arepally GM, Chong BH, et al. American Society of Hematology 2018 guidelines for management of venous thromboembolism. Heparin-induced thrombocytopenia. Blood Adv. 2018.",
...
export const PULMONARY_EDEMA_SAMPS: Samp[] = [
  ...
  /* 02 ------------------------------------------------------------------ */
  {
    ...
    title: "Chest pressure six weeks after a hip repair",
    stem:
      "A 77-year-old woman is brought to the emergency department by ambulance with 90 minutes of central chest pressure and 40 minutes of worsening shortness of breath. Six weeks ago, after surgery for a hip fracture, her platelets fell while she was on enoxaparin prophylaxis, and heparin-induced thrombocytopenia was confirmed with a positive platelet activation assay. Her platelets recovered on rivaroxaban, which she finished 5 days ago. She had an ischemic stroke 3 years ago and has no residual deficit. She takes ASA 81 mg and atorvastatin. She is sweaty and speaks in short phrases but is alert. There are crackles to the mid zones of both lungs. The ECG shows 4 mm of ST elevation in V1 to V5. Her platelets are 204 x 10^9/L and her creatinine clearance is 48 mL/minute.",
    vitals: { temperature: "36.7°C", pulse: "112/minute", resp: "32/minute", bp: "158/94 mmHg", o2sat: "86% on room air", weight: "58 kg" },
    questions: [
      {
        id: "q1",
        kind: "single",
        prompt: "Which of the following reperfusion plans is most appropriate for her?",
        options: [
          "Fibrinolysis with enoxaparin, then angiography",
          "Primary PCI with bivalirudin",
          "Primary PCI with enoxaparin",
          "Primary PCI with fondaparinux alone",
          "Primary PCI with unfractionated heparin",
        ],
        correct: 1,
        explanation:
          "She has an anterior STEMI at a PCI centre, so primary PCI is the reperfusion strategy, but her confirmed heparin-induced thrombocytopenia 6 weeks ago rules out heparin in any form. The 2023 ESC ACS guideline names bivalirudin as the recommended alternative to unfractionated heparin in ACS with a history of HIT, and the ASH HIT guideline also suggests bivalirudin for PCI. The bolus is 0.75 mg/kg, about 44 mg for 58 kg, followed by 1.75 mg/kg/h. Enoxaparin is itself a heparin, and ASH advises a non-heparin anticoagulant rather than unfractionated heparin or LMWH after HIT. The ESC guideline does not recommend fondaparinux for primary PCI. Fibrinolysis is inferior to timely primary PCI and would also need a heparin.",
      ...
      },
      {
        ...
        kind: "single",
        update:
          "Bivalirudin is started. BiPAP at 10/5 cm H2O with FiO2 0.5 and a nitroglycerin infusion were started on arrival. Twenty minutes later her respiratory rate is 22/minute, saturation 94% and BP 136/82 mmHg. She is alert and speaks in full sentences. A venous gas shows pH 7.35 and PCO2 43 mmHg. The catheterization laboratory is ready.",
        prompt: "Which of the following is the most appropriate respiratory plan for her procedure?",
        options: [
          "Delay PCI until she is off BiPAP",
          "High-flow nasal oxygen during the procedure",
          "Keep BiPAP on during the procedure",
          "Non-rebreather mask during the procedure",
          "Rapid sequence intubation before the procedure",
        ],
        correct: 2,
        explanation:
          "Her respiratory rate has fallen from 32 to 22/minute, her saturation has risen from 86% to 94%, her PCO2 is normal and she is alert, so noninvasive ventilation is working. The ESC heart failure guideline starts it for a respiratory rate above 25/minute or a saturation below 90% to reduce intubation, and keeps intubation for respiratory failure that progresses despite it. Rapid sequence intubation now would add the risks of induction and delay reperfusion without a clear indication. High-flow nasal oxygen or a non-rebreather mask would remove the positive pressure that is lowering her preload and work of breathing. Waiting to wean her would delay reperfusion of an occluded artery.",
      ...
      },
      {
        ...
        kind: "short",
        required: 2,
        prompt: "How does her history change your choice of oral P2Y12 inhibitor?",
        accept: [
          { id: "prasugrel", text: "Avoid prasugrel, because she has had a stroke", match: ["no prasugrel", "avoid prasugrel", "not prasugrel", "prasugrel not", "prasugrel contraindicated", "withhold prasugrel", "without prasugrel", "prasugrel avoided", "never prasugrel"] },
          { id: "tica", text: "Ticagrelor 180 mg PO loading dose, or clopidogrel 600 mg if ticagrelor cannot be used", match: ["ticagrelor", "clopidogrel", "brilinta", "plavix"] },
        ],
        unacceptable: [{ text: "Prasugrel loading dose", match: ["prasugrel 60", "give prasugrel", "start prasugrel", "load prasugrel", "prasugrel load"] }],
        explanation:
          "The 2023 ESC ACS guideline lists previous stroke as a contraindication to prasugrel. It also advises caution with prasugrel at 75 years or older and a lower maintenance dose below 60 kg, and she is 77 years old and weighs 58 kg. Ticagrelor, with a 180 mg loading dose, is the potent alternative. It is contraindicated after intracranial hemorrhage, but her stroke was ischemic. Clopidogrel 600 mg is used when neither potent drug can be given. Her ASA continues.",
      ...
      },
      {
        ...
        required: 3,
        update:
          "PCI of an occluded proximal left anterior descending artery succeeds. Three hours later she is on BiPAP at 10/5 cm H2O with FiO2 0.35. Her respiratory rate is 18/minute, saturation 97%, heart rate 84/minute and BP 124/74 mmHg. She is alert and asks to have the mask taken off.",
        prompt: "How would you take her off BiPAP safely?",
        accept: [
          { id: "fio2", text: "Lower the FiO2 first, keeping her saturation at 90% or more", match: ["fio2", "lower oxygen", "reduce oxygen", "wean oxygen", "titrate oxygen", "decrease oxygen", "lower the oxygen", "reduce the oxygen"] },
          { id: "trial", text: "A supervised trial off BiPAP on nasal prongs or a mask", match: ["trial off", "trial of", "nasal prong", "nasal cannula", "face mask", "venturi", "off bipap", "remove bipap", "remove the mask", "take off bipap"] },
          { id: "watch", text: "Close observation of her respiratory rate, saturation and work of breathing", match: ["respiratory rate", "work of breathing", "observe", "observation", "monitor", "reassess", "watch"] },
          { id: "resume", text: "Put BiPAP back on if her respiratory rate rises above 25/minute, her saturation falls below 90% or she tires", match: ["resume", "reapply", "re apply", "put back", "back on", "restart bipap", "return to bipap", "if she tire", "if she worsen"] },
          { id: "upright", text: "Keep her sitting upright", match: ["upright", "sit up", "sitting up", "head of bed"] },
        ],
        explanation:
          "The ESC heart failure guideline starts noninvasive ventilation for a respiratory rate above 25/minute or a saturation below 90%, and she is now well inside both limits. It also advises titrating the FiO2 to the saturation and giving oxygen when the saturation is below 90%. So the FiO2 comes down first, and then she has a trial off BiPAP on nasal prongs while her respiratory rate, saturation and effort are watched. If she crosses those limits again, BiPAP goes back on, and progressive failure despite it would call for intubation. Sitting upright helps her breathe while the congestion clears.",
        keyFeature: { topic: "pulmonary-edema", n: 4 },
        source: "esc-hf-2021",
      },
    ],
    sources: [S.ash, S.esc, S.escAcs],
    ...META,
    reviewed: false,
    version: 2,
  },
