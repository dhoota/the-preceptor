...
const S = {
  ...
  aorta: {
    id: "acc-aha-aorta-2022",
    citation:
      "Isselbacher EM, Preventza O, Hamilton Black J, et al. 2022 ACC/AHA guideline for the diagnosis and management of aortic disease. Circulation. 2022.",
...
export const PRE_ECLAMPSIA_SAMPS: Samp[] = [
  ...
  /* 15 ------------------------------------------------------------------ */
  {
    id: "pre-eclampsia-15",
    topic: "pre-eclampsia",
    title: "High blood pressure at 18 weeks",
    stem:
      "A 26-year-old woman, G1P0 at 18 weeks and 2 days by a 12-week ultrasound, is sent to the emergency department from her first prenatal visit because of a high BP reading. At a sports physical at age 17 she was told her BP was high, but it was never rechecked. For 2 years she has had frequent headaches, and her calves cramp and her feet feel cold when she runs. She takes only a prenatal vitamin. She has no visual symptoms or abdominal pain. Her femoral pulses are weak and arrive later than her radial pulses. A soft systolic murmur is heard at the left upper sternal border and between the shoulder blades. Reflexes are 2+. The fetal heart rate is 150/minute.",
    vitals: { temperature: "36.8°C", pulse: "76/minute", resp: "16/minute", bp: "162/96 mmHg", o2sat: "99% on room air", weight: "61 kg" },
    questions: [
      {
        id: "q1",
        kind: "short",
        required: 2,
        prompt: "What features suggest a cause for her hypertension other than pre-eclampsia?",
        accept: [
          { id: "ga", text: "Hypertension before 20 weeks", match: ["20 week", "before 20", "18 week", "early gestation", "gestational age", "second trimester"] },
          { id: "prior", text: "High BP noted before pregnancy, at age 17", match: ["age 17", "before pregnancy", "prepregnancy", "pre pregnancy", "sports physical", "previous high", "chronic", "longstanding", "long standing", "adolescence", "teenager"] },
          { id: "fem", text: "Weak, delayed femoral pulses", match: ["femoral", "radiofemoral", "radio femoral", "delayed pulse", "weak pulse", "pulse delay"] },
          { id: "murmur", text: "Systolic murmur heard between the shoulder blades", match: ["murmur", "interscapular", "shoulder blade", "bruit"] },
          { id: "claud", text: "Calf cramps and cold feet with exercise", match: ["cramp", "claudication", "cold feet", "leg pain", "calf"] },
        ],
        explanation:
          "ISSHP classifies hypertension found before 20 weeks as chronic hypertension, while pre-eclampsia develops at or after 20 weeks. Her high reading at age 17 shows that the hypertension predates the pregnancy. ISSHP does not advise routine testing for secondary causes unless there are clues, and she has several. Weak, delayed femoral pulses, a systolic murmur between the shoulder blades and calf symptoms with exercise fit coarctation of the aorta, which causes hypertension in the arms and poor flow to the legs.",
        keyFeature: { topic: "pre-eclampsia", n: 2 },
        source: "isshp",
      },
      {
        ...
        kind: "short",
        required: 4,
        prompt: "What would you do to evaluate her hypertension?",
        accept: [
          { id: "legbp", text: "BP in both arms and a leg", match: ["leg", "lower limb", "lower extremity", "ankle", "thigh", "four limb", "both arms", "arm and leg", "ankle brachial"] },
          { id: "echo", text: "Echocardiogram", match: ["echo", "echocardiogram"] },
          { id: "aorta", text: "Aortic imaging, preferably MRI without gadolinium", match: ["mri", "cmr", "magnetic resonance", "ct angiogram", "ct angiography", "cta"] },
          { id: "upcr", text: "Urine protein to creatinine ratio and urinalysis", match: ["protein creatinine", "pcr", "urinalysis", "urine protein", "proteinuria", "urine microscopy", "albumin creatinine", "dipstick"] },
          { id: "cbc", text: "CBC with platelets", match: ["cbc", "platelet", "blood count"] },
          { id: "creat", text: "Creatinine and electrolytes", match: ["creatinine", "electrolyte", "potassium", "renal function", "kidney function"] },
          { id: "lft", text: "AST or ALT", match: ["ast", "alt", "liver enzyme", "transaminase", "liver function"] },
          { id: "ecg", text: "ECG for left ventricular hypertrophy", match: ["ecg", "electrocardiogram"] },
          { id: "fetal", text: "Obstetric ultrasound for fetal growth", match: ["obstetric ultrasound", "fetal ultrasound", "growth ultrasound", "fetal growth"] },
          { id: "home", text: "Home or ambulatory BP readings", match: ["home bp", "home blood pressure", "ambulatory", "hbpm", "abpm"] },
        ],
        unacceptable: [{ text: "MRI with gadolinium", match: ["gadolinium"] }],
        explanation:
          "The 2022 ACC/AHA aortic disease guideline recommends measuring BP in both arms and a leg in coarctation, and an arm to leg difference of more than 20 mmHg supports a significant narrowing. An echocardiogram shows the narrowing and the aortic valve, which is bicuspid in at least half of patients with coarctation. MRI or CT then defines the anatomy, and in pregnancy MRI without gadolinium is preferred. Every woman with chronic hypertension also needs a baseline urine protein, platelet count, creatinine and liver enzymes, so that superimposed pre-eclampsia can be recognized later. An ECG and a fetal growth scan are also reasonable.",
        keyFeature: { topic: "pre-eclampsia", n: 2 },
        source: "acc-aha-aorta-2022",
      },
      {
        id: "q3",
        kind: "short",
        required: 3,
        update:
          "BP is 160/96 mmHg in the right arm and 116/72 mmHg in the left leg. Echocardiography shows a bicuspid aortic valve and a narrowing of the descending aorta beyond the left subclavian artery, with a peak gradient of 45 mmHg. The ascending aorta is not dilated. Urine protein to creatinine ratio, platelets, creatinine and liver enzymes are normal.",
        prompt: "What would you arrange for her now?",
        accept: [
          { id: "drug", text: "An oral antihypertensive such as labetalol, long-acting nifedipine or methyldopa", match: ["labetalol", "nifedipine", "methyldopa", "antihypertensive"] },
          { id: "target", text: "A target diastolic BP of about 85 mmHg", match: ["85", "target diastolic", "diastolic target"] },
          { id: "team", text: "Referral to a pregnancy heart team with cardiology and maternal-fetal medicine", match: ["cardiology", "cardiologist", "maternal fetal", "mfm", "high risk obstetric", "heart team", "congenital", "perinatologist", "obstetrician", "obstetrics"] },
          { id: "admit", text: "Hospital observation until her BP is controlled", match: ["admit", "admission", "observe", "observation"] },
          { id: "asa", text: "Low-dose ASA at bedtime to reduce the risk of pre-eclampsia", match: ["asa", "aspirin"] },
          { id: "fetal", text: "Serial fetal growth ultrasound", match: ["growth", "fetal ultrasound", "serial ultrasound", "fetal monitoring", "fetal surveillance"] },
          { id: "monitor", text: "Close BP monitoring, including home readings", match: ["home bp", "home blood pressure", "bp monitoring", "close monitoring", "frequent bp"] },
          { id: "mri", text: "MRI of the aorta without gadolinium", match: ["mri", "cmr", "magnetic resonance"] },
        ],
        unacceptable: [
          {
            text: "ACE inhibitor or angiotensin receptor blocker",
            match: ["ramipril", "enalapril", "lisinopril", "perindopril", "ace inhibitor", "losartan", "candesartan", "valsartan", "telmisartan", "angiotensin receptor"],
            dangerous: true,
          },
        ],
        explanation:
          "The 2025 ESC pregnancy guideline lists close BP monitoring, treatment of hypertension and care by a pregnancy heart team for coarctation, with stenting kept for refractory hypertension or maternal or fetal compromise. A systolic BP of 160 mmHg or more needs urgent treatment in a monitored setting under ISSHP. The ESC guideline names methyldopa, labetalol and nifedipine as the drugs of choice and favours tight diastolic control, which ISSHP sets at 85 mmHg. Chronic hypertension is a high-risk factor for pre-eclampsia, so low-dose ASA at bedtime is advised until 36 weeks. Coarctation raises the risk of preterm birth and low birth weight, which fetal growth scans track. ACE inhibitors and angiotensin receptor blockers are contraindicated in pregnancy.",
        keyFeature: { topic: "pre-eclampsia", n: 4 },
        source: "esc-preg-2025",
      },
    ],
    sources: [S.isshp, S.aorta, S.escPreg],
    ...META,
    reviewed: false,
    version: 2,
  },
