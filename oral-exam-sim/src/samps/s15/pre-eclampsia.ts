...
const S = {
  ...
  eular: {
    id: "eular-sle-2017",
    citation:
      "Andreoli L, Bertsias GK, Agmon-Levin N, et al. EULAR recommendations for women's health and the management of family planning, assisted reproduction, pregnancy and menopause in patients with systemic lupus erythematosus and/or antiphospholipid syndrome. Ann Rheum Dis. 2017.",
    url: "https://doi.org/10.1136/annrheumdis-2016-209770",
  },
  tcPreg: {
    id: "tc-preg-vte-2025",
    citation: "Thrombosis Canada. Clinical guide: Pregnancy. Venous thromboembolism treatment. 2025.",
    url: "https://thrombosiscanada.ca/clinical_guides/pdfs/TREATMENTOFDEEPVEINTHROMBOSISP_50.pdf",
  },
...
export const PRE_ECLAMPSIA_SAMPS: Samp[] = [
  ...
  /* 15 ------------------------------------------------------------------ */
  {
    ...
    topic: "pre-eclampsia",
    alsoTopics: ["dvt-pe"],
    title: "Swelling and foamy urine at 31 weeks",
    stem:
      "A 30-year-old woman, G1P0 at 31 weeks and 2 days, presents to the emergency department with 4 days of swelling of her face and legs and foamy urine. She has systemic lupus erythematosus with class IV lupus nephritis, diagnosed 6 years ago and in remission for 3 years. She takes hydroxychloroquine 400 mg daily, azathioprine 100 mg daily, prednisone 5 mg daily and ASA 162 mg at bedtime. Her antiphospholipid antibodies are negative. Three weeks ago a left femoral DVT was diagnosed, and she started dalteparin 7 500 units SC every 12 hours. Her last dose was at 07:00, and it is now 13:00. At 12 weeks her BP was 116 mmHg systolic and 72 mmHg diastolic, her urine protein to creatinine ratio (PCR) was 22 mg/mmol, her creatinine was 64 umol/L and her platelets were 226 x 10^9/L. She has facial edema, pitting edema to both knees and a swollen left thigh. Reflexes are 2+. The fetal heart rate is 140/minute.",
    vitals: { temperature: "36.8°C oral", pulse: "92/minute", resp: "18/minute", bp: "158/104 mmHg", o2sat: "98% on room air", weight: "74 kg" },
    questions: [
      {
        id: "q1",
        kind: "short",
        required: 3,
        prompt: "What features on history and examination would suggest that her lupus is active?",
        accept: [
          { id: "rash", text: "A new rash, such as a malar or photosensitive rash", match: ["rash", "malar", "butterfly", "photosensitiv", "cutaneous lupus"] },
          { id: "joint", text: "Joint pain or swelling", match: ["joint", "arthritis", "arthralgia", "synovitis"] },
          { id: "ulcer", text: "Oral or nasal ulcers", match: ["ulcer"] },
          { id: "sero", text: "Pleuritic chest pain or pericarditis", match: ["pleuritic", "pleurisy", "pericarditis", "serositis", "pleural", "pericardial"] },
          { id: "fever", text: "Fever", match: ["fever", "febrile"] },
          { id: "hair", text: "New hair loss", match: ["hair", "alopecia"] },
          { id: "hematuria", text: "Visible blood in the urine", match: ["hematuria", "blood in the urine", "blood in urine", "cola", "red urine"] },
          { id: "adhere", text: "Missed or stopped doses of hydroxychloroquine or azathioprine", match: ["missed", "stopped hydroxychloroquine", "stopped azathioprine", "stopped her medication", "not taking", "nonadherence", "non adherence", "adherence", "compliance"] },
        ],
        explanation:
          "Her rising BP, edema and heavy proteinuria at 31 weeks fit superimposed pre-eclampsia and a lupus nephritis flare equally well, and the two need different treatment. The EULAR recommendations advise judging pregnancy flares by clinical activity, while remembering that normal pregnancy can mimic some lupus signs. Rash, arthritis, mouth ulcers, serositis, fever and hair loss point to active lupus, and visible hematuria points to active nephritis. Stopping hydroxychloroquine raises the risk of a flare in pregnancy, so ask whether she has missed doses.",
        keyFeature: { topic: "pre-eclampsia", n: 2 },
        source: "eular-sle-2017",
      },
      {
        id: "q2",
        kind: "short",
        required: 3,
        update:
          "She has had no rash, joint symptoms, mouth ulcers, chest pain or fever, and she has taken every dose of her medications. A repeat BP 15 minutes later is 156/106 mmHg. Her PCR is now 380 mg/mmol.",
        prompt: "What tests would help distinguish a lupus nephritis flare from superimposed pre-eclampsia?",
        accept: [
          { id: "comp", text: "C3 and C4, compared with her earlier results", match: ["c3", "c4", "complement"] },
          { id: "dna", text: "Anti-dsDNA antibody titre", match: ["dsdna", "ds dna", "double stranded", "anti dna", "dna antibod"] },
          { id: "sed", text: "Urine microscopy for red cell casts and dysmorphic red cells", match: ["microscopy", "cast", "sediment", "dysmorphic"] },
          { id: "liver", text: "AST and ALT", match: ["ast", "alt", "liver enzyme", "transaminase", "liver function"] },
          { id: "angio", text: "sFlt-1 to PlGF ratio or PlGF, where available", match: ["plgf", "sflt", "placental growth", "angiogenic"] },
        ],
        explanation:
          "The EULAR recommendations use falling C3 and C4, even within the normal range, and rising anti-dsDNA titres to separate a lupus flare from pre-eclampsia. Renal activity is judged by urine sediment, with glomerular hematuria and casts pointing to nephritis. Her proteinuria has risen in both conditions, so it cannot decide between them. ISSHP counts transaminases above 40 IU/L and angiogenic imbalance, such as a low PlGF or a high sFlt-1 to PlGF ratio, as evidence of pre-eclampsia superimposed on chronic disease. A higher BP alone is not enough for that diagnosis.",
        keyFeature: { topic: "pre-eclampsia", n: 2 },
        source: "isshp",
      },
      {
        ...
        required: 3,
        update:
          "Her C3, C4 and anti-dsDNA titre are unchanged from 12 weeks, and urine microscopy shows no red cell casts. Platelets are 118 x 10^9/L, ALT 96 U/L and creatinine 71 umol/L. Obstetrics diagnoses superimposed pre-eclampsia and plans betamethasone and delivery in about 48 hours. Labetalol and magnesium sulfate are started.",
        prompt: "What is your plan for her anticoagulation until delivery?",
        accept: [
          { id: "ufh", text: "Switch to a therapeutic IV unfractionated heparin infusion", match: ["unfractionated", "ufh", "heparin infusion", "iv heparin", "heparin drip", "intravenous heparin"] },
          { id: "stopufh", text: "Stop the heparin infusion 4 to 6 hours before delivery or neuraxial anesthesia", match: ["4 6 hour", "4 hour before", "6 hour before", "stop heparin before", "stop the heparin before", "stop infusion before", "stop the infusion before", "hold heparin before"] },
          { id: "hold", text: "Give no further dalteparin", match: ["hold dalteparin", "stop dalteparin", "no dalteparin", "no more dalteparin", "no further dalteparin", "withhold dalteparin", "discontinue dalteparin", "hold the dalteparin", "stop the dalteparin", "avoid dalteparin", "hold next dose", "skip next dose", "hold lmwh", "stop lmwh", "no lmwh", "avoid lmwh", "no further lmwh"] },
          { id: "neur", text: "No neuraxial anesthesia within 24 hours of her last dalteparin dose, with the time shared with anesthesia", match: ["no neuraxial", "no epidural", "no spinal", "avoid neuraxial", "avoid epidural", "neuraxial 24", "epidural 24", "anesthesia", "anaesthesia", "anesthetist", "anaesthetist"] },
          { id: "restart", text: "Restart anticoagulation about 12 to 24 hours after delivery", match: ["restart", "resume", "after delivery", "postpartum anticoag"] },
        ],
        unacceptable: [
          { text: "Continue dalteparin as scheduled", match: ["continue dalteparin", "next dalteparin", "give dalteparin", "continue lmwh"] },
          { text: "Protamine", match: ["protamine"] },
          { text: "Warfarin or a DOAC", match: ["warfarin", "apixaban", "rivaroxaban", "dabigatran", "edoxaban", "doac"] },
        ],
        explanation:
          "Thrombosis Canada advises a planned delivery for women on therapeutic LMWH, with the last twice-daily dose 24 hours before induction or caesarean section, and no neuraxial anesthesia within 24 hours of a therapeutic dose. Her DVT is only 3 weeks old, which places her at very high risk of recurrence. For women with a clot in the last 2 to 4 weeks the guide allows a switch to therapeutic IV unfractionated heparin, stopped 4 to 6 hours before delivery or epidural insertion. It keeps a vena cava filter for clots less than 2 weeks old, so she does not need one. Anticoagulation restarts 12 to 24 hours after delivery if bleeding allows. Protamine is not needed without bleeding, and warfarin and DOACs are not used in pregnancy.",
        keyFeature: { topic: "pre-eclampsia", n: 4 },
        source: "tc-preg-vte-2025",
      },
    ],
    sources: [S.eular, S.isshp, S.tcPreg],
    ...META,
    reviewed: false,
    version: 2,
  },
