...
export const MULTIPLE_PATIENTS_S44: Samp[] = [
  ...
  },
  {
    ...
    topic: "multiple-patients",
    title: "A call about a wedding reception",
    stem:
    ...
    vitals: { temperature: "37.8°C tympanic", pulse: "118/minute", resp: "22/minute", bp: "82/44 mmHg", o2sat: "96% on room air" },
    questions: [
      {
        id: "q1",
        kind: "single",
        prompt: "Which of the following is the most appropriate way to prepare your department for the arriving guests?",
        options: [
          "Cohort guests in one area with dedicated staff",
          "Place each guest in an airborne isolation room",
          "Seat guests among other waiting patients",
          "Stop assessing new walk-in patients",
          "Turn away all ambulances",
        ],
        correct: 0,
        explanation:
          "Norovirus causes about half of gastroenteritis outbreaks and spreads easily on hands and surfaces. The CDC guideline advises cohorting ill patients together with dedicated nursing staff, with careful handwashing with soap and water. Seating guests among other patients spreads the illness through the department. Norovirus does not need airborne isolation, and a community hospital has too few such rooms for 60 guests. Turning away all ambulances or stopping walk-in assessment abandons other emergencies in the community.",
        keyFeature: { topic: "multiple-patients", n: 4 },
      ...
      },
      {
        ...
        kind: "single",
        update:
          "In the first hour 16 guests arrive. Four of them are described below. The others are vomiting but alert, drinking small sips and have normal vital signs.",
        prompt: "Which of the following guests should receive physician assessment and treatment first?",
        options: [
          "A 7-year-old boy vomiting but drinking",
          "A 45-year-old man with severe cramps",
          "A 30-year-old woman at 32 weeks gestation",
          "An 82-year-old woman with a BP of 82/44 mmHg",
          "The groom with a pounding headache",
        ],
        correct: 3,
        explanation:
          "The older woman has hypotension, tachycardia and drowsiness from fluid loss, made worse by her diuretic and ACE inhibitor, so she needs resuscitation first with IV fluid. The other guests are then managed in parallel, with nurses repeating vital signs on a schedule. The pregnant woman needs early assessment and fetal monitoring, but she has no stated instability. A drinking child, cramps and headache can wait for reassessment.",
        keyFeature: { topic: "multiple-patients", n: 2 },
      ...
      },
      {
        id: "q3",
        kind: "single",
        prompt: "Which of the following is the most appropriate plan for the guests who are alert with normal vital signs?",
        options: [
          "Discharge home without assessment",
          "IV saline bolus for every guest",
          "Nurse-led oral fluids with timed reassessment",
          "Physician review before any treatment",
          "Stool culture before any treatment",
        ],
        correct: 2,
        explanation:
          "The CDC guideline notes that this illness usually settles in 1 to 3 days and that dehydration is treated with oral or IV fluid. Guests who are alert, drinking and have normal vital signs can start oral fluids by nursing protocol, with vital signs repeated on a schedule, while the physicians treat the unstable. Waiting for a physician before any treatment delays care for all of them. An IV bolus for every guest uses stretchers and staff that the sick need. Discharge without assessment could miss a guest who is becoming dehydrated. A stool culture does not guide treatment tonight.",
        keyFeature: { topic: "multiple-patients", n: 2 },
        source: "cdc-norovirus",
      },
      {
    ...
    sources: [
      S.caepDisaster,
      { id: "cdc-norovirus", citation: "Centers for Disease Control and Prevention. Updated norovirus outbreak management and disease prevention guidelines. MMWR Recomm Rep. 2011.", url: "https://pubmed.ncbi.nlm.nih.gov/21368741/" },
    ],
    ...META,
    version: 3,
  },
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: "q2",
        kind: "single",
        prompt: "Which of the following calls is most important to make early for this group?",
        options: [
          "Local police about the seller",
          "Ophthalmology about the blurred vision",
          "Regional hospital to arrange dialysis",
      ...
      },
      {
        id: "q3",
        kind: "single",
        prompt: "Which of the following patients from the party should receive fomepizole now?",
        options: [
          "Both men and the 38-year-old woman",
          "Every person from the party",
          "Only the 44-year-old man",
          "Only the 52-year-old man",
          "The 38-year-old and 29-year-old women",
        ],
        correct: 0,
        explanation:
    ...
    sources: [
      S.ctas2016,
      { id: "extrip-methanol", citation: "Roberts DM, et al. Recommendations for the role of extracorporeal treatments in the management of acute methanol poisoning. A systematic review and consensus statement. EXTRIP Work Group. Crit Care Med. 2015.", url: "https://pubmed.ncbi.nlm.nih.gov/25493973/" },
      S.hicks,
      { id: "aact-methanol", citation: "Barceloux DG, Bond GR, Krenzelok EP, Cooper H, Vale JA. American Academy of Clinical Toxicology practice guidelines on the treatment of methanol poisoning. J Toxicol Clin Toxicol. 2002.", url: "https://pubmed.ncbi.nlm.nih.gov/12216995/" },
    ],
    ...META,
    version: 2,
  },
