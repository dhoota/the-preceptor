...
export const SHOCK_SAMPS: Samp[] = [
    ...
    questions: [
      {
        ...
        kind: "short",
        required: 2,
        prompt: "Why may his heart rate and blood pressure understate his blood loss?",
        accept: [
      ...
      },
      {
        id: "q3",
        kind: "single",
        update: "The eFAST shows fluid around the liver and spleen and in the pelvis. After 500 mL of Ringer's lactate his BP is 82/50 mmHg.",
        prompt: "Which of the following is the most appropriate resuscitation fluid for him now?",
        options: [
          "Albumin 25% 200 mL IV",
          "Normal saline 2 L IV bolus",
          "Plasma 15 mL/kg to correct his INR",
          "Platelets before any red cells",
          "Uncrossmatched red cells now",
        ],
        correct: 4,
        explanation:
          "He is bleeding into his abdomen and stays hypotensive after crystalloid, so he needs red cells now. The European guideline recommends a restricted volume strategy until bleeding is controlled and, for expected massive bleeding, red cells given with fibrinogen or plasma. It restricts colloids such as albumin because of their effect on hemostasis. More saline dilutes clotting factors. Waiting to correct his INR with plasma delays the red cells he needs, and platelets do not restore oxygen carrying capacity.",
        keyFeature: { topic: "shock", n: 3 },
        source: "euro-trauma-2023",
      },
      {
        ...
        kind: "short",
        required: 2,
        update: "CT shows a laceration of the right lobe of the liver with active contrast extravasation. INR 2.2, platelets 46 x 10^9/L, fibrinogen 0.9 g/L. Interventional radiology is on the way.",
        prompt: "Which hemostatic treatments does he need while the liver bleeding is being controlled?",
        accept: [
          { id: "fib", text: "Fibrinogen concentrate or cryoprecipitate, about 3 to 4 g", match: ["fibrinogen", "cryoprecipitate", "cryo"] },
          { id: "plt", text: "Platelet transfusion to keep platelets above 50 x 10^9/L", match: ["platelet"] },
          { id: "txa", text: "Tranexamic acid 1 g IV over 10 minutes, then 1 g over 8 hours, within 3 hours of injury", match: ["tranexamic", "txa"] },
          { id: "ca", text: "Monitor and correct ionized calcium", match: ["calcium"] },
          { id: "visco", text: "Viscoelastic testing to guide products", match: ["viscoelastic", "rotem", "teg", "thromboelastography"] },
        ],
        explanation:
          "His fibrinogen of 0.9 g/L is below the 1.5 g/L level at which the European guideline recommends fibrinogen concentrate or cryoprecipitate, starting with 3 to 4 g. It suggests platelets to keep the count above 50 x 10^9/L during ongoing bleeding, tranexamic acid 1 g over 10 minutes then 1 g over 8 hours within 3 hours of injury, and keeping ionized calcium in the normal range. Early and repeated coagulation testing, conventional or viscoelastic, guides further products.",
        keyFeature: { topic: "multiple-trauma", n: 4 },
        source: "euro-trauma-2023",
      },
    ],
    sources: [S.euroTrauma, S.agaCirrhosis],
    ...META,
    reviewed: false,
    version: 2,
  },
  ...
  /* 05 Stab wound above the clavicle ------------------------------------ */
  {
    ...
    stem:
      "A 24-year-old man is brought to the emergency department by ambulance 20 minutes after he was stabbed once just above the left clavicle. Paramedics have held a gauze pad on the wound, and bright red blood wells up whenever the pressure is eased. He is pale, anxious and speaking in full sentences. His trachea is midline and there is no expanding hematoma in the neck. Breath sounds are slightly reduced at the left apex. A full log roll finds no other wound. Both radial pulses are weak.",
    ...
    questions: [
      ...
      },
      {
        ...
        kind: "short",
        required: 3,
        update: "The eFAST shows a small left pleural collection and no pericardial fluid. After 500 mL of crystalloid from paramedics his BP is 78/48 mmHg.",
        prompt: "What are the principles of his fluid and blood resuscitation?",
        accept: [
          { id: "blood", text: "Uncrossmatched red cells now through the massive hemorrhage protocol", match: ["massive transfusion", "massive hemorrhage", "massive haemorrhage", "mtp", "red cell", "prbc", "uncrossmatched", "blood"] },
          { id: "ratio", text: "Plasma or fibrinogen with the red cells, and platelets", match: ["plasma", "fibrinogen", "cryoprecipitate", "platelet", "ratio"] },
          { id: "restrict", text: "No further crystalloid", match: ["limit crystalloid", "stop crystalloid", "minimize crystalloid", "minimise crystalloid", "no more crystalloid", "no further crystalloid", "restrict crystalloid", "limit saline", "stop saline"] },
          { id: "target", text: "Permissive hypotension with a systolic target of about 90 mmHg until bleeding is controlled", match: ["permissive", "systolic 80", "systolic 90", "sbp 80", "sbp 90", "80 to 90", "hypotensive resuscitation"] },
          { id: "warm", text: "Warm all products and prevent heat loss", match: ["warm", "warmer", "hypothermia"] },
        ],
        unacceptable: [{ text: "Another 2 L of crystalloid", match: ["2 l crystalloid", "2 l saline", "2l saline", "2l crystalloid", "more crystalloid", "more saline"] }],
        explanation:
          "He is in hemorrhagic shock from a wound that pressure only partly controls. The European guideline recommends a restricted volume strategy with a systolic target of 80 to 90 mmHg until major bleeding stops, when there is no brain injury. For expected massive bleeding it recommends red cells with fibrinogen or with plasma at a ratio of at least 1 to 2, and suggests a high platelet ratio. A review of penetrating neck trauma aims for a systolic near 90 mmHg, because lower pressures risk stroke if a head vessel is injured and higher pressures can dislodge clot. Active warming prevents hypothermia. More crystalloid dilutes clotting factors and carries no oxygen.",
        keyFeature: { topic: "shock", n: 3 },
        source: "euro-trauma-2023",
      },
      {
        ...
        kind: "short",
        required: 1,
        update: "Tranexamic acid was given on arrival. After 4 units of red cells and 4 units of plasma his ionized calcium is 0.84 mmol/L.",
        prompt: "What drug does he need now, with its dose?",
        accept: [
          { id: "cacl", text: "Calcium chloride 1 g IV (10 mL of 10%)", match: ["calcium chloride 1 g", "calcium chloride 1g", "calcium chloride 10 ml", "calcium chloride 1 gram", "cacl 1 g", "cacl2 1 g"] },
          { id: "cagluc", text: "Calcium gluconate 3 g IV (30 mL of 10%), which gives about the same elemental calcium", match: ["calcium gluconate 3 g", "calcium gluconate 3g", "calcium gluconate 30 ml", "calcium gluconate 3 gram"] },
        ],
        explanation:
          "Each unit of red cells or plasma carries about 3 g of citrate, which binds calcium. His ionized calcium of 0.84 mmol/L is well below the normal 1.1 to 1.3 mmol/L, and the European guideline advises prompt correction below 0.9 mmol/L, since levels below 0.8 mmol/L are linked to dysrhythmias. Low calcium impairs clotting and cardiac contractility. The guideline prefers calcium chloride. 10 mL of 10% calcium chloride gives 270 mg of elemental calcium, while 10 mL of 10% calcium gluconate gives 90 mg.",
        keyFeature: { topic: "shock", n: 8 },
        source: "euro-trauma-2023",
      },
      {
        ...
        kind: "short",
        required: 2,
        prompt: "What would you do to control bleeding from the wound while the operating room is readied?",
        accept: [
          ...
          { id: "pack", text: "Pack the wound with hemostatic gauze", match: ["hemostatic gauze", "haemostatic gauze", "hemostatic dressing", "pack the wound", "wound packing", "packing"] },
          { id: "or", text: "Urgent operating room with a vascular or thoracic surgeon", match: ["operating room", "operating theatre", "vascular surgeon", "thoracic surgeon", "vascular surgery", "thoracic surgery", "trauma surgeon", "surgical control"] },
        ],
        explanation:
    ...
    sources: [S.euroTrauma, S.lossNeck],
    ...META,
    reviewed: false,
    version: 2,
  },
    ...
    questions: [
      ...
      },
      {
        ...
        accept: [
          ...
          { id: "mg", text: "Magnesium sulfate IV", match: ["magnesium"] },
      ...
      },
      {
        ...
        kind: "menu",
        select: 2,
        update: "Twenty minutes later he goes into ventricular fibrillation. After three shocks, epinephrine and amiodarone, he remains in ventricular fibrillation.",
        prompt: "Which of the following are the most appropriate next steps for him?",
        options: [
          "Activate ECMO or bypass",
        ...
        correct: [0, 6],
        explanation:
          "In the review of aconite dysrhythmias, prolonged cardiopulmonary resuscitation was followed by a return to sinus rhythm in 9 of 15 patients and cardiopulmonary bypass in 4 of 6. The authors call both time-buying strategies that let the body excrete the alkaloids. Stopping at 20 minutes abandons a patient who may recover. Digoxin immune Fab treats cardiac glycoside toxicity, not aconite. Calcium, naloxone and physostigmine treat calcium channel blocker, opioid and anticholinergic toxicity, and hemodialysis cannot be run during cardiac arrest.",
        keyFeature: { topic: "tox", n: 4 },
        source: "coulson-aconite-2017",
      },
    ],
