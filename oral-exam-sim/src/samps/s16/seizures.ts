  ...
  /* 05 Caffeine tablet overdose ---------------------------------------- */
  {
    ...
    questions: [
      ...
      },
      {
        ...
        kind: "short",
        required: 1,
        update: "Forty minutes later she has a second generalized seizure that stops after lorazepam 4 mg IV. She then has runs of ventricular tachycardia. Her BP is 84/40 mmHg.",
        prompt: "What treatment would remove the caffeine?",
        accept: [
          { id: "hd", text: "Urgent hemodialysis", match: ["hemodialysis", "haemodialysis", "dialysis", "extracorporeal", "hemoperfusion"] },
        ],
        explanation:
          "Recurrent seizures, ventricular tachycardia and hypotension mark severe caffeine poisoning. Kohara's series proposes extracorporeal removal for convulsive seizures, ventricular arrhythmia, circulatory collapse, severe tachycardia, depressed consciousness or a caffeine concentration of 140 mg/L or more, with hemodialysis as the first choice. Hemodialysis under VA ECMO support is considered for lethal arrhythmia or cardiac arrest, and continuous methods for patients too unstable for intermittent hemodialysis.",
        keyFeature: { topic: "tox", n: 4 },
        source: "kohara-caffeine-2026",
      },
      {
        ...
        kind: "short",
        required: 2,
        update: "She recovers fully after hemodialysis. She holds a G2 driver's licence and works weekends as a lifeguard.",
        prompt: "What advice would you give her about driving and other activities before discharge?",
        accept: [
          { id: "nodrive", text: "No driving until she has fully recovered and had a neurologic evaluation", match: ["not drive", "no driving", "stop driving", "avoid driving", "dont drive", "should not drive"] },
          { id: "later", text: "Once she has recovered from the toxic cause and been assessed, she can drive again", match: ["resume driving", "drive again", "return to driving", "can drive"] },
          { id: "lifeguard", text: "No lifeguarding, swimming alone or work at heights until she is cleared", match: ["lifeguard", "lifeguarding", "no lifeguarding", "no lifeguard", "avoid lifeguarding", "swimming", "no swimming", "avoid swimming", "swim alone", "heights", "no heights"] },
          { id: "caffeine", text: "Stop using caffeine tablets and high-dose caffeine products", match: ["avoid caffeine", "no caffeine", "stop caffeine", "caffeine tablets", "energy drink"] },
          { id: "followup", text: "Follow-up with her physician or a neurologist", match: ["neurologist", "neurology", "follow up", "family physician", "family doctor"] },
        ],
        explanation:
          "The CMA Driver's Guide says that when a seizure is directly related to a toxic illness and the patient has fully recovered, the seizure is of no concern in judging later fitness to drive, but a neurologic evaluation should be obtained in all such cases. Until that is done she should not drive. Activities where a sudden loss of awareness would endanger her or others, such as lifeguarding and swimming alone, wait until she is cleared. She should stop using caffeine tablets.",
        keyFeature: { topic: "seizures", n: 5 },
        source: "cma-driver",
      },
    ],
    sources: [S.kohara, S.cmaDriver],
    ...META,
    reviewed: false,
    version: 2,
  },
  ...
  /* 07 Exertional collapse with a normal resting ECG ------------------- */
  {
    ...
    questions: [
      ...
      },
      {
        ...
        kind: "short",
        required: 3,
        prompt: "What management does he need for this condition?",
        accept: [
          { id: "bb", text: "A nonselective beta blocker such as nadolol", match: ["nadolol", "propranolol", "beta blocker", "nonselective beta"] },
          { id: "flecainide", text: "Flecainide added as directed by electrophysiology", match: ["flecainide"] },
          { id: "sport", text: "No competitive sport or strenuous exercise until assessed", match: ["no sport", "no competitive", "avoid sport", "avoid competitive", "avoid strenuous", "no strenuous", "exercise restriction", "restrict exercise", "no soccer", "stop soccer"] },
          { id: "cardiology", text: "Admission for monitoring and urgent pediatric cardiology or electrophysiology care", match: ["cardiology", "cardiologist", "electrophysiology", "electrophysiologist", "admit", "admission", "monitor"] },
          { id: "family", text: "Genetic testing and screening of first-degree relatives", match: ["family screening", "screen family", "relatives", "sibling", "genetic", "ryr2"] },
        ],
        unacceptable: [
          { text: "An antiseizure medication", match: ["levetiracetam", "antiseizure", "antiepileptic", "anticonvulsant", "carbamazepine", "valproate"] },
          { text: "A selective beta blocker such as metoprolol", match: ["metoprolol", "atenolol", "bisoprolol"] },
        ],
        explanation:
          "Beta blockers are first-line for CPVT, and the CPVT review prefers nonselective drugs such as nadolol because selective beta-1 blockers appear less effective. It advises avoiding strenuous activity, especially competitive sport, and notes that genetically positive relatives should be treated even with a negative exercise test. In the Sydney cohort, events recurred mainly with poor adherence or a beta blocker alone, and flecainide added to the beta blocker suppressed exercise-induced VT. ICDs can give inappropriate shocks and trigger VT storms in CPVT, so that decision rests with electrophysiology.",
        keyFeature: { topic: "arrhythmia", n: 6 },
        source: "luo-cpvt-2025",
      },
    ],
    sources: [S.luoCpvt, S.fitzgeraldCpvt],
    ...META,
    reviewed: false,
    version: 2,
  },
