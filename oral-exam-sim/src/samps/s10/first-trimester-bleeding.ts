...
const S = {
  ...
  niceSigns: {
    id: "nice-ng126-signs",
    citation: "National Institute for Health and Care Excellence. NG126. Ectopic pregnancy and miscarriage: diagnosis and initial management. Section 1.4, Symptoms and signs of ectopic pregnancy and initial assessment. 2019, updated 2026.",
    url: "https://www.nice.org.uk/guidance/ng126/chapter/Recommendations",
  },
  ikomi: {
    id: "ikomi",
    citation: "Ikomi A, Matthews M, Kuan AM, Henson G. The effect of physiological urine dilution on pregnancy test results in complicated early pregnancies. Br J Obstet Gynaecol. 1998. 105(4):462 to 465.",
    url: "https://doi.org/10.1111/j.1471-0528.1998.tb10135.x",
  },
  sheele: {
    id: "sheele",
    citation: "Sheele JM, Bernstein R, Counselman FL. A ruptured ectopic pregnancy presenting with a negative urine pregnancy test. Case Rep Emerg Med. 2016.",
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC5030406/",
  },
  escPregnancy: {
    id: "esc-pregnancy",
    citation: "De Backer J, Haugaa KH, et al. 2025 ESC Guidelines for the management of cardiovascular disease and pregnancy. European Society of Cardiology. Eur Heart J. 2025. 46(43):4462.",
...
export const FIRST_TRIMESTER_BLEEDING_SAMPS: Samp[] = [
  ...
  },
  {
    ...
    topic: "first-trimester-bleeding",
    title: "Collapse after a long run",
    stem:
      "A 26-year-old woman is brought to the emergency department by EMS after collapsing at the end of a 20 km training run on a warm morning. She was unresponsive for a few seconds. Since then she has had crampy lower abdominal pain, which she blames on the run, and light vaginal bleeding that she thinks is an early period. She has drunk 2 L of water and a sports drink since the collapse. She is a marathon runner, and her watch records a usual resting heart rate of 46/minute. Triage has labelled her exertional dehydration. Lying down she feels well. On standing her pulse rises to 128/minute and she feels faint. She is pale.",
    vitals: { temperature: "37.4°C", pulse: "96/minute", resp: "18/minute", bp: "104/78 mmHg", o2sat: "99% on room air" },
    questions: [
      {
        id: "q1",
        kind: "short",
        required: 2,
        prompt: "What findings suggest early hemorrhagic shock rather than exertional dehydration?",
        accept: [
          k("relative", "A heart rate of 96 that is double her usual resting rate of 46", "double", "baseline", "usual resting", "resting rate", "relative tachycardia", "her normal"),
          k("ortho", "A pulse rise of 32 on standing with presyncope", "orthostatic", "postural", "on standing", "standing", "presyncope", "faint"),
          k("persist", "Symptoms that persist after stopping exercise and drinking 2 L", "persist", "despite fluid", "despite drinking", "not improved", "after stopping"),
          k("pp", "Narrow pulse pressure of 26 mmHg", "pulse pressure", "narrow"),
          k("pale", "Pallor", "pale", "pallor", "cool", "clammy"),
          k("syncope", "Collapse with loss of consciousness", "collapse", "syncope", "unresponsive", "loss of consciousness"),
        ],
        unacceptable: [no("A pulse under 100 excludes shock", "excludes shock", "rules out shock", "pulse normal")],
        explanation:
          "Her pulse of 96/minute looks unremarkable, but it is more than double her own resting rate of 46/minute. Standing raises it by 32/minute to 128/minute and she becomes presyncopal. Symptoms that persist after she has stopped running and drunk 2 L are not explained by dehydration. Her pulse pressure of 26 mmHg is narrow and she is pale. NICE lists tachycardia, orthostatic hypotension, pallor, collapse and dizziness among the presentations of ectopic pregnancy.",
        keyFeature: { topic: "first-trimester-bleeding", n: 1 },
        source: "nice-ng126-signs",
      },
      {
        id: "q2",
        kind: "short",
        required: 1,
        update: "The triage urine pregnancy test was negative. The urine specific gravity was 1.002.",
        prompt: "What test do you order next?",
        accept: [k("serum", "Serum hCG, quantitative or qualitative", "serum hcg", "blood hcg", "serum pregnancy", "blood pregnancy", "quantitative hcg", "quantitative bhcg", "quantitative beta", "serum beta", "serum bhcg", "quant hcg")],
        unacceptable: [
          harm("Accept the urine result as excluding pregnancy", "pregnancy excluded", "rules out pregnancy", "not pregnant"),
          no("Repeat the urine test on a first morning sample", "first morning", "morning urine", "repeat urine"),
        ],
        explanation:
          "Her urine was very dilute after 2 L of fluid, with a specific gravity of 1.002. In a prospective study of women with suspected early pregnancy complications, urine tests with higher hCG detection limits missed pregnancies in dilute urine, and the authors advised caution in gynecological emergencies. A serum hCG removes the effect of dilution and gives an answer within the hour. Waiting for a morning urine sample is unsafe in a woman who collapsed and is bleeding.",
        keyFeature: { topic: "first-trimester-bleeding", n: 2 },
        source: "ikomi",
      },
      {
        ...
        required: 3,
        update:
          "Serum hCG is 190 IU/L. Bedside ultrasound shows an empty uterus and a small amount of free fluid in the pouch of Douglas. There is no fluid in the hepatorenal space. After 20 minutes lying down her pulse is 90/minute.",
        prompt: "What are your next steps?",
        accept: [
          k("gyn", "Gynecology assessment in the department now", "gynecology", "gynaecology", "gyne", "obstetric", "ob gyn"),
          k("tvus", "Formal transvaginal ultrasound", "transvaginal", "tvus", "formal ultrasound", "endovaginal"),
          k("group", "Blood group and antibody screen", "blood group", "type and screen", "group and screen", "antibody screen", "crossmatch", "cross match"),
          k("cbc", "CBC", "cbc", "hemoglobin", "complete blood count"),
          k("iv", "IV access", "iv access", "iv line", "intravenous access", "large bore"),
          k("monitor", "Monitored bed with serial vitals and repeat abdominal examination", "monitor", "serial vital", "repeat exam", "reassess"),
          k("npo", "Nothing by mouth", "npo", "nothing by mouth", "nil by mouth", "fasting"),
        ],
        unacceptable: [harm("Discharge with follow up for dehydration", "discharge", "send home", "outpatient ultrasound")],
        explanation:
          "A positive hCG, an empty uterus and pelvic free fluid in a woman who collapsed make ectopic pregnancy the working diagnosis. NICE advises immediate specialist assessment for a woman with a positive test and pain or bleeding, and gynecology should see her in the department. Formal transvaginal imaging looks for an adnexal mass. A blood group, CBC and IV access prepare for surgery or transfusion if bleeding resumes. She stays monitored and nothing by mouth, because the fluid may be the first sign of rupture.",
        keyFeature: { topic: "first-trimester-bleeding", n: 2 },
        source: "nice-ng126-signs",
      },
      {
        ...
        kind: "short",
        required: 2,
        update: "The sports medicine fellow says an hCG of 190 IU/L is too low for a tubal pregnancy to bleed and that the fluid is from the run.",
        prompt: "Why is this reasoning unsafe?",
        accept: [
          k("low", "Ectopic pregnancies can rupture at very low hCG levels", "low hcg", "low level", "any level", "any hcg", "rupture at", "very low"),
          k("single", "A single hCG value cannot locate the pregnancy", "single", "one value", "one level", "locate", "location"),
          k("early", "An intrauterine sac would not yet be visible at this level, so the empty uterus does not settle it", "discriminatory", "not yet visible", "too early to see", "too early to be seen", "not yet be visible"),
          k("urine", "Her negative urine test already shows how low her hCG is", "urine"),
          k("fluid", "Free fluid after a collapse is not explained by running", "free fluid", "running", "exercise"),
        ],
        explanation:
          "Urine tests generally turn positive once serum hCG reaches about 25 IU/L, and a ruptured ectopic pregnancy with hemoperitoneum has been reported at a serum hCG of 10 IU/L. No hCG level excludes ectopic pregnancy or rupture, and a single value cannot locate a pregnancy. At 190 IU/L an intrauterine sac is not expected to be visible, so the empty uterus neither confirms nor excludes an ectopic. Free fluid after a collapse is not explained by running and is treated as blood until proven otherwise.",
        keyFeature: { topic: "first-trimester-bleeding", n: 4 },
        source: "sheele",
      },
    ],
    sources: [S.niceSigns, S.ikomi, S.sheele],
    ...META,
    version: 2,
    reviewed: false,
  },
  ...
  },
  {
    ...
    topic: "first-trimester-bleeding",
    title: "Heavy bleeding on warfarin",
    stem:
      "A 33-year-old woman presents to the emergency department with 5 hours of heavy vaginal bleeding with clots and crampy lower abdominal pain. She has soaked 6 pads in the last 2 hours. She has a mechanical mitral valve and takes warfarin 4 mg daily, which her previous heart team continued when she became pregnant. She moved from another province 3 weeks ago and has not had an ultrasound in this pregnancy. She is 12 weeks and 4 days by a certain last menstrual period. Point of care INR is 4.6. She is pale and her hands are cool. On standing her pulse rises to 124/minute and her systolic pressure falls by 22 mmHg.",
    vitals: { temperature: "36.9°C", pulse: "96/minute", resp: "18/minute", bp: "114/72 mmHg", o2sat: "98% on room air", weight: "68 kg" },
    questions: [
      {
        id: "q1",
        kind: "short",
        required: 2,
        prompt: "What findings suggest that her blood loss is significant?",
        accept: [
          k("pads", "Soaking 6 pads in 2 hours with clots", "pad", "soaking", "soaked", "clot"),
          k("ortho", "Pulse rise of 28 and systolic fall of 22 mmHg on standing", "orthostatic", "postural", "on standing", "standing", "systolic fall", "drop in blood pressure"),
          k("tachy", "Resting pulse of 96", "resting pulse", "tachycardia", "96", "heart rate"),
          k("pale", "Pallor and cool hands", "pale", "pallor", "cool", "cold hand"),
          k("inr", "An INR of 4.6 that will keep her bleeding", "inr", "supratherapeutic", "anticoagulated", "warfarin"),
        ],
        unacceptable: [no("A normal supine blood pressure excludes shock", "excludes shock", "rules out shock", "blood pressure normal")],
        explanation:
          "Her pulse rises by 28/minute and her systolic pressure falls by 22 mmHg on standing, which shows a meaningful loss of circulating volume while her supine pressure is still normal. Soaking 6 pads in 2 hours with clots is heavy ongoing bleeding. Pallor, cool hands and a resting pulse of 96/minute add to the picture. An INR of 4.6 is above her valve target and makes further bleeding likely. NICE lists tachycardia, pallor and orthostatic hypotension among the signs of a bleeding early pregnancy.",
        keyFeature: { topic: "first-trimester-bleeding", n: 1 },
        source: "nice-ng126-signs",
      },
      {
        ...
        prompt: "Which of the following is the most appropriate next step to locate this pregnancy?",
        options: [
          "CT of abdomen and pelvis with contrast",
          "Formal ultrasound booked for tomorrow",
          "MRI of the pelvis without contrast",
          "Pelvic ultrasound at the bedside now",
          "Quantitative hCG repeated in 48 hours",
        ],
        correct: 3,
        explanation:
          "She is bleeding heavily, is orthostatic and has never had a scan in this pregnancy, so its location must be found now. A bedside pelvic ultrasound can show an intrauterine pregnancy, an empty uterus or free fluid within minutes. A scan tomorrow or a repeat hCG in 48 hours leaves an ectopic pregnancy undetected while she bleeds. CT exposes the pregnancy to radiation and MRI delays care, and neither is a first test in early pregnancy. NICE advises immediate specialist assessment for a woman with a positive test and bleeding or pain.",
        keyFeature: { topic: "first-trimester-bleeding", n: 2 },
        source: "nice-ng126-signs",
      },
      {
        ...
        kind: "short",
        required: 3,
        update: "Bedside ultrasound shows an empty uterus with blood in the endometrial cavity and no adnexal mass. There is no free fluid. Hemoglobin is 96 g/L.",
        prompt: "What are your next steps?",
        accept: [
          k("gyn", "Gynecology assessment today", "gynecology", "gynaecology", "gyne", "obstetric"),
          k("pul", "Manage as a pregnancy of unknown location, not a complete miscarriage, because no intrauterine pregnancy was ever seen", "pregnancy of unknown location", "pul", "possible ectopic", "ectopic not excluded", "exclude ectopic", "not complete miscarriage", "not a complete miscarriage"),
          k("hcg", "Quantitative hCG now and in 48 hours", "quantitative", "serial hcg", "repeat hcg", "quant"),
          k("tvus", "Formal transvaginal ultrasound", "transvaginal", "tvus", "formal ultrasound"),
          k("team", "Involve her heart team or hematology in anticoagulation decisions", "cardiology", "cardiologist", "heart team", "hematology", "haematology", "thrombosis"),
          k("hold", "Hold tonight's warfarin dose", "hold warfarin", "withhold warfarin", "hold tonight", "omit warfarin", "skip warfarin", "hold the warfarin"),
          k("pcc", "Prothrombin complex concentrate if bleeding becomes life threatening", "pcc", "prothrombin complex", "octaplex", "beriplex"),
          k("xm", "Crossmatch red cells", "crossmatch", "cross match", "type and screen", "group and screen"),
        ],
        unacceptable: [
          no("Discharge as a complete miscarriage", "complete miscarriage discharge", "discharge home"),
          no("Full reversal with vitamin K 10 mg IV", "vitamin k 10", "10 mg vitamin k", "high dose vitamin k"),
        ],
        explanation:
          "An empty uterus after heavy bleeding fits a completed miscarriage, but no intrauterine pregnancy was ever seen, so she is managed as a pregnancy of unknown location with gynecology, serial hCG and a transvaginal scan. Her mechanical mitral valve carries a high risk of valve thrombosis, and the 2025 ESC pregnancy guideline calls for a structured anticoagulation plan with the pregnancy heart team and an expert hematologist. When rapid correction of a vitamin K antagonist is needed in pregnancy, the guideline prefers IV 4 factor prothrombin complex concentrate, with vitamin K only if necessary. She is not bleeding to the point of instability now, so reflex full reversal is avoided.",
        keyFeature: { topic: "first-trimester-bleeding", n: 2 },
        source: "esc-pregnancy",
      },
      {
        id: "q4",
        kind: "single",
        update: "Her blood group is A Rh D negative with a negative antibody screen.",
        prompt: "Which of the following is the most appropriate Rh immune globulin plan for this patient?",
        options: [
          "Defer it until the pregnancy is located",
          "Kleihauer Betke test first to set the dose",
          "Omit it while she is anticoagulated",
          "Rh immune globulin 120 mcg within 72 hours",
          "Rh immune globulin 300 mcg within 72 hours",
        ],
        correct: 4,
        explanation:
          "She is 12 weeks and 4 days pregnant, Rh D negative and not sensitized. For threatened or spontaneous abortion or ectopic pregnancy after 12 weeks, the 2024 SOGC guideline suggests 300 mcg of Rh immune globulin within 72 hours. The recommendation covers ectopic and intrauterine loss alike, so the dose does not wait for the pregnancy to be located. The 120 mcg dose is for earlier gestations. A Kleihauer Betke test is not used to set the dose for a first trimester event. Anticoagulation does not remove the need for prophylaxis.",
        keyFeature: { topic: "first-trimester-bleeding", n: 5 },
        source: "sogc-rh",
      },
    ],
    sources: [S.niceSigns, S.escPregnancy, S.sogcRh],
    ...META,
    version: 2,
    reviewed: false,
  },
