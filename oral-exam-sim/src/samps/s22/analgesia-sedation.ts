  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: "q3",
        kind: "single",
        update: "Twenty minutes after his first analgesic dose he still cries when his leg is moved. His FLACC score is 6. He is awake and his breathing is normal.",
        prompt: "Which of the following is the most appropriate next step to control his pain?",
        options: ["codeine 15 mg PO", "Fascia iliaca block", "ketamine 22 mg IV", "midazolam 0.75 mg IV", "No further analgesia"],
        correct: 1,
        explanation:
          "A FLACC score of 6 twenty minutes after the first dose is still moderate pain, so another modality should be added. A fascia iliaca block anaesthetises the femoral nerve territory and adds analgesia without more systemic opioid. In the one randomized trial of children with femoral fractures, it gave better and longer lasting pain relief than IV opioids, although the evidence is of low quality. Codeine should not be used in children in Canada. Ketamine 22 mg is about 1.5 mg/kg, a dissociative sedation dose rather than an analgesic dose. Midazolam sedates without relieving pain, and stopping now leaves him in pain.",
        keyFeature: { topic: TOPIC, n: 3 },
        source: "black-femur",
      },
    ],
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: "q2",
        kind: "single",
        update: "Twenty minutes later the rocuronium is still active. Her pulse rises to 138/minute and BP to 168/98 mmHg. No drug doses have been changed.",
        prompt: "Which of the following is the most appropriate response to the change in her vital signs?",
        options: ["Give fentanyl 50 mcg IV", "Give labetalol 10 mg IV", "Give rocuronium 50 mg IV", "Increase the ventilator rate", "Order repeat CT of chest and abdomen"],
        correct: 0,
        explanation:
      ...
      },
      {
        id: "q3",
        kind: "single",
        update: "The rocuronium has worn off. She grimaces and fights the ventilator when she is turned.",
    ...
    sources: [
      PADIS,
      { id: "ed-awareness", citation: "Pappal RD, Roberts BW, Mohr NM, et al. The ED-AWARENESS study: a prospective, observational cohort study of awareness with paralysis in mechanically ventilated patients admitted from the emergency department. Ann Emerg Med. 2021.", url: "https://doi.org/10.1016/j.annemergmed.2020.10.012" },
    ],
    reviewed: false,
    author: AUTHOR,
    version: 2,
