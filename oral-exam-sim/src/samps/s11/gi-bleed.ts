    ...
    questions: [
      ...
      },
      {
        ...
        accept: [
          ...
          { id: "cold", text: "Hypothermia", match: ["hypothermia"] },
          { id: "acid", text: "Hyperchloremic acidosis", match: ["acidosis"] },
          { id: "edema", text: "Tissue or pulmonary edema", match: ["edema", "ascites"] },
          { id: "o2", text: "Lacks oxygen carrying capacity and dilutes hemoglobin", match: ["oxygen carrying", "no oxygen", "hemoglobin"] },
          { id: "clot", text: "Dislodges clot by raising blood pressure", match: ["clot"] },
        ],
        explanation:
          "Crystalloid carries no oxygen and dilutes clotting factors. In portal hypertension it raises portal pressure and increases variceal rebleeding. It also worsens ascites, hypothermia and acidosis. Use blood early and target a modest blood pressure rather than normal.",
        keyFeature: { topic: "shock", n: 3 },
        source: "baveno",
      },
      {
