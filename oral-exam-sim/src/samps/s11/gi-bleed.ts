    ...
    questions: [
      {
        ...
        accept: [
          ...
          { id: "palmar", text: "Palmar erythema", match: ["palmar"] },
          { id: "ascites", text: "Ascites or shifting dullness", match: ["ascites"] },
          { id: "caput", text: "Caput medusae or dilated abdominal wall veins", match: ["caput"] },
          { id: "spleen", text: "Splenomegaly", match: ["splenomegaly"] },
          { id: "asterixis", text: "Asterixis or encephalopathy", match: ["asterixis"] },
          { id: "gyne", text: "Gynecomastia", match: ["gynecomastia"] },
          { id: "testes", text: "Testicular atrophy", match: ["testicular atrophy"] },
          { id: "dupuytren", text: "Dupuytren contracture", match: ["dupuytren"] },
          { id: "parotid", text: "Parotid enlargement", match: ["parotid"] },
          { id: "nails", text: "Leukonychia or clubbing", match: ["leukonychia"] },
          { id: "wasting", text: "Muscle wasting", match: ["wasting"] },
        ],
        explanation:
          "Stigmata of chronic liver disease raise the likelihood of variceal bleeding. That changes early therapy, because octreotide and antibiotic prophylaxis are added to standard care. Heavy alcohol use alone does not prove cirrhosis, so look for it.",
      ...
      },
      {
        ...
        accept: [
          ...
          { id: "rbc", text: "Transfuse uncrossmatched group O red cells", match: ["uncrossmatched", "transfuse", "transfusion", "prbc", "red cell", "red blood cell", "o negative", "o positive", "o neg"] },
          { id: "mtp", text: "Activate the massive hemorrhage protocol", match: ["massive transfusion", "massive hemorrhage", "mtp", "mhp"] },
          { id: "airway", text: "Assess airway and plan intubation for airway protection", match: ["intubation", "airway"] },
          { id: "monitor", text: "Cardiac monitoring and continuous oximetry", match: ["cardiac monitor", "cardiac monitoring", "telemetry"] },
          { id: "calls", text: "Early call to gastroenterology for endoscopy", match: ["gastroenterology"] },
        ],
        unacceptable: [
          { text: "Large volume crystalloid to a normal blood pressure", match: ["aggressive crystalloid"], },
          { text: "Aggressive fluid resuscitation", match: ["aggressive fluid"], },
        ],
        explanation:
          "This is hemorrhagic shock. Secure access, send crossmatch, and give blood early through the massive hemorrhage protocol. Keep crystalloid to the minimum needed to bridge to blood. Large volumes worsen coagulopathy and raise portal pressure, which increases variceal bleeding.",
      ...
      },
      {
        ...
        accept: [
          ...
          { id: "tips", text: "Rescue TIPS", match: ["tips", "transjugular"] },
          { id: "repeat", text: "Repeat endoscopic therapy by an experienced endoscopist", match: ["repeat endoscopy", "repeat endoscopic"] },
        ],
        explanation:
          "Balloon tamponade or an esophageal stent is a temporary bridge for refractory variceal bleeding. Definitive rescue is TIPS. Tamponade needs an intubated patient and should stay in no longer than about 24 hours.",
        keyFeature: { topic: "gi-bleed", n: 6 },
        source: "baveno",
      },
    ],
    sources: [S.baveno, S.cbs],
    ...META,
  },
  {
    id: "gi-bleed-02",
