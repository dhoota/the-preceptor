    ...
    questions: [
      {
        ...
        unacceptable: [
          { text: "Ampicillin, after a reaction with hives, lip swelling and breathing difficulty", match: ["ampicillin", "amoxicillin", "piperacillin", "benzylpenicillin", "pen g", "penicillin million unit", "penicillin 5 million"], dangerous: true },
          ...
          { text: "Hold the antibiotics until after delivery", match: ["antibiotic after delivery", "antibiotic after birth", "antibiotic postpartum", "treat after delivery", "wait until delivery", "wait until after delivery", "hold antibiotic until delivery", "hold antibiotic until birth", "withhold antibiotic until delivery", "delay antibiotic", "defer antibiotic"], dangerous: true },
        ],
        explanation:
