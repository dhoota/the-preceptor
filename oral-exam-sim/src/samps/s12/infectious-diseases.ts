    ...
    questions: [
      ...
      },
      {
        ...
        accept: [
          ...
          { id: "fever", text: "Maternal fever of 38.9°C, which is 38°C or more", match: ["fever", "temperature", "38.9"] },
          { id: "noiap", text: "No intrapartum antibiotic prophylaxis yet", match: ["no antibiotic", "no prophylaxis", "no intrapartum antibiotic", "inadequate prophylaxis", "without antibiotic"] },
      ...
      },
      {
        ...
        correct: [0, 1, 6],
        explanation:
          "Manitoba's protocol gives prophylaxis at labour or rupture of membranes to women with a positive screening swab, to women with group B streptococcus in the urine at any time in the current pregnancy, to women who have had an infant with group B streptococcal disease, and, whatever the swab shows, when delivery is before 37 weeks, when membranes have been ruptured for 18 hours or more, or when the temperature in labour reaches 38.0°C. So a fever of 38.2°C and labour at 34 weeks both qualify on their own. Membrane rupture of 10 hours with a negative swab and a negative swab at term do not. A caesarean before labour with intact membranes is the stated exception even with a positive swab. Colonization is transient, so a positive swab in an earlier pregnancy does not count, unlike a previous infant with the disease. Penicillin G 5 million units IV, then 2.5 to 3 million units every 4 hours until delivery, is the agent of choice.",
