...
const S = {
  ...
  chorio: { id: "chorio", citation: "Conde-Agudelo A, Romero R, Jung EJ, Garcia Sanchez AJ. Management of clinical chorioamnionitis: an evidence-based approach. Am J Obstet Gynecol. 2020.", url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC8315154/" },
  cpsEos: { id: "cps-eos", citation: "Jefferies AL. Management of term infants at increased risk for early onset bacterial sepsis. Canadian Paediatric Society, Fetus and Newborn Committee. Paediatr Child Health. 2017.", url: "https://cps.ca/en/documents/position/management-infant-sepsis" },
  mbGbs: { id: "mb-gbs", citation: "Manitoba Health, Seniors and Active Living. Communicable disease management protocol: streptococcal group B invasive disease of the newborn. Government of Manitoba. August 2016.", url: "https://www.gov.mb.ca/health/publichealth/cdc/protocol/groupb.pdf" },
  ...
  tintinalliNeck: { id: "tintinalli-neck", citation: "Tintinalli JE, Ma OJ, Yealy DM, Meckler GD, Stapczynski JS, Cline DM, Thomas SH, editors. Tintinalli's Emergency Medicine: A Comprehensive Study Guide. 9th ed. McGraw Hill. 2020. Chapter 246, Neck and Upper Airway." },
    ...
    questions: [
      {
        ...
        unacceptable: [
          { text: "Ampicillin, after a reaction with hives, lip swelling and breathing difficulty", match: ["ampicillin", "amoxicillin", "piperacillin", "benzylpenicillin", "pen g", "penicillin million unit", "penicillin 5 million", "pip tazo", "piperacillin tazobactam", "tazocin", "zosyn", "unasyn", "augmentin", "clavulin", "cloxacillin"], dangerous: true },
          ...
          { text: "Hold the antibiotics until after delivery", match: ["antibiotic after delivery", "antibiotic after birth", "antibiotic postpartum", "give antibiotic after delivery", "give antibiotic after birth", "give antibiotic postpartum", "start antibiotic after delivery", "start antibiotic after birth", "start antibiotic postpartum", "antibiotic only after delivery", "antibiotic only after birth", "postpone antibiotic", "treat after delivery", "wait until delivery", "wait until after delivery", "hold antibiotic until delivery", "hold antibiotic until birth", "withhold antibiotic until delivery", "withhold antibiotic until birth", "hold antibiotic until after delivery", "hold antibiotic until after birth", "withhold antibiotic until after delivery", "withhold antibiotic until after birth", "delay antibiotic", "defer antibiotic"], dangerous: true },
        ],
        explanation:
          "Fever of 38.9°C with a pulse of 122/minute, a fetal heart rate of 178/minute, uterine tenderness, foul smelling discharge and a white cell count of 19.4 x 10^9/L meet the clinical criteria for intraamniotic infection. Those criteria ask for fever plus two or more of those signs. The usual regimen is ampicillin with gentamicin. Hives, lip swelling and breathing difficulty within minutes of amoxicillin describe anaphylaxis, so a penicillin is unsafe. Manitoba's protocol also rules out cefazolin, which is for a penicillin allergy without those features. Full marks need both parts of the regimen. Vancomycin 1 g IV every 12 hours or clindamycin 900 mg IV every 8 hours replaces the ampicillin as the gram positive agent. Gentamicin 5 mg/kg IV every 24 hours, which is 390 mg at 78 kg, covers gram negative organisms. No susceptibility result is available, and the Manitoba protocol directs vancomycin rather than clindamycin when susceptibility to clindamycin and erythromycin is unknown. So vancomycin is the more reliable substitute. Acetaminophen treats the fever but is not part of the antibiotic regimen.",
        keyFeature: { topic: "infectious-diseases", n: 1 },
        source: "chorio",
      },
      {
        ...
        correct: 0,
        explanation:
          "Antibiotics belong in labour rather than after birth, because intrapartum treatment lowers the rate of neonatal pneumonia and sepsis. Intraamniotic infection on its own is not an indication for caesarean delivery, and vaginal birth is the safer route, so caesarean is kept for standard obstetric indications. No evidence shows that delivering immediately after the diagnosis improves maternal or neonatal outcomes. Amniotic fluid culture takes days, and the clinical criteria identify proven intraamniotic infection only about half the time, so treatment cannot wait for a result.",
        keyFeature: { topic: "infectious-diseases", n: 1 },
        source: "chorio",
      },
      {
        ...
        kind: "short",
        required: 2,
        prompt: "Which features of this case raise the risk of early onset sepsis in her newborn?",
        accept: [
        ...
        explanation:
          "The Canadian Paediatric Society names maternal group B streptococcal colonization in the current pregnancy, group B streptococcal bacteriuria, a previous infant with invasive disease, rupture of membranes of 18 hours or more and maternal fever of 38°C or more as the factors most often linked with early onset sepsis, and it states that these factors are additive. She has colonization, 26 hours of ruptured membranes and a fever of 38.9°C. Prophylaxis counts as adequate only when penicillin G, ampicillin or cefazolin is given at least 4 hours before birth. She has had none, and the society counts clindamycin or vancomycin as inadequate prophylaxis when managing the newborn. Manitoba's protocol adds intraamniotic infection and a longer duration of membrane rupture. At 38 weeks, preterm birth is not a factor here.",
      ...
      },
      {
        ...
        prompt: "Which of the following situations call for intrapartum prophylaxis against group B streptococcus under the Manitoba protocol?",
        options: [
          "Fever of 38.2°C in labour, negative screening swab",
          "Group B streptococcus in the urine this pregnancy",
          "Membranes intact, caesarean before labour, positive swab",
          "Membranes ruptured 10 hours, negative screening swab",
          "Negative screening swab at 36 weeks, labour at term",
          "Positive swab in a previous pregnancy, negative now",
          "Preterm labour at 34 weeks, no screening swab done",
        ],
        correct: [0, 1, 6],
        explanation:
          "Manitoba's protocol gives prophylaxis at labour or rupture of membranes to women with a positive screening swab, to women with group B streptococcus in the urine at any time in the current pregnancy, to women who have had an infant with group B streptococcal disease, and, whatever the swab shows, when delivery is before 37 weeks, when membranes have been ruptured for 18 hours or more, or when the temperature in labour reaches 38.0°C. So a fever of 38.2°C and labour at 34 weeks both qualify on their own. The Canadian Paediatric Society statement offers risk based prophylaxis only when the swab result is unknown, so the fever with a negative swab follows the Manitoba protocol named in the stem and is Manitoba specific. Membrane rupture of 10 hours with a negative swab and a negative swab at term do not. A caesarean before labour with intact membranes is the stated exception even with a positive swab. Colonization is transient, so a positive swab in an earlier pregnancy does not count, unlike a previous infant with the disease. Penicillin G 5 million units IV, then 2.5 to 3 million units every 4 hours until delivery, is the agent of choice.",
        keyFeature: { topic: "infectious-diseases", n: 10 },
        source: "mb-gbs",
      },
    ],
    sources: [S.chorio, S.cpsEos, S.mbGbs],
    ...META,
    version: 2,
    reviewed: false,
  },
