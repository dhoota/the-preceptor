...
export const INFECTIOUS_DISEASES_SAMPS: Samp[] = [
  ...
  },
  {
    ...
    topic: "infectious-diseases",
    alsoTopics: ["shock"],
    title: "Spreading skin lesions and fever",
    stem:
      "A 38-year-old man presents to the emergency department with 10 days of painful skin lesions and 2 days of fever and chills. The lesions began around the anus and genitals and have spread to his face, trunk and limbs. He has HIV and stopped antiretroviral therapy 2 years ago. His last CD4 count, 8 months ago, was 90 x 10^6/L. He had an MRSA groin abscess last year. He injects methamphetamine. He has more than 100 firm, umbilicated papules and pustules, many with necrotic centres. On the right thigh, a cluster of ulcerated lesions sits within 12 cm of warm, tender, spreading erythema with purulent drainage. Lactate is 4.6 mmol/L. A lesion swab is sent for mpox PCR.",
    vitals: { temperature: "39.3°C", pulse: "126/minute", resp: "24/minute", bp: "84/48 mmHg", o2sat: "95% on room air", weight: "64 kg" },
    questions: [
      {
        id: "q1",
        kind: "short",
        required: 2,
        prompt: "What empiric antimicrobial therapy do you start now?",
        accept: [
          { id: "mrsa", text: "Vancomycin IV for MRSA, or linezolid or daptomycin", match: ["vancomycin", "vanco", "linezolid", "daptomycin"] },
          { id: "broad", text: "Piperacillin-tazobactam IV, or another broad agent such as meropenem", match: ["piperacillin", "pip tazo", "piptazo", "tazocin", "meropenem", "imipenem", "ceftriaxone and metronidazole", "ceftriaxone plus metronidazole", "cefepime and metronidazole", "cefepime plus metronidazole"] },
        ],
        unacceptable: [
          { text: "Wait for the mpox PCR before antibiotics", match: ["wait for pcr", "await pcr", "after pcr result", "wait for mpox"] },
          { text: "No antibiotics because the illness is viral", match: ["no antibiotic", "antibiotics not needed", "antibiotics not indicated", "withhold antibiotic"], dangerous: true },
        ],
        explanation:
          "He has sepsis with hypotension and a lactate of 4.6 mmol/L from a spreading, draining skin infection around ulcerated lesions. SSC 2026 recommends antimicrobials immediately, ideally within 1 hour, and coverage for a resistant organism when the risk of it is high. His MRSA abscess last year puts him at high risk of MRSA, so vancomycin is added. Necrotic lesions near the perineum in a host with advanced HIV justify broad Gram-negative and anaerobic cover, such as piperacillin-tazobactam. The antibiotics treat the bacterial superinfection, not the virus, so a pending mpox PCR is no reason to wait.",
        keyFeature: { topic: "infectious-diseases", n: 1 },
        source: "ssc-2026",
      },
      {
        ...
        options: [
          "After CT of the thigh excludes necrotizing infection",
          "After the mpox PCR result is available",
          "After the surgical team assesses the thigh",
          "Once 30 mL/kg of crystalloid has been given",
          "Within 1 hour, after blood cultures are drawn",
        ],
        correct: 4,
        explanation:
          "SSC 2026 recommends antimicrobials immediately, ideally within 1 hour of recognizing sepsis or septic shock. It also recommends blood cultures as soon as possible and ideally before the first dose, which takes minutes and does not delay treatment. Imaging and a surgical assessment of the thigh are needed to look for necrotizing infection, but they run in parallel and do not come first. The mpox PCR will not change the need for antibiotics tonight. Crystalloid of at least 30 mL/kg starts at the same time as the antibiotics, and neither waits for the other.",
        keyFeature: { topic: "infectious-diseases", n: 1 },
        source: "ssc-2026",
      },
      {
        ...
        kind: "short",
        required: 2,
        prompt: "Which host factors in his history raise his risk of severe infection?",
        accept: [
          { id: "cd4", text: "Advanced HIV with a CD4 count of 90 x 10^6/L", match: ["cd4", "advanced hiv", "aids", "immunosuppress", "immunocompromise", "hiv"] },
          { id: "art", text: "Untreated HIV, off antiretroviral therapy for 2 years", match: ["off art", "no art", "stopped art", "not on art", "antiretroviral", "untreated hiv", "uncontrolled hiv", "viral load"] },
          { id: "mrsa", text: "Previous MRSA infection", match: ["mrsa", "methicillin resistant"] },
          { id: "idu", text: "Injection drug use", match: ["inject", "injection drug", "methamphetamine", "ivdu", "pwid", "drug use", "crystal meth"] },
        ],
        explanation:
          "Immunosuppression is the main host factor. The Canadian Immunization Guide lists people with uncontrolled HIV among those at higher risk of severe mpox, and he has had no antiretroviral therapy for 2 years with a last CD4 count of 90 x 10^6/L. His previous MRSA abscess is a host factor for a resistant skin superinfection and shapes the antibiotic choice. Injecting drugs breaks the skin and adds a route for bacterial infection.",
      ...
      },
      {
        ...
        kind: "menu",
        select: 3,
        update: "The PCR confirms mpox. Public health asks for help identifying contacts for post-exposure vaccination. He lives with a roommate and has had four sexual partners in the past 5 weeks.",
        prompt: "Which of the following contacts should be offered post-exposure mpox vaccine?",
        options: [
          "Neighbour who spoke with him at his door",
          "Paramedic who wore a gown, gloves and mask",
          "Partner from five weeks ago, unvaccinated",
          "Partner from nine days ago, unvaccinated",
          "Partner from three days ago, two doses last year",
          "Partner from three days ago, unvaccinated",
          "Roommate who shares his towels and bedding",
          "Sister who visited briefly without touching",
        ],
        correct: [3, 5, 6],
        explanation:
          "The Canadian Immunization Guide recommends a post-exposure dose for people with a high-risk exposure who have not had 2 doses, as soon as possible, preferably within 4 days and up to 14 days after the last exposure. PHAC counts sexual partners, household members and people in contact with contaminated bedding or towels as high-risk contacts. His unvaccinated partners from three and nine days ago and his roommate qualify. The partner from five weeks ago is past the 14-day window. The partner with 2 doses already has a complete series. The paramedic used appropriate PPE, and a talk at the door or a short visit without touching is low risk. All contacts self-monitor for 21 days.",
        keyFeature: { topic: "infectious-diseases", n: 10 },
        source: "phac-mpox",
      },
    ],
    sources: [S.ssc2026, S.cigMpox, S.phacMpox],
    ...META,
    version: 2,
    reviewed: false,
  },
