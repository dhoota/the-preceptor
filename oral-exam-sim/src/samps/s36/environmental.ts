...
export const ENVIRONMENTAL_S36: Samp[] = [
  ...
  /* 17 ------------------------------------------------------------------ */
  {
    id: "environmental-17",
    topic: "environmental",
    title: "A boy who stopped sweating at camp",
    stem: "A 9-year-old boy is brought to the emergency department by ambulance from a day camp in Windsor, Ontario, on a humid 33°C afternoon. After 2 hours of outdoor games he became confused, stumbled and vomited once. His counsellor noticed that his skin was hot and dry while the other children were soaked with sweat. Paramedics moved him into the shade but did not cool him further. He has epilepsy treated with topiramate, started 3 months ago, and attention deficit hyperactivity disorder treated with methylphenidate. He has had no recent illness. He is agitated and does not know where he is. His skin is hot, flushed and dry. His pupils are 4 mm and reactive. His neck is supple, and he passed urine at camp an hour ago.",
    vitals: { temperature: "41.4°C rectal", pulse: "152/minute regular", resp: "30/minute", bp: "96/52 mmHg", o2sat: "98% on room air", weight: "30 kg" },
    questions: [
      {
        id: "q1",
        kind: "single",
        prompt: "Which of the following is the most appropriate first step in the management of this boy?",
        options: [
          "Blood cultures and CT head first",
          "Cold water immersion now",
          "IV fluid bolus and observe",
          "Lumbar puncture before cooling",
          "Tepid sponging and a fan",
        ],
        correct: 1,
      ...
      },
      {
        id: "q2",
        kind: "single",
        prompt: "Which of the following best explains why this boy did not sweat like the other children?",
        options: [
          "Anticholinergic poisoning",
          "Dehydration from one vomit",
          "Meningitis with sepsis",
          "Methylphenidate stimulant effect",
          "Topiramate-related hypohidrosis",
        ],
        correct: 4,
        ...
        keyFeature: { topic: "environmental", n: 2 },
        source: "incecik-topiramate",
      },
      {
        id: "q3",
        kind: "single",
        prompt: "Which of the following is the most accurate way to track his core temperature during cooling?",
        options: [
      ...
      },
      {
        ...
        prompt: "Which of the following is the most appropriate advice before this boy returns to summer camp?",
        options: [
          "Avoid all outdoor activity this summer",
          "Return to full games tomorrow",
          "Review topiramate with his neurologist",
          "Take acetaminophen before games",
          "Take extra salt tablets at camp",
        ],
        correct: 2,
  ...
  /* 23 ------------------------------------------------------------------ */
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["After his core temperature stabilizes", "After 24 hours of observation", "Before core rewarming begins", "Once the feet thaw on their own", "Only after surgical consultation"],
        correct: 0,
        explanation:
    ...
    sources: [S.paal, S.wmsFrost, S.poole],
    ...META,
  },
