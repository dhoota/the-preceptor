...
export const SEIZURES_S49: Samp[] = [
  ...
  /* 22 Febrile seizure after MMRV vaccine ------------------------------- */
  {
    id: "seizures-22",
    topic: T,
    alsoTopics: ["pediatric-fever"],
    title: "Toddler brought in after shaking at home",
    stem:
    ...
    vitals: { temperature: "39.0°C rectal", pulse: "150/minute", resp: "34/minute", o2sat: "99% on room air", weight: "10 kg" },
    questions: [
      {
        id: "q1",
        kind: "single",
        prompt: "Which of the following best explains the timing of her fever and seizure?",
        options: [
          "Acute otitis media",
      ...
      },
      {
        id: "q4",
        kind: "menu",
        prompt: "Which of the following statements for her parents are accurate about this simple febrile seizure?",
        options: [
          "A future febrile seizure may harm her learning",
          "Daily antiseizure medicine is not advised",
          "Her epilepsy risk is close to average",
          "Regular ibuprofen will prevent another seizure",
          "She is likely to develop epilepsy",
          "She needs an MRI before starting school",
        ],
        select: 2,
        correct: [1, 2],
        explanation:
          "The AAP guideline recommends neither continuous nor intermittent antiseizure medicine after simple febrile seizures, because the harms outweigh the benefit of preventing a benign recurrence. Children with simple febrile seizures have about the same 1% risk of epilepsy by age 7 years as other children, so epilepsy is not likely. No decline in learning has been shown after recurrent simple febrile seizures. Antipyretics do not prevent recurrence. Nothing in her history or examination calls for an MRI.",
        keyFeature: { topic: T, n: 8 },
        source: "aap-fs-long",
      },
    ],
    sources: [S.cigMeasles, S.cigContra, { ...S.aapFsLong, url: "https://doi.org/10.1542/peds.2008-0939" }],
    ...META,
    version: 2,
  },
