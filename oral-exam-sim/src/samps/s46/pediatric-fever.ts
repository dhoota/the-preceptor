...
export const PEDIATRIC_FEVER_S46: Samp[] = [
  ...
  /* 22 ------------------------------------------------------------------ */
  {
    ...
    topic: "pediatric-fever",
    title: "Night call from a nursing station",
    stem:
      "You are working in a regional hospital emergency department as the on-call physician for a nursing station in a fly-in First Nations community in northern Manitoba. At 03:00 the nurse calls about a 2-year-old girl with 2 days of fever. She has no cough, vomiting or diarrhea. Her mother brought her in because she has been quiet and clingy since supper. She is fully immunized and has been healthy. The nurse measured her vital signs while she slept on her mother's lap. Her chest is clear, her abdomen is soft, her ears are normal and there is no rash.",
    vitals: { temperature: "39.6°C tympanic", pulse: "134/minute", resp: "30/minute", bp: "80/32 mmHg", o2sat: "97% on room air", weight: "12 kg" },
    questions: [
      {
        id: "q1",
        kind: "single",
        prompt: "Which of the following findings reported by the nurse is most concerning for sepsis?",
        options: [
          "Heart rate of 134/minute asleep",
          "Oxygen saturation of 97%",
          "Respiratory rate of 30/minute",
          "Temperature of 39.6°C tympanic",
          "Two days of fever",
        ],
        correct: 0,
        explanation:
          "The Canadian Paediatric Society gives a normal heart rate of 80 to 120/minute for a sleeping toddler. Her rate of 134/minute was counted while she slept, so it is too fast. It would pass for an awake toddler, whose range reaches 140/minute, which is why it is easy to miss. Her respiratory rate of 30/minute is inside the toddler range of 22 to 37/minute, and a saturation of 97% is normal. Fever for 2 days, even to 39.6°C, is common in minor viral illness and does not by itself separate sepsis from a benign cause.",
        keyFeature: { topic: "pediatric-fever", n: 2 },
        source: "cps-sepsis",
      },
      {
        id: "q2",
        kind: "single",
        update: "The nurse wakes her to examine her. She opens her eyes only when her name is called loudly. She glances at her mother, does not cry or push the nurse away and falls back asleep within seconds.",
        prompt: "Which of the following best describes her response to being woken for the examination?",
        options: [
          "Fear of the examining nurse",
          "Irritability from high fever",
          "Reduced response to social cues",
          "Stranger anxiety at her age",
          "Usual sleepiness for the hour",
        ],
        correct: 2,
        explanation:
          "She rouses only to a loud voice, glances at her mother without crying or resisting, and falls back asleep within seconds. That is a reduced response to social cues. NICE rates a child who is not responding normally to social cues, or who does not stay awake once roused, as at intermediate or high risk of serious illness. A frightened, irritable or stranger-wary toddler cries, clings to a parent or pushes the examiner away, and she does none of these. A well child woken at night stays awake or awakens quickly, so this is not usual sleepiness for the hour.",
        keyFeature: { topic: "pediatric-fever", n: 2 },
        source: "nice-fever-under-5",
      },
      {
        id: "q3",
        kind: "single",
        update: "The nurse reports warm pink hands and feet, a capillary refill of under 1 second and bounding pulses.",
        prompt: "Which of the following best describes the state of her circulation based on these findings?",
        options: [
          "Cold septic shock",
          "Dehydration without shock",
          "Fever with normal perfusion",
          "Hypovolemic shock",
          "Warm septic shock",
        ],
        correct: 4,
        explanation:
          "Flash capillary refill and bounding pulses are the signs of vasodilatation that the Canadian Paediatric Society describes in warm septic shock. Her blood pressure of 80/32 mmHg gives a wide pulse pressure of 48 mmHg with a low diastolic pressure. Her systolic pressure is above the Canadian Paediatric Society threshold for hypotension at 2 years, which is 70 + (2 x 2) = 74 mmHg. With a heart rate too fast for sleep, this is still shock. Warm pink skin is easily mistaken for normal perfusion. Cold septic shock and hypovolemic shock cause cool extremities and a slow capillary refill. She has no vomiting or diarrhea to cause dehydration.",
        keyFeature: { topic: "pediatric-fever", n: 2 },
        source: "cps-sepsis",
      },
      {
        id: "q4",
        kind: "single",
        update: "Two IV attempts fail. No one at the station can place an intraosseous needle. The station stocks ceftriaxone and amoxicillin. The medevac aircraft will land in 3 hours.",
        prompt: "Which of the following is the most appropriate antibiotic plan for her at this point?",
        options: [
          "amoxicillin PO now, then IV at hospital",
          "ceftriaxone IM now, before the flight",
          "ceftriaxone IV on arrival at hospital",
          "ceftriaxone IV once the flight team arrives",
          "No antibiotic until blood cultures are drawn",
        ],
        correct: 1,
        explanation:
          "She has signs of septic shock, so antibiotics should start within 1 hour of assessment. Blood cultures are ideally drawn first, but waiting for them must not delay treatment. When IV access cannot be obtained, the Canadian Paediatric Society advises intramuscular or intraosseous injection until it is, so ceftriaxone IM now is the plan. Waiting for the flight team or the hospital delays antibiotics by 3 hours or more. Oral amoxicillin is not an empiric sepsis treatment. The guidance names a cephalosporin such as ceftriaxone for a child with sepsis.",
        keyFeature: { topic: "pediatric-fever", n: 3 },
        source: "cps-sepsis",
      },
    ],
    sources: [S.cpsSepsis, S.niceFever],
    ...META,
    version: 2,
  },
