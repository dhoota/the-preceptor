...
export const TOX_SAMPS: Samp[] = [
  ...
  /* 09 Thyroid hormone excess -------------------------------------------- */
  {
    ...
    title: "Palpitations after a weight-loss plan",
    stem:
      "A 24-year-old woman presents to the emergency department with 3 days of palpitations, tremor, sweating and loose stools, and 2 hours of central chest tightness. For 3 weeks she has taken her mother's levothyroxine to lose weight, about ten 200 mcg tablets a day. She stopped yesterday. She takes a combined oral contraceptive and denies other drugs. She has no asthma or heart failure. She is restless but calm and oriented. Her skin is warm and moist. Pupils are 4 mm and reactive. There is a fine tremor of the outstretched hands. There is no goitre and no eye signs. The ECG shows sinus tachycardia without ST changes. A pregnancy test is negative.",
    vitals: { temperature: "38.2°C", pulse: "142/minute", resp: "22/minute", bp: "152/58 mmHg", o2sat: "98% on room air", weight: "52 kg" },
    questions: [
      {
        id: "q1",
        kind: "short",
        required: 2,
        prompt: "Which features of her presentation point to thyroid hormone excess rather than a sympathomimetic drug?",
        accept: [
          { id: "calm", text: "Calm and oriented, without psychomotor agitation", match: ["oriented", "calm", "not agitated", "no agitation", "no psychomotor", "no delirium", "lucid"] },
          { id: "gi", text: "Loose stools", match: ["diarrhea", "diarrhoea", "loose stool", "bowel movement", "hyperdefecation"] },
          { id: "source", text: "Three weeks of levothyroxine taken for weight loss", match: ["levothyroxine", "thyroxine", "synthroid", "thyroid hormone", "thyroid pill", "mother", "weight loss"] },
          { id: "course", text: "Symptoms that built over days and continue after stopping", match: ["over days", "gradual", "three days", "3 days", "after stopping", "persist", "slow onset"] },
          { id: "pupils", text: "Pupils of normal size that react to light", match: ["pupil", "no mydriasis", "not dilated"] },
        ],
        explanation:
          "AHA 2023 describes sympathomimetic poisoning as tachycardia, hypertension and hyperthermia with marked psychomotor agitation, and seizures when severe. She is restless but calm and oriented. The Synthroid product monograph lists palpitations, sweating, diarrhea, tremor, fever and weight loss as signs of excess levothyroxine, and warns that symptoms may appear only several days after ingestion. Her 3 weeks of levothyroxine, symptoms building over 3 days and loose stools fit that picture. Neither toxidrome has a direct antidote, so the diagnosis steers the supportive treatment.",
        keyFeature: { topic: "tox", n: 2 },
        source: "aha-2023",
      },
      {
        ...
        kind: "short",
        required: 1,
        prompt: "What drug do you give first for her tachycardia and tremor?",
        accept: [
          { id: "prop", text: "Propranolol", match: ["propranolol", "inderal"] },
          { id: "bb", text: "Another beta blocker, such as metoprolol or esmolol", match: ["beta blocker", "metoprolol", "esmolol", "atenolol", "nadolol", "bisoprolol", "beta blockade"] },
        ],
        unacceptable: [
          { text: "Phentolamine", match: ["phentolamine"] },
          { text: "Physostigmine", match: ["physostigmine"] },
        ],
        explanation:
          "Her tachycardia and tremor come from thyroid hormone acting on sympathetic pathways. The Synthroid product monograph names beta blockers, particularly propranolol, as useful against the increased central and peripheral sympathetic activity when no contraindication exists, and she has no asthma or heart failure. Phentolamine is a vasodilator that AHA 2023 supports for coronary vasospasm from sympathomimetic poisoning, which is not her problem. Physostigmine reverses anticholinergic toxicity, and her moist skin and loose stools argue against that toxidrome.",
        keyFeature: { topic: "tox", n: 4 },
        source: "synthroid-pm",
      },
      {
        id: "q3",
        kind: "menu",
        update: "After propranolol her pulse is 104/minute and the tremor has eased. TSH is below 0.01 mIU/L and free T4 is 86 pmol/L (reference 12 to 22 pmol/L). She asks to go home.",
        prompt: "Which of the following are most appropriate in her further management?",
        options: [
          "Admission with telemetry for several days",
          "Cholestyramine by mouth several times daily",
          "Cyproheptadine by mouth",
          "Dantrolene by IV infusion",
          "Discharge when her heart rate is below 100",
          "Hemodialysis through a temporary catheter",
          "Phentolamine by IV bolus",
          "Physostigmine by slow IV push",
        ],
        select: 2,
        correct: [0, 1],
        explanation:
          "The Synthroid product monograph warns that symptoms may not appear until several days after ingestion. She stopped only yesterday and her free T4 is about four times the upper reference limit, so a monitored admission is safer than discharge once the rate settles. The monograph lists cholestyramine among the measures used to reduce levothyroxine absorption after overdose. T4 is extensively protein bound, so dialysis removes very little. Phentolamine treats sympathomimetic vasospasm. Physostigmine treats anticholinergic toxicity, cyproheptadine serotonin toxicity and dantrolene malignant hyperthermia, and she has none of these.",
        keyFeature: { topic: "tox", n: 4 },
        source: "synthroid-pm",
      },
      {
        ...
        kind: "short",
        required: 3,
        prompt: "What life-threatening causes of her chest tightness must you consider?",
        accept: [
          { id: "acs", text: "Myocardial ischemia, including demand ischemia from tachycardia or coronary vasospasm", match: ["ischemia", "ischaemia", "acute coronary", "myocardial infarction", "vasospasm", "demand", "type 2", "stemi", "nstemi", "angina", "acs"] },
          { id: "pe", text: "Pulmonary embolism, given her combined oral contraceptive", match: ["pulmonary embolism", "embolism", "embolus"] },
          { id: "arrhythmia", text: "Tachyarrhythmia such as atrial fibrillation", match: ["atrial fibrillation", "afib", "arrhythmia", "dysrhythmia", "tachyarrhythmia", "svt", "ventricular tachycardia"] },
          { id: "dissection", text: "Aortic dissection", match: ["dissection"] },
          { id: "hf", text: "Heart failure or myocarditis", match: ["heart failure", "myocarditis", "cardiomyopathy", "pulmonary edema"] },
          { id: "ptx", text: "Pneumothorax", match: ["pneumothorax"] },
          { id: "tamponade", text: "Pericardial effusion with tamponade", match: ["tamponade", "pericardial effusion"] },
        ],
        explanation:
          "The Synthroid product monograph lists angina, arrhythmias and heart failure among the effects of excess levothyroxine. ESC 2023 recognizes type 2 MI from tachycardia or coronary vasospasm, and names pulmonary embolism and aortic dissection as life-threatening alternatives to ACS. Her combined oral contraceptive raises the chance of pulmonary embolism, which also causes tachycardia and chest pain. A single ECG without ST changes does not exclude these, so troponin and further testing follow.",
        keyFeature: { topic: "chest-pain", n: 1 },
        source: "esc-acs-2023",
      },
    ],
    sources: [S.synthroid, S.aha, S.esc2023],
    ...META,
    version: 2,
    reviewed: false,
  },
