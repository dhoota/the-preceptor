...
const S = {
  ...
  esc2023: { id: "esc-acs-2023", citation: "Byrne RA, Rossello X, Coughlan JJ, et al. 2023 ESC Guidelines for the management of acute coronary syndromes. Eur Heart J. 2023. Section 3.4.2 on CT for alternative diagnoses, section 11 and Figure 15 on MINOCA, and section 12.1 on Type 2 MI.", url: "https://doi.org/10.1093/eurheartj/ehad191" },
  cdcYb: { id: "cdc-yellow-book-2026", citation: "Ansdell VE. Food poisoning from marine toxins. In: CDC Yellow Book 2026: Health Information for International Travel. Centers for Disease Control and Prevention. 2025.", url: "https://www.cdc.gov/yellow-book/hcp/environmental-hazards-risks/food-poisoning-from-marine-toxins.html" },
  tortorella: { id: "tortorella-2014", citation: "Tortorella V, Masciari P, Pezzi M, et al. Histamine poisoning from ingestion of fish or scombroid syndrome. Case Rep Emerg Med. 2014.", url: "https://doi.org/10.1155/2014/482531" },
  gingras: { id: "gingras-2025", citation: "Gingras V, Marois L. Case of scombroid syndrome mimicking an anaphylactic fish allergy. Int J Emerg Med. 2025.", url: "https://doi.org/10.1186/s12245-025-00930-3" },
...
export const TOX_SAMPS: Samp[] = [
  ...
  /* 09 Histamine fish poisoning ------------------------------------------ */
  {
    id: "tox-09",
    topic: "tox",
    alsoTopics: ["chest-pain", "anaphylaxis"],
    title: "Flushing and chest tightness after dinner",
    stem:
      "A 46-year-old woman presents to the emergency department 50 minutes after eating seared tuna at a restaurant. About 30 minutes into the meal she noticed a peppery taste, then a hot flushed face, a throbbing headache, palpitations and tightness across her chest. She has had two loose stools. Her husband, who shared the tuna, is flushed with a headache and is waiting in triage. She eats tuna often and has no known allergies, asthma or heart disease. She smokes 10 cigarettes a day and takes no medications. Her face, neck and upper chest are bright red and blanch. There are no hives. Her lips and tongue are not swollen. There is no stridor or wheeze. The ECG shows sinus tachycardia without ST changes.",
    vitals: { temperature: "37.3°C oral", pulse: "128/minute", resp: "20/minute", bp: "112/64 mmHg", o2sat: "98% on room air", weight: "68 kg" },
    questions: [
      {
        id: "q1",
        kind: "short",
        required: 2,
        prompt: "Which features of her presentation point to histamine fish poisoning rather than an allergy to fish?",
        accept: [
          { id: "cluster", text: "Her husband, who ate the same fish, is ill at the same time", match: ["husband", "spouse", "partner", "other diner", "same fish", "shared", "cluster", "both ill", "others ill", "two people"] },
        ...
        explanation:
          "Her husband ate the same tuna and fell ill at the same time, and illness in everyone who shared the fish points to a toxin in the fish rather than an allergy in one person. She eats tuna often without trouble and has no food allergy. A peppery taste, then flushing of the face and upper chest, headache, palpitations and loose stools within an hour of eating fit histamine formed in poorly chilled fish. Anaphylaxis to fish usually starts within a few minutes, with generalized hives, swelling or hypotension, and she has none of these. Histamine survives cooking, so searing the tuna did not make it safe.",
        keyFeature: { topic: "tox", n: 2 },
      ...
      },
      {
        ...
        kind: "short",
        required: 2,
        prompt: "What drug treatment do you give her now?",
        accept: [
          { id: "h2", text: "An H2 antihistamine such as famotidine IV", match: ["famotidine", "pepcid", "cimetidine", "ranitidine", "h2 blocker", "h2 antagonist", "h2 antihistamine", "h2 receptor", "h2ra"] },
      ...
      },
      {
        id: "q3",
        kind: "menu",
        update: "After diphenhydramine and famotidine IV, her flushing and headache fade over 40 minutes and her pulse is 96/minute. Her husband improves with the same treatment.",
        prompt: "Which of the following belong in her plan once her symptoms have resolved?",
        options: [
          "Allergist referral for fish allergy testing",
          "Avoid all finned fish until allergy testing",
          "Cetirizine 10 mg PO daily for 2 days",
          "Epinephrine 0.3 mg autoinjector prescription",
          "Montelukast 10 mg PO daily for 7 days",
          "Prednisone 50 mg PO daily for 5 days",
          "Resume eating fish once she is well",
          "Tuna specific IgE blood test",
        ],
        select: 2,
        correct: [2, 6],
        explanation:
          "Scombroid is poisoning by histamine formed in badly stored fish, not an immune reaction, so the allergy pathway does not apply to her. Her husband fell ill from the same tuna and she eats tuna often without trouble, so an IgE-mediated fish allergy is unlikely and she may eat fish again once well. A day or two of oral cetirizine is a reasonable way to cover histamine still being absorbed from the gut, although the evidence for it is limited. An epinephrine autoinjector, fish avoidance, allergist referral and tuna specific IgE testing are the steps that prevent true fish allergy reactions. Prednisone is kept for severe reactions with airway edema, bronchospasm or hypotension. Montelukast blocks leukotrienes, and ingested histamine is the mediator here.",
        keyFeature: { topic: "tox", n: 4 },
        source: "gingras-2025",
      },
      {
        ...
        explanation:
          "New ST depression with chest tightness means myocardial ischemia until proven otherwise. Histamine constricts the coronary arteries and raises heart rate and cardiac automaticity, and scombroid poisoning has caused ST depression with wall motion loss, arrhythmias and severe myocardial dysfunction. Coronary spasm, allergic reactions and takotsubo cardiomyopathy are recognized causes of infarction with non-obstructive coronary arteries, and tachycardia can cause Type 2 MI. A true allergic reaction evolving toward anaphylaxis would also tighten the chest. Pulmonary embolism and aortic dissection remain the life-threatening alternatives to ACS that CT is used to exclude. Serial troponin and ECGs follow, and her smoking adds to her coronary risk.",
        keyFeature: { topic: "chest-pain", n: 1 },
        source: "esc-acs-2023",
      },
    ],
    sources: [S.cdcYb, S.tortorella, S.gingras, S.esc2023],
    ...META,
    version: 2,
    reviewed: false,
  },
