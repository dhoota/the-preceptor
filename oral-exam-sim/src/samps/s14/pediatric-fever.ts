    ...
    questions: [
      {
        ...
        options: [
          ...
          "Remove the snowsuit and blankets",
        ],
        correct: 4,
        explanation:
      ...
      },
      {
        ...
        accept: [
          { id: "fever", text: "It is a true fever, a rectal temperature of 38.0°C or more", match: ["true fever", "real fever", "genuine fever", "still febrile", "still has a fever", "38.0", "38 or more", "38 or higher", "fever over 38", "fever above 38", "fever more than 38", "fever at least 38", "still over 38", "still above 38"] },
          ...
          { id: "infection", text: "She still needs the evaluation for infection that a febrile infant aged 61 to 90 days needs", match: ["infection", "septic workup", "sepsis workup", "septic work up", "workup", "work up", "urinalysis", "urine culture", "uti", "bacterial"] },
        ],
        unacceptable: [
          { text: "Overheating alone explains it, so she needs no testing", match: ["overheating alone", "only overheating", "just overheating", "bundling explains", "due to bundling", "from bundling", "no test", "no testing", "no workup", "no work up", "no investigation", "from overheating", "due to overheating", "caused by overheating", "because of overheating", "overheated", "hyperthermia", "from overdressing", "overdressed", "caused by the snowsuit", "due to the snowsuit", "because of the snowsuit", "caused by heat", "due to heat", "because of heat"] },
        ],
        explanation:
          "Her rectal temperature is still 39.4°C after 20 minutes undressed. The CPS defines fever in an infant aged 90 days or younger as any rectal temperature of 38.0°C or more, measured at home or in a clinical setting, and rectal measurement is the reference standard at this age. In a randomized study of well infants aged 11 to 95 days in a room at 22 to 24°C, bundling raised skin temperature but not rectal temperature, and the authors concluded that a raised rectal temperature should rarely if ever be put down to bundling. Her heat exposure was greater than in that study, but a temperature that stays high once the clothing is off still calls for the evaluation for infection her age requires. The CPS advises at least a urinalysis and urine culture for febrile infants aged 61 to 90 days.",
