...
const S = {
  ...
  acsm2023: { id: "acsm-2023", citation: "Roberts WO, Armstrong LE, Sawka MN, Yeargin SW, Heled Y, O'Connor FG. ACSM expert consensus statement on exertional heat illness: recognition, management, and return to activity. Curr Sports Med Rep. 2023." },
  kimTopiramate: { id: "kim-topiramate", citation: "Kim SC, Seol IJ, Kim SJ. Hypohidrosis-related symptoms in pediatric epileptic patients with topiramate. Pediatr Int. 2010.", url: "https://doi.org/10.1111/j.1442-200X.2009.02912.x" },
...
export const PEDIATRIC_FEVER_SAMPS: Samp[] = [
  ...
  /* 11 ------------------------------------------------------------------ */
  {
    ...
    title: "Confused boy brought from a day camp",
    stem:
      "A 9-year-old boy is brought to the emergency department by ambulance from a city day camp in Winnipeg. A heat warning is in effect, with an air temperature of 32°C. He played soccer for an hour after lunch, then vomited and became confused. Staff found him lying in the shade, not making sense. He has focal epilepsy. He started topiramate 3 months ago, and the dose was increased 2 weeks ago. He is agitated and does not know where he is. GCS 13 (E3 V4 M6). His skin is flushed, hot and dry. Pupils are 4 mm and reactive. His neck is supple and there is no rash. The triage temperature was taken with a temporal artery thermometer.",
    vitals: { temperature: "38.6°C temporal", pulse: "152/minute", resp: "32/minute", bp: "96/54 mmHg", o2sat: "98% on room air", weight: "30 kg" },
    questions: [
      {
        id: "q1",
        kind: "single",
        ...
        correct: 3,
        explanation:
          "A confused, hot child after exertion in the heat has exertional heat stroke until a core temperature says otherwise. Heat stroke is defined by central nervous system dysfunction with a rectal temperature usually above 40°C, and a temporal artery reading can badly underestimate core temperature. When a rectal temperature can be taken at once, it is the best first step, and it sets the end point for cooling. If it cannot be taken at once, cooling comes first. Acetaminophen is not a cooling method. CT, lumbar puncture and a urine screen would delay cooling and can wait until he is cooler.",
      ...
      },
      {
        ...
        kind: "short",
        required: 2,
        update: "His rectal temperature is 41.4°C.",
        prompt: "What cooling measures do you use?",
        accept: [
          { id: "immersion", text: "Ice water or cold water immersion, in a tub or a tarp", match: ["immersion", "ice bath", "ice water", "cold water", "tub", "tarp"] },
          { id: "towels", text: "Rotating ice water soaked towels on the trunk, limbs and head", match: ["towel"] },
          { id: "packs", text: "Ice packs to the neck, axillae and groin as an adjunct", match: ["ice pack", "groin", "axilla", "axillae"] },
          { id: "spray", text: "Continuous cool water spray or dousing, with fans", match: ["spray", "dousing", "douse", "fan", "mist", "evaporative"] },
          { id: "probe", text: "Repeated or continuous rectal temperature during cooling", match: ["rectal", "probe", "core temperature"] },
          { id: "end", text: "Continue until about 38°C or until his mental status recovers", match: ["38", "mental status", "until alert", "wakes up"] },
        ],
        unacceptable: [{ text: "Antipyretics", match: ["acetaminophen", "ibuprofen", "antipyretic", "tylenol", "advil"] }],
        explanation:
          "Survival depends on how fast his temperature falls. Water conducts heat far better than air, so cold or ice water immersion is the preferred method when it is available. Ice water towels, dousing, spray and fans can start cooling while a tub or tarp is set up. Ice packs over the neck, axillae and groin help but are not enough alone. The ACSM places the end point at about 38°C or at recovery of normal mental status. Antipyretics are not a cooling method and should not replace any of these.",
      ...
      },
      {
        ...
        kind: "short",
        required: 3,
        prompt: "What history do you obtain from the camp staff and his parents?",
        accept: [
          { id: "topiramate", text: "Topiramate dose, the recent increase and adherence", match: ["topiramate", "dose", "adherence", "medication change"] },
          { id: "othermeds", text: "Access to other medications such as antihistamines, stimulants or antidepressants", match: ["antihistamine", "stimulant", "adhd", "antidepressant", "anticholinergic", "other medication", "ingestion", "pill"] },
          { id: "fluids", text: "How much he drank during the day", match: ["fluid intake", "drink", "drank", "water", "hydration"] },
          { id: "activity", text: "Duration and intensity of activity in the sun", match: ["activity", "exertion", "soccer", "sun exposure", "how long"] },
          { id: "clothing", text: "Heavy clothing or gear", match: ["clothing", "clothes", "dressed", "gear"] },
          { id: "acclim", text: "Whether these were his first hot days of the season", match: ["acclimatization", "acclimatized", "acclimatised", "first hot"] },
          { id: "illness", text: "Recent fever, diarrhea, vomiting or sick contacts", match: ["diarrhea", "diarrhoea", "sick contact", "recent illness", "fever before"] },
          { id: "sweat", text: "Whether he was sweating before he collapsed", match: ["sweat", "sweating"] },
          { id: "seizure", text: "Any seizure activity", match: ["seizure", "convulsion", "shaking"] },
        ],
        explanation:
          "Heat stroke usually has several contributors, and some are not infections. Topiramate commonly reduces sweating in children, and his hot, dry skin fits. A recent dose increase matters. Anticholinergic drugs such as antihistamines, stimulants and antidepressants also impair heat loss or raise heat production, and a child may take someone else's pills. Poor fluid intake, heavy clothing, lack of acclimatization and a recent vomiting or diarrheal illness all add risk. A seizure can also cause confusion, so ask what staff saw.",
        keyFeature: { topic: "pediatric-fever", n: 6 },
        source: "acsm-2023",
      },
      {
        ...
        kind: "short",
        required: 2,
        update: "After 20 minutes of cooling, his rectal temperature is 38.2°C. He is alert and oriented. His mother arrives and asks whether this could happen again.",
        prompt: "What do you tell his mother and his neurologist about his medication and heat?",
        accept: [
          { id: "cause", text: "Topiramate reduces sweating and likely contributed", match: ["reduces sweating", "reduced sweating", "hypohidrosis", "sweat", "sweating", "oligohidrosis"] },
          { id: "review", text: "His neurologist should review the topiramate and may switch to another drug", match: ["neurologist", "switch", "replace", "another drug", "another antiepileptic", "alternative"] },
          { id: "avoid", text: "Avoid hot, humid conditions and hard play in the heat while he takes it", match: ["avoid hot", "avoid heat", "avoid humid", "heat warning", "shade", "air conditioning", "air conditioned"] },
          { id: "signs", text: "Watch for flushing, heat intolerance and dry skin", match: ["flushing", "heat intolerance", "dry skin", "not sweating"] },
          { id: "drink", text: "Scheduled drinks during activity", match: ["hydration", "hydrate", "water", "drink", "fluid"] },
          { id: "camp", text: "Tell the camp and school staff", match: ["camp", "school", "coach"] },
          { id: "report", text: "Report the adverse drug reaction to Canada Vigilance", match: ["canada vigilance", "adverse drug reaction", "medeffect", "adverse reaction"] },
        ],
        explanation:
          "About 4 in 10 children taking topiramate in one prospective series had symptoms of reduced sweating, such as facial flushing, heat intolerance and hyperthermia. No child on other antiepileptic drugs had them. The authors advise that children on topiramate avoid hot and humid environments. His neurologist should decide whether to continue it, since stopping an antiepileptic drug has its own risks. The family and camp need to know the warning signs and plan shade, rest and drinks.",
        keyFeature: { topic: "environmental", n: 2 },
        source: "kim-topiramate",
      },
    ],
    sources: [S.acsm2023, S.kimTopiramate],
    ...META,
    version: 2,
    reviewed: false,
  },
