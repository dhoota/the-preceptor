  ...
  /* 11 ------------------------------------------------------------------ */
  {
    ...
    questions: [
      ...
      },
      {
        ...
        accept: [
          { id: "fever", text: "It is a true fever, a rectal temperature of 38.0°C or more", match: ["true fever", "real fever", "febrile", "fever"] },
        ...
        unacceptable: [
          { text: "Overheating alone explains it, so she needs no testing", match: ["overheating alone", "only overheating", "just overheating", "bundling explains", "due to bundling", "from bundling", "no test", "no testing", "no workup", "no work up", "no investigation"] },
        ],
        explanation:
